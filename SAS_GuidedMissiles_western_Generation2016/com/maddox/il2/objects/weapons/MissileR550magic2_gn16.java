// Source File Name: MissileR550magic2_gn16.java
// Author:           western0221
...
public class MissileR550magic2_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileR550magic2_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileR550magic2_gn16.class;
		...
		Property.set(class1, "groundTrackFactor", 17.5F); // lower value means higher probability of ground target tracking
		...
		Property.set(class1, "PkMaxFOVfrom", 22.0F); // max Angle offset from launch A/C POV for Pk calculation
	...
	public MissileR550magic2_gn16() {
	}

	public MissileR550magic2_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
