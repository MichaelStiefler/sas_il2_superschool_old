...
public class MissileAIM9D_gn16 extends Missile {
	...
	static {
		Class class1 = MissileAIM9D_gn16.class;
		...
		Property.set(class1, "maxFOVfrom", 5.0F); // max Angle offset from launch A/C POV
		Property.set(class1, "maxFOVto", 60.0F); // max Angle offset from target aft POV
		Property.set(class1, "PkMaxFOVfrom", 6.6F); // max Angle offset from launch A/C POV for Pk calculation
