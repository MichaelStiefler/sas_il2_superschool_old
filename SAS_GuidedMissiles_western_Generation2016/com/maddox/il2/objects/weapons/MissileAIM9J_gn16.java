// Source File Name: MissileAIM9J.java
// Author:           western0221
...
public class MissileAIM9J_gn16 extends Missile {
	...
	static {
		Class class1 = MissileAIM9J_gn16.class;
		...
		Property.set(class1, "timeFire", 5.0F); // Rocket Engine Burn time in Seconds
		Property.set(class1, "force", 16000F); // Rocket Engine Power (in Newton)
		...
		Property.set(class1, "massa", 77.0F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 52.2F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "maxFOVfrom", 33.0F); // max Angle offset from launch A/C POV
		...
		Property.set(class1, "friendlyName", "AIM-9J"); // Display Name of this missile
