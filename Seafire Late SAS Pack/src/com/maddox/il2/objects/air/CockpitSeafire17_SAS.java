...
public class CockpitSeafire17_SAS extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (fm != null) {
				...
				float f = ((SEAFIRE17_SAS) aircraft()).k14Distance;
				setNew.k14w = (5F * CockpitSeafire17_SAS.k14TargetWingspanScale[((SEAFIRE17_SAS) aircraft()).k14WingspanType]) / f;
				setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
				setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitSeafire17_SAS.k14TargetMarkScale[((SEAFIRE17_SAS) aircraft()).k14WingspanType];
				setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float) ((SEAFIRE17_SAS) aircraft()).k14Mode;
				...
				float f3 = floatindex((f - 200F) * 0.04F, CockpitSeafire17_SAS.k14BulletDrop) - CockpitSeafire17_SAS.k14BulletDrop[0];
	...
	public CockpitSeafire17_SAS() {
		...
		tmpP = new Point3d();
		tmpV = new Vector3d();
		if (aircraft() instanceof SEAFIRE17_SAS) {
			mesh.materialReplace("BORT2", "BORT2b");
			mesh.materialReplace("text14", "text14b");
		}
		cockpitNightMats = (new String[] { "COMPASS", "BORT2", "prib_five", "prib_five_damage", "prib_one", "prib_one_damage", "prib_three", "prib_three_damage", "prib_two", "prib_two_damage",
				"text13", "text15" });
		setNightMats(false);
	...
	public void reflectWorldToInstruments(float f) {
		...
		int i = ((SEAFIRE17_SAS) aircraft()).k14Mode;
		boolean flag = i < 2;
		...
		if (aircraft() instanceof SEAFIRE17_SAS) {
			if (SEAFIRE17_SAS.bChangedPit) {
				reflectPlaneToModel();
				SEAFIRE17_SAS.bChangedPit = false;
			}
		}
		...
		mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -floatindex(cvt(Pitot.Indicator((float) fm.Loc.z, fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 25F), speedometerScale));
	...
	private static final float speedometerScale[] = { 0.0F, 7.5F, 17.5F, 37F, 63F, 88.5F, 114.5F, 143F, 171.5F, 202.5F, 228.5F, 255.5F, 282F, 309F, 336.5F, 366.5F, 394F, 421F, 448.5F, 474.5F, 500.5F,
			530F, 557.5F, 584F, 609F, 629F };
	...
	private static final float k14BulletDrop[] = { 5.812F, 6.168F, 6.508F, 6.978F, 7.24F, 7.576F, 7.849F, 8.108F, 8.473F, 8.699F, 8.911F, 9.111F, 9.384F, 9.554F, 9.787F, 9.928F, 9.992F, 10.282F,
