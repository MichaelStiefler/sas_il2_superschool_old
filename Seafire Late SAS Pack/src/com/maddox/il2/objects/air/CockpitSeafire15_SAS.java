...
public class CockpitSeafire15_SAS extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (fm != null) {
				...
				float f = ((SEAFIRE15_SAS) aircraft()).k14Distance;
				setNew.k14w = (5F * CockpitSeafire15_SAS.k14TargetWingspanScale[((SEAFIRE15_SAS) aircraft()).k14WingspanType]) / f;
				setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
				setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitSeafire15_SAS.k14TargetMarkScale[((SEAFIRE15_SAS) aircraft()).k14WingspanType];
				setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float) ((SEAFIRE15_SAS) aircraft()).k14Mode;
				...
				float f3 = floatindex((f - 200F) * 0.04F, CockpitSeafire15_SAS.k14BulletDrop) - CockpitSeafire15_SAS.k14BulletDrop[0];
	...
	public CockpitSeafire15_SAS() {
		...
		tmpP = new Point3d();
		tmpV = new Vector3d();
		if (aircraft() instanceof SEAFIRE15_SAS) {
	...
	public void reflectWorldToInstruments(float f) {
		...
		int i = ((SEAFIRE15_SAS) aircraft()).k14Mode;
		boolean flag = i < 2;
		...
		if (aircraft() instanceof SEAFIRE15_SAS) {
			if (SEAFIRE15_SAS.bChangedPit) {
				reflectPlaneToModel();
				SEAFIRE15_SAS.bChangedPit = false;
			}
		}
