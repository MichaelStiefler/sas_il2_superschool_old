...
public class SEAFIRE47_SAS extends SPITFIRE9 implements TypeFighterAceMaker, TypeBNZFighter {

	public SEAFIRE47_SAS() {
		k14Mode = 0;
		k14WingspanType = 0;
		k14Distance = 200F;
		flapps = 0.0F;
	...
	static {
		Class class1 = SEAFIRE47_SAS.class;
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitSeafire47_SAS.class });
		...
		Aircraft.weaponsRegister(class1, "3x500lb", new String[] { "MGunHispanoMkIkpzl 175", "MGunHispanoMkIkpzl 175", "MGunHispanoMkIkpzl 150", "MGunHispanoMkIkpzl 150", "PylonSpitC 1",
				...
				null, null, null });
		Aircraft.weaponsRegister(class1, "8xHVAR", new String[] { "MGunHispanoMkIkpzl 175", "MGunHispanoMkIkpzl 175", "MGunHispanoMkIkpzl 150", "MGunHispanoMkIkpzl 150", null, null, null, null, null,
				null, null, null, "PylonSpitROCK 1", "PylonSpitROCK 1", "PylonSpitROCK 1", "PylonSpitROCK 1", null, null, null, "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1",
				"RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", null });
		Aircraft.weaponsRegister(class1, "90gal_dt+8xHVAR", new String[] { "MGunHispanoMkIkpzl 175", "MGunHispanoMkIkpzl 175", "MGunHispanoMkIkpzl 150", "MGunHispanoMkIkpzl 150", "PylonSpitC 1",
				null, null, null, null, null, null, null, "PylonSpitROCK 1", "PylonSpitROCK 1", "PylonSpitROCK 1", "PylonSpitROCK 1", null, null, null, "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1",
				"RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "FuelTankGun_TankSF17 1" });
		Aircraft.weaponsRegister(class1, "1x250lb+8xHVAR", new String[] { "MGunHispanoMkIkpzl 175", "MGunHispanoMkIkpzl 175", "MGunHispanoMkIkpzl 150", "MGunHispanoMkIkpzl 150", "PylonSpitC 1", null,
				null, null, null, "BombGun250lbsE 1", null, null, "PylonSpitROCK 1", "PylonSpitROCK 1", "PylonSpitROCK 1", "PylonSpitROCK 1", null, null, null, "RocketGunHVAR5BEAU 1",
				"RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", null });
		Aircraft.weaponsRegister(class1, "1x500lb+8xHVAR", new String[] { "MGunHispanoMkIkpzl 175", "MGunHispanoMkIkpzl 175", "MGunHispanoMkIkpzl 150", "MGunHispanoMkIkpzl 150", "PylonSpitC 1", null,
				null, null, null, "BombGun500lbsE 1", null, null, "PylonSpitROCK 1", "PylonSpitROCK 1", "PylonSpitROCK 1", "PylonSpitROCK 1", null, null, null, "RocketGunHVAR5BEAU 1",
				"RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", "RocketGunHVAR5BEAU 1", null });
