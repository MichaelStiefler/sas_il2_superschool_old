...
public class AircraftState {
	...
	private static final String astateOilStrings[] = {
		"3DO/Effects/Aircraft/OilSmokeSPD.eff",
		"3DO/Effects/Aircraft/OilSmokeTSPD.eff", null, null };
	private static final String astateTankStrings[] = { null, null, null,
		"3DO/Effects/Aircraft/RedLeakTSPD.eff", null, null,
		"3DO/Effects/Aircraft/RedLeakTSPD.eff", null, null,
		"3DO/Effects/Aircraft/TankSmokeSPD.eff",
		"3DO/Effects/Aircraft/TankSmokeTSPD.eff", null,
		...
		"3DO/Effects/Aircraft/FireGND.eff",
		"3DO/Effects/Aircraft/BlackHeavyGND.eff", null };
	private static final String astateEngineStrings[] = { null, null, null,
		"3DO/Effects/Aircraft/GraySmallSPD.eff",
		"3DO/Effects/Aircraft/GraySmallTSPD.eff", null,
		"3DO/Effects/Aircraft/EngineSmokeSPD.eff",
		"3DO/Effects/Aircraft/EngineSmokeTSPD.eff", null,
		"3DO/Effects/Aircraft/EngineHeavySPD.eff",
		"3DO/Effects/Aircraft/EngineHeavyTSPD.eff", null,
		"3DO/Effects/Aircraft/FireSPD.eff",
		"3DO/Effects/Aircraft/EngineHeavySPD.eff",
		"3DO/Effects/Aircraft/EngineHeavyTSPD.eff", null, null, null,
		"3DO/Effects/Aircraft/GraySmallGND.eff", null, null,
		"3DO/Effects/Aircraft/BlackMediumGND.eff", null, null,
		"3DO/Effects/Aircraft/BlackHeavyGND.eff", null, null,
		"3DO/Effects/Aircraft/FireGND.eff",
		"3DO/Effects/Aircraft/BlackHeavyGND.eff", null };
	private static final String astateCondensateStrings[] = { null,
	"3DO/Effects/Aircraft/CondensateTSPD.eff" };
	private static final String astateStallStrings[] = { null,
	"3DO/Effects/Aircraft/StallTSPD.eff" };
	public static final String astateHUDPilotHits[] = { "Player", "Pilot",
		"CPilot", "NGunner", "TGunner", "WGunner", "VGunner", "RGunner",
		"EngMas", "BombMas", "RadMas", "ObsMas" };
	...
	private Eff3DActor astateOilEffects[][] = { { null, null }, { null, null },
			{ null, null }, { null, null }, { null, null }, { null, null },
			{ null, null }, { null, null } };
	public byte astateTankStates[] = { 0, 0, 0, 0 };
	private Eff3DActor astateTankEffects[][] = { { null, null, null },
			{ null, null, null }, { null, null, null }, { null, null, null } };
	public byte astateEngineStates[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
	private Eff3DActor astateEngineEffects[][] = { { null, null, null },
			{ null, null, null }, { null, null, null }, { null, null, null },
			{ null, null, null }, { null, null, null }, { null, null, null },
			{ null, null, null } };
	public byte astateSootStates[] = { 0, 0, 0, 0, 0, 0, 0, 0 };
	public Eff3DActor astateSootEffects[][] = { { null, null }, { null, null },
			{ null, null }, { null, null }, { null, null }, { null, null },
			{ null, null }, { null, null } };
	public Eff3DActor astateCondensateEffects[] = { null, null, null, null,
			null, null, null, null };
	...
	private Eff3DActor astateNavLightsEffects[] = { null, null, null, null,
			null, null };
	private LightPointActor astateNavLightsLights[] = { null, null, null, null,
			null, null };
	public Eff3DActor astateLandingLightEffects[] = { null, null, null, null };
	private LightPointActor astateLandingLightLights[] = { null, null, null,
			null };
	public String astateEffectChunks[] = { null, null, null, null, null, null,
	...
	static class Item {
		...
		boolean equals(int i, int i_1_, Actor actor) {
			return msgDestination == i && msgContext == i_1_
					&& initiator == actor;
		}
	}
	...
	private void doSetOilState(int i, int j) {
		if (astateOilStates[i] == j)
			return;
		Aircraft.debugprintln(aircraft, "AS: Checking '"
				+ astateEffectChunks[i + 22] + "' visibility..");
		boolean flag = aircraft
				.isChunkAnyDamageVisible(astateEffectChunks[i + 22]);
		Aircraft.debugprintln(aircraft, "AS: '" + astateEffectChunks[i + 22]
				+ "' is " + (flag ? "visible" : "invisible") + "..");
		Aircraft.debugprintln(aircraft, "Stating OilFilter " + i + " to state "
				+ j + (flag ? ".." : " rejected (missing part).."));
		if (!flag)
			return;
		Aircraft.debugprintln(aircraft, "Stating OilFilter " + i + " to state "
				+ j + "..");
		...
		case 1: // '\001'
			...
			if (s != null)
				try {
					astateOilEffects[i][0] = Eff3DActor.New(actor,
							actor.findHook("_Engine" + (i + 1) + "Oil"), null,
							1.0F, s, -1F);
				} catch (Exception exception) {
				}
			...
			if (s != null)
				try {
					astateOilEffects[i][1] = Eff3DActor.New(actor,
							actor.findHook("_Engine" + (i + 1) + "Oil"), null,
							1.0F, s, -1F);
	...
	public void setTankState(Actor actor1, int i, int j) {
		...
		if (bIsMaster) {
			...
			if (aircraft.FM.isPlayers() && actor1 != actor
					&& (actor1 instanceof Aircraft)
					&& ((Aircraft) actor1).isNetPlayer() && j > 5
					&& astateTankStates[0] < 5 && astateTankStates[1] < 5
					&& astateTankStates[2] < 5 && astateTankStates[3] < 5
					&& !aircraft.FM.isSentBuryNote())
				Chat.sendLogRnd(3, "gore_lightfuel", (Aircraft) actor1,
						aircraft);
			netToMirrors(9, i, j);
		} else {
	...
	public boolean doSetTankState(Actor actor1, int i, int j) {
		boolean flag = aircraft
				.isChunkAnyDamageVisible(astateEffectChunks[i + 0]);
		Aircraft.debugprintln(aircraft, "Stating Tank " + i + " to state " + j
				+ (flag ? ".." : " rejected (missing part).."));
		if (!flag)
			return false;
		...
		for (int k = 0; k < 3; k++) {
			...
			if (s != null)
				if (j > 2)
					astateTankEffects[i][k] = Eff3DActor.New(actor,
							actor.findHook("_Tank" + (i + 1) + "Burn"), null,
							1.0F, s, -1F);
				else
					astateTankEffects[i][k] = Eff3DActor.New(actor,
							actor.findHook("_Tank" + (i + 1) + "Leak"), null,
							1.0F, s, -1F);
		}
	...
	private void doHitTank(Actor actor1, int i) {
		if ((World.Rnd().nextInt(0, 99) < 75 || (actor instanceof Scheme1))
				&& astateTankStates[i] == 6) {
			...
			if (World.Rnd().nextInt(0, 99) < 75 && aircraft.FM.Skill > 1) {
				Aircraft.debugprintln(aircraft, "BAILING OUT - Tank " + i
						+ " is on fire!.");
				hitDaSilk();
			}
	...
	private void doExplodeTank(int i) {
		...
		Eff3DActor.New(actor, actor.findHook("_Tank" + (i + 1) + "Burn"), null,
				1.0F, "3DO/Effects/Fireworks/Tank_Burn.eff", -1F);
		Eff3DActor.New(actor, actor.findHook("_Tank" + (i + 1) + "Burn"), null,
				1.0F, "3DO/Effects/Fireworks/Tank_SmokeBoiling.eff", -1F);
		Eff3DActor.New(actor, actor.findHook("_Tank" + (i + 1) + "Burn"), null,
				1.0F, "3DO/Effects/Fireworks/Tank_Sparks.eff", -1F);
		Eff3DActor.New(actor, actor.findHook("_Tank" + (i + 1) + "Burn"), null,
				1.0F, "3DO/Effects/Fireworks/Tank_SparksP.eff", -1F);
		aircraft.msgCollision(actor, astateEffectChunks[i + 0] + "0",
				astateEffectChunks[i + 0] + "0");
		if ((actor instanceof Scheme1)
				&& aircraft.isChunkAnyDamageVisible(astateEffectChunks[i + 0]))
			aircraft.msgCollision(actor, "CF_D0", "CF_D0");
		HookNamed hooknamed = new HookNamed((ActorMesh) actor, "_Tank"
				+ (i + 1) + "Burn");
		Loc loc = new Loc();
		Loc loc1 = new Loc();
	...
	public void setEngineState(Actor actor1, int i, int j) {
		...
		if (bIsMaster) {
			...
			if (aircraft.FM.isPlayers() && actor1 != actor
					&& (actor1 instanceof Aircraft)
					&& ((Aircraft) actor1).isNetPlayer() && j > 3
					&& astateEngineStates[0] < 3 && astateEngineStates[1] < 3
					&& astateEngineStates[2] < 3 && astateEngineStates[3] < 3
					&& !aircraft.FM.isSentBuryNote())
	...
	public boolean doSetEngineState(Actor actor1, int i, int j) {
		Aircraft.debugprintln(aircraft, "AS: Checking '"
				+ astateEffectChunks[i + 4] + "' visibility..");
		boolean flag = aircraft
				.isChunkAnyDamageVisible(astateEffectChunks[i + 4]);
		Aircraft.debugprintln(aircraft, "AS: '" + astateEffectChunks[i + 4]
				+ "' is " + (flag ? "visible" : "invisible") + "..");
		Aircraft.debugprintln(aircraft, "Stating Engine " + i + " to state "
				+ j + (flag ? ".." : " rejected (missing part).."));
		if (!flag)
			return false;
		...
		for (int k = 0; k < 3; k++) {
			...
			if (s != null)
				astateEngineEffects[i][k] = Eff3DActor.New(actor,
						actor.findHook("_Engine" + (i + 1) + "Smoke"), null,
						1.0F, s, -1F);
		}
	...
	private void doHitEngine(Actor actor1, int i) {
		...
		if (astateEngineStates[i] >= 2 && !(actor instanceof Scheme1)
		...
		if (astateEngineStates[i] == 4)
			if (actor instanceof Scheme1) {
				if (World.Rnd().nextBoolean()) {
					Aircraft.debugprintln(aircraft, "BAILING OUT - Engine " + i
							+ " is on fire..");
					aircraft.hitDaSilk();
				}
				aircraft.FM.setReadyToDie(true);
	...
	private void doExplodeEngine(int i) {
		...
		Eff3DActor.New(actor, actor.findHook("_Engine" + (i + 1) + "Smoke"),
				null, 1.0F, "3DO/Effects/Fireworks/Tank_Burn.eff", -1F);
		Eff3DActor.New(actor, actor.findHook("_Engine" + (i + 1) + "Smoke"),
				null, 1.0F, "3DO/Effects/Fireworks/Tank_SmokeBoiling.eff", -1F);
		Eff3DActor.New(actor, actor.findHook("_Engine" + (i + 1) + "Smoke"),
				null, 1.0F, "3DO/Effects/Fireworks/Tank_Sparks.eff", -1F);
		Eff3DActor.New(actor, actor.findHook("_Engine" + (i + 1) + "Smoke"),
				null, 1.0F, "3DO/Effects/Fireworks/Tank_SparksP.eff", -1F);
		aircraft.msgCollision(aircraft, astateEffectChunks[i + 4] + "0",
				astateEffectChunks[i + 4] + "0");
		Actor actor1;
		if (aircraft.getDamager() != null)
			actor1 = aircraft.getDamager();
		else
			actor1 = actor;
		HookNamed hooknamed = new HookNamed((ActorMesh) actor, "_Engine"
				+ (i + 1) + "Smoke");
		Loc loc = new Loc();
		Loc loc1 = new Loc();
		actor.pos.getCurrent(loc);
		hooknamed.computePos(actor, loc, loc1);
		MsgExplosion.send(null, astateEffectChunks[4 + i] + "0",
				loc1.getPoint(), actor1, 1.248F, 0.026F, 1, 75F);
	}
	...
	private void doSetEngineSpecificDamage(int i, int j) {
		...
		case 2: // '\002'
			throw new RuntimeException("(" + aircraft.typedName()
					+ ") A.S.: Unimplemented feature (E.S.D./H.)");
		...
		default:
			throw new RuntimeException("(" + aircraft.typedName()
					+ ") A.S.: Corrupt data in (E.S.D./null)");
		}
	}
	...
	public void doSetEngineExtinguisherVisuals(int i) {
		...
		Aircraft.debugprintln(aircraft, "AS: '" + astateEffectChunks[i + 4]
				+ "' is " + (flag ? "visible" : "invisible") + "..");
		Aircraft.debugprintln(aircraft, "Firing Extinguisher on Engine " + i
				+ (flag ? ".." : " rejected (missing part).."));
		if (!flag) {
			return;
		} else {
			Eff3DActor.New(actor,
					actor.findHook("_Engine" + (i + 1) + "Smoke"), null, 1.0F,
					"3DO/Effects/Aircraft/EngineExtinguisher1.eff", 3F);
			return;
		}
	}
	...
	public void setControlsDamage(Actor actor1, int i) {
		...
		if (bIsMaster) {
			...
			if (aircraft.FM.isPlayers() && actor1 != actor
					&& (actor1 instanceof Aircraft)
					&& ((Aircraft) actor1).isNetPlayer()
					&& !aircraft.FM.isSentControlsOutNote()
					&& !aircraft.FM.isSentBuryNote()) {
	...
	private void doSetControlsDamage(int i, Actor actor1) {
		...
		default:
			throw new RuntimeException("(" + aircraft.typedName()
					+ ") A.S.: Corrupt data in (C.A.D./null)");
		}
	}
	...
	private void doSetGliderBoostOn() {
		...
		else if (actor instanceof AR_234B2)
			((AR_234B2) actor).doFireBoosters();
		else
			throw new RuntimeException("(" + aircraft.typedName()
					+ ") A.S.: Unexpected command (G.B./On not in Nul)");
	}
	...
	private void doSetGliderBoostOff() {
		if (actor instanceof Scheme0)
			...
			throw new RuntimeException("(" + aircraft.typedName()
					+ ") A.S.: Unexpected command (G.B./Off not in Nul)");
	}
	...
	private void doSetGliderCutCart() {
		if (actor instanceof Scheme0)
			...
			throw new RuntimeException("(" + aircraft.typedName()
					+ ") A.S.: Unexpected command (G.C.C./Off not in Nul)");
	}
	...
	private void doSetCondensateState(boolean flag) {
		for (int i = 0; i < aircraft.FM.EI.getNum(); i++) {
			...
			if (flag) {
				...
				if (s != null)
					try {
						astateCondensateEffects[i] = Eff3DActor.New(actor,
								actor.findHook("_Engine" + (i + 1) + "Smoke"),
								astateCondensateDispVector, 1.0F, s, -1F);
					} catch (Exception exception) {
						Aircraft.debugprintln(aircraft,
								"Above condensate failed - probably a glider..");
					}
			}
		}
	...
	private void doSetStallState(boolean flag) {
		...
		if (flag) {
			...
			if (s != null) {
				if (bWingTipLExists)
					astateStallEffects[0] = Eff3DActor.New(actor,
							actor.findHook("_WingTipL"), null, 1.0F, s, -1F);
				if (bWingTipRExists)
					astateStallEffects[1] = Eff3DActor.New(actor,
							actor.findHook("_WingTipR"), null, 1.0F, s, -1F);
			}
		}
	}
	...
	private void doSetBeacon(Actor actor1, int i, int j) {
		...
		if (World.getPlayerAircraft() != actor)
			return;
		if (i > 0) {
			Actor actor2 = (Actor) Main.cur().mission.getBeacons(
					actor.getArmy()).get(i - 1);
			boolean flag = Aircraft.hasPlaneZBReceiver(aircraft);
			if (!flag
					&& ((actor2 instanceof TypeHasYGBeacon) || (actor2 instanceof TypeHasHayRake))) {
				int k = i - beacon;
				beacon = i;
				if (k > 0)
					beaconPlus();
			...
			if (aircraft.getPilotsCount() == 1
					|| aircraft.FM.EI.engines.length == 1)
				Main3D.cur3D().ordersTree.setFrequency(null);
			if (actor2 instanceof TypeHasYGBeacon) {
				Main3D.cur3D().ordersTree
				.setFrequency(OrdersTree.FREQ_FRIENDLY);
				...
				String s2 = Property.stringValue(actor2.getClass(), "i18nName",
						s);
	...
	public void startListeningRadioStation(String s) {
		...
		if (k < 10)
			...
			s4 = "" + k;
		String as[] = { s2 + s3 + s4, s2 + s3 + "XX", s2 + "XX" + s4,
				s2 + "XXXX" };
	...
	private void doSetNavLightsState(boolean flag) {
		...
		if (flag) {
			for (int j = 0; j < astateNavLightsEffects.length; j++) {
				Aircraft.debugprintln(aircraft, "AS: Checking '"
						+ astateEffectChunks[j + 12] + "' visibility..");
				boolean flag1 = aircraft
						.isChunkAnyDamageVisible(astateEffectChunks[j + 12]);
				Aircraft.debugprintln(aircraft, "AS: '"
						+ astateEffectChunks[j + 12] + "' is "
						+ (flag1 ? "visible" : "invisible") + "..");
				if (flag1) {
					bNavLightsOn = flag;
	...
	private void doSetLandingLightState(boolean flag) {
		...
		if (flag) {
			for (int j = 0; j < astateLandingLightEffects.length; j++) {
				Aircraft.debugprintln(aircraft, "AS: Checking '"
						+ astateEffectChunks[j + 18] + "' visibility..");
				boolean flag1 = aircraft
						.isChunkAnyDamageVisible(astateEffectChunks[j + 18]);
				Aircraft.debugprintln(aircraft, "AS: '"
						+ astateEffectChunks[j + 18] + "' is "
						+ (flag1 ? "visible" : "invisible") + "..");
				if (flag1) {
					String s = "3DO/Effects/Fireworks/FlareWhiteWide.eff";
					astateLandingLightEffects[j] = Eff3DActor.New(actor,
							actor.findHook("_LandingLight0" + j), null, 1.0F,
							s, -1F);
	...
	public void setPilotState(Actor actor1, int i, int j, boolean flag) {
		...
		if (bIsMaster) {
			...
			if (flag && aircraft.FM.isPlayers() && i == astatePlayerIndex
					&& !World.isPlayerDead() && actor1 != actor
					&& (actor1 instanceof Aircraft)
					&& ((Aircraft) actor1).isNetPlayer() && j == 100)
	...
	private void doSetBleedingPilot(int i, int j, Actor actor1) {
		if (Mission.isSingle() || aircraft.FM.isPlayers()
				&& !Mission.isServer() || Mission.isNet() && Mission.isServer()
				&& !aircraft.isNetPlayer()) {
			if (j == 0)
				return;
			long l = 0x1d4c0 / j;
			if (astateBleedingNext[i] == 0L) {
				astateBleedingNext[i] = l;
				if (World.getPlayerAircraft() == actor && Config.isUSE_RENDER()
						&& (!bIsAboutToBailout || astateBailoutStep <= 11)
						&& astatePilotStates[i] < 100) {
					boolean flag = i == astatePlayerIndex
							&& !World.isPlayerDead();
					if (j < 10)
						HUD.log(flag ? "PlayerBLEED0"
								: astateHUDPilotHits[astatePilotFunctions[i]]
										+ "BLEED0");
					else
						HUD.log(flag ? "PlayerBLEED1"
								: astateHUDPilotHits[astatePilotFunctions[i]]
										+ "BLEED1");
				}
			} else {
	...
	private void doSetPilotState(int i, int j, Actor actor1) {
		...
		if (World.getPlayerAircraft() == actor && Config.isUSE_RENDER()
			...
			if (astatePilotStates[i] < 100 && j == 100) {
				HUD.log(flag ? "PlayerHIT2"
						: astateHUDPilotHits[astatePilotFunctions[i]] + "HIT2");
				if (flag) {
					World.setPlayerDead();
					if (Mission.isNet())
					...
					if (Main3D.cur3D().cockpits != null
						...
						for (int l = 0; l < k; l++) {
							...
							if (Actor.isValid(cockpit)
									&& cockpit.astatePilotIndx() != i
									&& !isPilotDead(cockpit.astatePilotIndx())
									&& !Mission.isNet()
									&& AircraftHotKeys.isCockpitRealMode(l))
								AircraftHotKeys.setCockpitRealMode(l, false);
						}

					}
				}
			} else if (astatePilotStates[i] < 66 && j > 66)
				HUD.log(flag ? "PlayerHIT1"
						: astateHUDPilotHits[astatePilotFunctions[i]] + "HIT1");
			else if (astatePilotStates[i] < 25 && j > 25)
				HUD.log(flag ? "PlayerHIT0"
						: astateHUDPilotHits[astatePilotFunctions[i]] + "HIT0");
		}
		...
		if (j > 99) {
			...
			EventLog.onPilotKilled(aircraft, i, actor1 == aircraft ? null
					: actor1);
		} else if (byte0 < 66 && j > 66)
			EventLog.onPilotHeavilyWounded(aircraft, i);
		else if (byte0 < 25 && j > 25)
	...
	public void setJamBullets(int i, int j) {
		if (aircraft.FM.CT.Weapons[i] == null
				|| aircraft.FM.CT.Weapons[i].length <= j
				|| aircraft.FM.CT.Weapons[i][j] == null)
			return;
		if (bIsMaster) {
			doSetJamBullets(i, j);
			netToMirrors(24, i, j);
	...
	private void doSetJamBullets(int i, int j) {
		if (aircraft.FM.CT.Weapons != null && aircraft.FM.CT.Weapons[i] != null
				&& aircraft.FM.CT.Weapons[i][j] != null
				&& aircraft.FM.CT.Weapons[i][j].haveBullets()) {
			if (actor == World.getPlayerAircraft()
					&& aircraft.FM.CT.Weapons[i][j].haveBullets())
				if (aircraft.FM.CT.Weapons[i][j].bulletMassa() < 0.095F)
					HUD.log(i > 9 ? "FailedTMGun" : "FailedMGun");
				else
	...
	private void doSetFlatTopString(Actor actor1, int i) {
		if (Actor.isValid(actor1) && (actor1 instanceof BigshipGeneric)
				&& ((BigshipGeneric) actor1).getAirport() != null) {
	...
	public void update(float f) {
		...
		bCriticalStatePassed = bIsAboveCriticalSpeed != (aircraft
				.getSpeed(null) > 10D);
		...
		bCriticalStatePassed = bIsAboveCondensateAlt != (aircraft.FM
				.getAltitude() > 7000F);
		if (bCriticalStatePassed) {
			bIsAboveCondensateAlt = aircraft.FM.getAltitude() > 7000F;
			doSetCondensateState(bIsAboveCondensateAlt);
		}
		bCriticalStatePassed = bIsOnInadequateAOA != (aircraft.FM.getSpeed() > 17F && aircraft.FM
				.getAOA() > 15F - aircraft.FM.getAltitude() * 0.001F);
		if (bCriticalStatePassed) {
			bIsOnInadequateAOA = aircraft.FM.getSpeed() > 17F
					&& aircraft.FM.getAOA() > 15F - aircraft.FM.getAltitude() * 0.001F;
		...
		if (bIsMaster) {
			...
			for (int j1 = 0; j1 < 4; j1++)
				...
				case 1: // '\001'
					if (World.Rnd().nextFloat(0.0F, 1.0F) < 0.0125F) {
						repairTank(j1);
						Aircraft.debugprintln(aircraft, "Tank " + j1
								+ " protector clothes the hole - leak stops..");
					}
					// fall through
				...
				case 5: // '\005'
					...
					if (World.Rnd().nextFloat() < 0.0048F) {
						Aircraft.debugprintln(aircraft, "Tank " + j1
								+ " fires up to the next stage..");
						hitTank(aircraft, j1, 1);
					}
					if (!(actor instanceof Scheme1)
							|| astateTankEffects[j1][0] == null
							|| Math.abs(astateTankEffects[j1][0].pos
									.getRelPoint().y) >= 1.8999999761581421D
									|| astateTankEffects[j1][0].pos.getRelPoint().x <= -2.5999999046325684D
									|| astatePilotStates[0] >= 96)
						break;
					hitPilot(actor, 0, 5);
					if (astatePilotStates[0] < 96)
						break;
					hitPilot(actor, 0, 101 - astatePilotStates[0]);
					if (aircraft.FM.isPlayers() && Mission.isNet()
							&& !aircraft.FM.isSentBuryNote())
						Chat.sendLogRnd(3, "gore_burnedcpt", aircraft, null);
					break;

				case 6: // '\006'
					if (aircraft.FM.getSpeed() > 140F
							&& World.Rnd().nextFloat(0.0F, 1.0F) < 0.05F) {
						repairTank(j1);
						Aircraft.debugprintln(aircraft, "Tank " + j1
								+ " cuts fire..");
					}
			...
			for (int k1 = 0; k1 < aircraft.FM.EI.getNum(); k1++) {
				if (astateEngineStates[k1] > 1) {
					aircraft.FM.EI.engines[k1].setReadyness(actor,
							aircraft.FM.EI.engines[k1].getReadyness()
							- (float) astateEngineStates[k1] * 0.00025F
							* f);
					if (aircraft.FM.EI.engines[k1].getReadyness() < 0.2F
							&& aircraft.FM.EI.engines[k1].getReadyness() != 0.0F)
				...
				case 3: // '\003'
					if (World.Rnd().nextFloat(0.0F, 1.0F) < 0.01F) {
						...
						Aircraft.debugprintln(aircraft, "Engine " + k1
								+ " catches fire..");
					}
					break;
				...
				case 4: // '\004'
					if (aircraft.FM.getSpeed() > 111F
							&& World.Rnd().nextFloat(0.0F, 1.0F) < 0.15F) {
						repairEngine(k1);
						Aircraft.debugprintln(aircraft, "Engine " + k1
								+ " cuts fire..");
					}
					if ((actor instanceof Scheme1)
							&& World.Rnd().nextFloat() < 0.06F) {
						Aircraft.debugprintln(aircraft,
								"Engine 0 detonates and explodes, fatal damage level forced..");
						aircraft.msgCollision(actor, "CF_D0", "CF_D0");
					}
					if ((actor instanceof Scheme1) && astatePilotStates[0] < 96) {
						...
						if (astatePilotStates[0] >= 96) {
							...
							if (aircraft.FM.isPlayers() && Mission.isNet()
									&& !aircraft.FM.isSentBuryNote())
								Chat.sendLogRnd(3, "gore_burnedcpt", aircraft,
										null);
						}
					}
					break;
				...
				if (astateOilStates[k1] > 0)
					aircraft.FM.EI.engines[k1].setReadyness(aircraft,
							aircraft.FM.EI.engines[k1].getReadyness()
							- 0.001875F * f);
			}
	...
	private final void doRemoveBlister1() {
		if (aircraft.hierMesh().chunkFindCheck("Blister1_D0") != -1
				&& getPilotHealth(0) > 0.0F) {
			if (aircraft instanceof JU_88NEW) {
				float f = aircraft.FM.getAltitude()
						- Landscape.HQ_Air((float) aircraft.FM.Loc.x,
								(float) aircraft.FM.Loc.y);
				if (f < 0.3F) {
			...
			Wreckage wreckage = new Wreckage((ActorHMesh) actor, aircraft
					.hierMesh().chunkFind("Blister1_D0"));
	...
	private final void doRemoveBlisters() {
		for (int i = 2; i < 10; i++)
			if (aircraft.hierMesh().chunkFindCheck("Blister" + i + "_D0") != -1
			&& getPilotHealth(i - 1) > 0.0F) {
				aircraft.hierMesh().hideSubTrees("Blister" + i + "_D0");
				Wreckage wreckage = new Wreckage((ActorHMesh) actor, aircraft
						.hierMesh().chunkFind("Blister" + i + "_D0"));
				wreckage.collide(false);
				Vector3d vector3d = new Vector3d();
				vector3d.set(aircraft.FM.Vwld);
				wreckage.setSpeed(vector3d);
	...
	public void netUpdate(boolean flag, boolean flag1, NetMsgInput netmsginput)
		...
		if (flag1) {
			if (flag) {
				...
				case 4: // '\004'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unexpected command (E.S.)");

				case 5: // '\005'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unexpected command (E.R.)");

				case 6: // '\006'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unexpected command (E.E.)");
				...
				case 12: // '\f'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unexpected command (G.B./On)");

				case 13: // '\r'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unexpected command (G.B./Off)");

				case 14: // '\016'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unexpected command (G.C.C./Off)");

				case 15: // '\017'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unexpected command (A.S.S.)");

				case 30: // '\036'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unexpected command (NV.LT.ST.)");

				case 31: // '\037'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unexpected command (LA.LT.ST.)");

				case 16: // '\020'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unexpected command (W.T.S.)");
				...
				case 18: // '\022'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unimplemented feature (K.P.)");

				case 19: // '\023'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unimplemented feature (H.S.)");

				case 20: // '\024'
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Unexpected command (B.O.)");
				...
				case 34: // '"'
					((TypeDockable) aircraft).typeDockableRequestAttach(actor1,
							k, true);
					break;

				case 35: // '#'
					((TypeDockable) aircraft).typeDockableRequestDetach(actor1,
							k, true);
					break;
				...
				aircraft.net.postTo(
						aircraft.net.masterChannel(),
						new NetMsgGuaranted(netmsginput, netmsginput
								.available() > 3 ? 1 : 0));
			}
		} else {
			if (aircraft.net.isMirrored())
				aircraft.net.post(new NetMsgGuaranted(netmsginput, netmsginput
						.available() > 3 ? 1 : 0));
			...
			case 12: // '\f'
				if (j1 == 5)
					...
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Corrupt data in signal (G.S.B./On)");
				break;
			...
			case 13: // '\r'
				if (j1 == 7)
					...
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Corrupt data in signal (G.S.B./Off)");
				break;
			...
			case 14: // '\016'
				if (j1 == 9)
					...
					throw new RuntimeException("(" + aircraft.typedName()
							+ ") A.S.: Corrupt data in signal (G.C.C./Off)");
				break;
			...
			case 18: // '\022'
				throw new RuntimeException("(" + aircraft.typedName()
						+ ") A.S.: Unimplemented signal (K.P.)");

			case 19: // '\023'
				throw new RuntimeException("(" + aircraft.typedName()
						+ ") A.S.: Unimplemented signal (H.S.)");
			...
			case 34: // '"'
				...
				.typeDockableDoAttachToDrone(actor2, l);
				break;
	...
	public void netReplicate(NetMsgGuaranted netmsgguaranted)
		...
		if (aircraft instanceof FW_190A8MSTL)
			...
			i = aircraft.FM.EI.getNum();
		for (int j = 0; j < i; j++) {
			aircraft.FM.EI.engines[j].replicateToNet(netmsgguaranted);
		...
		netmsgguaranted.writeByte((bShowSmokesOn ? 1 : 0)
				| (bNavLightsOn ? 2 : 0) | (bLandingLightOn ? 4 : 0));
		...
		if (aircraft instanceof TypeDockable)
			((TypeDockable) aircraft)
			.typeDockableReplicateToNet(netmsgguaranted);
		if (aircraft.FM.CT.bHasWingControl) {
		...
		if (aircraft.FM.CT.bHasArrestorControl) {
			...
			netmsgguaranted
			.writeByte((int) (aircraft.FM.CT.getArrestor() * 255F));
		}
		...
		if (World.getPlayerAircraft() == aircraft)
			replicateFuzeStatesToNet(World.cur().userCfg.fuzeType,
					Fuze_EL_AZ.getFuzeMode(), World.cur().userCfg.bombDelay);
		// TODO
	...
	public void netFirstUpdate(NetMsgInput netmsginput) throws IOException {
		...
		if (aircraft instanceof FW_190A8MSTL)
			...
			i = aircraft.FM.EI.getNum();
		for (int j = 0; j < i; j++) {
			aircraft.FM.EI.engines[j].replicateFromNet(netmsginput);
			int k = netmsginput.readUnsignedByte();
		...
		if (l1 != 0) {
			...
			for (int i2 = 1; i2 <= Math.min(astateBailoutStep, 3); i2++)
				if (aircraft.hierMesh().chunkFindCheck(
						"Blister" + (i2 - 1) + "_D0") != -1)
					aircraft.hierMesh().hideSubTrees(
							"Blister" + (i2 - 1) + "_D0");
		...
		if (aircraft.FM.CT.bHasWingControl) {
			...
			aircraft.FM.CT
			.forceWing((float) netmsginput.readUnsignedByte() / 255F);
		...
		if (aircraft.FM.CT.bHasArrestorControl) {
			...
			aircraft.FM.CT
			.forceArrestor((float) netmsginput.readUnsignedByte() / 255F);
		...
		if (aircraft.isNetPlayer()) {
			...
			int j3 = l2 % 6;
			float f = Property.floatValue(aircraft.getClass(), "LOSElevation",
					0.75F);
			updConvDist(j3, 0, f);
			l2 = (l2 - j3) / 6;
			j3 = l2 % 6;
	...
	public void setArmingSeeds() {
		...
		try {
			if (aircraft.FM.CT.Weapons[2] != null) {
				for (int i = 0; i < aircraft.FM.CT.Weapons[2].length; i++)
					if (aircraft.FM.CT.Weapons[2][i] instanceof RocketGun) {
						((RocketGun) aircraft.FM.CT.Weapons[2][i])
						.setSpreadRnd(armingRnd.nextInt());
					}

			}
			if (aircraft.FM.CT.Weapons[3] != null) {
				for (int j = 0; j < aircraft.FM.CT.Weapons[3].length; j++)
					if ((aircraft.FM.CT.Weapons[3][j] instanceof BombGun)
							&& !(aircraft.FM.CT.Weapons[3][j] instanceof FuelTankGun)) {
						int l = armingRnd.nextInt();
						((BombGun) aircraft.FM.CT.Weapons[3][j]).setRnd(l);
					}
	...
	public void netToMaster(int i, int j, int k, Actor actor1) {
		if (!bIsMaster) {
			...
			if (sendedMsg(itemsToMaster, i, j, k, actor1))
				return;
			try {
				NetMsgGuaranted netmsgguaranted = aircraft
						.netNewAStateMsg(true);
	...
	private void doSetFuzeStates(Actor actor1, int i, int j) {
		...
		if (aircraft.FM.CT.Weapons[3] != null) {
			for (int i1 = 0; i1 < aircraft.FM.CT.Weapons[3].length; i1++)
				if (aircraft.FM.CT.Weapons[3][i1] != null
				&& (aircraft.FM.CT.Weapons[3][i1] instanceof BombGun)
				&& aircraft.FM.CT.Weapons[3][i1].countBullets() != 0) {
