...
//    EventLog.type("stepTargetHoming " + millisecondsFromStart);
  ...
  //TODO: For Countermeasures:
    ...
    int lockTime = random.nextInt((int) (lFlareLockTime + 1000));
  	...
  	for (int t = 0; t < m; t++) {
  		...
  		if(lockType == 1 && flarechaff instanceof com.maddox.il2.objects.weapons.RocketFlare &&  lFlareLockTime < lockTime && flare1Distance < 200D && (double) (GuidedMissileUtils.angleActorBetween(victim, this)) > 30)
  		{
  			victim = flarechaff;
  		} else { if(flarechaff instanceof com.maddox.il2.objects.weapons.RocketChaff &&  lFlareLockTime < lockTime && flare1Distance < 500D && (double) (GuidedMissileUtils.angleActorBetween(victim, this)) > 30)
  			victim = flarechaff;
  		}
  	}
