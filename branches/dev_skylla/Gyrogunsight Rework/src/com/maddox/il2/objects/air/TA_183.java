...
import com.maddox.il2.objects.air.PaintSchemeFMPar06;
...
public class TA_183 extends Scheme1 implements TypeFighter, TypeBNZFighter, TypeX4Carrier, TypeFighterAceMaker {
   ...
   static Class class$com$maddox$il2$objects$air$CockpitTA_183;
   ...
   public void moveSteering(float var1) {
      if(this.FM.CT.getGear() > 0.8F) {
         this.hierMesh().chunkSetAngles("GearC6_D0", 0.0F, var1, 0.0F);
      }
   ...
   protected void hitBone(String var1, Shot var2, Point3d var3) {
      if(var1.startsWith("xx")) {
         if(var1.startsWith("xxarmor")) {
            ...
            if(var1.endsWith("p1")) {
               this.getEnergyPastArmor((double)World.Rnd().nextFloat(12.0F, 19.0F) / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-5D), var2);
            } else if(var1.endsWith("p2")) {
               this.getEnergyPastArmor((double)World.Rnd().nextFloat(12.7F, 12.7F) / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-5D), var2);
            } else if(var1.endsWith("g1")) {
               this.getEnergyPastArmor((double)World.Rnd().nextFloat(20.0F, 60.0F) / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-5D), var2);
               this.FM.AS.setCockpitState(var2.initiator, this.FM.AS.astateCockpitState | 2);
               if(var2.power <= 0.0F) {
                  this.doRicochetBack(var2);
               }
            }
         } else {
            int var4;
            if(var1.startsWith("xxcontrols")) {
               ...
               if(var1.endsWith("bloc")) {
                  this.getEnergyPastArmor((double)World.Rnd().nextFloat(0.0F, 60.0F) / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-5D), var2);
               }
               ...
               if(var1.startsWith("xxspark") && World.Rnd().nextFloat() < 0.5F && this.getEnergyPastArmor((double)(6.8F * World.Rnd().nextFloat(1.0F, 1.5F)) / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-5D), var2) > 0.0F) {
                  Aircraft.debugprintln(this, "*** Keel Spars Damaged..");
                  this.nextDMGLevels(1, 2, "Keel1_D" + this.chunkDamageVisible("Keel1"), var2.initiator);
               }

               if(var1.startsWith("xxspart") && this.chunkDamageVisible("Tail1") > 2 && this.getEnergyPastArmor(3.86F / (float)Math.sqrt(Aircraft.v1.y * Aircraft.v1.y + Aircraft.v1.z * Aircraft.v1.z), var2) > 0.0F && World.Rnd().nextFloat() < 0.25F) {
         ...
         if(var1.startsWith("xtail")) {
            ...
            if(var1.startsWith("xstabl")) {
               this.hitChunk("StabL", var2);
            }

            if(var1.startsWith("xstabr")) {
               this.hitChunk("StabR", var2);
            }
         } else if(var1.startsWith("xvator")) {
            if(var1.startsWith("xvatorl") && this.chunkDamageVisible("VatorL") < 1) {
               this.hitChunk("VatorL", var2);
            }

            if(var1.startsWith("xvatorr") && this.chunkDamageVisible("VatorR") < 1) {
               this.hitChunk("VatorR", var2);
            }
         } else if(var1.startsWith("xwing")) {
            if(var1.startsWith("xwinglin") && this.chunkDamageVisible("WingLIn") < 3) {
               this.hitChunk("WingLIn", var2);
            }

            if(var1.startsWith("xwingrin") && this.chunkDamageVisible("WingRIn") < 3) {
               this.hitChunk("WingRIn", var2);
            }

            if(var1.startsWith("xwinglmid") && this.chunkDamageVisible("WingLMid") < 3) {
               this.hitChunk("WingLMid", var2);
            }

            if(var1.startsWith("xwingrmid") && this.chunkDamageVisible("WingRMid") < 3) {
               this.hitChunk("WingRMid", var2);
            }

            if(var1.startsWith("xwinglout") && this.chunkDamageVisible("WingLOut") < 3) {
               this.hitChunk("WingLOut", var2);
            }

            if(var1.startsWith("xwingrout") && this.chunkDamageVisible("WingROut") < 3) {
               this.hitChunk("WingROut", var2);
            }
         } else if(var1.startsWith("xarone")) {
            if(var1.startsWith("xaronel") && this.chunkDamageVisible("AroneL") < 1) {
               this.hitChunk("AroneL", var2);
            }

            if(var1.startsWith("xaroner") && this.chunkDamageVisible("AroneR") < 1) {
         ...
         if(var1.startsWith("xcockpit")) {
            ...
            if(World.Rnd().nextFloat() < 0.2F) {
               this.FM.AS.setCockpitState(var2.initiator, this.FM.AS.astateCockpitState | 64);
            }
         } else if(var3.y > 0.0D) {
   ...
   public void rareAction(float var1, boolean var2) {
      ...
      if((!(this.FM instanceof RealFlightModel) || !((RealFlightModel)this.FM).isRealMode()) && var2 && this.FM instanceof Pilot) {
         ...
         if(var3.get_maneuver() == 63 && var3.target != null) {
            ...
            this.FM.Or.transformInv((Tuple3d)var4);
 ...
 //-------------------------------------------------------------------------------------------------------
   ...
   static {
      Class var0 = CLASS.THIS();
      new NetAircraft.SPAWN(var0);
      Property.set(var0, "iconFar_shortClassName", "Ta-183");
      Property.set(var0, "meshName", "3DO/Plane/Ta-183(Multi1)/hier.him");
      Property.set(var0, "PaintScheme", (Object)(new PaintSchemeFMPar06()));
      Property.set(var0, "originCountry", PaintScheme.countryGermany);
      Property.set(var0, "yearService", 1946.0F);
      Property.set(var0, "yearExpired", 1948.5F);
      Property.set(var0, "FlightModel", "FlightModels/Ta-183.fmd");
      Property.set(var0, "cockpitClass", (Object)(class$com$maddox$il2$objects$air$CockpitTA_183 == null?(class$com$maddox$il2$objects$air$CockpitTA_183 = class$("com.maddox.il2.objects.air.CockpitTA_183")):class$com$maddox$il2$objects$air$CockpitTA_183));
      Property.set(var0, "LOSElevation", 1.2158F);
      Aircraft.weaponTriggersRegister(var0, new int[]{0, 0, 0, 0, 9, 9, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2});
      Aircraft.weaponHooksRegister(var0, new String[]{"_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalDev01", "_ExternalDev02", "_ExternalRock01", "_ExternalRock02", "_ExternalRock03", "_ExternalRock04", "_ExternalRock05", "_ExternalRock06", "_ExternalRock07", "_ExternalRock08", "_ExternalRock09", "_ExternalRock10", "_ExternalRock11", "_ExternalRock12", "_ExternalRock13", "_ExternalRock14", "_ExternalRock15", "_ExternalRock16", "_ExternalRock17", "_ExternalRock18", "_ExternalRock19", "_ExternalRock20", "_ExternalRock21", "_ExternalRock22", "_ExternalRock23", "_ExternalRock24", "_ExternalRock25", "_ExternalRock25", "_ExternalRock26", "_ExternalRock26", "_ExternalRock27", "_ExternalRock27", "_ExternalRock28", "_ExternalRock28"});
      Aircraft.weaponsRegister(var0, "default", new String[]{"MGunMK108k 120", "MGunMK108k 120", "MGunMK108k 120", "MGunMK108k 120", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null});
      Aircraft.weaponsRegister(var0, "24r4m", new String[]{"MGunMK108k 120", "MGunMK108k 120", "MGunMK108k 120", "MGunMK108k 120", "PylonMe262_R4M_Left", "PylonMe262_R4M_Right", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", "RocketGunR4M 1", null, null, null, null, null, null, null, null});
      Aircraft.weaponsRegister(var0, "4x4", new String[]{"MGunMK108k 120", "MGunMK108k 120", "MGunMK108k 120", "MGunMK108k 120", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, "RocketGunX4 1", "BombGunNull 1", "RocketGunX4 1", "BombGunNull 1", "RocketGunX4 1", "BombGunNull 1", "RocketGunX4 1", "BombGunNull 1"});
      Aircraft.weaponsRegister(var0, "none", new String[]{null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null});
   }
}
