...
public class P_80 extends Scheme1 implements TypeFighter, TypeBNZFighter, TypeFighterAceMaker
{
    ...
    static /* synthetic */ Class class$com$maddox$il2$objects$air$P_80;
  ...
  //-------------------------------------------------------------------------------------------------------
    ...
    public void moveWheelSink() {
        ...
        P_80.xyz[0] = -0.19075f * cvt;
        this.hierMesh().chunkSetLocate("GearC6_D0", P_80.xyz, P_80.ypr);
    ...
    protected void hitBone(final String s, final Shot shot, final Point3d point3d) {
        ...
        if (s.startsWith("xxarmor")) {
            ...
            if (s.endsWith("p1")) {
                this.getEnergyPastArmor(13.350000381469727 / (Math.abs(P_80.v1.x) + 9.999999747378752E-5), shot);
                if (shot.power <= 0.0f) {
                ...
                this.getEnergyPastArmor(World.Rnd().nextFloat(40.0f, 60.0f) / (Math.abs(P_80.v1.x) + 9.999999747378752E-5), shot);
        ...
        if (s.startsWith("xxeng1")) {
            ...
            if (s.endsWith("bloc")) {
                this.getEnergyPastArmor(World.Rnd().nextFloat(0.0f, 60.0f) / (Math.abs(P_80.v1.x) + 9.999999747378752E-5), shot);
            }
        ...
        if (this.FM.AS.isMaster()) {
            if (this.curctl == -1.0f) {
                ...
                if (this.curctl < 1.05f) {
                    if ((this.curctl - this.oldctl) / f > 3.0f && this.FM.EI.engines[0].getRPM() < 2400.0f && this.FM.EI.engines[0].getStage() == 6 && World.Rnd().nextFloat() < 0.25f) {
    ...
    static {
        Property.set((P_80.class$com$maddox$il2$objects$air$P_80 == null) ? (P_80.class$com$maddox$il2$objects$air$P_80 = class$("com.maddox.il2.objects.air.P_80")) : P_80.class$com$maddox$il2$objects$air$P_80, "originCountry", PaintScheme.countryUSA);
    }
}
