 ...
 *
 * <p>
 * Enum names of this enum themselves are represented by <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">ISO 3166-1 alpha-2</a> code (2-letter upper-case alphabets). There are instance methods to get the country name ({@link #getName()}), the <a
 * href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3" >ISO 3166-1 alpha-3</a> code ({@link #getAlpha3()}) and the <a href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric">ISO 3166-1 numeric</a> code ({@link #getNumeric()}). In addition, there are
 * static methods to get a {@code CountryCode} instance that corresponds to a given alpha-2/alpha-3/numeric code ({@link #getByCode(String)}, {@link #getByCode(int)}).
 * </p>
 *
...
public enum CountryCode {
     ...
     *
     * <p>
     * In most cases, this method creates a new {@code Locale} instance every time it is called, but some {@code CountryCode} instances return their corresponding entries in {@code Locale} class. For example, {@link #CA CountryCode.CA} always returns
     * {@link Locale#CANADA}.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * This method is an alias of {@link Currency}{@code .}{@link Currency#getInstance(Locale) getInstance}{@code (}{@link #toLocale()}{@code )}. The only difference is that this method returns {@code null} when {@code Currency.getInstance(Locale)} throws
     ...
     *
     * <p>
     * In addition, this method returns {@code null} also when the ISO 3166 code represented by this {@code CountryCode} instance is not supported by the implementation of {@link Currency#getInstance(Locale)}. At the time of this writing, {@link #SS}
     ...
     *            If {@code false}, this method internally canonicalizes the given code by {@link String#toUpperCase()} and then performs search. For example, {@code getByCode("jp", true)} returns {@code null}, but on the other hand,
     ...
     *
     * @return
     *         If {@code code} is {@code null} or an empty string, {@code null} is returned.
