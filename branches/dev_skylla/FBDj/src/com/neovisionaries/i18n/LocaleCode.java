 ...
 *
 * <p>
 * The list of the enum entries was generated based on the output from {@link java.util.Locale#getAvailableLocales()
 * Locale.getAvailableLocales()} of Java SE 7, but locales whose format do not match either 'xx' or 'xx-XX' were excluded.
 * </p>
 *
...
public enum LocaleCode {
     ...
     *
     * <p>
     * where <i>language</i> is an <a href="http://en.wikipedia.org/wiki/ISO_639-1">ISO 639-1</a> code and <i>country</i> is an <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">ISO 3166-1 alpha-2</a> code.
     * </p>
     *
     * @return
     ...
     *
     * <p>
     * In most cases, this method creates a new Locale instance every time it is called, but some LocaleCode instancess return their corresponding entries in Locale class. For example, {@link #it LocaleCode.it} always returns {@link Locale#ITALIAN}.
     * </p>
     *
     * <p>
     * The table below lists LocaleCode entries whose toLocale() do not create new Locale instances but return entries in Locale class.
     * </p>
     *
     ...
     *
     * <p>
     * This method just calls {@link #getByCode(String, boolean) getByCode}{@code (code, true)}. Note that the behavior has changed since the version 1.13. In the older versions, this method was an alias of {@code getByCode(code, false)}.
     * </p>
     *
     * @param code
     *            A locale code.
     ...
     *
     * <p>
     * where <i>language</i> is an <a href="http://en.wikipedia.org/wiki/ISO_639-1">ISO 639-1</a> code and <i>country</i> is an <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">ISO 3166-1 alpha-2</a> code. The separator between <i>language</i>
     * and <i>country</i> should be a hyphen (<code>-</code>) or an underscore (<code>_</code>).
     * </p>
     *
     * <p>
     ...
     * getByCode}{@code (language, country, true)}. Note that the behavior has changed since the version 1.13. In the older versions, this method was an alias of {@code getByCode(language, country, false)}.
     * </p>
     *
     * @param language
    ...
    /**
     * Get a {@code LocaleCode} instance that corresponds to the given {@link Locale} instance.
     *
     * @param locale
     ...
     * getByLanguage}{@code (language, true)}. Note that the behavior has changed since the version 1.13. In the older versions, this method was an alias of {@code getByLanguage(language, false)}.
     * </p>
     *
     * @param language
     ...
     *
     * @return
     *         List of {@code LocaleCode} instances. If there is no {@code LocaleCode} instance whose language matches the given one, the size of the returned
     *         list is zero.
     *
     * @since 1.3
     */
     ...
     * getByLanguage}{@code (}{@link LanguageCode}{@code .}{@link LanguageCode#getByCode(String, boolean) getByCode}{@code (language, caseSensitive))}.
     * </p>
     *
     * @param language
     *            Language code. ISO 639 alpha-2 or alpha-3.
     ...
     * getByCountry}{@code (country, true)}. Note that the behavior has changed since the version 1.13. In the older versions, this method was an alias of {@code getByCountry(country, false)}.
     * </p>
     *
     * @param country
     ...
     *
     * @return
     *         List of {@code LocaleCode} instances. If there is no {@code LocaleCode} instance whose country matches the given one, the size of the returned
     *         list is zero.
     *
     * @since 1.3
     */
     ...
     * getByCountry}{@code (}{@link CountryCode}{@code .}{@link CountryCode#getByCode(String, boolean) getByCode}{@code (country, caseSensitive))}.
     * </p>
     *
     * @param country
     *            Country code. ISO 3166-1 alpha-2 or alpha-3.
