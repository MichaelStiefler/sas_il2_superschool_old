...
final class ServiceFinder {
     ...
     * ClassLoader seg�ts�g�vel.</p>
     * <p>
     * Az implement�l� oszt�ly n�v keres�se a <CODE>serviceId</CODE> nev� system property vizsg�lat�val kezd�dik. Amennyiben nincs ilyen property, �gy a keres�s a <CODE>/META-INF/services/<I>serviceId</I></CODE> nev� file tartalm�val folytat�dik.
     * Amennyiben nincs ilyen nev� file, �gy a param�terk�nt �tadott <CODE>defaultService</CODE> lesz az oszt�ly neve.
     * </p>
     * <p>
