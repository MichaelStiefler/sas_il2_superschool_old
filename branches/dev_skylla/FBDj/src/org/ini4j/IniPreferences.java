...
public class IniPreferences extends AbstractPreferences {
     ...
     *
     * This is just a helper constructor, to make simpler constructing <code>IniPreferences</code> directly from <code>Reader</code>.
     *
     * @param input
     ...
     * Constructs a new preferences node based on newly loaded <code>Ini</code> instance.
     *
     * This is just a helper constructor, to make simpler constructing <code>IniPreferences</code> directly from <code>InputStream</code>.
     *
     * @param input
     ...
     * Constructs a new preferences node based on newly loaded <code>Ini</code> instance.
     *
     * This is just a helper constructor, to make simpler constructing <code>IniPreferences</code> directly from <code>URL</code>.
     *
     * @param input
    ...
    /**
     * Implements the <CODE>getSpi</CODE> method as per the specification in {@link java.util.prefs.AbstractPreferences#getSpi(String)}.
     *
    ...
    /**
     * Implements the <CODE>childrenNamesSpi</CODE> method as per the specification in {@link java.util.prefs.AbstractPreferences#childrenNamesSpi()}.
     * 
    ...
    /**
     * Implements the <CODE>childSpi</CODE> method as per the specification in {@link java.util.prefs.AbstractPreferences#childSpi(String)}.
     * 
     * @param name
     *            child name
     * @return child node
    ...
    /**
     * Implements the <CODE>flushSpi</CODE> method as per the specification in {@link java.util.prefs.AbstractPreferences#flushSpi()}.
     *
    ...
    /**
     * Implements the <CODE>keysSpi</CODE> method as per the specification in {@link java.util.prefs.AbstractPreferences#keysSpi()}.
     *
    ...
    /**
     * Implements the <CODE>putSpi</CODE> method as per the specification in {@link java.util.prefs.AbstractPreferences#putSpi(String,String)}.
     *
     * This implementation doesn;t support this operation, so allways throws UnsupportedOperationException.
     *
     * @param key
    ...
    /**
     * Implements the <CODE>removeNodeSpi</CODE> method as per the specification in {@link java.util.prefs.AbstractPreferences#removeNodeSpi()}.
     *
     * This implementation doesn;t support this operation, so allways throws UnsupportedOperationException.
     * 
     * @throws UnsupportedOperationException
    ...
    /**
     * Implements the <CODE>removeSpi</CODE> method as per the specification in {@link java.util.prefs.AbstractPreferences#removeSpi(String)}.
     * 
     * @param key
     *            key to remove
     * @throws UnsupportedOperationException
    ...
    /**
     * Implements the <CODE>syncSpi</CODE> method as per the specification in {@link java.util.prefs.AbstractPreferences#syncSpi()}.
     *
     * This implementation does nothing.
     *
     * @throws BackingStoreException
    ...
    protected class SectionPreferences extends AbstractPreferences {
        ...
        /**
         * Implements the <CODE>flush</CODE> method as per the specification in {@link java.util.prefs.Preferences#flush()}.
         *
        ...
        /**
         * Implements the <CODE>sync</CODE> method as per the specification in {@link java.util.prefs.Preferences#sync()}.
         *
