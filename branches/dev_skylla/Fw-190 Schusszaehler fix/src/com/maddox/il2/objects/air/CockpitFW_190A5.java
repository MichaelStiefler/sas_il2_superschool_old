...
public class CockpitFW_190A5 extends CockpitPilot
{
  ...
  //------------------------------------------------------------------------
    ...
    public void reflectWorldToInstruments(final float f_54_) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x20) == 0x0 && (this.fm.AS.astateCockpitState & 0x80) == 0x0) {
            this.mesh.chunkSetAngles("NeedleCD", (this.setNew.vspeed < 0.0f) ? this.floatindex(this.cvt(-this.setNew.vspeed, 0.0f, 30.0f, 0.0f, 6.0f), CockpitFW_190A5.vsiNeedleScale) : (-this.floatindex(this.cvt(this.setNew.vspeed, 0.0f, 30.0f, 0.0f, 6.0f), CockpitFW_190A5.vsiNeedleScale)), 0.0f, 0.0f);
        }
        if ((this.fm.AS.astateCockpitState & 0x40) == 0x0 && (this.fm.AS.astateCockpitState & 0x8) == 0x0 && (this.fm.AS.astateCockpitState & 0x10) == 0x0) {
    ...
    static {
        ...
        Property.set((CockpitFW_190A5.class$com$maddox$il2$objects$air$CockpitFW_190A5 == null) ? (CockpitFW_190A5.class$com$maddox$il2$objects$air$CockpitFW_190A5 = class$("com.maddox.il2.objects.air.CockpitFW_190A5")) : CockpitFW_190A5.class$com$maddox$il2$objects$air$CockpitFW_190A5, "normZN", 0.72f);
        Property.set((CockpitFW_190A5.class$com$maddox$il2$objects$air$CockpitFW_190A5 == null) ? (CockpitFW_190A5.class$com$maddox$il2$objects$air$CockpitFW_190A5 = class$("com.maddox.il2.objects.air.CockpitFW_190A5")) : CockpitFW_190A5.class$com$maddox$il2$objects$air$CockpitFW_190A5, "gsZN", 0.66f);
    }
