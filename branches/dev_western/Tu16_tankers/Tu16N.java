    ...
    implements TypeTransport, TypeDockable, TypeTankerDrogue
{
    ...
    private void drogueRefuelAI()
    {
        ...
        if(bEmpty || (FM.getAltitude() < 1000F && FM.getAltitude() != 0.0F && !bFirstTime) || FM.CT.getGear() > 0.0F
           || ias > 700F || (ias < 325F && ias != 0.0F && !bFirstTime) || FM.M.fuel < FM.M.maxFuel * 0.10F || enemy1 != null)
        {
...
//            }
    ...
    protected void moveBayDoor(float f)
    {
        ...
        {
            if(!bEmpty && f > 0.98F && !bDrogueExtended && FM.M.fuel > FM.M.maxFuel * 0.10F)
                decideRefuel(true);
            if((f < 0.95F || FM.M.fuel < FM.M.maxFuel * 0.10F) && bDrogueExtended)
                decideRefuel(false);
        }
