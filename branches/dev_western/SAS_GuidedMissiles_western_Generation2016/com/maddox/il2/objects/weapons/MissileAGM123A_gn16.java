...
public class MissileAGM123A_gn16 extends Missile {
        ...
        if(Actor.isValid(getOwner()))
        {
            ...
            if(laseron)
            {
                ...
                if(p.distance(pT) > 0.0D)
                {
                    ...
                    if(pT.z > 0.10000000000000001D)
                        deltaTangage = f2;
                    or.increment(30F * f2 * deltaAzimuth, 30F * f2 * deltaTangage, 0F);
  ...
  static {
    Class class1 = com.maddox.il2.objects.weapons.MissileAGM123A_gn16.class;
