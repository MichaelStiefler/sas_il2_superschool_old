...
public class MissileAIM9E_gn16 extends Missile {
	...
	static {
		Class class1 = MissileAIM9E_gn16.class;
		...
		Property.set(class1, "timeFire", 2.7F); // Rocket Engine Burn time in Seconds
		Property.set(class1, "force", 22500F); // Rocket Engine Power (in Newton)
		...
		Property.set(class1, "friendlyName", "AIM-9E"); // Display Name of this missile
