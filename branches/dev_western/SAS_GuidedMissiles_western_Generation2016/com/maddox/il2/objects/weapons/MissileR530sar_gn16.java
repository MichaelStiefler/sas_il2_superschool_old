// Source File Name: MissileR530sar_gn16.java
// Author:           western0221
...
public class MissileR530sar_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileR530sar_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileR530sar_gn16.class;
		...
		Property.set(class1, "maxFOVfrom", 16.0F); // max Angle offset from launch A/C POV
		Property.set(class1, "maxFOVto", 360.0F); // max Angle offset from target aft POV
		Property.set(class1, "PkMaxFOVfrom", 13.6F); // max Angle offset from launch A/C POV for Pk calculation
		Property.set(class1, "PkMaxFOVto", 80.0F); // max Angle offset from target aft POV for Pk calculation
		Property.set(class1, "PkDistMin", 600.0F); // min Distance for Pk calculation
		...
		Property.set(class1, "friendlyName", "R530sar"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileR530sar_gn16() {
	}

	public MissileR530sar_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
