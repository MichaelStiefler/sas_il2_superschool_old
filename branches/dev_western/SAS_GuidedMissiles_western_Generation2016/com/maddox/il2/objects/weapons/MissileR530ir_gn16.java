// Source File Name: MissileR530ir_gn16.java
// Author:           western0221
...
public class MissileR530ir_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileR530ir_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileR530ir_gn16.class;
		Property.set(class1, "mesh", "3do/arms/MatraR530_gn16/mono.sim");
		...
		Property.set(class1, "timeFire", 6.5F); // Rocket Engine Burn time in Seconds
		...
		Property.set(class1, "dragCoefficient", 0.32F); // Aerodynamic Drag Coefficient
		Property.set(class1, "powerType", 0); // Type of Explosion. 0="Splash", 1="Splinters", 2="Napalm"
		Property.set(class1, "power", 2.7F); // RL Data: 27kg HE warhead, for realism reduced to 1/10th of it's RL weight
		Property.set(class1, "radius", 16.3F); // Radius of Explosion Effect
        Property.set(class1, "proximityFuzeRadius", 28F); // Exploding decition Radius of Proximity Fuze
		Property.set(class1, "kalibr", 0.260F); // Diameter of Missile Body
		Property.set(class1, "massa", 193F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 135.5F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "maxFOVfrom", 10.0F); // max Angle offset from launch A/C POV
		Property.set(class1, "maxFOVto", 55.0F); // max Angle offset from target aft POV
		Property.set(class1, "PkMaxFOVfrom", 12.0F); // max Angle offset from launch A/C POV for Pk calculation
		Property.set(class1, "PkMaxFOVto", 62.0F); // max Angle offset from target aft POV for Pk calculation
		...
		Property.set(class1, "friendlyName", "R530ir"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileR530ir_gn16() {
        setMesh(Property.stringValue(getClass(), "mesh"));
        mesh.materialReplace("Ordnance1", "Ordnance1IR");
        mesh.materialReplace("Ordnance1p", "Ordnance1IRp");
        mesh.materialReplace("Ordnance1q", "Ordnance1IRq");
	}

	public MissileR530ir_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
