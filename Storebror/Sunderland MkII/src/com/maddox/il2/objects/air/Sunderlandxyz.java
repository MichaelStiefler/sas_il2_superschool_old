...
//        System.out.println("### Sunderland MkII cutFM(" + i + ", " + j + ", " + (actor==null?"null":actor.getClass().getName()) + ")");
    ...
    protected void nextDMGLevel(String s, int i, Actor actor) {
        ...
        if (s.startsWith("CF") || s.startsWith("Tail1")) {
            if (this == World.getPlayerAircraft())
                this.updateDamageState(); // Keep track of fuselage and tail damage states, this is required to hide and show them properly player enters/leaves turrets
        }
    }
