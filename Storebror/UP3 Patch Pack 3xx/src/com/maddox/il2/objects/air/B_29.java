    ...
    implements TypeBomber, TypeX4Carrier, TypeGuidedBombCarrier
{
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            ...
            fSightCurForwardAngle = (float)Math.toDegrees(Math.atan(fSightCurDistance / B_29.toMeters(fSightCurAltitude)));
            calibDistance = B_29.toMetersPerSecond(fSightCurSpeed) * floatindex(Aircraft.cvt(B_29.toMeters(fSightCurAltitude), 0.0F, 7000F, 0.0F, 7F), calibrationScale);
            if((double)fSightCurDistance < (double)calibDistance + (double)B_29.toMetersPerSecond(fSightCurSpeed) * Math.sqrt(B_29.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            //CockpitB29.class, CockpitB29_Bombardier.class, CockpitB29_TGunner.class, CockpitB29_T2Gunner.class, CockpitB29_AGunner.class
        ...
        B_29.weaponTriggersRegister(class1, new int[] {
            10, 10, 10, 10, 11, 11, 12, 12, 13, 13, 
            14, 14, 3, 3, 3, 3
        });
        B_29.weaponHooksRegister(class1, new String[] {
        ...
        B_29.weaponsRegister(class1, "default", new String[] {
