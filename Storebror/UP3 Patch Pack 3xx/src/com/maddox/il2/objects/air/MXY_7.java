    ...
    implements MsgCollisionRequestListener, TypeDockable
{
    ...
    public void msgEndAction(Object obj, int i)
    {
        ...
        case 2:
            ...
            MsgExplosion.send(this, null, FM.Loc, actor, 0.0F, charge_armed?1200F:120F, 0, charge_armed?800F:80F);
            if (!charge_armed) break;
    ...
    public void update(float f)
    {
        ...
        if (FM.getSpeedKMH() > 200F) charge_armed = true;
    }
