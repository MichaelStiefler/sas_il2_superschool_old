...
//        DebugLog("typeDockableIsDocked()", 1);
    ...
    public void typeDockableRequestAttach(Actor actor) {
        ...
        DebugLog("parasiteAircraft.FM.AS.isMaster()=" + parasiteAircraft.FM.AS.isMaster() + ", parasiteAircraft.FM.Gears.onGround()=" + parasiteAircraft.FM.Gears.onGround() + ", parasiteAircraft.FM.getSpeedKMH()=" + parasiteAircraft.FM.getSpeedKMH() + ", this.FM.Gears.onGround()=" + this.FM.Gears.onGround() + ", this.FM.getSpeedKMH()=" + this.FM.getSpeedKMH(), 1);
        ...
        for (int i = 0; i < DRONES_LENGTH; i++) {
            ...
            if (Actor.isValid(drones[i])) continue;
            hookIndex = i;
    ...
    protected static Aircraft GetNearestFriendlyInstance(Aircraft referenceAircraft, float maxDistance) {
        ...
        for (int targetListIndex = 0; targetListIndex < targetListSize; targetListIndex++) {
            ...
            if (curTarget instanceof TB_3_4M_34R_SPB && curTarget != referenceAircraft && curTarget.getArmy() == referenceArmy) {
                ...
                double curTargetDistanceSquared = ((referencePos.x - curTargetPos.x) * (referencePos.x - curTargetPos.x) + (referencePos.y - curTargetPos.y) * (referencePos.y - curTargetPos.y) + (referencePos.z - curTargetPos.z) * (referencePos.z - curTargetPos.z));
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitTB_3.class, CockpitTB_3_Bombardier2.class, CockpitTB_3_NGunner.class,
                CockpitTB_3_TGunner3.class, CockpitTB_3_RGunner.class });
