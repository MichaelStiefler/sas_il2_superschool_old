    ...
    protected void hitBone(String s, Shot shot, Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("t1"))
                {
                    getEnergyPastArmor((double)World.Rnd().nextFloat(21F, 42F) / (Math.abs(Aircraft.v1.x) + 1E-004D), shot);
                    doRicochetBack(shot);
                } else
                if(s.endsWith("t3"))
            ...
            {
                if((s.endsWith("s1") || s.endsWith("7")) && getEnergyPastArmor(4.8F, shot) > 0.0F && World.Rnd().nextFloat() < 0.25F)
                {
                ...
                if((s.endsWith("3") || s.endsWith("6")) && World.Rnd().nextFloat() < 0.5F && getEnergyPastArmor(0.35F, shot) > 0.0F)
                {
