...
public abstract class PE_2 extends Scheme2a
{
    ...
    public static void moveGear(HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearL3_D0", 0.0F, -27F * (float)Math.sin((double)f * 3.1415926535897931D), 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, -170.5F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 112.5F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR3_D0", 0.0F, -27F * (float)Math.sin((double)f * 3.1415926535897931D), 0.0F);
        ...
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxeng1"))
            {
                ...
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(World.Rnd().nextFloat(0.0F, 6.8F), shot) > 0.0F)
                    {
                        ...
                        if(World.Rnd().nextFloat() < shot.power / 28000F)
                        {
                            ...
                            debugprintln(this, "*** Engine1 Crank Case Hit - Cylinder Feed Out, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                        }
                        ...
                        debugprintln(this, "*** Engine1 Crank Case Hit - Readyness Reduced to " + FM.EI.engines[0].getReadyness() + "..");
                    }
                ...
                if((s.endsWith("cyl1") || s.endsWith("cyl2")) && getEnergyPastArmor(World.Rnd().nextFloat(0.5F, 2.542F), shot) > 0.0F && World.Rnd().nextFloat() < FM.EI.engines[0].getCylindersRatio() * 1.72F)
                {
                    ...
                    debugprintln(this, "*** Engine1 Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/" + FM.EI.engines[0].getCylinders() + " Left..");
                    if(World.Rnd().nextFloat() < 0.01F)
                    {
                        FM.EI.engines[0].setEngineStuck(shot.initiator);
            ...
            if(s.startsWith("xxeng2"))
            {
                ...
                if(s.endsWith("case"))
                {
                    if(getEnergyPastArmor(World.Rnd().nextFloat(0.0F, 6.8F), shot) > 0.0F)
                    {
                        ...
                        if(World.Rnd().nextFloat() < shot.power / 28000F)
                        {
                            ...
                            debugprintln(this, "*** Engine2 Crank Case Hit - Cylinder Feed Out, " + FM.EI.engines[1].getCylindersOperable() + "/" + FM.EI.engines[1].getCylinders() + " Left..");
                        }
                        if(World.Rnd().nextFloat() < 0.08F)
                        {
                        ...
                        debugprintln(this, "*** Engine2 Crank Case Hit - Readyness Reduced to " + FM.EI.engines[1].getReadyness() + "..");
                    }
                    if(World.Rnd().nextFloat() < 0.01F)
                    {
                ...
                if((s.endsWith("cyl1") || s.endsWith("cyl2")) && getEnergyPastArmor(World.Rnd().nextFloat(0.5F, 2.542F), shot) > 0.0F && World.Rnd().nextFloat() < FM.EI.engines[1].getCylindersRatio() * 1.72F)
                {
                    ...
                    debugprintln(this, "*** Engine2 Cylinders Hit, " + FM.EI.engines[1].getCylindersOperable() + "/" + FM.EI.engines[1].getCylinders() + " Left..");
                    if(World.Rnd().nextFloat() < 0.01F)
                    {
                        FM.EI.engines[1].setEngineStuck(shot.initiator);
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                if(s.startsWith("xxspart") && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(7.5F / (float)Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F && World.Rnd().nextFloat() < 0.2F)
                {
    ...
    public void doWoundPilot(int i, float f)
    {
        ...
        case 2: // '\002'
            ...
            // ------------------------------------
            if (FM.turret.length < 3) break;
            if (FM.turret[2] == null) break;
            FM.turret[2].setHealth(f);
            if (FM.turret.length < 4) break;
            if (FM.turret[3] == null) break;
