...
public class DServer extends Main {
    ...
    public boolean beginApp(String iniFileName, String mainSectionName, int consoleNum) {
        ...
        if (Config.cur.netLocalHost != null) {
            try
            {
                    ...
                    if (bool1) {
                        if (bool2) {
                            if (this.consoleServer != null) {
                                this.consoleServer.bEnableType = false;
                            }
                            System.out.println(str);
                            if (this.consoleServer != null) {
                                this.consoleServer.bEnableType = true;
                            }
                        } else {
                            if (this.consoleServer != null) {
                                this.consoleServer.type(str + "\n");
                            }
