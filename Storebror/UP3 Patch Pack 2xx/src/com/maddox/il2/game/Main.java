...
public abstract class Main
{
    ...
    public static void exec(final Main paramMain, final String paramString1, final String paramString2, final int paramInt) {
        final IniFile localIniFile = new IniFile(paramString1, 0);
        String str = localIniFile.get("rts", "locale", "us").toLowerCase();
