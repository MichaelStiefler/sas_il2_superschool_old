    ...
    implements TypeBomber
{
    ...
    protected void nextDMGLevel(String s, int i, com.maddox.il2.engine.Actor actor)
    {
        ...
        if(FM.isPlayers()) {
            ...
            if (s.startsWith("CF")) {
                if (this == World.getPlayerAircraft())
                    ((CockpitH8K1) Main3D.cur3D().cockpitCur).updateDamageState();
            }
        }
    }

    protected void nextCUTLevel(String s, int i, com.maddox.il2.engine.Actor actor)
    {
    ...
    static 
    {
        ...
        weaponsRegister(class1, "16x60", new String[] {
            "MGunMG81t 450", "MGunMG81t 450", "MGunMG81t 450", "MGunType99No1t 450", "MGunType99No1t 600", null, null, null, null, null, 
        ...
        weaponsRegister(class1, "8x250", new String[] {
        ...
        weaponsRegister(class1, "2x4512", new String[] {
        ...
        weaponsRegister(class1, "2xType91late", new String[] {
