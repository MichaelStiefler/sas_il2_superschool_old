...
public class Kurogane extends Scheme1 implements TypeScout {
    ...
    public void update(float f) {
        super.update(f);
        this.hierMesh().chunkSetAngles("GearL8_D0", 0.0F, -((FlightModelMain) (super.FM)).Gears.gWheelAngles[0], 0.0F);
        this.hierMesh().chunkSetAngles("GearR8_D0", 0.0F, -((FlightModelMain) (super.FM)).Gears.gWheelAngles[1], 0.0F);
    }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            ...
            if (s.startsWith("xxeng1")) {
                ...
                } else if (s.startsWith("xxeng1cyls") && (this.getEnergyPastArmor(World.Rnd().nextFloat(0.2F, 4.4F), shot) > 0.0F) && (World.Rnd().nextFloat() < (((FlightModelMain) (super.FM)).EI.engines[0].getCylindersRatio() * 1.12F))) {
