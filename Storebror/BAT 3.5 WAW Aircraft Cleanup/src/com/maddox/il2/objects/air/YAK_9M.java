...
public class YAK_9M extends YAK_9TX {
    ...
    static {
        ...
        weaponsRegister(class1, "default", new String[] { "MGunUBsi 200", "MGunShVAKki 120", null, null });
        weaponsRegister(class1, "ns37", new String[] { "MGunUBsi 220", null, "MGunNS37ki 32", "PylonMG15120Internal" });
