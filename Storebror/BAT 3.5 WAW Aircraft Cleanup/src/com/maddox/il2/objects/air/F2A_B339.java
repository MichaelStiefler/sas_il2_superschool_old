...
public class F2A_B339 extends F2A {
    ...
    static {
        ...
        weaponsRegister(class1, "default", new String[] { "MGunBrowning50si 500", "MGunBrowning50si 500", "MGunBrowning50k 250", "MGunBrowning50k 250", null, null });
        weaponsRegister(class1, "2x100", new String[] { "MGunBrowning50si 500", "MGunBrowning50si 500", "MGunBrowning50k 250", "MGunBrowning50k 250", "BombGun100lbs 1", "BombGun100lbs 1" });
