...
public class MH_6 extends Scheme1
    implements TypeScout, TypeTransport
{
    ...
    public void computeVerticalThrust()
    {
        ...
        float f4 = 0.0F;
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 < 12F && FM.getSpeedKMH() > 1.0F && this.thisWeaponsName.startsWith("def") || this.thisWeaponsName.startsWith("non"))
            f4 = 2.0F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 < 12F && FM.getSpeedKMH() > 1.0F && this.thisWeaponsName.startsWith("M134"))
            f4 = 2.2F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 < 18F && FM.getSpeedKMH() > 1.0F && this.thisWeaponsName.startsWith("Delta"))
            f4 = 2.7F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 < 18F && FM.getSpeedKMH() > 1.0F && this.thisWeaponsName.startsWith("LAU"))
            f4 = 2.45F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 < 18F && FM.getSpeedKMH() > 1.0F && this.thisWeaponsName.startsWith("2xMiniGun"))
            f4 = 2.8F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 < 18F && FM.getSpeedKMH() > 1.0F && this.thisWeaponsName.startsWith("2xMiniguns+2xLAU"))
            f4 = 3.1F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 > 12F && super.thisWeaponsName.startsWith("def") || this.thisWeaponsName.startsWith("non") || this.thisWeaponsName.startsWith("M134"))
            f4 = 1.0F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 > 18F && this.thisWeaponsName.startsWith("LAU"))
            f4 = 1.2F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 > 18F && this.thisWeaponsName.startsWith("2xMiniGun"))
            f4 = 1.7F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 > 18F && this.thisWeaponsName.startsWith("2xMiniguns+2xLAU"))
            f4 = 2.05F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 > 18F && this.thisWeaponsName.startsWith("Delta"))
            f4 = 1.65F * f;
        else
    ...
    public void computeHovering()
    {
        ...
        float f1 = Pitot.Indicator((float)((Tuple3d) (((FlightModelMain) (FM)).Loc)).z, FM.getSpeed()) * 3.6F;
        float f2 = 0.0F;
        if(FM.EI.engines[0].getStage() > 5 && f1 < 50F && FM.getSpeedKMH() > 16F && FM.CT.StabilizerControl)
            f2 = 0.58F * f;
    ...
    {
        float f = Aircraft.cvt(FM.getSpeedKMH(), 70F, 160F, 722F, 3000F);
