...
public class Shackleton extends Scheme4
    implements TypeTransport, TypeBomber
{
    ...
    public void msgShot(Shot shot)
    {
        ...
        if(shot.chunkName.startsWith("CF"))
        {
            ...
            if(((Tuple3d) (Aircraft.Pd)).x > 2.4749999046325684D && ((Tuple3d) (Aircraft.Pd)).x < 4.4899997711181641D && ((Tuple3d) (Aircraft.Pd)).z > 0.61000001430511475D && (double)shot.power * Math.sqrt(((Tuple3d) (Aircraft.v1)).y * ((Tuple3d) (Aircraft.v1)).y + ((Tuple3d) (Aircraft.v1)).z * ((Tuple3d) (Aircraft.v1)).z) > 11900D && World.Rnd().nextFloat() < 0.45F)
            {
                for(int i = 0; i < 4; i++)
    ...
    private static Aircraft._WeaponSlot[] GenerateDefaultConfig(int i)
    {
        ...
        try
        {
            a_lweaponslot[0] = new Aircraft._WeaponSlot(10, "MGunBrowning303t", 2000);
            a_lweaponslot[1] = new Aircraft._WeaponSlot(10, "MGunBrowning303t", 2000);
            a_lweaponslot[2] = new Aircraft._WeaponSlot(11, "MGunBrowning303t", 2000);
            a_lweaponslot[3] = new Aircraft._WeaponSlot(11, "MGunBrowning303t", 2000);
            a_lweaponslot[4] = new Aircraft._WeaponSlot(12, "MGunBrowning303t", 2000);
            a_lweaponslot[5] = new Aircraft._WeaponSlot(12, "MGunBrowning303t", 2000);
            a_lweaponslot[6] = new Aircraft._WeaponSlot(10, "MGunBrowning303t", 2000);
            a_lweaponslot[7] = new Aircraft._WeaponSlot(10, "MGunBrowning303t", 2000);
        }
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitShackleton.class, CockpitShackleton_Bombardier.class, CockpitShackleton_FGunner.class, CockpitShackleton_TGunner.class, CockpitShackleton_AGunner.class
        });
