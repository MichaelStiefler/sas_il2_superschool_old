    ...
    implements TypeStormovikArmored
{
    ...
    {
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, cvt(f2, 0.01F, 0.47F, 0.0F, -45F), 0.0F);
        ...
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, cvt(f1, 0.44F, 0.99F, 0.0F, -85F), 0.0F);
        hiermesh.chunkSetAngles("GearR3_D0", 0.0F, cvt(f1, 0.44F, 0.99F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, cvt(f1, 0.44F, 0.99F, 0.0F, -69F), 0.0F);
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, cvt(f1, 0.44F, 0.54F, 0.0F, -70F), 0.0F);
        hiermesh.chunkSetAngles("GearR7_D0", 0.0F, cvt(f1, 0.44F, 0.54F, 0.0F, -70F), 0.0F);
    }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d)
    {
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.startsWith("xxarmorp"))
                {
                    ...
                    case 1:
                        getEnergyPastArmor(12.880000114440918D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                if(s.startsWith("xxsparli") && chunkDamageVisible("WingLIn") > 2 && (double)World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && getEnergyPastArmor(6.9600000381469727D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    debuggunnery("Spar Construction: WingLIn Spar Hit, Breaking in Half..");
                    nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if(s.startsWith("xxsparri") && chunkDamageVisible("WingRIn") > 2 && (double)World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && getEnergyPastArmor(6.9600000381469727D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    debuggunnery("Spar Construction: WingRIn Spar Hit, Breaking in Half..");
                    nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if(s.startsWith("xxsparlm") && chunkDamageVisible("WingLMid") > 2 && (double)World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && getEnergyPastArmor(6.9600000381469727D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    debuggunnery("Spar Construction: WingLMid Spar Hit, Breaking in Half..");
                    nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if(s.startsWith("xxsparrm") && chunkDamageVisible("WingRMid") > 2 && (double)World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && getEnergyPastArmor(6.9600000381469727D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    debuggunnery("Spar Construction: WingRMid Spar Hit, Breaking in Half..");
                    nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if(s.startsWith("xxsparlo") && chunkDamageVisible("WingLOut") > 2 && (double)World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && getEnergyPastArmor(6.9600000381469727D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
                    debuggunnery("Spar Construction: WingLOut Spar Hit, Breaking in Half..");
                    nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if(s.startsWith("xxsparro") && chunkDamageVisible("WingROut") > 2 && (double)World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && getEnergyPastArmor(6.9600000381469727D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
                {
        ...
        if(s.startsWith("xcockpit"))
        {
            if(point3d.z > 0.77500000000000002D)
            {
                ...
                if(v1.x < -0.90000000000000002D && getEnergyPastArmor(12D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)
