...
public class F_8FN extends F_8fuelReceiver
    implements TypeCountermeasure, TypeFastJet
{
    ...
    public void computeLoadoutsDrag()
    {
        ...
        if(thisWeaponsName.startsWith("2xR550"))
            polares.CxMin_0 = 0.023F;
        if(thisWeaponsName.startsWith("2xR530"))
    ...
    {
        if(raretimer != Time.current() && this == World.getPlayerAircraft() && counter++ % 5 == 0)
            APQ94();
    ...
    static 
    {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            ...
            "_Rock03", "_Rock04", "_Rock05", "_Rock06", "_Rock07", "_Rock08", "_ExternalDev05", "_ExternalDev06", "_ExternalDev07", "_ExternalDev08", 
