...
public class TU_4A extends B_29X
    implements TypeBomber
{
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitTU4A.class, CockpitTU4A_Bombardier.class, CockpitTU4A_TGunner.class, CockpitTU4A_T2Gunner.class, CockpitTU4A_FGunner.class, CockpitTU4A_AGunner.class, CockpitTU4A_RGunner.class
        });
