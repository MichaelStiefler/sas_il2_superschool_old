...
public class LINCOLN extends Scheme4
    implements TypeTransport, TypeBomber
{
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitLincoln.class, CockpitLincoln_Bombardier.class, CockpitLincoln_NGunner.class, CockpitLincoln_TGunner.class, CockpitLincoln_AGunner.class
        });
