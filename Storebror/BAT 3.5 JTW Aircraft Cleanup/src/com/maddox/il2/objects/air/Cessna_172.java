...
public class Cessna_172 extends Scheme1
    implements TypeScout, TypeTransport, TypeFighter
{
    ...
    private static Aircraft._WeaponSlot[] GenerateDefaultConfig(int i)
    {
        ...
        try
        {
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "BombGunSlowFlare", 5);
    ...
    public void moveWheelSink()
    {
        ...
        hierMesh().chunkSetAngles("GearL2_D0", 0.0F, AircraftLH.floatindex(f, gearL2), 0.0F);
        ...
        hierMesh().chunkSetAngles("GearR2_D0", 0.0F, -AircraftLH.floatindex(f, gearL2), 0.0F);
    }
