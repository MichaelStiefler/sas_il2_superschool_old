...
public class CF_104L extends F_104
    implements TypeGuidedMissileCarrier, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeZBReceiver, TypeFuelDump, TypeDockable
{
    ...
    private void receivingRefuel(float f)
    {
        ...
        if(typeDockableIsDocked())
        {
            ...
            {
                float f1 = ((TypeTankerDrogue)queen_).requestRefuel(this, 9.893F, f);
                FM.M.fuel += f1;
            } else
            if(afueltank.length > 0 && afueltank[0] != null && !FM.M.bFuelTanksDropped)
            {
                ...
                float f3 = ((TypeTankerDrogue)queen_).requestRefuel(this, 9.893F, f);
