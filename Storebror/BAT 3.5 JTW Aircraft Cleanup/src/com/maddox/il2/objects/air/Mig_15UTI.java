...
;
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitMig_15F.class, CockpitMig_15UTIi.class
        });
