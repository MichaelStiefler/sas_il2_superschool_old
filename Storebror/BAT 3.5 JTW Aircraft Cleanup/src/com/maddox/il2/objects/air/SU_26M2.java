    ...
    implements TypeFighter, TypeTNBFighter
{
    ...
    private static Aircraft._WeaponSlot[] GenerateDefaultConfig(int i)
    {
        ...
        try
        {
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunShKASk", 1000);
            a_lweaponslot[1] = new Aircraft._WeaponSlot(0, "MGunShKASk", 1000);
            a_lweaponslot[2] = new Aircraft._WeaponSlot(0, "MGunShKASk", 1000);
            a_lweaponslot[3] = new Aircraft._WeaponSlot(0, "MGunShKASk", 1000);
        }
