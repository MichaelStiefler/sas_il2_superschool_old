...
public class Mi24V extends Scheme2a
    implements TypeStormovik, TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector
{
    ...
    public void setCommonThreatActive()
    {
        ...
        if(l1 - lastCommonThreatActive > intervalCommonThreat)
        {
            lastCommonThreatActive = l1;
            doDealCommonThreat();
        }
    }
    ...
    {
        long l1 = Time.current();
        if(l1 - lastRadarLockThreatActive > intervalRadarLockThreat)
        {
            lastRadarLockThreatActive = l1;
    ...
    {
        long l1 = Time.current();
        if(l1 - lastMissileLaunchThreatActive > intervalMissileLaunchThreat)
        {
            lastMissileLaunchThreatActive = l1;
    ...
    private boolean sirenaWarning()
    {
        ...
        if((aircraft1 instanceof Aircraft) && aircraft1.getArmy() != World.getPlayerArmy() && (aircraft1 instanceof TypeFighterAceMaker) && (aircraft1 instanceof TypeRadarGunsight) && aircraft1 != World.getPlayerAircraft() && aircraft1.getSpeed(vector3d) > 20D)
        {
            ...
            if(k1 < 0)
                k1 += 360;
            int l1 = k1 - j;
            int i2 = (int)(Math.ceil(((double)j1 * 3.2808399000000001D) / 100D) * 100D);
            if(i2 >= 5280)
                i2 = (int)Math.floor(i2 / 5280);
            bRadarWarning = (double)j1 <= 3000D && (double)j1 >= 50D && l1 >= 195 && l1 <= 345 && Math.sqrt(i1 * i1) >= 120D;
    ...
    public static void moveGear(HierMesh hiermesh, float f)
    {
        ...
        float f6 = Aircraft.cvt(f, 0.2F, 0.8F, 0.0F, -90F);
        ...
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxtank"))
            {
                ...
                if(getEnergyPastArmor(0.12F, shot) > 0.0F && World.Rnd().nextFloat() < 0.25F)
                {
                    ...
                    if(this.FM.AS.astateTankStates[k] == 1)
                    {
                        debuggunnery("Fuel System: Fuel Tank " + k + " Pierced..");
                        this.FM.AS.hitTank(shot.initiator, 2, 1);
    ...
    public void computeVerticalThrust()
    {
        ...
        float f3 = Aircraft.cvt(FM.getAltitude(), 0.0F, 5000F, 1.0F, 0.5F);
        float f4 = 0.0F;
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.engines[1].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 < 15F)
            f4 = 1.5F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.engines[1].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 > 15F)
            f4 = 1.12F * f;
    ...
    public void computeHovering()
    {
        ...
        float f2 = Aircraft.cvt(f1, 0.0F, 100F, 1.0F, 0.0F);
        float f3 = 0.0F;
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.engines[1].getStage() > 5 && !flag && f1 < 35F && FM.getSpeedKMH() > 12F && FM.CT.StabilizerControl)
            f3 = 0.4F * f;
        FM.producedAF.x -= f3 * (10F * FM.M.mass) * (1.0F * f2);
    }
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitMi24.class, CockpitMi24_TGunner.class
        });
