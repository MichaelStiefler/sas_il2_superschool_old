...
public class U_10B extends Scheme1
    implements TypeStormovik
{
    ...
    {
        hierMesh().chunkSetAngles("Blister1_D0", 80F * f, 0.0F, 0.0F);
        hierMesh().chunkSetAngles("Blister2_D0", -80F * f, 0.0F, 0.0F);
        hierMesh().chunkSetAngles("Blister3_D0", 0.0F, -180F * f, 0.0F);
