...
public class NetChannel implements Destroy {
    ...
    public void destroy() {
        ...
        if ((this.state & 0x3fffffff) == 0) this.connect.channelDestroying(this, (this.diagnosticMessage == null || this.diagnosticMessage.length() < 1)?"disconnected":this.diagnosticMessage);
        do {
