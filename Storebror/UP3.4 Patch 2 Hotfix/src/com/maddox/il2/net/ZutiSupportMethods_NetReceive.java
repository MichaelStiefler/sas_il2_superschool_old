...
//            printDebugMessage("ZutiSupportMethods_NetReceive processReceivedMessage ID=" + messageId);
    ...
    public static void awardedForInspectingArea() {
        try {
            ...
            HUD.log("mds.netCommand.completedTInspect", new java.lang.Object[] { "250" });
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
