...
//        this.setTriggerActor(null);
        ...
        this.setTriggerMultiple(triggeredBy == 12 && noObjectsMin < 0);
        this.align();
        this.drawing(true);
...
//        System.out.println("ActorTrigger.getDisplayTime()=" + this.displayTime);
        return this.displayTime;
    }

    public void setDisplayTime(float displayTime) {
//        System.out.println("ActorTrigger.setDisplayTime(" + displayTime + ")");
...
//    public static final int TRIGGER_TYPE_MESSAGE                    = 3;
    ...
    public static final int TRIGGERED_BY_CURRENT_PLAYER_ONLY        = 12;
    public static final int TRIGGERED_BY_SIZE                       = 13;
}
