...
//    public GUISwitchBox3 sUse24bitSkins;
    ...
    public class DialogClient extends GUIDialogClient {
        ...
        public void render() {
            ...
            if (GUIDifficulty.this.bFirst) {
                ...
                //                this.draw(this.x1024(528.0F), this.y1024(32.0F), this.x1024(272.0F), this.y1024(48.0F), 0, GUIDifficulty.this.i18n("diff.Use24bitSkins"));
...
//            GUIDifficulty.this.sNoMinimapPath.setPosC(this.x1024(88.0F), this.y1024(120.0F));
            // --------------------------------------------------
//            GUIDifficulty.this.sUse24bitSkins.setPosC(this.x1024(88.0F), this.y1024(312.0F));
...
//        this.sUse24bitSkins.setEnable(bEnable);
...
//        this.setShow(this.bThird, this.sUse24bitSkins);
...
//        this.sUse24bitSkins.setChecked(difficultysettings.Use24bitSkins, false);
...
//            difficultysettings.Use24bitSkins = sUse24bitSkins.isChecked();
    ...
    protected GUIDifficulty(GWindowRoot gwindowroot, int i) {
        ...
        // ---------------------------------------
//        this.sUse24bitSkins = (GUISwitchBox3)this.dialogClient.addControl(new GUISwitchBox3(dialogClient));
