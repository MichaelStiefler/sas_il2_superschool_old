...
;
    ...
    private void fillItems()
    {
        ...
        for(int j = 0; j < as.length; j++)
        {
            ...
            {
                // +++ TODO: Added by SAS~Storebror: Skip invalid entries of all sorts
                try {
                // -------------------------------------------------------------------
                    ...
                    {
                        // +++ TODO: Added by SAS~Storebror: Skip invalid entries of all sorts
                        if (flag && !(item2 instanceof ItemJoy)) continue;
                        // -------------------------------------------------------------------
                        if(item2.key[0] == 0)
                            item2.key[0] = l;
                        else
                    ...
                    if(flag && s.charAt(0) == '-')
                    {
                        ...
                        Item item3 = (Item)mapItems.get(s.substring(1));
                        if (!(item3 instanceof ItemJoy)) continue;
                        ItemJoy itemjoy = (ItemJoy)item3;
                        // -------------------------------------------------------------------
                        if(itemjoy != null)
                        {
                            itemjoy.bMinus = true;
