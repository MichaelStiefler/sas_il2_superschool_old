...
//            // TODO: --- By SAS~Storebror: Avoid masses of "damaged" event log entries when ships get bombed! ---    
    ...
    private BigshipGeneric(ShipProperties shipproperties, ActorSpawnArg actorspawnarg) {
        ...
        if (this instanceof RwyTransp || this instanceof RwyTranspWide || this instanceof RwyTranspSqr || this instanceof RwyTranspNoColl || this instanceof RwyTranspWideNoColl || this instanceof RwyTranspSqrNoColl) this.hideTransparentRunwayRed();
        ...
        if ((this instanceof RwyTransp || this instanceof RwyTranspWide || this instanceof RwyTranspSqr || this instanceof RwyTranspNoColl || this instanceof RwyTranspWideNoColl || this instanceof RwyTranspSqrNoColl) && Engine.land().isWater(this.pos.getAbs().getX(), this.pos.getAbs().getY())) this.hierMesh().chunkVisible("Hull1", false);
