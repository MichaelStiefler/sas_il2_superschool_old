...
public abstract class FW_190V extends Scheme1 implements TypeFighter, TypeBNZFighter {
    ...
    public static void moveGear(HierMesh hiermesh, float f) {
        ...
        double theta0 = -0.14D;
        FW_190V.AxisPos[FW_190V.axisD][FW_190V.idX] = Math.cos(theta0) * FW_190V.LengthA_D;
        FW_190V.AxisPos[FW_190V.axisD][FW_190V.idY] = Math.sin(theta0) * FW_190V.LengthA_D;
        double theta1 = ((f * 77D) / 180D) * Math.PI;
        FW_190V.AxisPos[FW_190V.axisB][FW_190V.idX] = Math.cos(theta1) * FW_190V.LengthA_B;
        FW_190V.AxisPos[FW_190V.axisB][FW_190V.idY] = Math.sin(theta1) * FW_190V.LengthA_B;
        double LengthB_D = FW_190V.getDst(FW_190V.AxisPos[FW_190V.axisB][FW_190V.idX], FW_190V.AxisPos[FW_190V.axisB][FW_190V.idY], FW_190V.AxisPos[FW_190V.axisD][FW_190V.idX], FW_190V.AxisPos[FW_190V.axisD][FW_190V.idY]);
        double theta4_1 = Math.acos((FW_190V.LengthA_D - FW_190V.AxisPos[FW_190V.axisB][FW_190V.idX]) / LengthB_D);
        ...
        double theta3 = 0.0D;
        Cos2_2 = (((LengthB_D * LengthB_D) + FW_190V.LengthB_C * FW_190V.LengthB_C) - FW_190V.LengthC_D * FW_190V.LengthC_D) / (2D * LengthB_D * FW_190V.LengthB_C);
        Cos2_2 = Cos2_2 <= 1.0D ? Cos2_2 : 1.0D;
        Cos2_2 = Cos2_2 >= -1D ? Cos2_2 : -1D;
        theta2_2 = Math.acos(Cos2_2);
        Cos4_2 = (((LengthB_D * LengthB_D) + FW_190V.LengthC_D * FW_190V.LengthC_D) - FW_190V.LengthB_C * FW_190V.LengthB_C) / (2D * LengthB_D * FW_190V.LengthC_D);
        Cos4_2 = Cos4_2 <= 1.0D ? Cos4_2 : 1.0D;
        Cos4_2 = Cos4_2 >= -1D ? Cos4_2 : -1D;
        theta4_2 = Math.acos(Cos4_2);
        Cos3 = ((FW_190V.LengthC_D * FW_190V.LengthC_D) + (FW_190V.LengthB_C * FW_190V.LengthB_C) - (LengthB_D * LengthB_D)) / (2.0F * FW_190V.LengthC_D * FW_190V.LengthB_C);
