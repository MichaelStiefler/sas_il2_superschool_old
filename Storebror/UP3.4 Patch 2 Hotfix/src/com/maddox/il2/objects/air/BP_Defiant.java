...
public class BP_Defiant extends DefiantRAF implements TypeTNBFighter {
    ...
    public void update(float f) {
        super.update(f);
        if (this.FM == null || this.FM.CT == null) return;
        this.updateTurretStatus(f);
        switch (this.turretMode) {
            case TURRET_MODE_HEAD_TRACKING:
            case TURRET_MODE_LOCKED_FWD:
                if (this.FM.CT.WeaponControl != null && this.FM.CT.WeaponControl.length > 10) this.FM.CT.WeaponControl[10] = this.FM.CT.WeaponControl[0];
            case TURRET_MODE_LOCKED_AFT:
                if (this.FM.turret != null && this.FM.turret.length > 0 && this.FM.turret[0] != null) this.FM.turret[0].bIsAIControlled = false;
                break;
            case TURRET_MODE_NORMAL:
            default:
                break;
        }
        if (this.FM.CT.Weapons == null || this.FM.CT.Weapons.length < 11) return;
        if (this.FM.CT.Weapons[0] == null || this.FM.CT.Weapons[0].length == 0) return;
