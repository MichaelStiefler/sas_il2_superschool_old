    ...
    implements TypeBNZFighter
{
    ...
    public void update(float f)
    {
        ...
        if(kangle > 1.0F)
            kangle = 1.0F;
        super.update(f);
        if(this.FM.CT.getCockpitDoor() > 0.2F && bHasBlister && this.FM.getSpeedKMH() > fMaxKMHSpeedForOpenCanopy && hierMesh().chunkFindCheck("Blister1_D0") != -1)
        {
            try
            {
    ...
    static 
    {
        ...
        Aircraft.weaponsRegister(class1, "R1-SC50", new String[] {
        ...
        Aircraft.weaponsRegister(class1, "U4-MK108", new String[] {
        ...
        Aircraft.weaponsRegister(class1, "U4R3-MK108-DROPTANK", new String[] {
        ...
        Aircraft.weaponsRegister(class1, "U3-NOMG131", new String[] {
            null, null, null, "MGunMG15120MGki 200", null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null
        });
        Aircraft.weaponsRegister(class1, "U3R3-TANK-NOMG131", new String[] {
            null, null, null, "MGunMG15120MGki 200", null, null, null, null, "PylonETC900 1", "FuelTankGun_Type_D 1", 
            null, null, null, null, null, null, null, null, null, null, 
            null, null
        });
