...
public class PaintSchemeBMPar09 extends PaintScheme {
    ...
    public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k) {
        ...
        if (regiment.country() == PaintScheme.countryGermany) {
            ...
            this.changeMat(hiermesh, "Overlay2", "psBM02GERCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "German/" + (char) (65 + (k - 1)) + ".tga", "German/" + PaintScheme.psGermanBomberLetter[l][i] + ".tga", PaintScheme.psGermanBomberColor[i][0], PaintScheme.psGermanBomberColor[i][1], PaintScheme.psGermanBomberColor[i][2], 0.1F, 0.1F, 0.1F);
            this.changeMat(hiermesh, "Overlay4", "psBM02GERCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "German/" + (char) (65 + (k - 1)) + ".tga", "German/" + PaintScheme.psGermanBomberLetter[l][i] + ".tga", PaintScheme.psGermanBomberColor[i][0], PaintScheme.psGermanBomberColor[i][1], PaintScheme.psGermanBomberColor[i][2], 0.1F, 0.1F, 0.1F);
        ...
        if (regiment.country() == PaintScheme.countryNetherlands) {
            ...
            this.changeMat(hiermesh, "Overlay1", "psBM0RDUTCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + (k / 10) + ".tga", "German/" + (k % 10) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
            this.changeMat(hiermesh, "Overlay4", "psBM0RDUTCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + (k / 10) + ".tga", "German/" + (k % 10) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
            return;
        }
        if (regiment.country() == PaintScheme.countrySouthAfricaS) {
            ...
            this.changeMat(hiermesh, "Overlay3", "psBM02SASSNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + (k / 10) + ".tga", "SA/" + (k % 10) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
            this.changeMat(hiermesh, "Overlay2", "psBM02SASSNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + (k / 10) + ".tga", "SA/" + (k % 10) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
            return;
        }
        if (regiment.country() == PaintScheme.countrySouthAfricaB) {
            ...
            this.changeMat(hiermesh, "Overlay3", "psBM02SASBNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + (k / 10) + ".tga", "SA/" + (k % 10) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
            this.changeMat(hiermesh, "Overlay2", "psBM02SASBNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + (k / 10) + ".tga", "SA/" + (k % 10) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
            return;
        }
        if (regiment.country() == PaintScheme.countryAngola) {
            this.changeMat(hiermesh, "Overlay3", "psBM02ANGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + (k / 10) + ".tga", "German/" + (k % 10) + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
            this.changeMat(hiermesh, "Overlay2", "psBM02ANGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + (k / 10) + ".tga", "German/" + (k % 10) + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
        ...
        if (regiment.country() == PaintScheme.countryMozambique) {
            this.changeMat(hiermesh, "Overlay3", "psBM02MZBCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + (k / 10) + ".tga", "German/" + (k % 10) + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
            this.changeMat(hiermesh, "Overlay2", "psBM02MZBCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + (k / 10) + ".tga", "German/" + (k % 10) + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
        ...
        if (regiment.country() == PaintScheme.countryFinland) {
            ...
            this.changeMat(hiermesh, "Overlay2", "psBM02FINACOD" + s1 + c, "Finnish/" + s1 + ".tga", "Finnish/sn" + c + ".tga", 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
            this.changeMat(hiermesh, "Overlay3", "psBM02FINACOD" + s1 + c, "Finnish/" + s1 + ".tga", "Finnish/sn" + c + ".tga", 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
            return;
        }
        if (regiment.country() == PaintScheme.countryFrance) {
            if (k < 10) {
        ...
        if (regiment.country() == PaintScheme.countryBritain) {
            if ("ra".equals(regiment.branch()) || "rz".equals(regiment.branch()) || "rn".equals(regiment.branch())) {
                ...
                this.changeMat(hiermesh, "Overlay2", "psBM02BRINAVYLNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + (char) ((65 + k) - 1) + ".tga", "null.tga", PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2], 1.0F, 1.0F, 1.0F);
                this.changeMat(hiermesh, "Overlay3", "psBM02BRINAVYRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/" + (char) ((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2]);
                ...
                this.changeMat(hiermesh, "Overlay2", "psBM02BRILNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + (char) ((65 + k) - 1) + ".tga", "null.tga", PaintScheme.psBritishSkyColor[0], PaintScheme.psBritishSkyColor[1], PaintScheme.psBritishSkyColor[2], 1.0F, 1.0F, 1.0F);
                this.changeMat(hiermesh, "Overlay3", "psBM02BRIRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/" + (char) ((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishSkyColor[0], PaintScheme.psBritishSkyColor[1], PaintScheme.psBritishSkyColor[2]);
        ...
        if (regiment.country() == PaintScheme.countryNewZealand) {
            ...
            this.changeMat(hiermesh, "Overlay2", "psBM0RRZLNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + (char) ((65 + k) - 1) + ".tga", "null.tga", PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2], 1.0F, 1.0F, 1.0F);
            this.changeMat(hiermesh, "Overlay3", "psBM0RRZRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/" + (char) ((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2]);
        ...
        if (regiment.country() == PaintScheme.countryUSA) {
            this.changeMat(hiermesh, "Overlay1", "psBM0RUSACNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "States/" + (k / 10) + ".tga", "States/" + (k % 10) + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
            this.changeMat(hiermesh, "Overlay4", "psBM0RUSACNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "States/" + (k / 10) + ".tga", "States/" + (k % 10) + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
        ...
        if (regiment.country() == PaintScheme.countryFinlandAllied) {
            ...
            this.changeMat(hiermesh, "Overlay2", "psBM02FINACOD" + s2 + c1, "Finnish/" + s2 + ".tga", "Finnish/sn" + c1 + ".tga", 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
            this.changeMat(hiermesh, "Overlay3", "psBM02FINACOD" + s2 + c1, "Finnish/" + s2 + ".tga", "Finnish/sn" + c1 + ".tga", 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
            return;
        }
        if (regiment.country() == PaintScheme.countryBelgium) {
            this.changeMat(hiermesh, "Overlay2", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + (k / 10) + ".tga", "Default/1" + (k % 10) + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
        ...
        if (regiment.country() == PaintScheme.countryLithuania) {
            ...
            this.changeMat(hiermesh, "Overlay2", "psBM02FINACID" + s3 + c2, "Finnish/" + s3 + ".tga", "Finnish/sn" + c2 + ".tga", 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
            this.changeMat(hiermesh, "Overlay3", "psBM02FINACID" + s3 + c2, "Finnish/" + s3 + ".tga", "Finnish/sn" + c2 + ".tga", 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
