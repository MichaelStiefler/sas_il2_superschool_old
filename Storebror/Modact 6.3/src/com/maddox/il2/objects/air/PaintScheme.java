...
public abstract class PaintScheme {
    ...
    public String typedName(Aircraft aircraft) {
        ...
        return this.typedName(aircraft.getClass(), regiment, squadron.indexInRegiment(), wing.indexInSquadron(), wing.aircIndex(aircraft));
    }
    ...
    public String typedNameNum(Aircraft aircraft, int i) {
        ...
        Squadron squadron = wing.squadron();
        Regiment regiment = wing.regiment();
        return this.typedNameNum(aircraft.getClass(), regiment, squadron.indexInRegiment(), wing.indexInSquadron(), i);
    }

    public String typedName(Class class1, Regiment regiment, int i, int j, int k) {
        return this.typedNameNum(class1, regiment, i, j, (j * 4) + k + 1);
    }

    public void prepare(Aircraft aircraft) {
        this.prepare(aircraft, true);
    }
    ...
    public void prepare(Aircraft aircraft, boolean flag) {
        ...
        Squadron squadron = wing.squadron();
        Regiment regiment = wing.regiment();
        this.prepare(aircraft.getClass(), aircraft.hierMesh(), regiment, squadron.indexInRegiment(), wing.indexInSquadron(), wing.aircIndex(aircraft), flag);
    }

    public void prepareNum(Aircraft aircraft, int i) {
        this.prepareNum(aircraft, i, true);
    }
    ...
    public void prepareNum(Aircraft aircraft, int i, boolean flag) {
        ...
        Squadron squadron = wing.squadron();
        Regiment regiment = wing.regiment();
        this.prepareNum(aircraft.getClass(), aircraft.hierMesh(), regiment, squadron.indexInRegiment(), wing.indexInSquadron(), i, flag);
    }

    public void prepare(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k) {
        this.prepare(class1, hiermesh, regiment, i, j, k, true);
    }

    public void prepare(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k, boolean flag) {
        this.prepareNum(class1, hiermesh, regiment, i, j, (j * 4) + k + 1, flag);
    }
    ...
    public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k, boolean flag) {
        if (flag) {
            this.prepareNum(class1, hiermesh, regiment, i, j, k);
        } else {
            if ((regiment.country() == countryUSA) || ((regiment.country() == countryBritain) && "rn".equals(regiment.branch())) || (regiment.country() == countryJapan) || (regiment.country() == countryUSABlue)) {
                this.changeMat(null, hiermesh, "Overlay5", "null", "null.tga", 1.0F, 1.0F, 1.0F);
            } else {
                this.changeMat(null, hiermesh, "Overlay5", regiment.name(), regiment.fileNameTga(), 1.0F, 1.0F, 1.0F);
            }
            this.changeMat(null, hiermesh, "Overlay1", "null", "null.tga", 1.0F, 1.0F, 1.0F);
            this.changeMat(null, hiermesh, "Overlay2", "null", "null.tga", 1.0F, 1.0F, 1.0F);
            this.changeMat(null, hiermesh, "Overlay3", "null", "null.tga", 1.0F, 1.0F, 1.0F);
            this.changeMat(null, hiermesh, "Overlay4", "null", "null.tga", 1.0F, 1.0F, 1.0F);
            this.changeMat(null, hiermesh, "Overlay6", "null", "null.tga", 1.0F, 1.0F, 1.0F);
            this.changeMat(null, hiermesh, "Overlay7", "null", "null.tga", 1.0F, 1.0F, 1.0F);
            this.changeMat(null, hiermesh, "Overlay8", "null", "null.tga", 1.0F, 1.0F, 1.0F);
            this.changeMat(null, hiermesh, "Overlay7a", "null", "null.tga", 1.0F, 1.0F, 1.0F);
            this.prepareNumOff(class1, hiermesh, regiment, i, j, k);
        }
    }
    ...
    public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k) {
        this.prepareNum(class1, hiermesh, regiment, i, j, k, false);
    }

    public static void init() {
        psGermanFighterString = (new String[][] { new String[] { I18N.color("White") + " ", I18N.color("Red") + " ", I18N.color("Gold") + " ", I18N.color("Green") + " " }, new String[] { I18N.color("White") + " ", I18N.color("Black") + " ", I18N.color("Brown") + " ", I18N.color("Blue") + " " } });
        psRussianBomberString = (new String[] { I18N.color("Red"), I18N.color("Yellow"), I18N.color("Aqua"), I18N.color("Green") });
        psFinnishFighterString = (new String[][] { new String[] { I18N.color("Red") + " ", I18N.color("White") + " ", I18N.color("Yellow") + " ", I18N.color("Blue") + " " }, new String[] { I18N.color("Red") + " ", I18N.color("White") + " ", I18N.color("Yellow") + " ", I18N.color("Blue") + " " } });
    }

    protected void changeMat(Class class1, HierMesh hiermesh, String s, String s1, String s2, float f, float f1, float f2) {
        ...
        if (s.equals("Overlay7")) {
            ...
            if (i != -1) {
                if (s1.startsWith("balken")) {
                    this.changeMat(class1, hiermesh, "Overlay10", "balken7", s2, f, f1, f2);
                } else {
                    this.changeMat(class1, hiermesh, "Overlay10", s1, s2, f, f1, f2);
                }
            }
        }
        // --- TODO: 4.12 changed code ---

        String as[] = this.getCustomMarkings(class1, s1, s2, s);
        if (as != null) {
            s1 = as[0];
            s2 = as[1];
        }
        String s3 = null;
        if (class1 != null) {
            s3 = this.getPlaneSpecificMaterialID(class1);
            if (s3 != null) {
                s1 = s1 + "_" + s3;
            }
        }
        ...
        if (i != -1) {
            ...
            if (mat != null) {
                ...
                if (s3 != null) {
                    this.changeMatAppearance(hiermesh, s);
                }
            }
        }
    }
    ...
    // +++ TODO: 4.12 changed code +++
    protected void changeMat(Class class1, HierMesh hiermesh, String s, String s1, String s2, String s3, float f, float f1, float f2, float f3, float f4, float f5) {
        if (!Config.isUSE_RENDER()) {
            return;
        }
        int i = hiermesh.materialFind(s);
    ...
    protected void changeMat(HierMesh hiermesh, String s, String s1, String s2, String s3, float f, float f1, float f2, float f3, float f4, float f5) {
        if (!Config.isUSE_RENDER()) {
            return;
        }
        int i = hiermesh.materialFind(s);
    ...
    public static Mat makeMat(Class class1, String s, String s1, String s2, String s3, float f, float f1, float f2, float f3, float f4, float f5) {
        if (!Config.isUSE_RENDER()) {
            return null;
        }
        if (class1 != null) {
    ...
    private static String getUniqueMatName(Class class1, String s, String s1) {
        if (class1.isAssignableFrom(P_51B.class)) {
            if (s.equals("Overlay1")) {
                s1 = s1 + "P51BL";
            } else if (s.equals("Overlay4")) {
                s1 = s1 + "P51BR";
            }
        } else if (class1.isAssignableFrom(P_51D20NA.class) || class1.isAssignableFrom(P_51D5NT.class)) {
            s1 = s1 + "P51D";
        } else if ((class1.toString().indexOf("BF_109") != -1) && (s1.indexOf("ITA") != -1)) {
            s1 = s1 + "BF109";
        }
        return s1;
    }
    ...
    private static void customizeMat(SectFile sectfile, Class class1, String s, String s1, boolean flag) {
        ...
        } else if (class1.isAssignableFrom(DXXI_SARJA3_EARLY.class) || class1.isAssignableFrom(DXXI_SARJA3_LATE.class) || class1.isAssignableFrom(DXXI_SARJA4.class)) {
        ...
        } else if (s1.endsWith("BF109")) {
            sectfile.set("Layer0", "TextureCoordScale", "0.0 0.0 1.3 1.3");
            if (flag) {
                sectfile.set("Layer1", "TextureCoordScale", "-0.5 0.0 1.3 1.3");
            }
        } else if (class1.isAssignableFrom(P_36A3.class) || class1.isAssignableFrom(P_36A4.class) || class1.isAssignableFrom(H_75A3.class) || class1.isAssignableFrom(H_75A4.class)) {
        ...
        } else if ((class1.isAssignableFrom(P_40E_NEW.class) || class1.isAssignableFrom(P_40EM105_NEW.class)) && (s1.indexOf("FINACID") != -1)) {
            if (s.equals("Overlay3")) {
                sectfile.set("Layer0", "TextureCoordScale", "0.35 0.0 1.0 1.0");
                if (flag) {
                    sectfile.set("Layer1", "TextureCoordScale", "-0.15 0.0 1.0 1.0");
                }
            }
            if (s.equals("Overlay2")) {
                sectfile.set("Layer0", "TextureCoordScale", "0.3 0.0 1.0 1.0");
                if (flag) {
                    sectfile.set("Layer1", "TextureCoordScale", "-0.2 0.0 1.0 1.0");
                }
            }
        }
    }
    ...
    public static Mat makeMat(String s, String s1, String s2, float f, float f1, float f2, float f3, float f4, float f5) {
        if (!Config.isUSE_RENDER()) {
            return null;
        }
    ...
    protected String getFAFACCode(Class class1, int i) {
        ...
        if (class1.isAssignableFrom(P_36A4.class) || class1.isAssignableFrom(H_75A4.class)) {
            return "CU-50";
        }
        if (class1.isAssignableFrom(P_36A3.class) || class1.isAssignableFrom(H_75A3.class)) {
            return "CU-5" + (5 + i);
        }
        ...
        if (class1.isAssignableFrom(P_40E.class) || class1.isAssignableFrom(P_40E_NEW.class)) {
            return "KH-5";
        }
        if (class1.isAssignableFrom(P_40EM105.class) || class1.isAssignableFrom(P_40EM105_NEW.class)) {
            return "KH-5";
        }
        if (class1.isAssignableFrom(P_40M.class) || class1.isAssignableFrom(com.maddox.il2.objects.air.P_40M_NEW.class)) {
            return "KH-5";
        }
        ...
        if (class1.isAssignableFrom(SB_2M103_96.class)) {
            return "SB-" + i;
        }
        if (class1.isAssignableFrom(SB_2M103.class)) {
            return "SB-" + i;
        }
        if (class1.isAssignableFrom(SB_2M103A.class)) {
            return "SB-" + i;
        }
        if (class1.isAssignableFrom(U_2.class)) {
            return "VU-";
        }
        if (class1.isAssignableFrom(U_2VS.class)) {
            return "VU-";
        }
        if (class1.isAssignableFrom(U_2VSLNB.class)) {
            return "VU-";
        }
    ...
    private String[] getCustomMarkings(Class class1, String s, String s1, String s2) {
        ...
        if (s.equals("whitestar1")) {
            ...
            if (s.equals("redstar0") || s.equals("redstar1") || s.equals("redstar2") || s.equals("redstar3")) {
                ...
                if (j > 0) {
                    // +++ TODO: 4.12 changed code +++
                    if ((PE_8.class).isAssignableFrom(class1) || (PE_8_M40F.class).isAssignableFrom(class1))
                    // --- TODO: 4.12 changed code ---
                    {
                        if (j < 19421231) {
                    ...
                    // if(j < 19391000 && !SB_2M100A.class.isAssignableFrom(class1) && !SB_2M103.class.isAssignableFrom(class1) && !IL_4_DB3B.class.isAssignableFrom(class1) && !IL_4_DB3F.class.isAssignableFrom(class1) &&
                    // !IL_4_DB3M.class.isAssignableFrom(class1) && !IL_4_DB3T.class.isAssignableFrom(class1) && !IL_4_IL4.class.isAssignableFrom(class1))
                    // +++ TODO: 4.12 changed code +++
                    if ((j < 19391000) && !(SB_2M100A.class).isAssignableFrom(class1) && !(SB_2M103_96.class).isAssignableFrom(class1) && !(SB_2M103.class).isAssignableFrom(class1) && !(IL_4_DB3B.class).isAssignableFrom(class1) && !(IL_4_DB3F.class).isAssignableFrom(class1) && !(IL_4_DB3M.class).isAssignableFrom(class1) && !(IL_4_DB3T.class).isAssignableFrom(class1) && !(IL_4_IL4.class).isAssignableFrom(class1))
                    // --- TODO: 4.12 changed code ---
                    {
            ...
            } else if (BF_109G6AS.class.isAssignableFrom(class1) || BF_109G6Late.class.isAssignableFrom(class1) || BF_109G10.class.isAssignableFrom(class1) || FW_190F8.class.isAssignableFrom(class1) || FW_190A8.class.isAssignableFrom(class1) || FW_190A6.class.isAssignableFrom(class1)) {
                if (s.equals("balken0")) {
            ...
            } else if (FW_190A9.class.isAssignableFrom(class1)) {
                if (s.equals("balken0")) {
                    return (new String[] { "balken4", "German/balken4.tga" });
                }
                if (s.equals("balken1")) {
            ...
            } else if ((JU_88A6.class).isAssignableFrom(class1) && s.equals("balken1")) {
                return (new String[] { "balken4", "German/balken4.tga" });
            }
        }
        return null;
    ...
    public static final char      psGermanFighterGruppeChar[][] = { { ' ', '-', '~', '\244' }, { ' ', '-', '|', '\261' } };
    ...
    public static final float     psBritishSkyColor[]           = { 0.7255F, 0.8431F, 0.6471F };
    public static final float     psBritishOrangeColor[]        = { 0.988F, 0.8F, 0.08F };
    public static final float     psBritishBlackColor[]         = { 0.0F, 0.0F, 0.0F };
