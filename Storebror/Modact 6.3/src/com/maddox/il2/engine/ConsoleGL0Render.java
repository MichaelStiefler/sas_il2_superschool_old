...
class ConsoleGL0Render extends Render {
    ...
    private void setAIFlyablesCaption() {
        ...
        if ("ru".equals(userLanguage)) {
            AI_FLYABLES = " \u0438 SAS \u043b\u0435\u0442\u043d\u044b\u0439 AI \u0421\u0430\u043c\u043e\u043b\u0435\u0442\u044b" + versionAIFlyables;
        ...
        if (ConsoleGL0.backgroundMat != null) {
            ...
            if (this.sstep != null) {
                ...
                if ("ru".equalsIgnoreCase(RTSConf.cur.locale.getLanguage())) {
                    ...
                    TTFont.font[2].output(i, RendersMain.getViewPortWidth() * 0.083F, ((RendersMain.getViewPortHeight() * 0.12F) + TTFont.font[2].height()) - TTFont.font[2].descender(), 0.0F, GAME_VERSION + " c SAS ModA\u043a\u0442\u0438\u0432\u0430\u0442\u043e\u0440\u043e\u043c " + MODACT_VERSION + AI_FLYABLES);
                } else {
    ...
    private static final String GAME_VERSION              = "V 4.13.3m";
    private static final String MODACT_VERSION            = "6.30";
