...
public class Jetman extends HE_LERCHE3 implements TypeStormovik {
	...
	static {
		...
		try {
			...
			String s = "default";
			Aircraft._WeaponSlot a_lweaponslot[] = new Aircraft._WeaponSlot[4];
			a_lweaponslot[0] = new Aircraft._WeaponSlot(1, "JetManLazer", 20);
			a_lweaponslot[1] = new Aircraft._WeaponSlot(1, "JetManLazer", 20);
			a_lweaponslot[2] = null;
			a_lweaponslot[3] = null;
			arraylist.add(s);
			hashmapint.put(Finger.Int(s), a_lweaponslot);
			s = "X4-Mini";
			a_lweaponslot = new Aircraft._WeaponSlot[4];
			a_lweaponslot[0] = new Aircraft._WeaponSlot(1, "JetManLazer", 20);
			a_lweaponslot[1] = new Aircraft._WeaponSlot(1, "JetManLazer", 20);
			a_lweaponslot[2] = new Aircraft._WeaponSlot(2, "RocketGunJetManX4Mini", 1);
			a_lweaponslot[3] = null;
			arraylist.add(s);
			hashmapint.put(Finger.Int(s), a_lweaponslot);
			s = "Nuke-Device";
			a_lweaponslot = new Aircraft._WeaponSlot[4];
			a_lweaponslot[0] = new Aircraft._WeaponSlot(1, "JetManLazer", 80);
			a_lweaponslot[1] = new Aircraft._WeaponSlot(1, "JetManLazer", 80);
			a_lweaponslot[2] = null;
			a_lweaponslot[3] = new Aircraft._WeaponSlot(3, "BombGunJetManNuke", 1);
			arraylist.add(s);
			hashmapint.put(Finger.Int(s), a_lweaponslot);
