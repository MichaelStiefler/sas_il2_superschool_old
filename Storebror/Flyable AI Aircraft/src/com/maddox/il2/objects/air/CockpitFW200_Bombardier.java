...
public class CockpitFW200_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			if (bEntered) {
				float f = ((FW_200C3U4) aircraft()).fSightCurForwardAngle;
				float f1 = -((FW_200C3U4) aircraft()).fSightCurSideslip;
	...
	public CockpitFW200_Bombardier() {
		super("3DO/Cockpit/Pe-2-Bombardier/BombardierFW200.him", "he111");
		bEntered = false;
		try {
			Loc loc = new Loc();
	...
	public void reflectWorldToInstruments(float f) {
		mesh.chunkSetAngles("zMark1", ((FW_200C3U4) aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
		float f1 = cvt(((FW_200C3U4) aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
