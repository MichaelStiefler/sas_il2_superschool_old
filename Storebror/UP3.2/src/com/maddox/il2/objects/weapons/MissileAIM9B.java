...
public class MissileAIM9B extends Missile {
	...
	static {
		...
		Property.set(class1, "fxLock", "weapon.AIM9"); // prs file for Lock Tone
		Property.set(class1, "fxLockVolume", 1.2F); // Volume for Lock Tone, "1" is default
//		Property.set(class1, "fxNoLock", "weapon.AIM9.nolock"); // prs file for No Lock Tone
		Property.set(class1, "fxNoLockVolume", 0.7F); // Volume for No Lock Tone, "1" is default
...
//		Property.set(class1, "smplNoLock", "AIM9_no_lock.wav"); // wav file for No Lock Tone
		Property.set(class1, "singleTone", 1); // set to "1" if one single tone is used for lock / no lock
