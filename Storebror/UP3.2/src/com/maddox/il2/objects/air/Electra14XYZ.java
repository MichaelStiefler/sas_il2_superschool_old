...
public abstract class Electra14XYZ extends Scheme2
    implements TypeTransport
{
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            {
                if((s.endsWith("lm1") || s.endsWith("lm2")) && World.Rnd().nextFloat() < Aircraft.cvt((float)Math.abs(Aircraft.v1.x), 0.0F, 1.0F, 1.0F, 0.08F) && chunkDamageVisible("WingLMid") > 2 && getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    Aircraft.debugprintln(this, "*** WingLMid Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if((s.endsWith("rm1") || s.endsWith("rm2")) && World.Rnd().nextFloat() < Aircraft.cvt((float)Math.abs(Aircraft.v1.x), 0.0F, 1.0F, 1.0F, 0.08F) && chunkDamageVisible("WingRMid") > 2 && getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    Aircraft.debugprintln(this, "*** WingRMid Spars Damaged..");
                    nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if((s.endsWith("lo1") || s.endsWith("lo2")) && World.Rnd().nextFloat() < Aircraft.cvt((float)Math.abs(Aircraft.v1.x), 0.0F, 1.0F, 1.0F, 0.33F) && chunkDamageVisible("WingLOut") > 2 && getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    Aircraft.debugprintln(this, "*** WingLOut Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if((s.endsWith("ro1") || s.endsWith("ro2")) && World.Rnd().nextFloat() < Aircraft.cvt((float)Math.abs(Aircraft.v1.x), 0.0F, 1.0F, 1.0F, 0.33F) && chunkDamageVisible("WingROut") > 2 && getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
                    Aircraft.debugprintln(this, "*** WingROut Spars Damaged..");
                    nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                }
                if((s.endsWith("k1") || s.endsWith("k2")) && World.Rnd().nextFloat() < Aircraft.cvt((float)Math.abs(Aircraft.v1.x), 0.0F, 1.0F, 1.0F, 0.26F) && chunkDamageVisible("Keel1") > 1 && getEnergyPastArmor(8.6F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)
                {
