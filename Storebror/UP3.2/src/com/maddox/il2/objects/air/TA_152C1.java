...
// private float deltaTangage;
	...
	public void rareAction(final float n, final boolean b) {
		...
		if (((super.FM instanceof RealFlightModel) && ((RealFlightModel) super.FM).isRealMode()) || !b
		...
		if ((pilot.get_maneuver() == 63) && (pilot.target != null)) {
			...
			if ((((point3d.x > 4000.0) && (point3d.x < 5500.0))
					|| ((point3d.x > 100.0) && (point3d.x < 5000.0) && (World.Rnd().nextFloat() < 0.33f)))
	 ...
	 * = 0; } HUD.log(AircraftHotKeys.hudLogWeaponId, "AskaniaWing" +
	...
	static {
		...
		Aircraft.weaponHooksRegister(this1,
				new String[] { "_CANNON01", "_CANNON03", "_CANNON04", "_CANNON05", "_CANNON06", "_ExternalDev01",
						"_ExternalDev02", "_ExternalRock01", "_ExternalRock01", "_ExternalRock02", "_ExternalRock02",
