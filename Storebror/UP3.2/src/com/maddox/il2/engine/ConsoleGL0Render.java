...
//                }
                ...
                for (int offset=5; offset>0;offset--) {
                    TTFont.font[2].output(0x33000000 * (6-offset), (float)RendersMain.getViewPortWidth() * 0.02F + offset, (float)RendersMain.getViewPortHeight() * 0.17F - offset, 0.0F, sstep);
                    TTFont.font[2].output(0x33000000 * (6-offset), (float)RendersMain.getViewPortWidth() * 0.02F + offset, ((float)RendersMain.getViewPortHeight() * 0.17F + (float)TTFont.font[2].height()) - (float)TTFont.font[2].descender() - offset, 0.0F, versionString);
                    TTFont.font[2].output(0x33000000 * (6-offset), (float)RendersMain.getViewPortWidth() * 0.02F + offset, ((float)RendersMain.getViewPortHeight() * 0.17F + (float)(TTFont.font[2].height() * 2)) - (float)(TTFont.font[2].descender() * 2) - offset, 0.0F, VERSION_STRING1);
                }
                TTFont.font[2].output(0xff000000, (float)RendersMain.getViewPortWidth() * 0.02F + 1F, (float)RendersMain.getViewPortHeight() * 0.17F + 1F, 0.0F, sstep);
                TTFont.font[2].output(0xff000000, (float)RendersMain.getViewPortWidth() * 0.02F + 1F, ((float)RendersMain.getViewPortHeight() * 0.17F + (float)TTFont.font[2].height()) - (float)TTFont.font[2].descender() + 1F, 0.0F, versionString);
                TTFont.font[2].output(0xff000000, (float)RendersMain.getViewPortWidth() * 0.02F + 1F, ((float)RendersMain.getViewPortHeight() * 0.17F + (float)(TTFont.font[2].height() * 2)) - (float)(TTFont.font[2].descender() * 2) + 1F, 0.0F, VERSION_STRING1);
                ...
                TTFont.font[2].output(i, (float)RendersMain.getViewPortWidth() * 0.02F, ((float)RendersMain.getViewPortHeight() * 0.17F + (float)(TTFont.font[2].height() * 2)) - (float)(TTFont.font[2].descender() * 2), 0.0F, VERSION_STRING1);
