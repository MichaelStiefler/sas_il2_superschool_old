	...
	public static void HydrogenBalloonExplosion(Loc loc, Actor actor)
	{
		if (Config.isUSE_RENDER())
		{
			...
			for (int i = 0; i < 2; i++)
			{
				...
				//TODO: +++ FX Repack Mod +++
				Eff3DActor.New(loc1, 1.0F, "3DO/Effects/Fireworks/Tank_SmokeBoiling.eff", -1.0F);
//				Eff3DActor.New(loc1, 1.0F, "3DO/Effects/Fireworks/Tank_Burn.eff", -1.0F);
	...
	public static void runByName(String s, ActorHMesh actorhmesh, String s1, String s2, float f, Actor actor)
	{
		...
		else if (s.equalsIgnoreCase("_TankSmoke_"))
		{
			...
			{
				//TODO: +++ FX Repack Mod +++
				Eff3DActor.New(actorhmesh, hooknamed, null, 1.0F, "Effects/Smokes/TankDyingFire.eff", -1F);
				Eff3DActor.New(actorhmesh, hooknamed, null, 1.0F, "Effects/Smokes/TankDyingSmoke.eff", -1F);
...
//				Eff3DActor.New(actorhmesh, hooknamed, null, 1.0F, "Effects/Smokes/TankDyingSmoke.eff", f);
		...
		else if (s.equalsIgnoreCase("Car"))
		{
			...
			{
				//TODO: +++ FX Repack Mod +++
				Eff3DActor.New(actorhmesh, hooknamed, null, 1.0F, "Effects/Smokes/CarDyingFire.eff", -1F);
				Eff3DActor.New(actorhmesh, hooknamed, null, 1.0F, "Effects/Smokes/CarDyingSmoke.eff", -1F);
...
//				Eff3DActor.New(actorhmesh, hooknamed, null, 1.0F, "Effects/Smokes/TankDyingSmoke.eff", f);
		...
		//TODO: --- FX Repack Mod ---
	        ...
	        if(f > 0.0F)
	        {
	            Eff3DActor.New(actorhmesh, hooknamed, null, 1.0F, "Effects/Explodes/Objects/StAir/Fire.eff", -1F);
	            Eff3DActor.New(actorhmesh, hooknamed, null, 1.0F, "Effects/Explodes/Objects/StAir/Smoke.eff", -1F);
	        }
	    }
		//TODO: --- FX Repack Mod ---
		else if (s.equalsIgnoreCase("Aircraft"))
		...
		else if (s.equalsIgnoreCase("WagonWood"))
		{
			new MsgAction(0.0, actorhmesh)
			{
				public void doAction(Object obj)
				{
					...
					((Actor) obj).pos.getAbs(point3d);
					//TODO: +++ FX Repack Mod +++
					ExplodeVagons(point3d, point3d, 2.0F);
//					ExplodeVagonArmor(point3d, point3d, 2.0F);
					//TODO: --- FX Repack Mod ---
				}
			};
...
//			Eff3DActor.New(loc, 1.0F, s2, 3.0F);
            Eff3DActor.New(loc, 1.0F, s2, -1F);
            Eff3DActor.New(loc, 1.0F, s3, 3F);
            Eff3DActor.New(loc, 1.0F, s4, -1F);
			//TODO: --- FX Repack Mod ---
...
//				String s3 = "effects/Explodes/" + s + "/Land/Burn.eff";
	            String s1 = "effects/Explodes/" + s + "/Land/Burn.eff";
	            String s2 = "effects/Explodes/" + s + "/Land/Fontain.eff";
	            String s3 = "effects/Explodes/" + s + "/Land/Shock.eff";
	            String s4 = "effects/Explodes/" + s + "/Land/Peaces.eff";
	            String s5 = "effects/Explodes/" + s + "/Land/Burn_Fog.eff";
				//TODO: --- FX Repack Mod ---
				for (int i1 = 0; i1 < k; i1++)
				{
					...
					//TODO: +++ FX Repack Mod +++
	                Eff3DActor.New(l, 1.0F, s2, size);
	                Eff3DActor.New(l, 1.0F, s4, size);
	                Eff3DActor.New(l, 1.0F, s5, size);
					//TODO: --- FX Repack Mod ---
				}
...
//			Eff3DActor.New(l, 1.0F, s + "Burn.eff", f);
	...
	//TODO: +++ FX Repack Mod +++
	  public static float cvt(float f1, float f2, float f3, float f4, float f5) {
		    f1 = Math.min(Math.max(f1, f2), f3);
		    return f4 + (f5 - f4) * (f1 - f2) / (f3 - f2);
		  }

	    public static void ExplodeAmmo(Point3d point3d, int i)
	    {
	        if(Config.isUSE_RENDER())
	        {
	            Loc loc = new Loc(point3d);
	            Eff3DActor.New(loc, 1.0F, "Effects/Explodes/Bomb1000/Land/Burn.eff", 0.4F);
	            Eff3DActor.New(loc, 1.0F, "3DO/Effects/Fireworks/Direct_Hit_Smoke.eff", -1F);
	            Eff3DActor.New(loc, 1.0F, "3DO/Effects/Fireworks/Ammovag_expl.eff", -1F);
	            Eff3DActor.New(loc, 1.0F, "3DO/Effects/Fireworks/Shock.eff", -1F);
	            Eff3DActor.New(loc, 1.0F, "3DO/Effects/Fireworks/Direct_Hit_Sparks.eff", -1F);
	            Eff3DActor.New(loc, 1.0F, "Effects/Explodes/Objects/Vags/Pieces.eff", -1F);
	            double d = point3d.z;
	            World.cur();
	            if(d - World.land().HQ(point3d.x, point3d.y) > 3D)
	            {
	                SfxExplosion.crashAir(point3d, 1);
	            } else
	            {
	    ...
	    private static void LinearExplodeW(Point3d point3d, Point3d point3d1, float f, float f1, String s, String s1)
	    {
	        ...
	        for(int j = 0; j < i; j++)
	        {
	            ...
	            o.set(0.0F, 90F, 0.0F);
	            l.set(point3d2, o);
	            Eff3DActor.New(l, 1.0F, Math.random() >= 0.5D ? s1 : s, 180F);
	        }

	    }

	    public static void ExplodeVagons(Point3d point3d, Point3d point3d1, float f)
	    {
	        if(Config.isUSE_RENDER())
	        {
	            LinearExplodeW(point3d, point3d1, f, 0.5F, "effects/Explodes/Objects/VagS/Fire.eff", "effects/Explodes/Objects/VagS/Fire_Smoke.eff");
	            SfxExplosion.wagon(point3d, point3d1, f, 6);
	        }
	    }

	    public static void ExplodeLoco(Point3d point3d, Point3d point3d1, float f)
	    {
	        if(Config.isUSE_RENDER())
	        {
	            Point3d point3d2 = new Point3d();
	            ...
	            {
	                point3d2.interpolate(point3d, point3d1, Math.random());
	                Tank_ExplodeCollapse(point3d2);
	            }

	            LinearExplodeW(point3d, point3d1, f, 0.5F, "effects/Explodes/Objects/VagS/Steam_Expl.eff", "effects/Explodes/Objects/VagS/Fire_Smoke.eff");
	            SfxExplosion.wagon(point3d, point3d1, f, 6);
	        }
	    }
...
//			LinearExplode(point3d, point3d1, f, 0.5F, "effects/Explodes/Objects/VagonArmor/SmokeBoiling.eff", "effects/Explodes/Objects/VagonArmor/SmokeBoiling2.eff");
	...
	public static void ExplodeVagonFuel(Point3d point3d, Point3d point3d1, float f)
	{
		if (Config.isUSE_RENDER())
		{
			...
			//TODO: +++ FX Repack Mod +++
            LinearExplodeW(point3d, point3d1, f, 0.75F, "Effects/Explodes/Objects/VagonFuel/Fire.eff", "Effects/Explodes/Objects/VagonFuel/Fire_Smoke.eff");
			//TODO: --- FX Repack Mod ---
	...
	public static void bomb50_land(Point3d point3d, float f, float f1)
	{
		if (Config.isUSE_RENDER())
		{
			...
			l.set(point3d, o);
			//TODO: +++ FX Repack Mod +++
            Eff3DActor.New(l, f1, "3DO/Effects/Fireworks/Direct_Hit_smoke.eff", -1F);
            Eff3DActor.New(l, f1, "3DO/Effects/Fireworks/Direct_Hit.eff", -1F);
            Eff3DActor.New(l, f1, "3DO/Effects/Fireworks/Shock.eff", -1F);
            Eff3DActor.New(l, f1, "3DO/Effects/Fireworks/Direct_Hit_sparks.eff", -1F);
...
//			Eff3DActor.New(l, f1, "3DO/Effects/Fireworks/Tank_Sparks.eff", -1.0F);
	...
	public static void Cannon_Land(Point3d point3d, float f, float f1)
	{
		if (Config.isUSE_RENDER())
		{
			...
			//TODO: +++ FX Repack Mod +++
            Eff3DActor.New(l, 1.0F, "effects/Explodes/Cannon/Land/Dustik.eff", f);
			//TODO: --- FX Repack Mod ---
		}
	}
			...
			if (actor != null)
			{
				...
				if (i == 2)
				{
					...
					else
					{
						...
						{
							//TODO: +++ FX Repack Mod +++
							vector3d.set(World.Rnd().nextDouble(-40.0, 40.0), World.Rnd().nextDouble(-40.0, 40.0), World.Rnd().nextDouble(3.0, 20.0));
...
//							Eff3DActor.New(ballisticprojectile, null, null, 1.0F, "3DO/Effects/Fireworks/PhosfourousFire.eff", f2);
	                        Eff3DActor.New(actor, null, rel, 1.0F, "3DO/Effects/Fireworks/Napalm_Burn.eff", -1F);
