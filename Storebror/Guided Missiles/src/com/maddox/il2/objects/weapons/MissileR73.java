...
public class MissileR73 extends Missile {
	...
	static {
		...
		Property.set(class1, "timeFire", 5.2F); // Rocket Engine Burn time in Seconds
		Property.set(class1, "force", 18000F); // Rocket Engine Power (in Newton)
		...
		Property.set(class1, "power", 0.74F); // RL Data: 7.4kg HE warhead, for realism reduced to 1/10th of it's RL weight
		Property.set(class1, "radius", 12.5F); // Radius of Explosion Effect
		Property.set(class1, "kalibr", 0.17F); // Diameter of Missile Body
		Property.set(class1, "massa", 105.0F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 71F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "friendlyName", "R-73"); // Display Name of this missile
