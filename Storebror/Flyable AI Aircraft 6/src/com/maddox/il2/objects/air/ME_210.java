...
public abstract class ME_210 extends Scheme2 {
	...
	public void update(float f) {
		...
		if (Math.abs(flapps[0] - kangle0) > 0.01F) {
			flapps[0] = kangle0;
		...
		if (Math.abs(flapps[1] - kangle1) > 0.01F) {
			flapps[1] = kangle1;
	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				...
				if (s.endsWith("p1"))
					getEnergyPastArmor((double) World.Rnd().nextFloat(0.0F, 45.2F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
					...
					getEnergyPastArmor(10.100000381469727D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
				else if (s.endsWith("p6"))
					getEnergyPastArmor(12D + (double) World.Rnd().nextFloat(10F, 30F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
			...
			if (s.startsWith("xxtank")) {
				...
				if (getEnergyPastArmor(World.Rnd().nextFloat(0.1F, 2.23F), shot) > 0.0F && World.Rnd().nextFloat() < 0.25F) {
					...
					} else if (FM.AS.astateTankStates[i1] == 1) {
						debuggunnery("Fuel Tank " + (i1 + 1) + ": Pierced..");
						FM.AS.hitTank(shot.initiator, i1, 1);
	...
	public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
		float f3 = 10F * Math.min(f2, 0.1F);
		hiermesh.chunkSetAngles("GearC2_D0", 0.0F, 0.0F, 0.0F);
		hiermesh.chunkSetAngles("GearC9_D0", 0.0F, 80F * f2, 0.0F);
		hiermesh.chunkSetAngles("GearC3_D0", 0.0F, 130F * f3, 0.0F);
		hiermesh.chunkSetAngles("GearC4_D0", 0.0F, 130F * f3, 0.0F);
		float f4 = 10F * (f >= 0.5F ? Math.min(1.0F - f, 0.1F) : Math.min(f, 0.1F));
		float f5 = 10F * (f1 >= 0.5F ? Math.min(1.0F - f1, 0.1F) : Math.min(f1, 0.1F));
		...
		hiermesh.chunkSetAngles("GearL4_D0", 0.0F, -55F * f4, 0.0F);
		hiermesh.chunkSetAngles("GearL5_D0", 0.0F, -55F * f4, 0.0F);
		hiermesh.chunkSetAngles("GearR2_D0", 0.0F, -115F * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR9_D0", 0.0F, -85F * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR3_D0", 0.0F, -140F * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR4_D0", 0.0F, -55F * f5, 0.0F);
		hiermesh.chunkSetAngles("GearR5_D0", 0.0F, -55F * f5, 0.0F);
	}
