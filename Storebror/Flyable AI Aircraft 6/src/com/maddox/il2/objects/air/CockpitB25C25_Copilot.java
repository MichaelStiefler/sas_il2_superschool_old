...
// Source File Name:   CockpitB25J_Copilot.java
...
//            CockpitCopilot, B_25C25

public class CockpitB25C25_Copilot extends CockpitCopilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                setNew.prop1 = 0.85F * setOld.prop1 + fm.EI.engines[0].getCoPControlProp() * 0.15F;
                setNew.prop2 = 0.85F * setOld.prop2 + fm.EI.engines[1].getCoPControlProp() * 0.15F;
    ...
    public CockpitB25C25_Copilot()
    {
        super("3DO/Cockpit/B-25J/co_pilot_hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_RPedalStep", 0.0F, -10F * fm.CT.getRudder() - fm.CT.getBrakeR() * 15F, 0.0F);
        mesh.chunkSetAngles("Z_LPedalStep", 0.0F, 10F * fm.CT.getRudder() - fm.CT.getBrakeL() * 15F, 0.0F);
        ...
        mesh.chunkSetAngles("zOilFlap1", 0.0F, -35F * fm.EI.engines[0].getCoPControlRadiator(), 0.0F);
        mesh.chunkSetAngles("zOilFlap2", 0.0F, -35F * fm.EI.engines[1].getCoPControlRadiator(), 0.0F);
        mesh.chunkSetAngles("zMix1", 0.0F, -45.8F * fm.EI.engines[0].getCoPControlMix(), 0.0F);
        mesh.chunkSetAngles("zMix2", 0.0F, -45.8F * fm.EI.engines[1].getCoPControlMix(), 0.0F);
        ...
        mesh.chunkSetAngles("zCompressor1", 0.0F, cvt(fm.EI.engines[0].getCoPControlCompressor(), 0.0F, 1.0F, 0.0F, -50F), 0.0F);
        mesh.chunkSetAngles("zCompressor2", 0.0F, cvt(fm.EI.engines[1].getCoPControlCompressor(), 0.0F, 1.0F, 0.0F, -50F), 0.0F);
        if(fm.Gears.cgear)
        {
            resetYPRmodifier();
        ...
        float f1 = ((B_25C25)aircraft()).getBombSightPDI();
        float f2 = Math.abs(f1);
        float f3 = floatindex(cvt(f2, 0.0F, 0.6666667F, 0.0F, 4F), pdiScale);
        float f4 = 1.0F;
        if(f1 < 0.0F)
            f4 = -1F;
        mesh.chunkSetAngles("zPDI", 0.0F, f3 * f4, 0.0F);
        ...
        if((fm.AS.astateCockpitState & 0x40) == 0)
        {
            ...
            mesh.chunkSetAngles("Z_Pres1", 0.0F, pictManf1 = 0.99F * pictManf1 + 0.01F * cvt(fm.EI.engines[0].getManifoldPressure(), 0.3386378F, 2.539784F, 0.0F, 346.5F), 0.0F);
            mesh.chunkSetAngles("Z_Pres2", 0.0F, pictManf2 = 0.99F * pictManf2 + 0.01F * cvt(fm.EI.engines[1].getManifoldPressure(), 0.3386378F, 2.539784F, 0.0F, 346.5F), 0.0F);
        }
        ...
        mesh.chunkSetAngles("Z_Temp2", 0.0F, cvt(fm.EI.engines[1].tWaterOut, 0.0F, 350F, 0.0F, 102.5F), 0.0F);
        mesh.chunkSetAngles("zOilTemp1", 0.0F, cvt(fm.EI.engines[0].tOilIn, -70F, 150F, 34F, -76F), 0.0F);
        mesh.chunkSetAngles("zOilTemp2", 0.0F, -cvt(fm.EI.engines[1].tOilIn, -70F, 150F, 34F, -76F), 0.0F);
        mesh.chunkSetAngles("Z_Oilpres1", 0.0F, cvt(1.0F + 0.05F * fm.EI.engines[1].tOilIn * fm.EI.engines[1].getReadyness(), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
        ...
        mesh.chunkSetAngles("Z_Brkpres1", 0.0F, 118F * ((fm.CT.getBrakeL() + fm.CT.getBrakeR()) / 2.0F), 0.0F);
        ...
        float f5 = 0.5F * fm.EI.engines[0].getRPM() + 0.5F * fm.EI.engines[1].getRPM();
        f5 = 2.5F * (float)Math.sqrt(Math.sqrt(Math.sqrt(Math.sqrt(f5))));
        mesh.chunkSetAngles("zSuction", 0.0F, cvt(f5, 0.0F, 10F, 0.0F, 297F), 0.0F);
