...
public class CockpitMSMorko extends CockpitPilot {
	...
	public CockpitMSMorko() {
		super("3DO/Cockpit/Morko/hier.him", "bf109");
	...
	public void reflectCockpitState() {
		if (aircraft() instanceof MS406) {
			mesh.chunkVisible("PRICEL_ST", true);
			mesh.chunkVisible("Z_Z_RETICLE2", true);
			mesh.chunkVisible("PRICEL", false);
			mesh.chunkVisible("Z_Z_MASK", false);
			mesh.chunkVisible("Z_Z_RETICLE", false);
		} else if (aircraft() instanceof MS410) {
			mesh.chunkVisible("PRICEL_ST", false);
			mesh.chunkVisible("Z_Z_RETICLE2", false);
			mesh.chunkVisible("PRICEL", true);
			mesh.chunkVisible("Z_Z_MASK", true);
