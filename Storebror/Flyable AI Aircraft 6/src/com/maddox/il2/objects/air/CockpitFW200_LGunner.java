...
public class CockpitFW200_LGunner extends CockpitGunner {

	public void moveGun(Orient orient) {
		super.moveGun(orient);
		mesh.chunkSetAngles("TurretLA", 0.0F, -orient.getYaw() + 22.6F, 0.0F);
	...
	public CockpitFW200_LGunner() {
		super("3DO/Cockpit/He-111H-2-LGun/LGunnerFW200.him", "he111_gunner");
		hook1 = null;
		iCocking = 0;
		iOldVisDrums = 2;
		iNewVisDrums = 2;
	...
	static {
		Property.set(CockpitFW200_LGunner.class, "aiTuretNum", 3);
		Property.set(CockpitFW200_LGunner.class, "weaponControlNum", 13);
		Property.set(CockpitFW200_LGunner.class, "astatePilotIndx", 4);
	}
}
