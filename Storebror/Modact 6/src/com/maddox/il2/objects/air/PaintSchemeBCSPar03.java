...
public class PaintSchemeBCSPar03 extends PaintSchemeBMPar03 {
	...
	public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k) {
		...
		if (regiment.country() == PaintScheme.countryPoland) {
			changeMat(hiermesh, "Overlay1", "psBCS03POLCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
		...
		if (regiment.country() == PaintScheme.countryRussia) {
			changeMat(hiermesh, "Overlay1", "psBCS03RUSCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", PaintScheme.psRussianBomberColor[i][0],
		...
		if (regiment.country() == PaintScheme.countryUSA) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay1", "psBCS03USAREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
					"British/" + regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psBCS03USAREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
					"British/" + regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psBCS03USALNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", 0.960784F, 0.745098F, 0.145098F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay3", "psBCS03USARNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/"
