...
//			if (FM.getAltitude() > 300F && boosterFireOutTime == -1L && FM.Loc.z != 0.0D && World.Rnd().nextFloat() < 0.05F) {
	...
	static {
		...
		Property.set(class1, "cockpitClass", new Class[] { com.maddox.il2.objects.air.CockpitAR_234B2.class,
				com.maddox.il2.objects.air.CockpitAR_234B2_Bombardier.class });
		...
		weaponsRegister(class1, "default",
				new String[] { "MGunMG15120k 200", "MGunMG15120k 200", null, null, null, null, null });
		weaponsRegister(class1, "2xtyped", new String[] { "MGunMG15120k 200", "MGunMG15120k 200", null, null, null,
				"FuelTankGun_Type_D", "FuelTankGun_Type_D" });
		weaponsRegister(class1, "3xsc500", new String[] { "MGunMG15120k 200", "MGunMG15120k 200", "BombGunSC500 1",
				"BombGunSC500 1", "BombGunSC500 1", null, null });
		weaponsRegister(class1, "3xsd500", new String[] { "MGunMG15120k 200", "MGunMG15120k 200", "BombGunSD500 1",
				"BombGunSD500 1", "BombGunSD500 1", null, null });
		weaponsRegister(class1, "1xsc1000", new String[] { "MGunMG15120k 200", "MGunMG15120k 200", null, null,
				"BombGunSC1000 1", null, null });
		weaponsRegister(class1, "1xsc10002xsc250", new String[] { "MGunMG15120k 200", "MGunMG15120k 200", "BombGunSC250 1",
				"BombGunSC250 1", "BombGunSC1000 1", null, null });
		weaponsRegister(class1, "3xab250", new String[] { "MGunMG15120k 200", "MGunMG15120k 200", "BombGunAB250 1",
				"BombGunAB250 1", "BombGunAB250 1", null, null });
		weaponsRegister(class1, "3xab500", new String[] { "MGunMG15120k 200", "MGunMG15120k 200", "BombGunAB500 1",
				"BombGunAB500 1", "BombGunAB500 1", null, null });
