...
public class RocketIgo_1_A extends RocketBomb
{
        ...
        implements NetUpdate
    {
        ...
        public void netUpdate()
        {
            ...
            {
                out.unLockAndClear();
                getSpeed(RocketIgo_1_A.v);
                out.writeFloat((float)RocketIgo_1_A.v.x);
                out.writeFloat((float)RocketIgo_1_A.v.y);
                out.writeFloat((float)RocketIgo_1_A.v.z);
