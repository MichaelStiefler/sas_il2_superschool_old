...
public class CockpitDo217_M1 extends CockpitPilot
{
    ...
    protected boolean doFocusEnter()
    {
        if(super.doFocusEnter())
        {
            ...
            if(aircraft() instanceof Do217_M1)
            {
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        this.mesh.chunkSetAngles("z_ThrottleL", 0.0F, -25F * interp(setNew.throttlel, setOld.throttlel, f), 0.0F);
        this.mesh.chunkSetAngles("z_ThrottleR", 0.0F, -25F * interp(setNew.throttler, setOld.throttler, f), 0.0F);
        ...
        this.mesh.chunkSetAngles("PropPitchLeverL", 0.0F, -70F * (1.0F - interp(setNew.propL, setOld.propL, f)), 0.0F);
        this.mesh.chunkSetAngles("PropPitchLeverR", 0.0F, -70F * (1.0F - interp(setNew.propR, setOld.propR, f)), 0.0F);
        ...
        if(useRealisticNavigationInstruments())
        {
            ...
            this.mesh.chunkSetAngles("z_AFN2a", 0.0F, cvt(f10, -40F, 40F, -32F, 32F), 0.0F);
            this.mesh.chunkSetAngles("z_AFN2b", 0.0F, 0.0F, cvt(f11, 0.0F, 1.0F, -20F, 15F));
