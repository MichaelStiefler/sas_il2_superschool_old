	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitHE_177A3_Bombardier.this.fm != null) {
				...
				CockpitHE_177A3_Bombardier.this.setNew.AirEnemy = 0.95F
						* CockpitHE_177A3_Bombardier.this.setOld.AirEnemy
						+ 0.05F * (((HE_177A3) CockpitHE_177A3_Bombardier.this.fm.actor).bAirEnemy ? 1.0F : 0.0F);
				...
				if (CockpitHE_177A3_Bombardier.this.useRealisticNavigationInstruments()) {
					...
					CockpitHE_177A3_Bombardier.this.setNew.radioCompassAzimuth.setDeg(
							CockpitHE_177A3_Bombardier.this.setOld.radioCompassAzimuth.getDeg(0.02F),
							CockpitHE_177A3_Bombardier.this.radioCompassAzimuthInvertMinus()
									- CockpitHE_177A3_Bombardier.this.setOld.azimuth.getDeg(1.0F) - 90F);
				} else {
					CockpitHE_177A3_Bombardier.this.setNew.waypointAzimuth.setDeg(
							CockpitHE_177A3_Bombardier.this.setOld.waypointAzimuth.getDeg(0.1F),
							f - CockpitHE_177A3_Bombardier.this.setOld.azimuth.getDeg(1.0F));
				}
				CockpitHE_177A3_Bombardier.this.setNew.azimuth.setDeg(
						CockpitHE_177A3_Bombardier.this.setOld.azimuth.getDeg(1.0F),
						CockpitHE_177A3_Bombardier.this.fm.Or.azimut());
				CockpitHE_177A3_Bombardier.this.setNew.throttle1 = 0.85F
						* CockpitHE_177A3_Bombardier.this.setOld.throttle1
						+ CockpitHE_177A3_Bombardier.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
				CockpitHE_177A3_Bombardier.this.setNew.throttle2 = 0.85F
						* CockpitHE_177A3_Bombardier.this.setOld.throttle2
						+ CockpitHE_177A3_Bombardier.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
				CockpitHE_177A3_Bombardier.this.setNew.pictAiler = 0.85F
						* CockpitHE_177A3_Bombardier.this.setOld.pictAiler
						+ 0.15F * CockpitHE_177A3_Bombardier.this
								.cvt(CockpitHE_177A3_Bombardier.this.fm.CT.AileronControl, -1F, 1.0F, -1F, 1.0F);
				CockpitHE_177A3_Bombardier.this.setNew.pictElev = 0.85F
						* CockpitHE_177A3_Bombardier.this.setOld.pictElev
						+ 0.15F * CockpitHE_177A3_Bombardier.this
								.cvt(CockpitHE_177A3_Bombardier.this.fm.CT.ElevatorControl, -1F, 1.0F, -1F, 1.0F);
				CockpitHE_177A3_Bombardier.this.setNew.elevTrim = 0.85F
						* CockpitHE_177A3_Bombardier.this.setOld.elevTrim
						+ 0.15F * CockpitHE_177A3_Bombardier.this.fm.CT.trimElevator;
				CockpitHE_177A3_Bombardier.this.setNew.rudderTrim = 0.85F
						* CockpitHE_177A3_Bombardier.this.setOld.rudderTrim
						+ 0.15F * CockpitHE_177A3_Bombardier.this.fm.CT.trimRudder;
				CockpitHE_177A3_Bombardier.this.setNew.ailTrim = 0.85F * CockpitHE_177A3_Bombardier.this.setOld.ailTrim
						+ 0.15F * CockpitHE_177A3_Bombardier.this.fm.CT.trimAileron;
				if (Math.toDegrees(CockpitHE_177A3_Bombardier.this.fm.EI.engines[0].getPropPhi()) < 36D) {
					CockpitHE_177A3_Bombardier.this.setNew.prop1 = 0.85F * CockpitHE_177A3_Bombardier.this.setOld.prop1
							+ ((FlightModelMain) CockpitHE_177A3_Bombardier.this.fm).EI.engines[0].getControlProp()
									* 0.15F;
					CockpitHE_177A3_Bombardier.this.setNew._prop1 = CockpitHE_177A3_Bombardier.this
							.cvt(CockpitHE_177A3_Bombardier.this.setNew.prop1, 0.0F, 1.0F, -22F, -63F);
				} else {
					CockpitHE_177A3_Bombardier.this.setNew.prop1 = 0.85F * CockpitHE_177A3_Bombardier.this.setOld.prop1;
					CockpitHE_177A3_Bombardier.this.setNew._prop1 = CockpitHE_177A3_Bombardier.this
							.cvt(CockpitHE_177A3_Bombardier.this.setNew.prop1, 0.0F, 1.0F, 0.0F, -63F);
				}
				if (Math.toDegrees(CockpitHE_177A3_Bombardier.this.fm.EI.engines[1].getPropPhi()) < 36D) {
					CockpitHE_177A3_Bombardier.this.setNew.prop2 = 0.85F * CockpitHE_177A3_Bombardier.this.setOld.prop2
							+ ((FlightModelMain) CockpitHE_177A3_Bombardier.this.fm).EI.engines[1].getControlProp()
									* 0.15F;
					CockpitHE_177A3_Bombardier.this.setNew._prop2 = CockpitHE_177A3_Bombardier.this
							.cvt(CockpitHE_177A3_Bombardier.this.setNew.prop2, 0.0F, 1.0F, -22F, -63F);
				} else {
					CockpitHE_177A3_Bombardier.this.setNew.prop2 = 0.85F * CockpitHE_177A3_Bombardier.this.setOld.prop2;
					CockpitHE_177A3_Bombardier.this.setNew._prop2 = CockpitHE_177A3_Bombardier.this
							.cvt(CockpitHE_177A3_Bombardier.this.setNew.prop2, 0.0F, 1.0F, 0.0F, -63F);
				}
				...
				CockpitHE_177A3_Bombardier.this.setNew.turn = (12F * CockpitHE_177A3_Bombardier.this.setOld.turn
						+ CockpitHE_177A3_Bombardier.this.w.z) / 13F;
				CockpitHE_177A3_Bombardier.this.setNew.altimeter = 0.85F
						* CockpitHE_177A3_Bombardier.this.setOld.altimeter
						+ CockpitHE_177A3_Bombardier.this.fm.getAltitude() * 0.15F;
				CockpitHE_177A3_Bombardier.this.setNew.vspeed = (99F * CockpitHE_177A3_Bombardier.this.setOld.vspeed
						+ CockpitHE_177A3_Bombardier.this.fm.getVertSpeed()) / 100F;
				...
				if (f1 > 55F || f1 < -55F || f2 < -55F || f2 > 55F) {
					CockpitHE_177A3_Bombardier.this.Pn.z = 250D;
				} else {
					CockpitHE_177A3_Bombardier.this.Pn.set(CockpitHE_177A3_Bombardier.this.fm.Loc);
					CockpitHE_177A3_Bombardier.this.Pn.z = CockpitHE_177A3_Bombardier.this.fm.getAltitude()
							- Engine.cur.land.HQ(((Tuple3d) CockpitHE_177A3_Bombardier.this.Pn).x,
									((Tuple3d) CockpitHE_177A3_Bombardier.this.Pn).y);
					...
					CockpitHE_177A3_Bombardier.this.Pn.z = (float) Math.sqrt(d * d + d1 * d1
							+ CockpitHE_177A3_Bombardier.this.Pn.z * CockpitHE_177A3_Bombardier.this.Pn.z);
					if (CockpitHE_177A3_Bombardier.this.fm.CT.getGear() > 0.5F) {
						CockpitHE_177A3_Bombardier.this.Pn.z = CockpitHE_177A3_Bombardier.this
								.cvt((float) CockpitHE_177A3_Bombardier.this.Pn.z, 0.0F, 150F, 0.0F, 250F);
					} else {
						CockpitHE_177A3_Bombardier.this.Pn.z = CockpitHE_177A3_Bombardier.this
								.cvt((float) CockpitHE_177A3_Bombardier.this.Pn.z, 0.0F, 750F, 0.0F, 250F);
					}
				}
				CockpitHE_177A3_Bombardier.this.setNew.AFN101 = 0.9F * CockpitHE_177A3_Bombardier.this.setOld.AFN101
						+ 0.1F * (float) CockpitHE_177A3_Bombardier.this.Pn.z;
				CockpitHE_177A3_Bombardier.this.setNew.beaconDirection = (10F
						* CockpitHE_177A3_Bombardier.this.setOld.beaconDirection
						+ CockpitHE_177A3_Bombardier.this.getBeaconDirection()) / 11F;
				CockpitHE_177A3_Bombardier.this.setNew.beaconRange = (10F
						* CockpitHE_177A3_Bombardier.this.setOld.beaconRange
						+ CockpitHE_177A3_Bombardier.this.getBeaconRange()) / 11F;
				CockpitHE_177A3_Bombardier.this.setNew.pictManf1 = 0.9F
						* CockpitHE_177A3_Bombardier.this.setOld.pictManf1
						+ 0.1F * CockpitHE_177A3_Bombardier.this.cvt(
								CockpitHE_177A3_Bombardier.this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F,
								0.0F, 330F);
				CockpitHE_177A3_Bombardier.this.setNew.pictManf2 = 0.8F
						* CockpitHE_177A3_Bombardier.this.setOld.pictManf2
						+ 0.2F * CockpitHE_177A3_Bombardier.this.cvt(
								CockpitHE_177A3_Bombardier.this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F,
								0.0F, 330F);
				CockpitHE_177A3_Bombardier.this.setNew.pictManf3 = 0.9F
						* CockpitHE_177A3_Bombardier.this.setOld.pictManf3
						+ 0.1F * CockpitHE_177A3_Bombardier.this.cvt(
								CockpitHE_177A3_Bombardier.this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F,
								0.0F, 330F);
				CockpitHE_177A3_Bombardier.this.setNew.pictManf4 = 0.8F
						* CockpitHE_177A3_Bombardier.this.setOld.pictManf4
						+ 0.2F * CockpitHE_177A3_Bombardier.this.cvt(
								CockpitHE_177A3_Bombardier.this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F,
								0.0F, 330F);
				...
				f3 /= Time.tickLenFs();
				f3 *= 3600F;
				CockpitHE_177A3_Bombardier.this.setNew.cons = 0.9F * CockpitHE_177A3_Bombardier.this.setOld.cons
						+ 0.1F * f3;
				...
				CockpitHE_177A3_Bombardier.this.setNew.consumptionL = 0.9F
						* CockpitHE_177A3_Bombardier.this.setOld.consumptionL + 0.1F * (f6 * f4) / (f4 + f5 + 1.0F);
				CockpitHE_177A3_Bombardier.this.setNew.consumptionR = 0.9F
						* CockpitHE_177A3_Bombardier.this.setOld.consumptionR + 0.1F * (f6 * f5) / (f4 + f5 + 1.0F);
...
//							CockpitHE_177A3_Bombardier.this.tAim + f7, 0.0F);
				...
				if (((HE_177A3) CockpitHE_177A3_Bombardier.this.fm.actor).bElectroSound
						&& ((HE_177A3) CockpitHE_177A3_Bombardier.this.fm.actor).bSightAutomation) {
					CockpitHE_177A3_Bombardier.this.sfxStart(16);
					((HE_177A3) CockpitHE_177A3_Bombardier.this.fm.actor).bElectroSound = false;
				} else if (((HE_177A3) CockpitHE_177A3_Bombardier.this.fm.actor).bElectroSound
						&& !((HE_177A3) CockpitHE_177A3_Bombardier.this.fm.actor).bSightAutomation) {
					CockpitHE_177A3_Bombardier.this.sfxStop(16);
					((HE_177A3) CockpitHE_177A3_Bombardier.this.fm.actor).bElectroSound = false;
				}
			}
			CockpitHE_177A3_Bombardier.this.setNew.bombDoor = 0.9F * CockpitHE_177A3_Bombardier.this.setOld.bombDoor
					+ 0.1F * CockpitHE_177A3_Bombardier.this.fm.CT.getBayDoor();
			return true;
		}
	...
	protected void doFocusLeave() {
		if (!this.isFocused())
			...
			this.aircraft().hierMesh().chunkVisible("Pilot4_FAK",
					this.aircraft().hierMesh().isChunkVisible("Pilot4_D0"));
			this.aircraft().hierMesh().chunkVisible("Pilot4_FAL",
					this.aircraft().hierMesh().isChunkVisible("Pilot4_D1"));
			this.aircraft().hierMesh().chunkVisible("HMask4_D0",
					this.aircraft().hierMesh().isChunkVisible("Pilot4_D0"));
			this.leave();
			super.doFocusLeave();
			return;
...
//			}
		...
		if (this.bEntered) {
			...
			float f32 = (float) Math
					.toDegrees(this.fm.EI.engines[0].getPropPhi() - this.fm.EI.engines[0].getPropPhiMin());
			...
			float f33 = (float) Math
					.toDegrees(this.fm.EI.engines[1].getPropPhi() - this.fm.EI.engines[1].getPropPhiMin());
			...
			this.mesh.chunkSetAngles("Z_N_FuelConsom",
					-this.cvt(0.5F * this.setNew.consumptionL, 0.0F, 500F, 0.0F, 255.5F), 0.0F, 0.0F);
