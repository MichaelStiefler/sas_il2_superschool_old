...
public class CockpitHE_111H11_NGunner extends CockpitGunner
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            f /= Time.tickLenFs();
            f *= 3600F;
            setNew.cons = 0.9F * setOld.cons + 0.1F * f;
            float f1 = fm.EI.engines[0].getEngineForce().x;
            float f2 = fm.EI.engines[1].getEngineForce().x;
            if(f1 < 100F || fm.EI.engines[0].getRPM() < 600F)
                f1 = 1.0F;
            if(f2 < 100F || fm.EI.engines[1].getRPM() < 600F)
                f2 = 1.0F;
            setNew.consL = 0.9F * setOld.consL + (0.1F * (setNew.cons * f1)) / (f1 + f2);
            setNew.consR = 0.9F * setOld.consR + (0.1F * (setNew.cons * f2)) / (f1 + f2);
            return true;
        }
    ...
    public CockpitHE_111H11_NGunner()
    {
        ...
        this.cockpitNightMats = (new String[] {
            "clocks2C", "clocks3B", "clocks4", "clocks5", "clocks6", "clocks8C"
        });
        setNightMats(false);
