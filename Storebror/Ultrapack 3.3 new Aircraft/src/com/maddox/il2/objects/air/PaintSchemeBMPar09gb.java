...
public class PaintSchemeBMPar09gb extends PaintScheme
{
    ...
    public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k)
    {
        ...
        if(regiment.country() == PaintScheme.countryGermany)
        {
            ...
            changeMat(class1, hiermesh, "Overlay7a", "balken1", "German/balken1.tga", 1.0F, 1.0F, 1.0F);
        ...
        if(regiment.country() == PaintScheme.countryNetherlands)
        {
            ...
            changeMat(class1, hiermesh, "Overlay7a", "DutchTriangle", "Dutch/roundel.tga", 1.0F, 1.0F, 1.0F);
        ...
        if(regiment.country() == PaintScheme.countryFinland)
        {
            ...
            changeMat(class1, hiermesh, "Overlay7a", "FAFhaken", "Finnish/" + (World.cur().isHakenAllowed() ? "FAFhaken.tga" : "FAFroundel.tga"), 1.0F, 1.0F, 1.0F);
            if(k < 10)
        ...
        } else
        {
            if(regiment.country() == PaintScheme.countryFrance)
            {
                ...
                changeMat(class1, hiermesh, "Overlay7a", "frenchroundel", "French/roundel.tga", 1.0F, 1.0F, 1.0F);
            }
            if(regiment.country() == PaintScheme.countryBritain)
            {
                ...
                {
                    k = clampToLiteral(k);
                    changeMat(hiermesh, "Overlay1", "psBM02BRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/" + regiment.aid()[1] + ".tga", PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2], PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2]);
                    changeMat(hiermesh, "Overlay4", "psBM02BRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/" + regiment.aid()[1] + ".tga", PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2], PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2]);
                    changeMat(hiermesh, "Overlay2", "psBM02BRILNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + (char)((65 + k) - 1) + ".tga", "null.tga", PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2], 1.0F, 1.0F, 1.0F);
                    changeMat(hiermesh, "Overlay3", "psBM02BRIRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/" + (char)((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2]);
                }
            } else
            if(regiment.country() == PaintScheme.countryHungary)
            {
                ...
                changeMat(class1, hiermesh, "Overlay7a", "hungarianbalkenolder", "Hungarian/balkenolder.tga", 1.0F, 1.0F, 1.0F);
            } else
            {
                if(regiment.country() == PaintScheme.countryItaly)
                {
                ...
                if(regiment.country() == PaintScheme.countryJapan)
                {
                    ...
                    changeMat(class1, hiermesh, "Overlay7a", "JAR1", "Japanese/JAR.tga", 1.0F, 1.0F, 1.0F);
                }
                if(regiment.country() == PaintScheme.countryPoland)
                {
                    ...
                    changeMat(class1, hiermesh, "Overlay7a", "polishcheckerboard", "Polish/checkerboard.tga", 1.0F, 1.0F, 1.0F);
                ...
                if(regiment.country() == PaintScheme.countryRomania)
                {
                    ...
                    changeMat(class1, hiermesh, "Overlay7a", "romaniancross", "Romanian/insignia.tga", 1.0F, 1.0F, 1.0F);
                } else
                if(regiment.country() == PaintScheme.countryRussia)
                {
                    if(k < 10)
                    ...
                    changeMat(class1, hiermesh, "Overlay7a", "redstar2", "Russian/redstar2.tga", 1.0F, 1.0F, 1.0F);
                ...
                if(regiment.country() == PaintScheme.countryNewZealand)
                {
                    ...
                    changeMat(class1, hiermesh, "Overlay7a", "newzealand7", "NewZealand/newzealand7.tga", 1.0F, 1.0F, 1.0F);
                } else
                if(regiment.country() == PaintScheme.countrySlovakia)
                {
                    if(k < 10)
                    ...
                    changeMat(class1, hiermesh, "Overlay7a", "slovakiancross2", "Slovakian/cross2.tga", 1.0F, 1.0F, 1.0F);
                } else
                if(regiment.country() == PaintScheme.countryUSA)
                {
                    ...
                    changeMat(class1, hiermesh, "Overlay7a", "whitestar1", "States/whitestar1.tga", 1.0F, 1.0F, 1.0F);
                }
            }
        }
    }
