...
public class CockpitHe111ABE_BGunner extends CockpitGunner {
	...
	public CockpitHe111ABE_BGunner() {
	...
	static {
		Property.set(CockpitHe111ABE_BGunner.class, "aiTuretNum", 2);
		Property.set(CockpitHe111ABE_BGunner.class, "weaponControlNum", 12);
		Property.set(CockpitHe111ABE_BGunner.class, "astatePilotIndx", 3);
	}
}
