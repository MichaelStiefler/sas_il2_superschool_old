...
public class CockpitHE_111H8_Bombardier extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        this.mesh.chunkVisible("Kuto_MidL", aircraft().hierMesh().isChunkVisible("Kuto_MidL_D0"));
        this.mesh.chunkVisible("Kuto_MidR", aircraft().hierMesh().isChunkVisible("Kuto_MidR_D0"));
