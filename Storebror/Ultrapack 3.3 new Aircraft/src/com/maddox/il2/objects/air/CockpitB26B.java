...
public class CockpitB26B extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                if(B26B != null)
                    setNew.PDI = B26B.fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        this.mesh.chunkSetAngles("zCompass3", 0.0F, setNew.radioCompassAzimuth.getDeg(f * 0.02F), 0.0F);
        if((this.fm.AS.astateCockpitState & 0x40) == 0)
        {
            this.mesh.chunkSetAngles("zMagnetic", 0.0F, setNew.azimuth.getDeg(f), 0.0F);
            this.mesh.chunkSetAngles("zNavP", 0.0F, setNew.waypointAzimuth.getDeg(f * 0.1F), 0.0F);
        }
        if((this.fm.AS.astateCockpitState & 0x40) == 0)
        {
        ...
        this.mesh.chunkSetAngles("zSuction", 0.0F, cvt(f_0_, 0.0F, 10F, 0.0F, 297F), 0.0F);
