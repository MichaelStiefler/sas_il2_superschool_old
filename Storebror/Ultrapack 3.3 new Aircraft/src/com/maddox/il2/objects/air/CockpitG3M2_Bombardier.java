...
public class CockpitG3M2_Bombardier extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((G3M)aircraft()).fSightCurForwardAngle;
                float f1 = -((G3M)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((G3M)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((G3M)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
