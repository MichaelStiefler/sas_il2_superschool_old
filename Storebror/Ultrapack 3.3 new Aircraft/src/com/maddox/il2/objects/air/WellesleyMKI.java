...
public class WellesleyMKI extends Scheme1
    implements TypeScout, TypeBomber, TypeStormovik
{
    ...
    {
        hierMesh().chunkSetAngles("Bay1_D0", 5F * f, -95F * f, 0F);
        hierMesh().chunkSetAngles("Bay2_D0", -5F * f, -95F * f, 0F);
        hierMesh().chunkSetAngles("Bay1b_D0", -5F * f, -95F * f, 0F);
        hierMesh().chunkSetAngles("Bay2b_D0", 5F * f, -95F * f, 0F);
    }
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitWellesley.class, CockpitWellesley_TGunner.class
        });
