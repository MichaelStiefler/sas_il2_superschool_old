...
public class CockpitJU_88A5 extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(fm != null)
            {
                ...
                if(buzzerFX != null)
                    if(fm.Loc.z < (double)((JU_88A5)aircraft()).fDiveRecoveryAlt && ((JU_88A5)((Interpolate) (fm)).actor).diveMechStage == 1)
                        buzzerFX.play();
                    else
                    if(buzzerFX.isPlaying())
                        buzzerFX.stop();
                f1 = ((JU_88A5)aircraft()).fDiveRecoveryAlt;
                float f2 = -(((JU_88A5)aircraft()).fDiveVelocity * 0.27777F * (float)Math.sin(Math.toRadians(((JU_88A5)aircraft()).fDiveAngle))) * 0.1019F;
                f2 += (float)Math.sqrt(f2 * f2 + 2.0F * f1 * 0.1019F);
                float f3 = ((JU_88A5)aircraft()).fDiveVelocity * 0.27777F * (float)Math.cos(Math.toRadians(((JU_88A5)aircraft()).fDiveAngle));
                float f4 = (f3 * f2 + 10F) - 10F;
                setNew.alpha = 90F - ((JU_88A5)aircraft()).fDiveAngle - (float)Math.toDegrees(Math.atan(f4 / f1));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        this.mesh.chunkSetAngles("z_Object20", cvt(((JU_88A5)aircraft()).fSightCurSpeed, 400F, 800F, 87F, -63.5F), 0.0F, 0.0F);
        ...
        resetYPRmodifier();
        Cockpit.xyz[2] = -(10.27825F * (float)Math.tan(Math.toRadians(setNew.alpha)));
        ...
        this.mesh.chunkSetAngles("zAlt3", (((JU_88A5)aircraft()).fDiveRecoveryAlt * 360F) / 6000F, 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_ELN1", cvt(0.05F * this.fm.EI.engines[0].tOilOut * this.fm.EI.engines[0].getReadyness() * this.fm.EI.engines[0].getReadyness(), 0.0F, 7.47F, 0.0F, 285F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_ELN2", cvt(this.fm.EI.engines[0].getReadyness(), 0.0F, 2.0F, 0.0F, 285F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_ERN1", cvt(0.05F * this.fm.EI.engines[1].tOilOut * this.fm.EI.engines[1].getReadyness() * this.fm.EI.engines[1].getReadyness(), 0.0F, 7.47F, 0.0F, 285F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_ERN2", cvt(this.fm.EI.engines[1].getReadyness(), 0.0F, 2.0F, 0.0F, 285F), 0.0F, 0.0F);
