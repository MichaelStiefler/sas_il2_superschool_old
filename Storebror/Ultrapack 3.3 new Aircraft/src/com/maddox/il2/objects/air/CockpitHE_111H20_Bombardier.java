...
public class CockpitHE_111H20_Bombardier extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((HE_111xyz)aircraft()).fSightCurForwardAngle;
            float f1 = ((HE_111xyz)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            this.mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((HE_111xyz)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((HE_111xyz)aircraft()).fSightCurReadyness > 0.93F;
        ...
        this.mesh.chunkSetAngles("zAltWheel", 0.0F, cvt(((HE_111xyz)aircraft()).fSightCurAltitude, 0.0F, 10000F, 0.0F, 375.8333F), 0.0F);
        this.mesh.chunkSetAngles("zAnglePointer", 0.0F, ((HE_111xyz)aircraft()).fSightCurForwardAngle, 0.0F);
        this.mesh.chunkSetAngles("zAngleWheel", 0.0F, -10F * ((HE_111xyz)aircraft()).fSightCurForwardAngle, 0.0F);
        this.mesh.chunkSetAngles("zSpeed", 0.0F, floatindex(cvt(Pitot.Indicator((float)this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 400F, 0.0F, 16F), speedometerScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeedPointer", 0.0F, cvt(((HE_111xyz)aircraft()).fSightCurSpeed, 150F, 600F, 0.0F, 60F), 0.0F);
        this.mesh.chunkSetAngles("zSpeedWheel", 0.0F, 0.333F * ((HE_111xyz)aircraft()).fSightCurSpeed, 0.0F);
