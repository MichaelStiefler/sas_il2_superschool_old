...
public class WhitleyMkVII extends WhitleyBombers
    implements TypeBomber
{
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitWhitley.class, CockpitWhitleyVII_Bombardier.class, CockpitWhitley_AGunner.class, CockpitWhitley_FGunner.class
        });
        Property.set(class1, "LOSElevation", 1.4078F);
        Aircraft.weaponTriggersRegister(class1, new int[] {
            10, 10, 11, 11, 11, 11, 12, 13, 3, 3, 
            3, 3, 3, 3, 3, 3
        });
