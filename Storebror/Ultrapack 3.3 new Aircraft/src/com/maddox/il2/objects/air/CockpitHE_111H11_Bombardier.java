...
public class CockpitHE_111H11_Bombardier extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            f3 /= Time.tickLenFs();
            f3 *= 3600F;
            setNew.cons = 0.9F * setOld.cons + 0.1F * f3;
            float f4 = fm.EI.engines[0].getEngineForce().x;
            float f5 = fm.EI.engines[1].getEngineForce().x;
            if(f4 < 100F || fm.EI.engines[0].getRPM() < 600F)
                f4 = 1.0F;
            if(f5 < 100F || fm.EI.engines[1].getRPM() < 600F)
                f5 = 1.0F;
            setNew.consL = 0.9F * setOld.consL + (0.1F * (setNew.cons * f4)) / (f4 + f5);
            setNew.consR = 0.9F * setOld.consR + (0.1F * (setNew.cons * f5)) / (f4 + f5);
            return true;
        }
    ...
    public CockpitHE_111H11_Bombardier()
    {
        ...
        this.cockpitNightMats = (new String[] {
            "clocks1C", "clocks2C", "clocks3B", "clocks4", "clocks5", "clocks6", "clocks8C"
        });
        setNightMats(false);
