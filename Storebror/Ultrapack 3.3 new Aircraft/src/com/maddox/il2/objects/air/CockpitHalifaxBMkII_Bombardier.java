...
public class CockpitHalifaxBMkII_Bombardier extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((Halifax)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((Halifax)aircraft()).fSightCurReadyness > 0.93F;
        ...
        mesh.chunkSetAngles("Turret1B", fm.turret[0].tu[0], fm.turret[0].tu[1], 0.0F);
    }
