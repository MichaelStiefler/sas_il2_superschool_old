	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitHE_177A3_NGunner.this.fm != null) {
				...
				CockpitHE_177A3_NGunner.this.setNew.AirEnemy = 0.95F * CockpitHE_177A3_NGunner.this.setOld.AirEnemy
						+ 0.05F * (((HE_177A3) CockpitHE_177A3_NGunner.this.fm.actor).bAirEnemy ? 1.0F : 0.0F);
				CockpitHE_177A3_NGunner.this.setNew.throttle1 = 0.85F * CockpitHE_177A3_NGunner.this.setOld.throttle1
						+ CockpitHE_177A3_NGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
				CockpitHE_177A3_NGunner.this.setNew.throttle2 = 0.85F * CockpitHE_177A3_NGunner.this.setOld.throttle2
						+ CockpitHE_177A3_NGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
				CockpitHE_177A3_NGunner.this.setNew.pictAiler = 0.85F * CockpitHE_177A3_NGunner.this.setOld.pictAiler
						+ 0.15F * CockpitHE_177A3_NGunner.this.cvt(CockpitHE_177A3_NGunner.this.fm.CT.AileronControl,
								-1F, 1.0F, -1F, 1.0F);
				CockpitHE_177A3_NGunner.this.setNew.pictElev = 0.85F * CockpitHE_177A3_NGunner.this.setOld.pictElev
						+ 0.15F * CockpitHE_177A3_NGunner.this.cvt(CockpitHE_177A3_NGunner.this.fm.CT.ElevatorControl,
								-1F, 1.0F, -1F, 1.0F);
				CockpitHE_177A3_NGunner.this.setNew.elevTrim = 0.85F * CockpitHE_177A3_NGunner.this.setOld.elevTrim
						+ 0.15F * CockpitHE_177A3_NGunner.this.fm.CT.trimElevator;
				CockpitHE_177A3_NGunner.this.setNew.rudderTrim = 0.85F * CockpitHE_177A3_NGunner.this.setOld.rudderTrim
						+ 0.15F * CockpitHE_177A3_NGunner.this.fm.CT.trimRudder;
				CockpitHE_177A3_NGunner.this.setNew.ailTrim = 0.85F * CockpitHE_177A3_NGunner.this.setOld.ailTrim
						+ 0.15F * CockpitHE_177A3_NGunner.this.fm.CT.trimAileron;
				if (Math.toDegrees(CockpitHE_177A3_NGunner.this.fm.EI.engines[0].getPropPhi()) < 36D) {
					CockpitHE_177A3_NGunner.this.setNew.prop1 = 0.85F * CockpitHE_177A3_NGunner.this.setOld.prop1
							+ ((FlightModelMain) CockpitHE_177A3_NGunner.this.fm).EI.engines[0].getControlProp()
									* 0.15F;
					CockpitHE_177A3_NGunner.this.setNew._prop1 = CockpitHE_177A3_NGunner.this
							.cvt(CockpitHE_177A3_NGunner.this.setNew.prop1, 0.0F, 1.0F, -22F, -63F);
				} else {
					CockpitHE_177A3_NGunner.this.setNew.prop1 = 0.85F * CockpitHE_177A3_NGunner.this.setOld.prop1;
					CockpitHE_177A3_NGunner.this.setNew._prop1 = CockpitHE_177A3_NGunner.this
							.cvt(CockpitHE_177A3_NGunner.this.setNew.prop1, 0.0F, 1.0F, 0.0F, -63F);
				}
				if (Math.toDegrees(CockpitHE_177A3_NGunner.this.fm.EI.engines[1].getPropPhi()) < 36D) {
					CockpitHE_177A3_NGunner.this.setNew.prop2 = 0.85F * CockpitHE_177A3_NGunner.this.setOld.prop2
							+ ((FlightModelMain) CockpitHE_177A3_NGunner.this.fm).EI.engines[1].getControlProp()
									* 0.15F;
					CockpitHE_177A3_NGunner.this.setNew._prop2 = CockpitHE_177A3_NGunner.this
							.cvt(CockpitHE_177A3_NGunner.this.setNew.prop2, 0.0F, 1.0F, -22F, -63F);
				} else {
					CockpitHE_177A3_NGunner.this.setNew.prop2 = 0.85F * CockpitHE_177A3_NGunner.this.setOld.prop2;
					CockpitHE_177A3_NGunner.this.setNew._prop2 = CockpitHE_177A3_NGunner.this
							.cvt(CockpitHE_177A3_NGunner.this.setNew.prop2, 0.0F, 1.0F, 0.0F, -63F);
				}
				CockpitHE_177A3_NGunner.this.setNew.altimeter = 0.85F * CockpitHE_177A3_NGunner.this.setOld.altimeter
						+ CockpitHE_177A3_NGunner.this.fm.getAltitude() * 0.15F;
				CockpitHE_177A3_NGunner.this.setNew.vspeed = (199F * CockpitHE_177A3_NGunner.this.setOld.vspeed
						+ CockpitHE_177A3_NGunner.this.fm.getVertSpeed()) / 200F;
				CockpitHE_177A3_NGunner.this.setNew.beaconDirection = (10F
						* CockpitHE_177A3_NGunner.this.setOld.beaconDirection
						+ CockpitHE_177A3_NGunner.this.getBeaconDirection()) / 11F;
				CockpitHE_177A3_NGunner.this.setNew.beaconRange = (10F * CockpitHE_177A3_NGunner.this.setOld.beaconRange
						+ CockpitHE_177A3_NGunner.this.getBeaconRange()) / 11F;
				CockpitHE_177A3_NGunner.this.setNew.pictManf1 = 0.9F * CockpitHE_177A3_NGunner.this.setOld.pictManf1
						+ 0.1F * CockpitHE_177A3_NGunner.this.cvt(
								CockpitHE_177A3_NGunner.this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_NGunner.this.setNew.pictManf2 = 0.8F * CockpitHE_177A3_NGunner.this.setOld.pictManf2
						+ 0.2F * CockpitHE_177A3_NGunner.this.cvt(
								CockpitHE_177A3_NGunner.this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_NGunner.this.setNew.pictManf3 = 0.9F * CockpitHE_177A3_NGunner.this.setOld.pictManf3
						+ 0.1F * CockpitHE_177A3_NGunner.this.cvt(
								CockpitHE_177A3_NGunner.this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_NGunner.this.setNew.pictManf4 = 0.8F * CockpitHE_177A3_NGunner.this.setOld.pictManf4
						+ 0.2F * CockpitHE_177A3_NGunner.this.cvt(
								CockpitHE_177A3_NGunner.this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				...
				CockpitHE_177A3_NGunner.this.setNew.consumptionL = 0.9F
						* CockpitHE_177A3_NGunner.this.setOld.consumptionL + 0.1F * (f3 * f1) / (f1 + f2 + 1.0F);
				CockpitHE_177A3_NGunner.this.setNew.consumptionR = 0.9F
						* CockpitHE_177A3_NGunner.this.setOld.consumptionR + 0.1F * (f3 * f2) / (f1 + f2 + 1.0F);
				CockpitHE_177A3_NGunner.this.setNew.bombDoor = 0.9F * CockpitHE_177A3_NGunner.this.setOld.bombDoor
						+ 0.1F * CockpitHE_177A3_NGunner.this.fm.CT.getBayDoor();
			}
			return true;
		}
...
//        gunLeverMoveAxis = -1;
//        magazines = -2;
		this.cockpitNightMats = new String[] { "Fl20274", "Fl20342na", "Fl20342", "Fl20516", "Fl20516_1", "Fl20556",
				"Fl20570", "Fl20572", "Fl20723_1000", "Fl20723_1185", "Fl20723_1850", "Fl20723_200na", "Fl20723_200",
				"Fl20723_640", "Fl22231", "Fl22316", "Fl22382", "Fl30489", "Fl30532", "Fl32336", "Ln27002",
...
//		this.hidePilot = true;
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("Z_N_RPM1", -this.floatindex(this.cvt(f27, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_N_RPM2", -this.floatindex(this.cvt(f27, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		float f28 = ((FlightModelMain) this.fm).EI.engines[1].getRPM();
		this.mesh.chunkSetAngles("Z_N_RPM3", -this.floatindex(this.cvt(f28, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_N_RPM4", -this.floatindex(this.cvt(f28, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		...
		this.mesh.chunkSetAngles("Z_tLink", 0.0F, 0.0F,
				this.floatindex(this.cvt(f39, 0.0F, 90F, 0.0F, 18F), Turret_Z1));
		this.mesh.chunkSetAngles("Z_tHandle", 0.0F, 0.0F,
				-this.floatindex(this.cvt(f39, 0.0F, 90F, 0.0F, 18F), Turret_Z2));
