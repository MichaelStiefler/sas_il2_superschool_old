...
public class CockpitB24D_FLGunner extends CockpitB24D_FGunner
{
    ...
    public void moveGun(Orient orient)
    {
        ...
        float f = -cvt(orient.getYaw(), 10F, 50F, 10F, 50F) - cvt(orient.getTangage(), -40F, -30F, 20F, 0.0F);
        float f1 = cvt(orient.getTangage(), -30F, 4F, -30F, 4F);
