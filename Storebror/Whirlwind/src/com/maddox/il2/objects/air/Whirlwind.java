...
//        StringTokenizer tokenizer = new StringTokenizer (content, split);
...
//    }    
//    
//    private void readFlapScale() {
//    	String lineX = "", lineY = "", lineZ = "", liney="", linep="", liner="";
//    	try {
//	    	BufferedReader br = new BufferedReader(new FileReader("c:/temp/fs.txt"));
//	    	lineX = br.readLine();
//	    	lineY = br.readLine();
//	    	lineZ = br.readLine();
//	    	liney = br.readLine();
...
//    		e.printStackTrace();
//    	}
//    	flapScaleX = lineToArray(lineX);
//    	flapScaleY = lineToArray(lineY);
//    	flapScaleZ = lineToArray(lineZ);
//    	flapScaley = lineToArray(liney);
//    	flapScalep = lineToArray(linep);
//    	flapScaler = lineToArray(liner);
//    }
//    
//    private float[] lineToArray(String theLine) {
//    	String[] arrayOfFloatString = split(theLine, " ");
//    	float[] theArray = new float[arrayOfFloatString.length];
//    	for (int i=0; i<arrayOfFloatString.length; i++) theArray[i]=Float.parseFloat(arrayOfFloatString[i]);
//    	return theArray;
//    }
	...
	public void update(float f) {
		...
		try {
			...
			if (Math.abs(kangle1 - controlRadiator) > 0.01F) {
				fkangle1.setFloat(this, controlRadiator);
				hierMesh().chunkSetAngles("WaterL_D0", 0.0F, -20.0F * controlRadiator, 0.0F);
			}
			...
			if (Math.abs(kangle2 - controlRadiator) > 0.01F) {
				fkangle2.setFloat(this, controlRadiator);
				hierMesh().chunkSetAngles("WaterR_D0", 0.0F, -20.0F * controlRadiator, 0.0F);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
