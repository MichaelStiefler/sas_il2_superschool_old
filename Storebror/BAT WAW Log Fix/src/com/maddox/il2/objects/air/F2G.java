...
//                    System.out.println("    No." + (k + 1) + ":" + s1 + "(" + i1 + ")");
    ...
    static 
    {
        ...
        try
        {
            ...
            if(FlightModelMain.sectFile("FlightModels/F8F-2.fmd") != null)
                byte0 = 8;
            else
            if(FlightModelMain.sectFile("FlightModels/SeaFuryMkI.fmd") != null)
                byte0 = 0;
            else
                byte0 = 6;
        }
...
//            System.out.println("F2G Loading FMD: FlightModels/F4U-1C.fmd");
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            com.maddox.il2.objects.air.CockpitF2G.class
        });
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalDev03", "_ExternalDev04", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb01", "_ExternalBomb02", 
            "_ExternalBomb03", "_ExternalBomb02", "_ExternalBomb03", "_ExternalRock01", "_ExternalRock02", "_ExternalRock03", "_ExternalRock04", "_ExternalRock05", "_ExternalRock06", "_ExternalRock07", 
            "_ExternalRock08"
        });
