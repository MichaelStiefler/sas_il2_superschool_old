...
public abstract class Barracuda extends Scheme1 {
    ...
    public void rareAction(float f, boolean flag) {
        ...
        if (flag) {
            if ((this.FM.AS.astateTankStates[0] > 4) && (World.Rnd().nextFloat() < 0.08F)) {
                this.nextDMGLevel(this.FM.AS.astateEffectChunks[0] + "0", 0, this);
            }
            if ((this.FM.AS.astateTankStates[1] > 4) && (World.Rnd().nextFloat() < 0.08F)) {
                this.nextDMGLevel(this.FM.AS.astateEffectChunks[1] + "0", 0, this);
            }
            if ((this.FM.AS.astateTankStates[2] > 4) && (World.Rnd().nextFloat() < 0.08F)) {
                this.nextDMGLevel(this.FM.AS.astateEffectChunks[2] + "0", 0, this);
            }
            if ((this.FM.AS.astateTankStates[3] > 4) && (World.Rnd().nextFloat() < 0.08F)) {
                this.nextDMGLevel(this.FM.AS.astateEffectChunks[3] + "0", 0, this);
            }
            if ((this.FM.AS.astateTankStates[0] > 5) && (World.Rnd().nextFloat() < 0.16F)) {
                this.FM.AS.hitTank(this, 1, 1);
            }
            if ((this.FM.AS.astateTankStates[1] > 5) && (World.Rnd().nextFloat() < 0.16F)) {
                this.FM.AS.hitTank(this, 1, 0);
            }
            if ((this.FM.AS.astateTankStates[2] > 5) && (World.Rnd().nextFloat() < 0.16F)) {
                this.FM.AS.hitTank(this, 1, 3);
            }
            if ((this.FM.AS.astateTankStates[3] > 5) && (World.Rnd().nextFloat() < 0.16F)) {
    ...
    public boolean turretAngles(int i, float af[]) {
        ...
        switch (i) {
            ...
            case 0:
                ...
                if (f2 < -floatindex(cvt(f3, 0.0F, 180.0F, 0.0F, 36.0F), af)) {
                    f2 = -floatindex(cvt(f3, 0.0F, 180.0F, 0.0F, 36.0F), af);
                }
                break;
        }
        af[0] = -f1;
    ...
    protected void moveWingFold(HierMesh mesh, float f) {
        ...
        if (this.FM.CT.wingControl > 0.0F) {
            if (this.FM.getSpeed() > 30F) {
    ...
    public void update(float f) {
        ...
        if (!this.gunnerRealMode && (Time.current() > this.tme)) {
            ...
            if (this.FM.turret.length != 0) {
                Actor actor = null;
                if (this.FM.turret[0].bIsOperable) {
