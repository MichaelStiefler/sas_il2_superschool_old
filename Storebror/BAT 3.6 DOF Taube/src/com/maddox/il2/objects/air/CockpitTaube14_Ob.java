...
public class CockpitTaube14_Ob extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTaube14_Ob.this.fm != null) {
                if (CockpitTaube14_Ob.this.bNeedSetUp) {
                    CockpitTaube14_Ob.this.reflectPlaneMats();
                    CockpitTaube14_Ob.this.bNeedSetUp = false;
                }
                CockpitTaube14_Ob.this.setTmp = CockpitTaube14_Ob.this.setOld;
                CockpitTaube14_Ob.this.setOld = CockpitTaube14_Ob.this.setNew;
                CockpitTaube14_Ob.this.setNew = CockpitTaube14_Ob.this.setTmp;
                CockpitTaube14_Ob.this.setNew.throttle = ((10F * CockpitTaube14_Ob.this.setOld.throttle) + CockpitTaube14_Ob.this.fm.CT.PowerControl) / 11F;
                CockpitTaube14_Ob.this.setNew.prop = ((10F * CockpitTaube14_Ob.this.setOld.prop) + CockpitTaube14_Ob.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitTaube14_Ob.this.setNew.altimeter = CockpitTaube14_Ob.this.fm.getAltitude();
                if (Math.abs(CockpitTaube14_Ob.this.fm.Or.getKren()) < 30F) {
                    CockpitTaube14_Ob.this.setNew.azimuth = ((35F * CockpitTaube14_Ob.this.setOld.azimuth) + -CockpitTaube14_Ob.this.fm.Or.getYaw()) / 36F;
                }
                if ((CockpitTaube14_Ob.this.setOld.azimuth > 270F) && (CockpitTaube14_Ob.this.setNew.azimuth < 90F)) {
                    CockpitTaube14_Ob.this.setOld.azimuth -= 360F;
                }
                if ((CockpitTaube14_Ob.this.setOld.azimuth < 90F) && (CockpitTaube14_Ob.this.setNew.azimuth > 270F)) {
                    CockpitTaube14_Ob.this.setOld.azimuth += 360F;
                }
                CockpitTaube14_Ob.this.setNew.waypointAzimuth = ((10F * CockpitTaube14_Ob.this.setOld.waypointAzimuth) + (CockpitTaube14_Ob.this.waypointAzimuth() - CockpitTaube14_Ob.this.setOld.azimuth) + World.Rnd().nextFloat(-10F, 10F)) / 11F;
                CockpitTaube14_Ob.this.setNew.vspeed = ((199F * CockpitTaube14_Ob.this.setOld.vspeed) + CockpitTaube14_Ob.this.fm.getVertSpeed()) / 200F;
                boolean flag = false;
                if (CockpitTaube14_Ob.this.setNew.gCrankAngle < (CockpitTaube14_Ob.this.fm.CT.getGear() - 0.005F)) {
                    if (Math.abs(CockpitTaube14_Ob.this.setNew.gCrankAngle - CockpitTaube14_Ob.this.fm.CT.getGear()) < 0.33F) {
                        CockpitTaube14_Ob.this.setNew.gCrankAngle += 0.0025F;
                        flag = true;
                    } else {
                        CockpitTaube14_Ob.this.setNew.gCrankAngle = CockpitTaube14_Ob.this.fm.CT.getGear();
                        CockpitTaube14_Ob.this.setOld.gCrankAngle = CockpitTaube14_Ob.this.fm.CT.getGear();
                    }
                }
                if (CockpitTaube14_Ob.this.setNew.gCrankAngle > (CockpitTaube14_Ob.this.fm.CT.getGear() + 0.005F)) {
                    if (Math.abs(CockpitTaube14_Ob.this.setNew.gCrankAngle - CockpitTaube14_Ob.this.fm.CT.getGear()) < 0.33F) {
                ...
                if (flag != this.sfxPlaying) {
                    if (flag) {
                        CockpitTaube14_Ob.this.sfxStart(16);
                    } else {
                        CockpitTaube14_Ob.this.sfxStop(16);
                    }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zGas1a", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 190F, 0.0F, 14F), CockpitTaube14_Ob.fuelQuantityScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitTaube14_Ob.speedometerScale), 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x20) == 0)) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 13F), CockpitTaube14_Ob.engineRPMScale), 0.0F);
