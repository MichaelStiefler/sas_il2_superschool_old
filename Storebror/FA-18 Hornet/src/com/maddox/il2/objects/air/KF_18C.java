...
public class KF_18C extends F_18 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump, TypeTankerDrogue, TypeDockable {
	...
	public void update(float f) {
		...
		super.update(f);
		if (super.FM.getAltitude() < 1000F || (double) FM.CT.getGear() > 0.0D || (double) FM.CT.getArrestor() > 0.0D) {
	...
	public void rareAction(float f, boolean flag) {
		...
		if ((!missilesList.isEmpty() || !backfireList.isEmpty()) && Time.current() > tX4Prev + 100L + (IR ? 5000L : 0L)) {
			...
			} else if (pilot.target != null || pilot.danger != null) {
	...
	static {
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitF18.class, CockpitF18FLIR.class });
		Property.set(class1, "LOSElevation", 0.965F);
		Aircraft.weaponTriggersRegister(class1, new int[] { 0, 2, 2, 2, 2, 2, 2, 2, 2, 9, 9, 9, 9, 9, 9, 9, 9, 2, 2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 9, 9, 9, 9, 3, 3, 3, 3, 3, 3, 3, 3, 9, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
				2, 2, 2, 2, 2, 2, 2 });
		Aircraft.weaponHooksRegister(class1, new String[] { "_CANNON01", "_Extmis05", "_Extmis06", "_Extmis07", "_Extmis08", "_Extmis10", "_Extmis11", "_Extmis12", "_Extmis13", "_ExtDev05", "_ExtTank03", "_ExtDev01", "_ExtDev02", "_ExtDev03",
				...
				"_Extmis45", "_Extmis46", "_Extmis47", "_Extmis48", "_Extmis49" });
		try {
