        ...
        if (this.typeDockableIsDocked()) {
            ...
            if (this.isNetMaster()) {
                if (this.lastPowerControl != this.FM.CT.getPowerControl()) {
                    ...
                    System.out.println("BF_109F4MSTL PowerControl = " + this.FM.CT.getPowerControl());
                ...
                if (this.lastTailWheelLocked != this.FM.Gears.bTailwheelLocked) {
                    ...
                    System.out.println("BF_109F4MSTL bTailwheelLocked = " + this.FM.Gears.bTailwheelLocked);
                ...
                if (this.lastBreak != this.FM.CT.BrakeControl ||
                    ...
                    this.lastBreakLeft = this.FM.CT.BrakeLeftControl;
                    this.lastBreakRight = this.FM.CT.BrakeRightControl;
                    System.out.println("BF_109F4MSTL BrakeControl=" + this.FM.CT.BrakeControl + ", BrakeLeftControl=" + this.FM.CT.BrakeLeftControl + ", BrakeRightControl=" + this.FM.CT.BrakeRightControl);
...
//            aircraft.FM.EI.bCurControl[1] = false;
    ...
    private void spawnBomb() {
        System.out.println("BF_109F4MSTL spawnBomb() 1");
        if (this.mistelQueen == null) return;
        System.out.println("BF_109F4MSTL spawnBomb() 2");
        if (this.mistelQueen.pos.getAbsPoint().z - Engine.cur.land.HQ(this.mistelQueen.pos.getAbsPoint().x, this.mistelQueen.pos.getAbsPoint().y) > 50D) {
            ...
            System.out.println("BF_109F4MSTL spawnBomb() 3");
            return;
        }
        ...
        System.out.println("BF_109F4MSTL spawnBomb() 4");
    }
    ...
    private boolean receiveNetExploded(NetMsgInput netmsginput) {
        System.out.println("BF_109F4MSTL receiveNetExploded() 1");
        if (this.net != netmsginput.readNetObj())
            return false;
        System.out.println("BF_109F4MSTL receiveNetExploded() 2");
        if (this.mistelQueen.net != netmsginput.readNetObj())
            return false;
        System.out.println("BF_109F4MSTL receiveNetExploded() 3");
        this.spawnBomb();
        System.out.println("BF_109F4MSTL receiveNetExploded() 6");
        return true;
    }

    private boolean receivePowerControl(NetMsgInput netmsginput) throws IOException {
        System.out.println("BF_109F4MSTL receivePowerControl() 1");
        if (this.net != netmsginput.readNetObj())
            return false;
        System.out.println("BF_109F4MSTL receivePowerControl() 2");
        float fThrottle = netmsginput.readFloat();
        System.out.println("BF_109F4MSTL receivePowerControl() 3");
        this.FM.CT.setPowerControl(fThrottle);
        System.out.println("BF_109F4MSTL receivePowerControl() 4");
        return true;
    }
    
    private boolean receiveTailWheelLocked(NetMsgInput netmsginput) throws IOException {
        System.out.println("BF_109F4MSTL receiveTailWheelLocked() 1");
        if (this.net != netmsginput.readNetObj())
            return false;
        System.out.println("BF_109F4MSTL receiveTailWheelLocked() 2");
        boolean bTailWheelLocked = netmsginput.readBoolean();
        System.out.println("BF_109F4MSTL receiveTailWheelLocked() 3");
        this.FM.CT.bHasLockGearControl = true;
        this.FM.Gears.bTailwheelLocked = bTailWheelLocked;
        this.FM.CT.bHasLockGearControl = false;
        System.out.println("BF_109F4MSTL receiveTailWheelLocked() 4");
        return true;
    }

    private boolean receiveBrakes(NetMsgInput netmsginput) throws IOException {
        System.out.println("BF_109F4MSTL receiveBrakes() 1");
        if (this.net != netmsginput.readNetObj())
            return false;
        System.out.println("BF_109F4MSTL receiveBrakes() 2");
        ...
        System.out.println("BF_109F4MSTL receiveBrakes() 3");
        return true;
    }
