...
//								id++;
	...
	public void doBegin()
	{
		if (!bPlaying)
		{
	        ...
	        if(Config.cur.ini.get("Mods", "AutoNtrk", 1) != 0) {
				...
				String filename = "records_auto/" + sanitizeFilename(datetime + "_" + name() + ".ntrk");
				float timeparam = (float)Config.cur.netSpeed / 1000F + 5F;
	            String autoNtrkFolder = Config.cur.ini.get("Mods", "AutoNtrkFolder", "records_auto");
