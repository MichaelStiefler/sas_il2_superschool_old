...
public class CockpitF_16C_B52 extends CockpitPilot
{
    ...
    protected void moveControls(float f)
    {
        ...
        super.mesh.chunkSetAngles("Throttole", 0.0F, 0.0F, -42F * interp(setNew.throttlel, setOld.throttlel, f));       
        resetYPRmodifier();
        Cockpit.xyz[0] = 0.0F;
        Cockpit.xyz[1] = 0.0F;
    ...
    private void movegauges(float paramfloat)
    {
        ...
        float N1L = cvt(((FlightModelMain) (super.fm)).EI.engines[0].getRPM(), 0.0F, 4080F, 0F, 300F);
        super.mesh.chunkSetAngles("GaugeMove_RPM_L", N1L, 0.0F, 0.0F);
    ...
    protected void Warninglight()
    {
    	...
    	if(!((FlightModelMain) (super.fm)).Gears.onGround())
    	{
        	...
        	super.mesh.chunkVisible("Int_LDG_ON", true); else
    		{	
        ...
        if(!setNew.isBatteryOn && !setNew.isGeneratorAllive)
        	super.mesh.chunkVisible("ZFLCS", true);	else super.mesh.chunkVisible("ZFLCS", false);       
    }    
