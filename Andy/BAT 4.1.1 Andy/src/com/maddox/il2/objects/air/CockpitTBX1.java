// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 15.11.2020 10:48:19
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: fullnames 
// Source File Name:   CockpitTBX1.java
...
public class CockpitTBX1 extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        com.maddox.il2.objects.air.Cockpit.xyz[2] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.06845F);
        com.maddox.il2.objects.air.Cockpit.ypr[2] = cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 1.0F);
        ...
        mesh.chunkSetAngles("Z_FuelPres1", 0.0F, cvt(fm.M.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 1.0F, 0.0F, 255F), 0.0F);
        mesh.chunkSetAngles("Z_TankPres1", 0.0F, cvt(fm.M.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 1.0F, 0.0F, 255F), 0.0F);
        ...
        resetYPRmodifier();
        if(fm.Gears.cgear)
            com.maddox.il2.objects.air.Cockpit.xyz[2] = -0.028F * fm.CT.getGear();
        mesh.chunkSetLocate("Z_GearInd1", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
        if(fm.Gears.lgear)
            com.maddox.il2.objects.air.Cockpit.xyz[2] = -0.028F * fm.CT.getGear();
        mesh.chunkSetLocate("Z_GearInd2", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
        resetYPRmodifier();
        if(fm.Gears.rgear)
            com.maddox.il2.objects.air.Cockpit.xyz[2] = -0.028F * fm.CT.getGear();
        mesh.chunkSetLocate("Z_GearInd3", com.maddox.il2.objects.air.Cockpit.xyz, com.maddox.il2.objects.air.Cockpit.ypr);
