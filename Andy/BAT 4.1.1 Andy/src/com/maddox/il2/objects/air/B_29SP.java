// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 14.12.2020 15:04:59
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: fullnames 
// Source File Name:   B_29SP.java
...
public class B_29SP extends com.maddox.il2.objects.air.B_29X
    implements com.maddox.il2.objects.air.TypeBomber
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = com.maddox.il2.objects.air.B_29SP.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= com.maddox.il2.objects.air.B_29SP.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / com.maddox.il2.objects.air.B_29SP.toMeters(fSightCurAltitude)));
            if((double)fSightCurDistance < (double)com.maddox.il2.objects.air.B_29SP.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(com.maddox.il2.objects.air.B_29SP.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.B_29SP.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "B-29");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/B-29-SP(Multi1)/hier.him");
        com.maddox.rts.Property.set(class1, "PaintScheme", new PaintSchemeBMPar05());
        com.maddox.rts.Property.set(class1, "meshName_us", "3DO/Plane/B-29-SP(USA)/hier.him");
        ...
        com.maddox.rts.Property.set(class1, "FlightModel", "FlightModels/B-29SP.fmd:B29_50");
        com.maddox.rts.Property.set(class1, "cockpitClass", new java.lang.Class[] {
            com.maddox.il2.objects.air.CockpitB29.class, com.maddox.il2.objects.air.CockpitB29SP_Bombardier.class, com.maddox.il2.objects.air.CockpitB29SP_Radar.class, com.maddox.il2.objects.air.CockpitB29SP_AGunner.class
        });
