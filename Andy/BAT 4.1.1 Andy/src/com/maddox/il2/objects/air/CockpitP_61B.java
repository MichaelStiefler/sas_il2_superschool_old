// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 10.11.2020 13:24:26
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: fullnames 
// Source File Name:   CockpitP_61B.java
...
public class CockpitP_61B extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public CockpitP_61B()
    {
        ...
        cockpitNightMats = (new java.lang.String[] {
            ...
            "256-8_Gauges4_DMG", "256-8_Gauges4", "256-9_Gauges5_DMG", "256-9_Gauges5", "256-18", "256-21", "256-22", "128_Gauge_DF", "128_Gauge_DF_DMG"
        });
        setNightMats(false);
        ...
        limits6DoF = (new float[] {
            0.7F, 0.055F, -0.07F, 0.11F, 0.12F, -0.11F, 0.04F, -0.03F
        });
    }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(fm.Gears.lgear)
            mesh.chunkSetAngles("Z_GearLInd", 0.0F, 86F * fm.CT.getGearL(), 0.0F);
        if(fm.Gears.rgear)
            mesh.chunkSetAngles("Z_GearRInd", 0.0F, -86F * fm.CT.getGearR(), 0.0F);
        if(fm.Gears.cgear)
            mesh.chunkSetAngles("Z_GearCInd", 0.0F, 86F * fm.CT.getGearC(), 0.0F);
        ...
        mesh.chunkSetAngles("Z_DF", 0.0F, cvt(setNew.waypointAzimuth.getDeg(f * 0.2F), -25F, 25F, -30F, 30F), 0.0F);
    }
    ...
    public void reflectCockpitState()
    {
        ...
        if((fm.AS.astateCockpitState & 0x40) != 0)
        {
            ...
            mesh.chunkVisible("Z_DF", false);
            mesh.chunkVisible("DF_gauge_D0", false);
            mesh.chunkVisible("DF_gauge_D1", true);
        }
