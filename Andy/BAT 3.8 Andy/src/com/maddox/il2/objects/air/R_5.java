  ...
  implements TypeBomber, TypeStormovik
{
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.air.R_5.class;
        ...
        Property.set(class1, "FlightModel", "FlightModels/R-5.fmd:dt_r-5_fm");
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitR_5dt.class, 
            CockpitR_5_OP1.class, 
            CockpitR_5_Bombardier.class, 
            CockpitR_5_TGunner.class
        });
