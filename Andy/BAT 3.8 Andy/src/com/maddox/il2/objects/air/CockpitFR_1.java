...
public class CockpitFR_1 extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			if (CockpitFR_1.this.fm != null) {
				CockpitFR_1.this.setTmp = CockpitFR_1.this.setOld;
				CockpitFR_1.this.setOld = CockpitFR_1.this.setNew;
				CockpitFR_1.this.setNew = CockpitFR_1.this.setTmp;
				CockpitFR_1.this.setNew.throttle1 = 0.9F * CockpitFR_1.this.setOld.throttle1 + 0.1F * CockpitFR_1.this.fm.EI.engines[0].getControlThrottle();
				CockpitFR_1.this.setNew.prop1 = 0.9F * CockpitFR_1.this.setOld.prop1 + 0.1F * CockpitFR_1.this.fm.EI.engines[0].getControlProp();
				CockpitFR_1.this.setNew.mix1 = 0.8F * CockpitFR_1.this.setOld.mix1 + 0.2F * CockpitFR_1.this.fm.EI.engines[0].getControlMix();
				CockpitFR_1.this.setNew.throttle2 = 0.9F * CockpitFR_1.this.setOld.throttle2 + 0.1F * CockpitFR_1.this.fm.EI.engines[1].getControlThrottle();
				CockpitFR_1.this.setNew.prop2 = 0.9F * CockpitFR_1.this.setOld.prop2 + 0.1F * CockpitFR_1.this.fm.EI.engines[1].getControlProp();
				CockpitFR_1.this.setNew.mix2 = 0.8F * CockpitFR_1.this.setOld.mix2 + 0.2F * CockpitFR_1.this.fm.EI.engines[1].getControlMix();
				CockpitFR_1.this.setNew.man1 = 0.92F * CockpitFR_1.this.setOld.man1 + 0.08F * CockpitFR_1.this.fm.EI.engines[0].getManifoldPressure();
				CockpitFR_1.this.setNew.man2 = 0.92F * CockpitFR_1.this.setOld.man2 + 0.08F * CockpitFR_1.this.fm.EI.engines[1].getManifoldPressure();
				CockpitFR_1.this.setNew.altimeter = CockpitFR_1.this.fm.getAltitude();
				CockpitFR_1.this.setNew.azimuth.setDeg(CockpitFR_1.this.setOld.azimuth.getDeg(1.0F), CockpitFR_1.this.fm.Or.azimut());
				CockpitFR_1.this.setNew.vspeed = (199F * CockpitFR_1.this.setOld.vspeed + CockpitFR_1.this.fm.getVertSpeed()) / 200F;
			}
			return true;
		}
	...
	public CockpitFR_1() {
		super("3DO/Cockpit/F7F-3/hierFR1.him", "bf109");
