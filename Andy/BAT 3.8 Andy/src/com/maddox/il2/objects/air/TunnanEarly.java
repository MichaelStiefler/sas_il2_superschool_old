...
public class TunnanEarly extends Scheme1 implements TypeFighter, TypeBNZFighter, TypeFighterAceMaker {
    ...
    static {
        ...
        Property.set(class1, "meshName_aq", "3DO/Plane/TunnanEarly(AT)/hier.him");
        Property.set(class1, "PaintScheme_aq", new PaintSchemeFMPar06());
        Property.set(class1, "meshName_at", "3DO/Plane/TunnanEarly(AT)/hier.him");
        Property.set(class1, "PaintScheme_at", new PaintSchemeFMPar06());
        Property.set(class1, "meshName_sw", "3DO/Plane/TunnanEarly(SW)/hier.him");
        Property.set(class1, "PaintScheme_sw", new PaintSchemeFMPar06());
