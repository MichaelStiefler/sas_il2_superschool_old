...
public class MissileALARM extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileALARM(actor, netchannel, i, point3d, orient, f);
        }
    }
    ...
    public MissileALARM(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.MissileALARM.class;
        Property.set(class1, "mesh", "3do/arms/ALARM/mono.sim");
		...
		Property.set(class1, "timeFire", 35F); // Rocket Booster Burn time in Seconds
		Property.set(class1, "force", 20000F); // Rocket Booster Power (in Newton)
		...
		Property.set(class1, "power", 56.25F); // RL Data: 4.5kg HE warhead, for realism reduced to 1/10th of it's RL weight
		Property.set(class1, "radius", 6F); // Radius of Explosion Effect
		Property.set(class1, "kalibr", 0.305F); // Diameter of Missile Body
		Property.set(class1, "massa", 208F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 150F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "sunRayAngle", 0F); // max. Angle at which the missile will track Sun Ray, zero disables Sun Ray tracking (only valid for IR detector missiles)
		...
		Property.set(class1, "PkDistOpt", 4000.0F); // optimum Distance for Pk calculation
		...
		Property.set(class1, "friendlyName", "ALARM"); // Display Name of this missile
