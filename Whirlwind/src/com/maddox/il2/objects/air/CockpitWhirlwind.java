	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			if (fm != null) {
				...
				setNew.oilPress1 = 0.95F * setOld.oilPress1 + 0.05F * cvt(fm.EI.engines[0].getRPM(), 0F, 1500F, 0F, 1F) * cvt(fm.EI.engines[0].tOilOut, 50F, 100F, 1F, 0.70710678118654752440084436210485F) * cvt(fm.EI.engines[0].tOilOut, 80F, 100F, 1F, 0.70710678118654752440084436210485F) * fm.EI.engines[0].getReadyness();
				setNew.oilPress2 = 0.95F * setOld.oilPress2 + 0.05F * cvt(fm.EI.engines[1].getRPM(), 0F, 1500F, 0F, 1F) * cvt(fm.EI.engines[1].tOilOut, 50F, 100F, 1F, 0.70710678118654752440084436210485F) * cvt(fm.EI.engines[1].tOilOut, 80F, 100F, 1F, 0.70710678118654752440084436210485F) * fm.EI.engines[1].getReadyness();
