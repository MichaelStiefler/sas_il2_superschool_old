 ...
 *
 * <p>
 * The initial entries in this enum was created based on <a href="http://www.currency-iso.org/en/home/tables/table-a1.html" >the official currency &amp; funds code list</a> (ISO 4217) of January 1, 2014.
 * </p>
 *
 * @since 1.9
 *
 * @see <a href="http://www.currency-iso.org/en/home/tables/table-a1.html" >The official currency &amp; funds code list</a>
 *
...
public enum CurrencyCode {
     ...
     * </ul>
     */
    EUR("Euro", 978, 2, CountryCode.AD, CountryCode.AT, CountryCode.AX, CountryCode.BE, CountryCode.BL, CountryCode.CY, CountryCode.DE, CountryCode.EE, CountryCode.ES, CountryCode.EU, CountryCode.FI, CountryCode.FR, CountryCode.GF, CountryCode.GP,
            CountryCode.GR, CountryCode.IE, CountryCode.IT, CountryCode.LU, CountryCode.LV, CountryCode.MC, CountryCode.ME, CountryCode.MF, CountryCode.MQ, CountryCode.MT, CountryCode.NL, CountryCode.PM, CountryCode.PT, CountryCode.RE, CountryCode.SI,
     ...
     * </ul>
     */
    USD("US Dollar", 840, 2, CountryCode.AS, CountryCode.BQ, CountryCode.EC, CountryCode.FM, CountryCode.GU, CountryCode.HT, CountryCode.IO, CountryCode.MH, CountryCode.MP, CountryCode.PA, CountryCode.PR, CountryCode.PW, CountryCode.SV, CountryCode.TC,
            CountryCode.TL, CountryCode.UM, CountryCode.US, CountryCode.VG, CountryCode.VI),
     ...
     *
     * <p>
     * This method is an alias of {@link Currency}{@code .}{@link Currency#getInstance(String) getInstance}{@code (this.name())}. The only difference is that this method returns {@code null} when {@code Currency.getInstance(String)} throws
     ...
     *            If {@code false}, this method internally canonicalizes the given code by {@link String#toUpperCase()} and then performs search. For example, {@code getByCode("jpy", true)} returns {@code null}, but on the other hand,
     ...
     * getByCountry}{@code (country, true)}. Note that the behavior has changed since the version 1.13. In the older versions, this method was an alias of {@code getByCountry(code, false)}.
     * </p>
     *
     * @param country
     ...
     *
     * @return
     *         List of {@code CurrencyCode} instances. If there is no {@code CurrencyCode} instance whose country list contains
