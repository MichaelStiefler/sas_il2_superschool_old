...
public class P_36A3 extends P_36 {
	...
	public static String getSkinPrefix(String s, Regiment regiment) {
		...
		} else if (regiment.country().equals("fr"))
			return "FR_";
		return "";
	}
	...
	public void onAircraftLoaded() {
		...
		if (thisWeaponsName.indexOf("bombs") == -1) {
			hierMesh().chunkVisible("RackRIn", false);
			hierMesh().chunkVisible("RackROut", false);
			hierMesh().chunkVisible("RackLIn", false);
			hierMesh().chunkVisible("RackLOut", false);
		}
	}
