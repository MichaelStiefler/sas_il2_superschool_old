...
public class CockpitB17D_RGunner extends CockpitGunner {
	...
	public void moveGun(Orient orient) {
		...
		mesh.chunkSetAngles("TurretRA", 0.0F, -orient.getYaw() + 50.0F, 0.0F);
	...
	public CockpitB17D_RGunner() {
		super("3DO/Cockpit/B-25J-RGun/RGunnerB17D.him", "he111_gunner");
		hook1 = null;
	}
	...
	static {
		Property.set(CockpitB17D_RGunner.class, "aiTuretNum", 4);
		Property.set(CockpitB17D_RGunner.class, "weaponControlNum", 14);
		Property.set(CockpitB17D_RGunner.class, "astatePilotIndx", 6);
	}
}
