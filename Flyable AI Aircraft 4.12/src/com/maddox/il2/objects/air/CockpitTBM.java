...
public class CockpitTBM extends CockpitPilot {
	...
	public CockpitTBM() {
		...
		pictManf = 1.0F;
		bNeedSetUp = true;
		cockpitNightMats = (new String[] { "aigtemp", "instru01", "instru01_D", "instru02", "instru02_D", "instru03", "instru03_D", "instru04", "instru04_D", "instru05", "instru05_D" });
		setNightMats(false);
	...
	public void reflectWorldToInstruments(float f) {
		...
		mesh.chunkSetAngles("Z_Compass1", 0.0F, -90F + setNew.waypointAzimuth.getDeg(f * 0.1F), 0.0F);
