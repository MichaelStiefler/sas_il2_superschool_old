...
public class CockpitME_323_RGunner extends CockpitGunner {
	...
	static {
		Property.set(CockpitME_323_RGunner.class, "aiTuretNum", 3);
		Property.set(CockpitME_323_RGunner.class, "weaponControlNum", 13);
		Property.set(CockpitME_323_RGunner.class, "astatePilotIndx", 5);
	}
}
