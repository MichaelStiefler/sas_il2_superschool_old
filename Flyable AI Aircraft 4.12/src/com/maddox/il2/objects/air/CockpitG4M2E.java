...
public class CockpitG4M2E extends CockpitPilot {
	...
	public CockpitG4M2E() {
		...
		pictAiler = 0.0F;
		pictElev = 0.0F;
		cockpitNightMats = (new String[] { "gauges5", "GP1_d1", "GP1", "GP2_d1", "GP2", "GP3", "GP4_d1", "GP4", "GP5_d1", "GP5", "GP6_d1", "GP6", "GP7", "GP9", "throttle", "Volt_Tacho" });
		setNightMats(false);
	...
	public void reflectWorldToInstruments(float f) {
		...
		mesh.chunkSetAngles("Z_Temp7", floatindex(cvt(fm.EI.engines[1].tOilIn, 0.0F, 120F, 0.0F, 12F), oilTempScale), 0.0F, 0.0F);
		mesh.chunkSetAngles("Z_Temp8", floatindex(cvt(fm.EI.engines[0].tOilIn, 0.0F, 120F, 0.0F, 12F), oilTempScale), 0.0F, 0.0F);
	...
	static {
		Property.set(CLASS.THIS(), "normZNs", new float[] { 1.47F, 1.1F, 0.86F, 0.8F });
	}
