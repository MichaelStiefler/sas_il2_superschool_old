...
public class CockpitB25C25_Bombardier extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			float f1 = ((B_25C25) aircraft()).fSightCurSideslip;
			CockpitB25C25_Bombardier.calibrAngle = 360F - fm.Or.getPitch();
			mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, CockpitB25C25_Bombardier.calibrAngle + f);
			if (bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(aAim + 10F * f1, tAim + CockpitB25C25_Bombardier.calibrAngle + f, 0.0F);
			}
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (bEntered) {
			mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((B_25C25) aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((B_25C25) aircraft()).fSightCurReadyness > 0.93F;
	...
	static {
		Property.set(CockpitB25C25_Bombardier.class, "astatePilotIndx", 0);
	}
