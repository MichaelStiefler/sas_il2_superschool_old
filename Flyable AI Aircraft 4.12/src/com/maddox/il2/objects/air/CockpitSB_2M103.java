...
public class CockpitSB_2M103 extends CockpitPilot {
	...
	protected boolean doFocusEnter() {
		if (super.doFocusEnter()) {
			...
			pilot1Mat = aircraft().hierMesh().material(aircraft().hierMesh().materialFind("Pilot1"));
			Mat mat = mesh.material(mesh.materialFind("transp"));
			aircraft().hierMesh().materialReplace("Pilot1", mat);
			return true;
		} else {
			return false;
		}
	...
	protected void doFocusLeave() {
		...
		aircraft().hierMesh().materialReplace("Pilot1", pilot1Mat);
		super.doFocusLeave();
	}
	...
	public void reflectWorldToInstruments(float f) {
		...
		mesh.chunkSetAngles("hMix_L", 0.0F, 41.67F * interp(setNew.mix1, setOld.mix1, f), 0.0F);
		mesh.chunkSetAngles("hMix_R", 0.0F, 41.67F * interp(setNew.mix2, setOld.mix2, f), 0.0F);
	...
	protected void reflectPlaneMats() {
		Mat mat = aircraft().hierMesh().material(aircraft().hierMesh().materialFind("Gloss1D0o"));
		mesh.materialReplace("Gloss1D0o", mat);
		mesh.materialReplace("Pilot1", pilot1Mat);
	}
