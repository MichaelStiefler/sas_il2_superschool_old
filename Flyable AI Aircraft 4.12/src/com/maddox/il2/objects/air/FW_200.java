...
public abstract class FW_200 extends Scheme4 implements TypeBomber, TypeTransport {
	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
			...
			if (s.startsWith("xxeng")) {
				...
				if (s.endsWith("case")) {
					if (getEnergyPastArmor(0.2F, shot) > 0.0F) {
						...
						debugprintln(this, "*** Engine (" + i + ") Crank Case Hit - Readyness Reduced to " + FM.EI.engines[i].getReadyness() + "..");
					}
				...
				if (s.endsWith("cyls")) {
					if (getEnergyPastArmor(5.85F, shot) > 0.0F && World.Rnd().nextFloat() < FM.EI.engines[i].getCylindersRatio() * 0.75F) {
						...
						debugprintln(this, "*** Engine (" + i + ") Cylinders Hit, " + FM.EI.engines[i].getCylindersOperable() + "/" + FM.EI.engines[i].getCylinders() + " Left..");
		...
		if (s.startsWith("xoil")) {
			...
			if (getEnergyPastArmor(0.2F, shot) > 0.0F && World.Rnd().nextFloat() < 0.25F) {
				...
				debugprintln(this, "*** Engine (" + j + ") Module: Oil Filter Pierced (E)..");
			}
			return;
		}
	...
	public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
		hiermesh.chunkSetAngles("GearC2_D0", 0.0F, -45F * f2, 0.0F);
		...
		hiermesh.chunkSetAngles("GearL8_D0", 0.0F, 0.0F, cvt(f, 0.01F, 0.07F, 0.0F, -80F));
		hiermesh.chunkSetAngles("GearL9_D0", 0.0F, 0.0F, cvt(f, 0.01F, 0.07F, 0.0F, 80F));
		hiermesh.chunkSetAngles("GearL10_D0", 0.0F, 0.0F, f >= 0.5F ? cvt(f, 0.93F, 0.99F, 80F, 0.0F) : cvt(f, 0.01F, 0.07F, 0.0F, -80F));
		hiermesh.chunkSetAngles("GearL11_D0", 0.0F, 0.0F, f >= 0.5F ? cvt(f, 0.93F, 0.99F, -80F, 0.0F) : cvt(f, 0.01F, 0.07F, 0.0F, 80F));
		hiermesh.chunkSetAngles("GearR2_D0", 0.0F, -43F * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR4_D0", 0.0F, -61F * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR5_D0", 0.0F, 166F * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR6_D0", 0.0F, 0.0F, -floatindex(f1 * 10F, anglesL6));
		hiermesh.chunkSetAngles("GearR7_D0", 0.0F, 0.0F, -floatindex(f1 * 10F, anglesL7));
		hiermesh.chunkSetAngles("GearR8_D0", 0.0F, cvt(f1, 0.01F, 0.07F, 0.0F, 80F), 0.0F);
		hiermesh.chunkSetAngles("GearR9_D0", 0.0F, cvt(f1, 0.01F, 0.07F, 0.0F, -80F), 0.0F);
		hiermesh.chunkSetAngles("GearR10_D0", 0.0F, f1 >= 0.5F ? cvt(f1, 0.93F, 0.99F, 80F, 0.0F) : cvt(f1, 0.01F, 0.07F, 0.0F, 80F), 0.0F);
		hiermesh.chunkSetAngles("GearR11_D0", 0.0F, f1 >= 0.5F ? cvt(f1, 0.93F, 0.99F, -80F, 0.0F) : cvt(f1, 0.01F, 0.07F, 0.0F, -80F), 0.0F);
	}
	...
	public void moveWheelSink() {
		float f = cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.4615F, 0.0F, -26.5F);
		hierMesh().chunkSetAngles("GearL3_D0", 0.0F, f, 0.0F);
		f = cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.4615F, 0.0F, 21.5F);
		hierMesh().chunkSetAngles("GearL12_D0", 0.0F, f, 0.0F);
		f = cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.4615F, 0.0F, 3.5F);
		hierMesh().chunkSetAngles("GearL13_D0", 0.0F, f, 0.0F);
		f = cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.4615F, 0.0F, -26.5F);
		hierMesh().chunkSetAngles("GearR3_D0", 0.0F, f, 0.0F);
		f = cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.4615F, 0.0F, 21.5F);
		hierMesh().chunkSetAngles("GearR12_D0", 0.0F, f, 0.0F);
		f = cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.4615F, 0.0F, 3.5F);
