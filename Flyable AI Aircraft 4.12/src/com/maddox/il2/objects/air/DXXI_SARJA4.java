...
public class DXXI_SARJA4 extends DXXI implements TypeScout {
	...
	public void rareAction(float f, boolean flag) {
		...
		if (flag && FM.AS.astateEngineStates[0] > 3 && World.Rnd().nextFloat() < 0.0023F)
			...
			if (World.cur().camouflage == 1) {
				...
				if (FM.Gears.gWheelSinking[0] > 0.0F) {
					...
					if ((double) skiAngleL > (double) (f4 * -10F) + 0.01D)
						skiAngleL = skiAngleL - spring;
					else if ((double) skiAngleL < (double) (f4 * -10F) - 0.01D)
						skiAngleL = skiAngleL + spring;
				...
				if (FM.Gears.gWheelSinking[1] > 0.0F) {
					...
					if ((double) skiAngleR > (double) (f4 * -10F) + 0.01D)
						skiAngleR = skiAngleR - spring;
					else if ((double) skiAngleR < (double) (f4 * -10F) - 0.01D)
						skiAngleR = skiAngleR + spring;
	...
	static {
		...
		weaponsRegister(class1, "default", new String[] { "MGunBrowning303k 300", "MGunBrowning303k 300", "MGunBrowning303k 300", "MGunBrowning303k 300" });
