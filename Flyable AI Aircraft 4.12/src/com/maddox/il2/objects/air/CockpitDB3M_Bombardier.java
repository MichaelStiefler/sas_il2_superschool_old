...
public class CockpitDB3M_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			resetYPRmodifier();
			float f = ((IL_4_DB3M) aircraft()).fSightCurSpeed;
			float f1 = ((IL_4_DB3M) aircraft()).fSightCurAltitude;
	...
	static {
		Property.set(CockpitDB3M_Bombardier.class, "astatePilotIndx", 0);
	}
