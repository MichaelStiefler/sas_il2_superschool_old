...
public class CockpitCantZ506B_RGunner extends CockpitGunner {
	...
	public CockpitCantZ506B_RGunner() {
		super("3DO/Cockpit/SM79Bombardier/CantZ506_RGun.him", "he111_gunner");
		hook1 = null;
		iCocking = 0;
	}
	...
	static {
		Property.set(CockpitCantZ506B_RGunner.class, "aiTuretNum", 3);
		Property.set(CockpitCantZ506B_RGunner.class, "weaponControlNum", 13);
		Property.set(CockpitCantZ506B_RGunner.class, "astatePilotIndx", 5);
	}
}
