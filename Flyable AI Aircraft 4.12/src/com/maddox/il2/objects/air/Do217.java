...
public abstract class Do217 extends Scheme2 implements TypeBomber, TypeTransport {
	...
	public void typeBomberUpdate(float f) {
		...
		if (fSightCurReadyness < 1.0F)
			...
			calibDistance = (fSightCurSpeed / 3.6F) * AircraftLH.floatindex(Aircraft.cvt(fSightCurAltitude, 0.0F, 7000F, 0.0F, 7F), calibrationScale);
	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor"))
				if (s.endsWith("p1")) {
					...
					getEnergyPastArmor((7D / Math.abs(Aircraft.v1.x)) * (double) World.Rnd().nextFloat(1.0F, 1.2F), shot);
				else
					getEnergyPastArmor(3F, shot);
			if (s.endsWith("p4")) {
				if (Aircraft.v1.x > 0.70710676908493042D)
					getEnergyPastArmor((7D / Aircraft.v1.x) * (double) World.Rnd().nextFloat(1.0F, 1.2F), shot);
			...
			if (s.startsWith("xxspar")) {
				...
				if ((s.endsWith("t1") || s.endsWith("t2")) && World.Rnd().nextFloat() < 0.1F && chunkDamageVisible("Tail1") > 1 && getEnergyPastArmor(15.9F / (float) Math.sqrt(Aircraft.v1.y * Aircraft.v1.y + Aircraft.v1.z * Aircraft.v1.z), shot) > 0.0F)
					msgCollision(this, "Tail1_D0", "Tail1_D0");
				if ((s.endsWith("li1") || s.endsWith("li2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.92000001668930054D * Math.abs(Aircraft.v1.x) && chunkDamageVisible("WingLIn") > 1
						&& getEnergyPastArmor(13.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
					nextDMGLevels(1, 2, "WingLIn_D2", shot.initiator);
				if ((s.endsWith("ri1") || s.endsWith("ri2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.92000001668930054D * Math.abs(Aircraft.v1.x) && chunkDamageVisible("WingRIn") > 1
						&& getEnergyPastArmor(10.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
					nextDMGLevels(1, 2, "WingRIn_D2", shot.initiator);
				if ((s.endsWith("lm1") || s.endsWith("lm2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.86000001430511475D * Math.abs(Aircraft.v1.x) && chunkDamageVisible("WingLMid") > 1
						&& getEnergyPastArmor(10.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
					nextDMGLevels(1, 2, "WingLMid_D2", shot.initiator);
				if ((s.endsWith("rm1") || s.endsWith("rm2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.86000001430511475D * Math.abs(Aircraft.v1.x) && chunkDamageVisible("WingRMid") > 1
						&& getEnergyPastArmor(13.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
					nextDMGLevels(1, 2, "WingRMid_D2", shot.initiator);
				if ((s.endsWith("lo1") || s.endsWith("lo2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * Math.abs(Aircraft.v1.x) && chunkDamageVisible("WingLOut") > 1
						&& getEnergyPastArmor(8.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
					nextDMGLevels(1, 2, "WingLOut_D2", shot.initiator);
				if ((s.endsWith("ro1") || s.endsWith("ro2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * Math.abs(Aircraft.v1.x) && chunkDamageVisible("WingROut") > 1
						&& getEnergyPastArmor(8.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
				...
				if ((s.endsWith("k1") || s.endsWith("k2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * Math.abs(Aircraft.v1.x) && chunkDamageVisible("WingROut") > 1
						&& getEnergyPastArmor(8.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
					nextDMGLevels(1, 2, "Keel1_D0", shot.initiator);
				if ((s.endsWith("sr1") || s.endsWith("sr2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * Math.abs(Aircraft.v1.x) && chunkDamageVisible("WingROut") > 1
						&& getEnergyPastArmor(8.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
					nextDMGLevels(1, 2, "StabR_D0", shot.initiator);
				if ((s.endsWith("sl1") || s.endsWith("sl2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * Math.abs(Aircraft.v1.x) && chunkDamageVisible("WingROut") > 1
						&& getEnergyPastArmor(8.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)
			...
			if (s.startsWith("xxeng")) {
				...
				} else if (s.endsWith("supc") && getEnergyPastArmor(0.05F, shot) > 0.0F && World.Rnd().nextFloat() < 0.89F)
				...
				if (j < 4 && getEnergyPastArmor(1.8F, shot) > 0.0F)
					if (shot.power < 14100F) {
						...
						if (FM.AS.astateTankStates[j] < 4 && World.Rnd().nextFloat() < 0.12F)
							FM.AS.hitTank(shot.initiator, j, 1);
						if (shot.powerType == 3 && FM.AS.astateTankStates[j] > 1 && World.Rnd().nextFloat() < 0.04F)
		...
		if (s.startsWith("xxmgun"))
			...
			} else if (s.endsWith("5") && getEnergyPastArmor(4.85F, shot) > 0.0F && World.Rnd().nextFloat() < 0.75F) {
	...
	public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
		...
		hiermesh.chunkSetAngles("GearR2_D0", 0.0F, Aircraft.cvt(f1, 0.1F, 1.0F, 0.0F, -107F), 0.0F);
		hiermesh.chunkSetAngles("GearL4_D0", 0.0F, Aircraft.cvt(f, 0.1F, 1.0F, 0.0F, -19F), 0.0F);
		hiermesh.chunkSetAngles("GearR4_D0", 0.0F, Aircraft.cvt(f1, 0.1F, 1.0F, 0.0F, -19F), 0.0F);
		hiermesh.chunkSetAngles("GearL5_D0", 0.0F, Aircraft.cvt(f, 0.1F, 1.0F, 0.0F, 60F), 0.0F);
		hiermesh.chunkSetAngles("GearR5_D0", 0.0F, Aircraft.cvt(f1, 0.1F, 1.0F, 0.0F, 60F), 0.0F);
		hiermesh.chunkSetAngles("GearR7_D0", 0.0F, Aircraft.cvt(f1, 0.01F, 0.2F, 0.0F, -65.5F), 0.0F);
		hiermesh.chunkSetAngles("GearL7_D0", 0.0F, Aircraft.cvt(f, 0.01F, 0.2F, 0.0F, -65.5F), 0.0F);
		hiermesh.chunkSetAngles("GearR6_D0", 0.0F, Aircraft.cvt(f1, 0.01F, 0.2F, 0.0F, 65.5F), 0.0F);
		hiermesh.chunkSetAngles("GearL6_D0", 0.0F, Aircraft.cvt(f, 0.01F, 0.2F, 0.0F, 65.5F), 0.0F);
		hiermesh.chunkSetAngles("GearC2_D0", 0.0F, Aircraft.cvt(f2, 0.1F, 0.3F, 0.0F, -60F), 0.0F);
		hiermesh.chunkSetAngles("GearC4_D0", 0.0F, Aircraft.cvt(f2, 0.1F, 0.2F, 0.0F, 75F), 0.0F);
		hiermesh.chunkSetAngles("GearC5_D0", 0.0F, Aircraft.cvt(f2, 0.1F, 0.2F, 0.0F, 75F), 0.0F);
	}
