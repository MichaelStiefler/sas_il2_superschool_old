...
import com.maddox.il2.engine.cmd.CmdFPS;
...
public class FlightModelMain extends FMMath
{
    ...
    public void drawData(int iFuelLevel)
    {
        ...
        if (iFuelLevel < 0) {
	        for(int i = 0; i <= 75; i += 25)
	        {
	            ...
	            String s1 = turnFile;
	            Wing.setFlaps(0.0F);
	            Wing.drawGraphs(s1, i, true);
	            Wing.setFlaps(0.0F);
	            s1 = speedFile + " " + (100 - i) + "% fuel" + " (" + CmdFPS.DumpDesc + ")_speed.txt";
	            drawSpeed(s1, 1.0F, 1.1F, 1.0F);
	            Wing.setFlaps(0.0F);
	            String s2 = speedFile + " avail thrust (" + CmdFPS.DumpDesc + ").txt";
	            String s3 = speedFile + " thrust summary " + (100 - i) + "% fuel (" + CmdFPS.DumpDesc + ").txt";
	            String s4 = speedFile + " req thrust " + (100 - i) + "% fuel (" + CmdFPS.DumpDesc + ").txt";
