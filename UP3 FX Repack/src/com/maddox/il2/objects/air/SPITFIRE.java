...
//TODO: +++ FX Repack Mod +++
public abstract class SPITFIRE extends SPITFLAME implements TypeFighter {
		...
		if (s.startsWith("xx")) {
			...
			if (s.startsWith("xxspar")) {
				if ((s.endsWith("t1") || s.endsWith("t2") || s.endsWith("t3") || s.endsWith("t4"))
						...
						&& getEnergyPastArmor(3.5F / (float)Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F) {
			...
			if (s.startsWith("xxeng1")) {
				...
				if (s.endsWith("cyl") && getEnergyPastArmor(0.45F, shot) > 0.0F
					...
					debugprintln(this, "*** Engine Cylinders Hit, " + FM.EI.engines[0].getCylindersOperable() + "/"
							+ FM.EI.engines[0].getCylinders() + " Left..");
