...
public abstract class P_47X extends Scheme1
    implements TypeFighter, TypeBNZFighter, TypeStormovik
{
    ...
    public void sfxFlaps(boolean flag)
    {
        if(flag)
        {
            bFlaps = true;
            bFlapsEnd = false;
            System.out.println("*** Flaps sound starts");
        }
        if(bFlaps && !flag)
        {
            bFlaps = false;
            bFlapsEnd = true;
            System.out.println("*** Flaps sound ends");
        }
    }
    ...
    public void sfxWheels()
    {
        if(FM.getSpeedKMH() > 0.0F)
        {
            ...
            System.out.println("*** Wheels sound used");
        }
    }
