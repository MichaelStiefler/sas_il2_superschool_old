...
public class CockpitP_47N15K extends CockpitPilot
{
    ...
    public CockpitP_47N15K()
    {
        ...
        super.cockpitNightMats = (new String[] {
            "prib1", "pribA", "pribB", "pribC", "prib4", "prib5", "prib6", "prib7", "pri14", "prib1_d1", 
            "pribA_d1", "prib4_d1", "Frame07", "Frame08", "panel", "shkalb", "Frame20", "shkala"
        });
        setNightMats(false);
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(((FlightModelMain) (super.fm)).EI.engines[0].getStage() < 2)
        {
            ...
            super.mesh.chunkSetLocate("zhorizont1b", new float[] {
                0.0F, 0.0F, -0.01F
            }, new float[] {
                0.0F, 0.0F, -10F
            });
    ...
    private static final float k14TargetMarkScale[] = {
        -0F, -4.2F, -15F, -26.5F, -42.5F, -57F, -62.5F, -70.5F, -83.5F, -97.5F, 
        -102.2F, -107.5F
    };
    private static final float k14TargetWingspanScale[] = {
        9.9F, 10.52F, 12F, 13.8F, 16.34F, 19F, 20F, 22F, 25F, 29.25F, 
        30F, 32.85F
    };
