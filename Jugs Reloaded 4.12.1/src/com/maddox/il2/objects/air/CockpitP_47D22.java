...
public class CockpitP_47D22 extends CockpitPilot {
	...
	public CockpitP_47D22() {
		super("3DO/Cockpit/P-47D-10/hier_D22.him", "bf109");
	...
	public void reflectWorldToInstruments(float f) {
		...
		super.mesh.chunkSetAngles("throtle", 0.0F, 0.0F, -62.7F * setNew.throttle);
		...
		super.mesh.chunkSetAngles("zSlip", 0.0F, cvt(getBall(7D), -7F, 7F, -16F, 16F), 0.0F);
		...
		super.mesh.chunkSetAngles("zpressfuel1a", 0.0F, cvt(((FlightModelMain) (super.fm)).M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 0.4F, 0.0F, -154F), 0.0F);
		...
		super.mesh.chunkSetLocate("zBlink1", Cockpit.xyz, Cockpit.ypr);
		super.mesh.chunkSetLocate("zBlink2", Cockpit.xyz, Cockpit.ypr);
		resetYPRmodifier();
	...
	public void reflectCockpitState() {
		if ((((FlightModelMain) (super.fm)).AS.astateCockpitState & 2) != 0) {
			...
			super.mesh.chunkVisible("ZSlip", false);
		}
		...
		if ((((FlightModelMain) (super.fm)).AS.astateCockpitState & 0x20) != 0) {
			...
			super.mesh.chunkVisible("zBlink1", false);
			super.mesh.chunkVisible("zBlink2", false);
		}
		retoggleLight();
	}
