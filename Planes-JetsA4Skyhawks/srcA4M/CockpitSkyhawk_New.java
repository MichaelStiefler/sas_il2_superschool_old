// Decompiled by DJ v3.12.12.96 Copyright 2011 Atanas Neshkov  Date: 03/11/2015 04:01:07 p.m.
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   CockpitSkyhawk_New.java
...
//            CockpitPilot, Cockpit, A4ESkyhawk_New

public class CockpitSkyhawk_New extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f4 = ((A4ESkyhawk_New)aircraft()).k14Distance;
                setNew.k14w = (5F * CockpitSkyhawk_New.k14TargetWingspanScale[((A4ESkyhawk_New)aircraft()).k14WingspanType]) / f4;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitSkyhawk_New.k14TargetMarkScale[((A4ESkyhawk_New)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((A4ESkyhawk_New)aircraft()).k14Mode;
                ...
                float f3 = floatindex((f4 - 200F) * 0.04F, CockpitSkyhawk_New.k14BulletDrop) - CockpitSkyhawk_New.k14BulletDrop[0];
    ...
    public CockpitSkyhawk_New()
    {
        super("3DO/Cockpit/CockpitSkyhawk_New/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        {
            int i = ((A4ESkyhawk_New)aircraft()).k14Mode;
            boolean flag = i < 2;
