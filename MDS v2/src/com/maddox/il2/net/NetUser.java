...
//                if (!ZutiSupportMethods_Net.isInOwnAircraft(this, World.getPlayerAircraft())) {
                    try {
                        ...
                        int iLogArmy = 0;
                        try {
                            iLogArmy = GUINetAircraft.getItem(place).reg.getArmy();
                        } catch (Exception ex) {}
                        System.out.println("### GUNNER POS SWITCH BUG DEBUG: NetUser.requestPlace NetUser " + this.uniqueName() + " place " + place + " setArmy(" + iLogArmy + ")");
                        // ...
