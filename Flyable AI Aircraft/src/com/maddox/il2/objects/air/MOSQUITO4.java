...
public class MOSQUITO4 extends MOSQUITO implements TypeBomber {
	...
	static {
		...
		weaponTriggersRegister(class1, new int[] { 0, 3, 3, 3, 3 });
		weaponHooksRegister(class1, new String[] { "_Clip04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04" });
		weaponsRegister(class1, "default", new String[] { null, null, null, null, null });
		weaponsRegister(class1, "4x250", new String[] { null, "BombGun250lbsE 1", "BombGun250lbsE 1", "BombGun250lbsE 1", "BombGun250lbsE 1" });
		weaponsRegister(class1, "4x500", new String[] { null, "BombGun500lbsE 1", "BombGun500lbsE 1", "BombGun500lbsE 1", "BombGun500lbsE 1" });
