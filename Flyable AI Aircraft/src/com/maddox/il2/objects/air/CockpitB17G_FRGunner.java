...
public class CockpitB17G_FRGunner extends CockpitGunner {
	...
	public void moveGun(Orient orient) {
		...
		mesh.chunkSetAngles("TurretRA", 0.0F, -orient.getYaw() + 78.0F, 0.0F);
	...
	public CockpitB17G_FRGunner() {
		super("3DO/Cockpit/B-25J-RGun/FRGunnerB17G.him", "he111_gunner");
		hook1 = null;
	}
	...
	static {
		Property.set(CockpitB17G_FRGunner.class, "aiTuretNum", 2);
		Property.set(CockpitB17G_FRGunner.class, "weaponControlNum", 12);
		Property.set(CockpitB17G_FRGunner.class, "astatePilotIndx", 1);
	}
}
