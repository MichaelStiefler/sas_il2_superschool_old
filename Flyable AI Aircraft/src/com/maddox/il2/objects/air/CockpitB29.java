...
public class CockpitB29 extends CockpitPilot {
	...
	public CockpitB29() {
		...
		pictManf4 = 1.0F;
		b29X = null;
		cockpitNightMats = (new String[] { "gauges1", "gauges1dmg", "gauges2", "gauges2dmg", "gauges3", "gauges3dmg", "gauges4", "gauges4dmg", "gauges5", "gauges5dmg", "texture25" });
		setNightMats(false);
	...
	public void reflectWorldToInstruments(float f) {
		...
		mesh.chunkSetAngles("power1L", 0.0F, -49F * interp(setNew.throttle1, setOld.throttle1, f), 0.0F);
		mesh.chunkSetAngles("power2L", 0.0F, -49F * interp(setNew.throttle2, setOld.throttle2, f), 0.0F);
		mesh.chunkSetAngles("power3L", 0.0F, -49F * interp(setNew.throttle3, setOld.throttle3, f), 0.0F);
		mesh.chunkSetAngles("power4L", 0.0F, -49F * interp(setNew.throttle4, setOld.throttle4, f), 0.0F);
		float f1;
	...
	static {
		Property.set(CLASS.THIS(), "normZNs", new float[] { 1.0F, 1.0F, 1.25F, 1.0F });
	}
