...
public class CockpitB25G1_TGunner extends CockpitGunner {
	...
	public CockpitB25G1_TGunner() {
		super("3DO/Cockpit/B-25J-TGun/TGunnerB25G1.him", "bf109");
		bNeedSetUp = true;
		prevTime = -1L;
		prevA0 = 0.0F;
		hook1 = null;
	...
	static {
		Property.set(CockpitB25G1_TGunner.class, "aiTuretNum", 1);
		Property.set(CockpitB25G1_TGunner.class, "weaponControlNum", 11);
		Property.set(CockpitB25G1_TGunner.class, "astatePilotIndx", 3);
	}
}
