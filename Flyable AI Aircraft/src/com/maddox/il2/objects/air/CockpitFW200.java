...
public class CockpitFW200 extends CockpitPilot {
	...
	public CockpitFW200() {
		...
		super.cockpitNightMats = (new String[] { "texture01_dmg", "texture01", "texture02_dmg", "texture02", "texture03_dmg", "texture03", "texture04_dmg", "texture04", "texture05_dmg", "texture05", "texture06_dmg", "texture06", "texture21_dmg",
				"texture21", "texture25" });
		setNightMats(false);
		if (aircraft() instanceof FW_200C3U4)
			fw200 = (FW_200C3U4) aircraft();
	...
	public void reflectWorldToInstruments(float f) {
		...
		// mesh.chunkSetAngles("BL_Vert", cvt(setNew.ilsLoc, -3.5F, 3.5F, -40F,
		// 40F), 0.0F, 0.0F);
		// if(setNew.ilsGS >= 0.0F)
		// mesh.chunkSetAngles("BL_Horiz", cvt(setNew.ilsGS, 0.0F, 0.5F, 0.0F,
		// 40F), 0.0F, 0.0F);
		// else
		// mesh.chunkSetAngles("BL_Horiz", cvt(setNew.ilsGS, -0.3F, 0.0F, -40F,
		// 0.0F), 0.0F, 0.0F);
		if (fm.AS.isAAFIAS)
