...
public class CockpitB17E_AGunner extends CockpitGunner {
	...
	public CockpitB17E_AGunner() {
		super("3DO/Cockpit/B-25J-AGun/AGunnerB17E.him", "bf109");
		bNeedSetUp = true;
	}
	...
	static {
		Property.set(CockpitB17E_AGunner.class, "aiTuretNum", 7);
		Property.set(CockpitB17E_AGunner.class, "weaponControlNum", 17);
		Property.set(CockpitB17E_AGunner.class, "astatePilotIndx", 4);
	}
}
