...
public class CockpitSU_2_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			if (bEntered) {
				float f = ((SU_2) aircraft()).fSightCurForwardAngle;
				float f1 = -((SU_2) aircraft()).fSightCurSideslip;
	...
	public CockpitSU_2_Bombardier() {
		super("3DO/Cockpit/Pe-2-Bombardier/BombardierSU2.him", "he111");
		bEntered = false;
		try {
			Loc loc = new Loc();
	...
	public void reflectWorldToInstruments(float f) {
		mesh.chunkSetAngles("zMark1", ((SU_2) aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
		float f1 = cvt(((SU_2) aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
