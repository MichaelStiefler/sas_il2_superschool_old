...
public class CockpitWellington_MkIII_RGunner extends CockpitGunner {
	...
	public void moveGun(Orient orient) {
		...
		mesh.chunkSetAngles("TurretRA", 0.0F, -orient.getYaw() + 30.0F, 0.0F);
	...
	public void reflectWorldToInstruments(float f) {
		mesh.chunkSetAngles("TurretLA", 0.0F, aircraft().FM.turret[2].tu[0], 0.0F);
		mesh.chunkSetAngles("TurretLB", 0.0F, aircraft().FM.turret[2].tu[1], 0.0F);
		mesh.chunkSetAngles("TurretLC", 0.0F, aircraft().FM.turret[2].tu[1], 0.0F);
