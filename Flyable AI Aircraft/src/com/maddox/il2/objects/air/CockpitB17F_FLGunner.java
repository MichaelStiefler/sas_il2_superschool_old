...
public class CockpitB17F_FLGunner extends CockpitGunner {
	...
	public CockpitB17F_FLGunner() {
		super("3DO/Cockpit/B-25J-LGun/FLGunnerB17F.him", "he111_gunner");
		hook1 = null;
	}
	...
	static {
		Property.set(CockpitB17F_FLGunner.class, "aiTuretNum", 1);
		Property.set(CockpitB17F_FLGunner.class, "weaponControlNum", 11);
		Property.set(CockpitB17F_FLGunner.class, "astatePilotIndx", 1);
	}
}
