...
public class CockpitB17G_BGunner extends CockpitGunner {
	...
	public void moveGun(Orient orient) {
		...
		mesh.chunkSetAngles("BaseB17G", 180F, 0.0F, 180F);
	...
	public CockpitB17G_BGunner() {
		super("3DO/Cockpit/A-20G-TGun/BGunnerB17G.him", "he111_gunner");
		bNeedSetUp = true;
		prevTime = -1L;
		prevA0 = 0.0F;
		hook1 = null;
	...
	static {
		Property.set(CockpitB17G_BGunner.class, "aiTuretNum", 4);
		Property.set(CockpitB17G_BGunner.class, "weaponControlNum", 14);
		Property.set(CockpitB17G_BGunner.class, "astatePilotIndx", 7);
	}
}
