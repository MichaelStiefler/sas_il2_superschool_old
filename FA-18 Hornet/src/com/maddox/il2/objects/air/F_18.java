...
public class F_18 extends Scheme2 implements TypeSupersonic, TypeFighter, TypeBNZFighter, TypeFighterAceMaker, TypeGSuit, TypeFastJet, TypeX4Carrier, TypeGuidedBombCarrier, TypeBomber, TypeAcePlane, TypeLaserSpotter {
...
//			this.sensPitchFromFmd = this.FM.SensPitch;
	...
	public void update(float f) {
		...
		for (int i = 1; i < 33; i++)
			hierMesh().chunkSetAngles("Eflap" + i, -8F * FM.EI.engines[0].getPowerOutput(), 0.0F, 0.0F);
		for (int j = 33; j > 32 && j < 65; j++)
			hierMesh().chunkSetAngles("Eflap" + j, -8F * FM.EI.engines[1].getPowerOutput(), 0.0F, 0.0F);
