...
public class CockpitT4 extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            setNew.k14w = (5F * CockpitT4.k14TargetWingspanScale[((F_18)aircraft()).k14WingspanType]) / f;
            setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
            setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitT4.k14TargetMarkScale[((F_18)aircraft()).k14WingspanType];
            ...
            float f3 = floatindex((f - 200F) * 0.04F, CockpitT4.k14BulletDrop) - CockpitT4.k14BulletDrop[0];
    ...
    protected void moveHUD(float f)
    {
        ...
        super.mesh.chunkVisible("Z_Z_RETICLE", isHudDisp);
