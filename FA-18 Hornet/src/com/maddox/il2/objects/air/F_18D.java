...
public class F_18D extends F_18 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump, TypeStormovikArmored, TypeLaserSpotter {
	...
	static {
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitF18.class, CockpitF18_Instructor.class, CockpitF18FLIR.class });
		...
		try {
			...
			a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61A2", 450);
