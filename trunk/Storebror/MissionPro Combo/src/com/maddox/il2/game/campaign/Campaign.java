//////////////////////////////////////////////////////////////////////////////////////////
//   Campaign MODded, subtle changes in v4.111
//   ** Modded by PAL to be accessed from outside to know changes in Campaigns **
...
{
    //By PAL, to be access from outside
...
label0:
        {
            ...
            s1 = s.substring(0, s.length() - 1);  //Not -2?
            int ai[] = {
                0, 0, 0, 0
            };
            int i = sectfile.sectionIndex("Wing");
            int j = sectfile.vars(i);
            for(int k = 0; k < j; k++) //All the flights
            {
