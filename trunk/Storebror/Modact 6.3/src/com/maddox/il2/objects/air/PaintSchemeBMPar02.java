...
public class PaintSchemeBMPar02 extends PaintScheme {
    ...
    public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k) {
        ...
        if (regiment.country() == PaintScheme.countryNetherlands) {
            ...
            this.changeMat(hiermesh, "Overlay1", "psBM0XDUTCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + (k / 10) + ".tga", "German/" + (k % 10) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
            this.changeMat(hiermesh, "Overlay4", "psBM0XDUTCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + (k / 10) + ".tga", "German/" + (k % 10) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
            return;
        }
        if (regiment.country() == PaintScheme.countrySouthAfricaS) {
        ...
        if (regiment.country() == PaintScheme.countryItaly) {
            if (k < 10) {
                this.changeMat(class1, hiermesh, "Overlay2", "psFB02ITALNUM" + l + i + k, "Italian/1" + (k % 10) + ".tga", 1.0F, 1.0F, 1.0F);
                this.changeMat(hiermesh, "Overlay3", "psFB02ITARNUM" + l + i + k, "null.tga", "Italian/1" + (k % 10) + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
            } else {
                this.changeMat(hiermesh, "Overlay2", "psFB02ITACNUM" + l + i + k, "Italian/1" + (k / 10) + ".tga", "Italian/1" + (k % 10) + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
                this.changeMat(hiermesh, "Overlay3", "psFB02ITACNUM" + l + i + k, "Italian/1" + (k / 10) + ".tga", "Italian/1" + (k % 10) + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
            }
        ...
        if (regiment.country() == PaintScheme.countryNewZealand) {
            ...
            this.changeMat(hiermesh, "Overlay2", "psBM0XRZLNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + (char) ((65 + k) - 1) + ".tga", "null.tga", PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2], 1.0F, 1.0F, 1.0F);
            this.changeMat(hiermesh, "Overlay3", "psBM0XRZRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/" + (char) ((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2]);
