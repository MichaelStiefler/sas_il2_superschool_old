...
public class FlightModelMain extends FMMath {
    ...
    public float getSpeed2KMH() {
        return (float) (this.Vflow.x * 3.6D * this.BOMBER_RND);
    }
    ...
    public void load(String s) {
        ...
        this.CT.bHasStabilizerControl = sectfile.get(s2, "CStabilizer", 0) == 1;
        ...
        if (f != -999F) {
            ...
            this.CT.dvGearR = (1.0F / f) - (1.0F / (f * 20F));
            this.CT.dvGearL = (1.0F / f) + (1.0F / (f * 20F));
            this.CT.dvGearC = (1.0F / f) + (1.0F / (f * 5F));
        }
    ...
    public FlightModelMain(String s) {
        ...
        this.Length = 0.0F;
        this.bReal = false;
        this.G_ClassCoeff = 0.0F;
        this.refM = 0.0F;
        this.ReferenceForce = 0.0F;

        this.flags0 = 240L;
        this.bDamagedGround = false;
        this.bDamaged = false;
        this.damagedInitiator = null;
        this.BOMBER_RND = tmp_rnd.nextFloat(0.98F, 1.02F);
        ...
        this.bombAM = new Vector3d(0.0D, 0.0D, 0.0D);
        ...
        switch (i) {
            ...
            case 3: // '\003'
                if (this.Sq.dragEngineCx[0] < 0.15F) {
                    this.Sq.dragEngineCx[0] += 0.050000000000000003D;
                }
                if (World.Rnd().nextFloat() < 0.12F) {
                    this.setReadyToReturn(true);
                }
    ...
    private static RangeRandom  tmp_rnd                    = new RangeRandom(System.currentTimeMillis());
    private final float         BOMBER_RND;
    public Controls             CT;
