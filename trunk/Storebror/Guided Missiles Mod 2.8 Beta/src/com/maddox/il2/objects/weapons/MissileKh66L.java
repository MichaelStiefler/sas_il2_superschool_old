...
public class MissileKh66L extends Missile {
	...
	static {
		Class class1 = MissileKh66L.class;
		...
		Property.set(class1, "timeFire", 12F); // Rocket Engine Burn time in Seconds
		...
		Property.set(class1, "power", 103F); // Explosion Power
		Property.set(class1, "radius", 60F); // Radius of Explosion Effect
		Property.set(class1, "kalibr", 0.275F); // Diameter of Missile Body
		Property.set(class1, "massa", 278F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 255F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "maxLockGForce", 90.0F); // max. G-Force for lockon
		...
		Property.set(class1, "PkDistMin", 1800.0F); // min Distance for Pk calculation
		Property.set(class1, "PkDistOpt", 5500.0F); // optimum Distance for Pk calculation
