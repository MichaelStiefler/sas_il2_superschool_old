                ...
                case 6:
                    ...
                    if (zutiIsMaster && !Paratrooper.this.zutiRecordedSafeLanding) {
                        ...
                        if (bp != null) {
                            ...
                            // System.out.println("Paratrooper - lie 1: number of hostile paratroopers inside home base at x=" + bp.place.x + " and y=" + bp.place.y + " is: " + bp.zutiParatroopersInsideHomeBaseArea +". Needed: " +
        ...
        switch (st) {
            ...
            case 6: {
                ...
                if (zutiIsMaster && !zutiRecordedSafeLanding) {
                    ...
                    if (bp != null) {
                        bp.zutiParatroopersInsideHomeBaseArea++;
                        // System.out.println("Paratrooper - lie 2: numbe of hostile paratroopers inside home base at x=" + bp.place.x + " and y=" + bp.place.y + " is: " + bp.zutiParatroopersInsideHomeBaseArea +". Needed: " +
                        // bp.zutiCapturingRequiredParatroopers);
...
//			System.out.println("AC = " + actor + ", isAC=" + (actor instanceof Aircraft));
            ...
            if (World.land().isWater(zp.x, zp.y)) {
                if (actor instanceof Aircraft) {
                    ...
                    if (ac.FM.getSpeedKMH() < ZutiSupportMethods_AI.MAX_SPEED_FOR_DECK_BAILOUT && ac.FM.getAltitude() < ZutiSupportMethods_AI.MAX_HEIGHT_FOR_DECK_BAILOUT) {
