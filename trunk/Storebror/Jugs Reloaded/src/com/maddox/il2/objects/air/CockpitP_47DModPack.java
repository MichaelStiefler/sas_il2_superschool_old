...
public class CockpitP_47DModPack extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		public boolean tick() {
			if (CockpitP_47DModPack.this.fm != null) {
				...
				if (Math.abs(CockpitP_47DModPack.this.fm.Or.getKren()) < 45F) {
					CockpitP_47DModPack.this.setNew.azimuth = (35F * CockpitP_47DModPack.this.setOld.azimuth - CockpitP_47DModPack.this.fm.Or.getYaw()) / 36F;
				}
				if (CockpitP_47DModPack.this.setOld.azimuth > 270F && CockpitP_47DModPack.this.setNew.azimuth < 90F) {
					CockpitP_47DModPack.this.setOld.azimuth -= 360F;
				}
				if (CockpitP_47DModPack.this.setOld.azimuth < 90F && CockpitP_47DModPack.this.setNew.azimuth > 270F) {
					CockpitP_47DModPack.this.setOld.azimuth += 360F;
				}
				...
				if (CockpitP_47DModPack.this.fm.EI.engines[0].getRPM() < 0.01F) {
					...
					if (CockpitP_47DModPack.this.fm.getAltitude() < 1500F) {
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("ZTemp1a", 0.0F, this.cvt(Atmosphere.temperature((float) ((Tuple3d) (this.fm.Loc)).z) - 273.15F, -15F, 55F, 0.0F, 30F), 0.0F);
		...
		if (this.sounds != null) {
			...
			if (soundfx == null) {
				...
				if (this.soundfx1 != null) {
					...
					this.soundfx1.setPosition(new Point3d(-0.5D, 0.69999999999999996D, -0.10000000000000001D));
