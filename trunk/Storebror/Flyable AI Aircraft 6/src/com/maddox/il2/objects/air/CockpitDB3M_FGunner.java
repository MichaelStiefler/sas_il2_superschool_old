...
public class CockpitDB3M_FGunner extends CockpitGunner {
	...
	public CockpitDB3M_FGunner() {
		super("3DO/Cockpit/Pe-8_NGUN/DB3M_hier.him", "i16");
		bNeedSetUp = true;
		hook1 = null;
	...
	static {
		Property.set(CockpitDB3M_FGunner.class, "aiTuretNum", 0);
		Property.set(CockpitDB3M_FGunner.class, "weaponControlNum", 10);
		Property.set(CockpitDB3M_FGunner.class, "astatePilotIndx", 1);
