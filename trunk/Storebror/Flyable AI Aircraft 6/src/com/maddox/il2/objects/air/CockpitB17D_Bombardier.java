...
public class CockpitB17D_Bombardier extends CockpitBombardier {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
            ...
            float f1 = ((B_17D)aircraft()).fSightHeadTurn * 30F;
...
//        float f1 = ((B_17D)aircraft()).fSightCurForwardAngle;
//        float f2 = ((B_17D)aircraft()).fSightCurAltitude;
//        float f3 = ((B_17D)aircraft()).fSightCurSpeed;
//        boolean flag = ((B_17D)aircraft()).bSightClutch;
//        float f4 = ((B_17D)aircraft()).fSightCurSideslip;
//        float f5 = ((B_17D)aircraft()).fSightHeadTurn * 30F;
//        float f6 = ((B_17D)aircraft()).getBombSightPDI();
...
//        mesh.chunkSetAngles("Z_KnobGrndSpd", 0.0F, 0.0F, (float)aircraft().FM.CT.bombTrainDelay * -32F);
	...
	static {
		Property.set(CockpitB17D_Bombardier.class, "astatePilotIndx", 2);
        Property.set(CockpitB17D_Bombardier.class, "aiTuretNum", -2);
        Property.set(CockpitB17D_Bombardier.class, "weaponControlNum", 3);
	}
