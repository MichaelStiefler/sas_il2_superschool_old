...
public class CockpitB25C25 extends CockpitPilot {
			...
			if (fm != null) {
				...
				if (useRealisticNavigationInstruments()) {
					...
					setNew.radioCompassAzimuth.setDeg(setOld.radioCompassAzimuth.getDeg(0.02F),
							radioCompassAzimuthInvertMinus() - setOld.azimuth.getDeg(1.0F) - 90F);
					...
					setNew.radioCompassAzimuth.setDeg(setOld.radioCompassAzimuth.getDeg(0.1F), f - setOld.azimuth.getDeg(0.1F)
							- 90F);
				}
	...
	public CockpitB25C25() {
		...
		pictManf1 = 1.0F;
		pictManf2 = 1.0F;
		cockpitNightMats = (new String[] { "texture01_dmg", "texture01", "texture02_dmg", "texture02", "texture03_dmg",
				"texture03", "texture04_dmg", "texture04", "texture05_dmg", "texture05", "texture06_dmg", "texture06",
				"texture21_dmg", "texture21", "texture25" });
		setNightMats(false);
	...
	public void reflectWorldToInstruments(float f) {
		...
		if ((fm.AS.astateCockpitState & 0x40) == 0)
			mesh.chunkSetAngles("Z_Climb1", 0.0F, floatindex(cvt(setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), variometerScale),
					0.0F);
		w.set(fm.getW());
		fm.Or.transform(w);
		...
		if ((fm.AS.astateCockpitState & 0x40) == 0) {
			...
			mesh.chunkSetAngles(
					...
					pictManf1 = 0.9F * pictManf1 + 0.1F
							* cvt(fm.EI.engines[0].getManifoldPressure(), 0.3386378F, 2.539784F, 0.0F, 346.5F), 0.0F);
			mesh.chunkSetAngles(
					"Z_Pres2",
					0.0F,
					pictManf2 = 0.9F * pictManf2 + 0.1F
							* cvt(fm.EI.engines[1].getManifoldPressure(), 0.3386378F, 2.539784F, 0.0F, 346.5F), 0.0F);
		}
		...
		mesh.chunkSetAngles("Z_Carbair1", 0.0F, -cvt(Atmosphere.temperature((float)fm.Loc.z) - 273.15F, -50F, 150F, -25F, 75F),
				0.0F);
		mesh.chunkSetAngles("Z_Carbair2", 0.0F, cvt(Atmosphere.temperature((float)fm.Loc.z) - 273.15F, -50F, 150F, -25F, 75F),
				0.0F);
		...
		mesh.chunkSetAngles("Z_Oilpres1", 0.0F,
				cvt(1.0F + 0.05F * fm.EI.engines[1].tOilIn * fm.EI.engines[1].getReadyness(), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
		mesh.chunkSetAngles("Z_Oilpres2", 0.0F,
				cvt(1.0F + 0.05F * fm.EI.engines[0].tOilIn * fm.EI.engines[0].getReadyness(), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
		...
		if ((fm.AS.astateCockpitState & 0x40) == 0)
			mesh.chunkSetAngles("zFreeAir", 0.0F,
					cvt(Atmosphere.temperature((float)fm.Loc.z) - 273.15F, -70F, 150F, -26.6F, 57F), 0.0F);
	...
	private static final float speedometerScale[] = { 0.0F, 2.5F, 59F, 126F, 155.5F, 223.5F, 240F, 254.5F, 271F, 285F, 296.5F,
			308.5F, 324F, 338.5F };
