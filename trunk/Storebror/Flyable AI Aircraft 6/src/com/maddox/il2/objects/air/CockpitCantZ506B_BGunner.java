...
public class CockpitCantZ506B_BGunner extends CockpitGunner {
	...
	public CockpitCantZ506B_BGunner() {
		super("3DO/Cockpit/Cant-BGun/BGunnerCant506B.him", "he111_gunner");
		hook1 = null;
	}
	...
	static {
		Property.set(CockpitCantZ506B_BGunner.class, "aiTuretNum", 1);
		Property.set(CockpitCantZ506B_BGunner.class, "weaponControlNum", 11);
		Property.set(CockpitCantZ506B_BGunner.class, "astatePilotIndx", 3);
	}
}
