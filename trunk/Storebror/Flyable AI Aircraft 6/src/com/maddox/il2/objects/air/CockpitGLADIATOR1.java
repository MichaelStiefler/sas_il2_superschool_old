...
public class CockpitGLADIATOR1 extends CockpitPilot {
	...
	public CockpitGLADIATOR1() {
		...
		pictElev = 0.0F;
		pictSupc = 0.0F;
		cockpitNightMats = (new String[] { "PRIB_01", "PRIB_02", "PRIB_03", "PRIB_04", "PRIB_05", "PRIB_06", "PRIB_07" });
		setNightMats(false);
		interpPut(new Interpolater(), null, Time.current(), null);
		if (acoustics != null)
			acoustics.globFX = new ReverbFXRoom(0.45F);
		limits6DoF = (new float[] { 0.7F, 0.055F, -0.07F, 0.11F, 0.12F, -0.1F, 0.05F, -0.03F });
	}
	...
	public void reflectWorldToInstruments(float f) {
		...
		mesh.chunkSetAngles("Z_OilPress1", 0.0F, 0.0F, cvt(1.0F + 0.05F * fm.EI.engines[0].tOilIn, 0.0F, 12F, 0.0F, -309F));
		...
		mesh.chunkSetAngles("Z_OilTemp1", 0.0F, 0.0F, cvt(fm.EI.engines[0].tOilIn, 0.0F, 140F, 0.0F, -315.5F));
		resetYPRmodifier();
		Cockpit.xyz[0] = -cvt(fm.Or.getTangage(), -20F, 20F, 0.042F, -0.042F);
		...
		Aircraft.ypr[1] = 0.0F;
		Aircraft.ypr[2] = 0.0F;
		Aircraft.xyz[1] = fm.CT.getCockpitDoor() * -0.6F;
		mesh.chunkSetLocate("XGlassDamage3", Aircraft.xyz, Aircraft.ypr);
		Aircraft.xyz[1] = fm.CT.getCockpitDoor() * 0.6F;
		mesh.chunkSetLocate("Canopy", Aircraft.xyz, Aircraft.ypr);
		mesh.chunkSetLocate("CanopyGlass", Aircraft.xyz, Aircraft.ypr);
		mesh.chunkSetLocate("XGlassDamage2", Aircraft.xyz, Aircraft.ypr);
		if (fm.CT.bHasBrakeControl) {
			float f2 = fm.CT.getBrake();
			mesh.chunkSetAngles("Z_brake_handle", f2 * 20F, 0.0F, 0.0F);
			mesh.chunkSetAngles("Z_brake_pressR", cvt(f2 + f2 * fm.CT.getRudder(), 0.0F, 1.5F, 0.0F, 148F), 0.0F, 0.0F);
			mesh.chunkSetAngles("Z_brake_pressL", cvt(f2 - f2 * fm.CT.getRudder(), 0.0F, 1.5F, 0.0F, 148F), 0.0F, 0.0F);
			mesh.chunkSetAngles("Z_brake_press", -150F + f2 * 40F, 0.0F, 0.0F);
		}
	}
	...
	static {
		Property.set(CLASS.THIS(), "normZNs", new float[] { 1.0F, 0.7F, 0.65F, 0.7F });
	}
