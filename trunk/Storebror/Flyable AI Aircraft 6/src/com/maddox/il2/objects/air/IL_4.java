...
public abstract class IL_4 extends Scheme2BomberOPB1 {
	...
	public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
		...
		hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 0.0F, 100F * f1);
		hiermesh.chunkSetAngles("GearR4_D0", 0.0F, -20F * f1, 0.0F);
	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		if (s.startsWith("xx")) {
			...
			if (s.startsWith("xxspar")) {
				if (s.startsWith("xxsparli") && chunkDamageVisible("WingLIn") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
					debuggunnery("*** WingLIn Spars Damaged..");
					nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
				}
				if (s.startsWith("xxsparri") && chunkDamageVisible("WingRIn") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
					debuggunnery("*** WingRIn Spars Damaged..");
					nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
				}
				if (s.startsWith("xxsparlm") && chunkDamageVisible("WingLMid") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
					debuggunnery("*** WingLMid Spars Damaged..");
					nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
				}
				if (s.startsWith("xxsparrm") && chunkDamageVisible("WingRMid") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
					debuggunnery("*** WingRMid Spars Damaged..");
					nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
				}
				if (s.startsWith("xxsparlo") && chunkDamageVisible("WingLOut") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
					debuggunnery("*** WingLOut Spars Damaged..");
					nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
				}
				if (s.startsWith("xxsparro") && chunkDamageVisible("WingROut") > 2 && getEnergyPastArmor(26.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
	...
	public void doMurderPilot(int i) {
		...
		case 2: // '\002'
			if (hierMesh().isChunkVisible("Pilot3_D0")) {
				...
				hierMesh().chunkVisible("Pilot3a_D1", true);
			}
			break;
		}
	}
	...
	public void update(float f) {
		if (FM.turret.length != 0 && FM.turret[1].bIsAIControlled && FM.turret[2].bIsAIControlled) {
			if (Time.current() > tme || !FM.turret[0].bIsAIControlled) {
				...
				} else if (FM.turret[2].bIsOperable) {
	...
	private void setRadist(int i, int j) {
		...
		case 1: // '\001'
			...
			hierMesh().chunkVisible("HMask2_D0", false);
			hierMesh().chunkVisible("HMask2a_D0", false);
			FM.turret[0].bIsOperable = !FM.turret[0].bIsAIControlled;
			switch (j) {
			case 0: // '\0'
