...
public class LA_7B20 extends LA_X {
    ...
    static {
        ...
        weaponsRegister(class1, "default", new String[] { "MGunB20s 130", "MGunB20s 150", "MGunB20s 150", null, null, null, null });
        weaponsRegister(class1, "2xFAB50", new String[] { "MGunB20s 130", "MGunB20s 130", "MGunB20s 130", "BombGunFAB50 1", "BombGunFAB50 1", null, null });
        weaponsRegister(class1, "2xFAB100", new String[] { "MGunB20s 130", "MGunB20s 130", "MGunB20s 130", "BombGunFAB100 1", "BombGunFAB100 1", null, null });
        weaponsRegister(class1, "2xDROPTANK", new String[] { "MGunB20s 130", "MGunB20s 130", "MGunB20s 130", null, null, "FuelTankGun_Tank80", "FuelTankGun_Tank80" });
