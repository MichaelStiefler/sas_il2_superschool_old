...
public class MC_200_7FB extends MC_200xyz {
    ...
    static {
        ...
        weaponsRegister(class1, "default", new String[] { "MGunBredaSAFAT127siMC200 350", "MGunBredaSAFAT127siMC200 350", null, null });
        weaponsRegister(class1, "2x50", new String[] { "MGunBredaSAFAT127siMC200 350", "MGunBredaSAFAT127siMC200 350", "BombGunIT_50_M 1", "BombGunIT_50_M 1" });
        weaponsRegister(class1, "2x100", new String[] { "MGunBredaSAFAT127siMC200 350", "MGunBredaSAFAT127siMC200 350", "BombGunIT_100_M 1", "BombGunIT_100_M 1" });
