    ...
    public void update(float f) {
        ...
        if (((FlightModelMain) (super.FM)).AS.isMaster()) {
            if (this.prevThtl < 0.25F) {
                ((FlightModelMain) (super.FM)).EI.engines[2].setControlThrottle(0.1176471F);
            } else if (this.prevThtl < 0.5F) {
                ((FlightModelMain) (super.FM)).EI.engines[2].setControlThrottle(0.4117647F);
            } else if (this.prevThtl < 0.75F) {
                ((FlightModelMain) (super.FM)).EI.engines[2].setControlThrottle(0.7058824F);
            } else {
            ...
            if ((((FlightModelMain) (super.FM)).EI.engines[2].getStage() > 0) && (((FlightModelMain) (super.FM)).EI.engines[2].getStage() < 7)) {
                if (!((FlightModelMain) (super.FM)).M.requestNitro((1774F * ((FlightModelMain) (super.FM)).EI.engines[2].getControlThrottle() * f) / 180F) && (World.cur().diffCur.Limited_Fuel || !super.FM.isPlayers())) {
