...
public abstract class FW_190G extends Scheme1 implements TypeFighter, TypeBNZFighter, TypeStormovik, TypeBomber {
    ...
    public static void moveGear(HierMesh hiermesh, float f) {
        ...
        double theta0 = -0.14D;
        FW_190G.AxisPos[FW_190G.axisD][FW_190G.idX] = Math.cos(theta0) * FW_190G.LengthA_D;
        FW_190G.AxisPos[FW_190G.axisD][FW_190G.idY] = Math.sin(theta0) * FW_190G.LengthA_D;
        double theta1 = ((f * 77D) / 180D) * Math.PI;
        FW_190G.AxisPos[FW_190G.axisB][FW_190G.idX] = Math.cos(theta1) * FW_190G.LengthA_B;
        FW_190G.AxisPos[FW_190G.axisB][FW_190G.idY] = Math.sin(theta1) * FW_190G.LengthA_B;
        double LengthB_D = FW_190G.getDst(FW_190G.AxisPos[FW_190G.axisB][FW_190G.idX], FW_190G.AxisPos[FW_190G.axisB][FW_190G.idY], FW_190G.AxisPos[FW_190G.axisD][FW_190G.idX], FW_190G.AxisPos[FW_190G.axisD][FW_190G.idY]);
        double theta4_1 = Math.acos((FW_190G.LengthA_D - FW_190G.AxisPos[FW_190G.axisB][FW_190G.idX]) / LengthB_D);
        ...
        double theta3 = 0.0D;
        Cos2_2 = (((LengthB_D * LengthB_D) + FW_190G.LengthB_C * FW_190G.LengthB_C) - FW_190G.LengthC_D * FW_190G.LengthC_D) / (2D * LengthB_D * FW_190G.LengthB_C);
        Cos2_2 = Cos2_2 <= 1.0D ? Cos2_2 : 1.0D;
        Cos2_2 = Cos2_2 >= -1D ? Cos2_2 : -1D;
        theta2_2 = Math.acos(Cos2_2);
        Cos4_2 = (((LengthB_D * LengthB_D) + FW_190G.LengthC_D * FW_190G.LengthC_D) - FW_190G.LengthB_C * FW_190G.LengthB_C) / (2D * LengthB_D * FW_190G.LengthC_D);
        Cos4_2 = Cos4_2 <= 1.0D ? Cos4_2 : 1.0D;
        Cos4_2 = Cos4_2 >= -1D ? Cos4_2 : -1D;
        theta4_2 = Math.acos(Cos4_2);
        Cos3 = ((FW_190G.LengthC_D * FW_190G.LengthC_D) + (FW_190G.LengthB_C * FW_190G.LengthB_C) - (LengthB_D * LengthB_D)) / (2.0F * FW_190G.LengthC_D * FW_190G.LengthB_C);
