...
//        FW_190.kc = 1.0F;
    ...
    public static void moveGear(HierMesh hiermesh, float f) {
        ...
        double theta0 = -0.14D;
        FW_190.AxisPos[FW_190.axisD][FW_190.idX] = Math.cos(theta0) * FW_190.LengthA_D;
        FW_190.AxisPos[FW_190.axisD][FW_190.idY] = Math.sin(theta0) * FW_190.LengthA_D;
        double theta1 = ((f * 77D) / 180D) * Math.PI;
        FW_190.AxisPos[FW_190.axisB][FW_190.idX] = Math.cos(theta1) * FW_190.LengthA_B;
        FW_190.AxisPos[FW_190.axisB][FW_190.idY] = Math.sin(theta1) * FW_190.LengthA_B;
        double LengthB_D = FW_190.getDst(FW_190.AxisPos[FW_190.axisB][FW_190.idX], FW_190.AxisPos[FW_190.axisB][FW_190.idY], FW_190.AxisPos[FW_190.axisD][FW_190.idX], FW_190.AxisPos[FW_190.axisD][FW_190.idY]);
        double theta4_1 = Math.acos((FW_190.LengthA_D - FW_190.AxisPos[FW_190.axisB][FW_190.idX]) / LengthB_D);
        ...
        double theta3 = 0.0D;
        Cos2_2 = (((LengthB_D * LengthB_D) + FW_190.LengthB_C * FW_190.LengthB_C) - FW_190.LengthC_D * FW_190.LengthC_D) / (2D * LengthB_D * FW_190.LengthB_C);
        Cos2_2 = Cos2_2 <= 1.0D ? Cos2_2 : 1.0D;
        Cos2_2 = Cos2_2 >= -1D ? Cos2_2 : -1D;
        theta2_2 = Math.acos(Cos2_2);
        Cos4_2 = (((LengthB_D * LengthB_D) + FW_190.LengthC_D * FW_190.LengthC_D) - FW_190.LengthB_C * FW_190.LengthB_C) / (2D * LengthB_D * FW_190.LengthC_D);
        Cos4_2 = Cos4_2 <= 1.0D ? Cos4_2 : 1.0D;
        Cos4_2 = Cos4_2 >= -1D ? Cos4_2 : -1D;
        theta4_2 = Math.acos(Cos4_2);
        Cos3 = ((FW_190.LengthC_D * FW_190.LengthC_D) + (FW_190.LengthB_C * FW_190.LengthB_C) - (LengthB_D * LengthB_D)) / (2.0F * FW_190.LengthC_D * FW_190.LengthB_C);
    ...
    public void onAircraftLoaded() {
        ...
        if ((World.cur().camouflage == 1) && (World.Rnd().nextFloat() < 0.03F)) {
            this.hierMesh().chunkVisible("CoverL2_D0", true);
            this.hierMesh().chunkVisible("CoverR2_D0", true);
        }
