...
public class CockpitBarracuda_TGunner extends CockpitGunner {
    ...
    public void setRealMode(boolean flag) {
        ...
        if (flag) {
            ((Barracuda) this.aircraft()).activateGunner(1);
        }
        ((Barracuda) this.aircraft()).setGunnerRealMode(flag);
    }

    public void moveGun(Orient orient) {
        if (((Barracuda) this.aircraft()).getTopGunnerPosition() < 1.0F) {
            return;
        }
    ...
    public void clipAnglesGun(Orient orient) {
        ...
        if (f1 < -this.floatindex(this.cvt(f2, 0.0F, 180F, 0.0F, 36F), angles)) {
            f1 = -this.floatindex(this.cvt(f2, 0.0F, 180F, 0.0F, 36F), angles);
        }
