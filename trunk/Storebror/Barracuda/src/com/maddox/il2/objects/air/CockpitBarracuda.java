        ...
        public boolean tick() {
            ...
            if (CockpitBarracuda.this.fm != null) {
                ...
                if (Math.abs(CockpitBarracuda.this.fm.Or.getKren()) < 30F) {
                    CockpitBarracuda.this.setNew.azimuth = ((35F * CockpitBarracuda.this.setOld.azimuth) + -CockpitBarracuda.this.fm.Or.getYaw()) / 36F;
                }
                if ((CockpitBarracuda.this.setOld.azimuth > 270F) && (CockpitBarracuda.this.setNew.azimuth < 90F)) {
                    CockpitBarracuda.this.setOld.azimuth -= 360F;
                }
                if ((CockpitBarracuda.this.setOld.azimuth < 90F) && (CockpitBarracuda.this.setNew.azimuth > 270F)) {
                    CockpitBarracuda.this.setOld.azimuth += 360F;
                }
