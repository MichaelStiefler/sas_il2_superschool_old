...
public class MissilePL3 extends Missile {
	...
	static {
		Class class1 = MissilePL3.class;
		Property.set(class1, "mesh", "3do/arms/PL3/mono.sim");
		...
		Property.set(class1, "timeLife", 58F); // Rocket life time in Seconds
		Property.set(class1, "timeFire", 5.3F); // Rocket Engine Burn time in Seconds
		...
		Property.set(class1, "power", 1.35F); // RL Data: 13.5kg HE warhead, for realism reduced to 1/10th of it's RL weight
		Property.set(class1, "radius", 12.93F); // Radius of Explosion Effect
		Property.set(class1, "kalibr", 0.127F); // Diameter of Missile Body
		Property.set(class1, "massa", 90.0F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 60F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "sunRayAngle", 12.0F); // max. Angle at which the missile will track Sun Ray, zero disables Sun Ray tracking (only valid for IR detector missiles)
		...
		Property.set(class1, "friendlyName", "PL-3"); // Display Name of this missile
	...
	public MissilePL3(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
