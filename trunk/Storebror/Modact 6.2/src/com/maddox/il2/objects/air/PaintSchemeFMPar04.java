...
public class PaintSchemeFMPar04 extends PaintScheme {
	...
	public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k) {
		...
		if (regiment.country() == PaintScheme.countryGermany) {
			...
			if (k <= 1 && i == 0) {
				...
				if (l1 == 1 || l1 == 5) {
					...
					changeMat(class1, hiermesh, "Overlay2", "psFM04GERCOMCGID" + l1, "German/00cG" + l1 + ".tga", 1.0F, 1.0F,
							1.0F);
					changeMat(class1, hiermesh, "Overlay3", "psFM04GERCOMCGID" + l1, "German/00cG" + l1 + ".tga", 1.0F, 1.0F,
							1.0F);
				}
				return;
			}
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay1", "psFM04GERLNUM" + l + i + "0" + k, "German/1" + i1 + k % 10 + ".tga",
						1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay4", "psFM04GERRNUM" + l + i + "0" + k, "null.tga", "German/1" + i1 + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay1", "psFM04GERCNUM" + l + i + k, "German/1" + i1 + k / 10 + ".tga", "German/1" + i1
						+ k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay4", "psFM04GERCNUM" + l + i + k, "German/1" + i1 + k / 10 + ".tga", "German/1" + i1
						+ k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
			if (l1 == 1 || l1 == 5) {
				changeMat(class1, hiermesh, "Overlay2", "null", "null.tga", 1.0F, 1.0F, 1.0F);
				...
				changeMat(class1, hiermesh, "Overlay2", "psFM04GERGRUPP" + l1 + "S" + i1, "German/1" + i1 + "0G" + l1 + ".tga",
						1.0F, 1.0F, 1.0F);
				changeMat(class1, hiermesh, "Overlay3", "psFM04GERGRUPP" + l1 + "S" + i1, "German/1" + i1 + "0G" + l1 + ".tga",
						1.0F, 1.0F, 1.0F);
			}
			return;
		}
		if (regiment.country() == PaintScheme.countryNetherlands) {
			...
			changeMat(hiermesh, "Overlay1", "psBM0NDUTCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psBM0NDUTCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			return;
		}
		if (regiment.country() == PaintScheme.countrySouthAfricaS) {
			...
			changeMat(hiermesh, "Overlay3", "psFM04SASSNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psFM04SASSNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			return;
		}
		if (regiment.country() == PaintScheme.countrySouthAfricaB) {
			...
			changeMat(hiermesh, "Overlay3", "psFM04SASBNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psFM04SASBNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			return;
		}
		if (regiment.country() == PaintScheme.countryAngola) {
			changeMat(hiermesh, "Overlay3", "psFM04ANGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
			...
			changeMat(hiermesh, "Overlay2", "psFM04ANGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryMozambique) {
			changeMat(hiermesh, "Overlay3", "psFM04MZBCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay2", "psFM04MZBCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryFinland) {
			...
			changeMat(class1, hiermesh, "Overlay7", "FAFhaken", "Finnish/"
					+ (World.cur().isHakenAllowed() ? "FAFhaken.tga" : "FAFroundel.tga"), 1.0F, 1.0F, 1.0F);
			if (i == 3)
				changeMat(class1, hiermesh, "Overlay8", "psFM04FINCNUM" + l + i + "_" + (char)(65 + (k % 10 - 1)), "Finnish/"
				...
				changeMat(class1, hiermesh, "Overlay8", "psFM04FINCNUM" + l + i + "0" + k, "Finnish/0" + k + ".tga",
						PaintScheme.psFinnishFighterColor[i][0], PaintScheme.psFinnishFighterColor[i][1],
						PaintScheme.psFinnishFighterColor[i][2]);
			else
				changeMat(hiermesh, "Overlay8", "psFM04FINCNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
			...
			changeMat(hiermesh, "Overlay2", "psFM04FINACID" + s1 + c, "Finnish/" + s1 + ".tga", "Finnish/sn" + c + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			changeMat(hiermesh, "Overlay3", "psFM04FINACID" + s1 + c, "Finnish/" + s1 + ".tga", "Finnish/sn" + c + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryFrance) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay2", "psFM04FRALNUM" + l + i + k, "Finnish/" + k % 10 + ".tga", 1.0F, 1.0F,
						1.0F);
				changeMat(hiermesh, "Overlay3", "psFM04FRARNUM" + l + i + k, "null.tga", "Finnish/" + k % 10 + ".tga", 1.0F,
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay2", "psFM04FRACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFM04FRACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
		...
		if (regiment.country() == PaintScheme.countryBritain) {
			if ("ra".equals(regiment.branch()) || "rz".equals(regiment.branch()) || "rn".equals(regiment.branch())) {
				k = clampToLiteral(k);
				changeMat(hiermesh, "Overlay1", "psFM04BRINAVYREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
				...
				changeMat(hiermesh, "Overlay4", "psFM04BRINAVYREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
						"British/" + regiment.aid()[1] + ".tga", PaintScheme.psBritishWhiteColor[0],
						PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2],
						PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1],
						PaintScheme.psBritishWhiteColor[2]);
				changeMat(hiermesh, "Overlay2", "psFM04BRINAVYLNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/"
				...
				changeMat(hiermesh, "Overlay3", "psFM04BRINAVYRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga",
				...
				k = clampToLiteral(k);
				changeMat(hiermesh, "Overlay1", "psFM04BRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
				...
				changeMat(hiermesh, "Overlay3", "psFM04BRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
						"British/" + regiment.aid()[1] + ".tga", PaintScheme.psBritishGrayColor[0],
						PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2],
						PaintScheme.psBritishGrayColor[0], PaintScheme.psBritishGrayColor[1], PaintScheme.psBritishGrayColor[2]);
				changeMat(hiermesh, "Overlay2", "psFM04BRILNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/"
				...
				changeMat(hiermesh, "Overlay4", "psFM04BRIRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/"
		...
		if (regiment.country() == PaintScheme.countryHungary) {
			changeMat(hiermesh, "Overlay1", "psFM04HUNREGI" + regiment.id(), "German/" + regiment.aid()[0] + ".tga", "German/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "psFM04HUNREGI" + regiment.id(), "German/" + regiment.aid()[0] + ".tga", "German/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psFM04HUNCNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"German/" + k / 10 + ".tga", "German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psFM04HUNCNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"German/" + k / 10 + ".tga", "German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryItaly) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay2", "psFM04ITALNUM" + l + i + k, "Italian/1" + k % 10 + ".tga", 1.0F, 1.0F,
						1.0F);
				changeMat(hiermesh, "Overlay3", "psFM04ITARNUM" + l + i + k, "null.tga", "Italian/1" + k % 10 + ".tga", 1.0F,
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay2", "psFM04ITACNUM" + l + i + k, "Italian/1" + k / 10 + ".tga", "Italian/1" + k
						% 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFM04ITACNUM" + l + i + k, "Italian/1" + k / 10 + ".tga", "Italian/1" + k
						% 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
			changeMat(class1, hiermesh, "Overlay6", "italian3", "Italian/roundel0.tga", 0.1F, 0.1F, 0.1F);
		}
		if (regiment.country() == PaintScheme.countryJapan) {
			changeMat(hiermesh, "Overlay2", "psFM04JAPCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
			...
			changeMat(hiermesh, "Overlay3", "psFM04JAPCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", PaintScheme.psRussianBomberColor[0][0],
					PaintScheme.psRussianBomberColor[0][1], PaintScheme.psRussianBomberColor[0][2],
					PaintScheme.psRussianBomberColor[0][0], PaintScheme.psRussianBomberColor[0][1],
					PaintScheme.psRussianBomberColor[0][2]);
		...
		if (regiment.country() == PaintScheme.countryPoland) {
			changeMat(hiermesh, "Overlay1", "psFM04POLCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "psFM04POLCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryRomania) {
			changeMat(hiermesh, "Overlay8", "psFM04ROMCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryRussia) {
			changeMat(hiermesh, "Overlay2", "psFM04RUSCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay3", "psFM04RUSCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countrySlovakia) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay4", "psFM04SLVKLNUM" + l + i + "0" + k, "Slovakian/" + k + ".tga", 1.0F,
						1.0F, 1.0F);
				changeMat(hiermesh, "Overlay1", "psFM04SLVKRNUM" + l + i + "0" + k, "null.tga", "Slovakian/" + k + ".tga",
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay1", "psFM04SLVKCNUM" + l + i + k, "Slovakian/" + k / 10 + ".tga", "Slovakian/" + k
						% 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay4", "psFM04SLVKCNUM" + l + i + k, "Slovakian/" + k / 10 + ".tga", "Slovakian/" + k
						% 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
		...
		if (regiment.country() == PaintScheme.countryUSA) {
			changeMat(hiermesh, "Overlay1", "psBM0NUSACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "psBM0NUSACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryFinlandAllied) {
			...
			changeMat(hiermesh, "Overlay2", "psFM04FINACID" + s2 + c1, "Finnish/" + s2 + ".tga", "Finnish/sn" + c1 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			changeMat(hiermesh, "Overlay3", "psFM04FINACID" + s2 + c1, "Finnish/" + s2 + ".tga", "Finnish/sn" + c1 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryBelgium) {
		...
		if (regiment.country() == PaintScheme.countryLithuania) {
			...
			changeMat(hiermesh, "Overlay2", "psFM04FINACID" + s3 + c2, "Finnish/" + s3 + ".tga", "Finnish/sn" + c2 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			changeMat(hiermesh, "Overlay3", "psFM04FINACID" + s3 + c2, "Finnish/" + s3 + ".tga", "Finnish/sn" + c2 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
