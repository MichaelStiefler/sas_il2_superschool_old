...
public class JU_87C extends JU_87 {
    ...
    static {
        ...
        try {
            Property.set(class1, "cockpitClass", new Class[] { Class.forName("com.maddox.il2.objects.air.CockpitJU_87B2"), Class.forName("com.maddox.il2.objects.air.CockpitJU_87B2_Gunner") });
        ...
        Aircraft.weaponsRegister(class1, "default", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG15t 900", null, null, null, null, null });
        Aircraft.weaponsRegister(class1, "4xSC50", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG15t 900", "BombGunSC50 1", "BombGunSC50 1", "BombGunSC50 1", "BombGunSC50 1" });
        Aircraft.weaponsRegister(class1, "1xSC500", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG15t 900", null, null, null, null, "BombGunSC500 1" });
        Aircraft.weaponsRegister(class1, "1xSC500_4xSC50", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG15t 900", "BombGunSC50 1", "BombGunSC50 1", "BombGunSC50 1", "BombGunSC50 1", "BombGunSC500 1" });
        Aircraft.weaponsRegister(class1, "1xSD500", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG15t 900", null, null, null, null, "BombGunSD500 1" });
        Aircraft.weaponsRegister(class1, "1xAB500", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG15t 900", null, null, null, null, "BombGunAB500 1" });
        Aircraft.weaponsRegister(class1, "1xSC250", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG15t 900", null, null, null, null, "BombGunSC250 1" });
        Aircraft.weaponsRegister(class1, "1xSC250_4xSC50", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG15t 900", "BombGunSC50 1", "BombGunSC50 1", "BombGunSC50 1", "BombGunSC50 1", "BombGunSC250 1" });
        Aircraft.weaponsRegister(class1, "1xAB250", new String[] { "MGunMG17si 500", "MGunMG17si 500", "MGunMG15t 900", null, null, null, null, "BombGunAB250 1" });
