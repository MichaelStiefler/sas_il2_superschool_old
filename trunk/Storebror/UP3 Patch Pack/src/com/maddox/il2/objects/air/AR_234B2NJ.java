...
//			if (FM.getAltitude() > 300F && boosterFireOutTime == -1L && FM.Loc.z != 0.0D && World.Rnd().nextFloat() < 0.05F) {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { com.maddox.il2.objects.air.CockpitAR_234B2NJ.class, com.maddox.il2.objects.air.CockpitAR_234B2NJ_Bombardier.class });
        ...
        Aircraft.weaponsRegister(class1, "default", new String[] { "MGunMG15120k 200", "MGunMG15120k 200", null, null, null, null, null });
        Aircraft.weaponsRegister(class1, "2xtyped", new String[] { "MGunMG15120k 200", "MGunMG15120k 200", null, null, null, "FuelTankGun_Type_D", "FuelTankGun_Type_D" });
