...
public class Supersonic {
	...
	public final void load(SectFile theSectFile) {
		...
		this.allParamsSet = theSectFile.exist(strSection, "VminMach") && theSectFile.exist(strSection, "VsoundMach1")
				&& theSectFile.exist(strSection, "CfsoundMach1") && theSectFile.exist(strSection, "VsoundMach2")
				&& theSectFile.exist(strSection, "CfsoundMach2") && theSectFile.exist(strSection, "VmaxMach")
