...
public class PaintSchemeBMPar09 extends PaintScheme {
	...
	public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k) {
		...
		if (regiment.country() == PaintScheme.countryGermany) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay1", "psBM02GERREGI" + regiment.id(), "German/" + regiment.aid()[0] + ".tga", "German/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "psBM02GERREGI" + regiment.id(), "German/" + regiment.aid()[0] + ".tga", "German/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psBM02GERCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "German/"
					+ (char)(65 + (k - 1)) + ".tga", "German/" + PaintScheme.psGermanBomberLetter[l][i] + ".tga",
					PaintScheme.psGermanBomberColor[i][0], PaintScheme.psGermanBomberColor[i][1],
					PaintScheme.psGermanBomberColor[i][2], 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psBM02GERCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "German/"
					+ (char)(65 + (k - 1)) + ".tga", "German/" + PaintScheme.psGermanBomberLetter[l][i] + ".tga",
					PaintScheme.psGermanBomberColor[i][0], PaintScheme.psGermanBomberColor[i][1],
					PaintScheme.psGermanBomberColor[i][2], 0.1F, 0.1F, 0.1F);
			...
			changeMat(class1, hiermesh, "Overlay8", "haken1", "German/"
					+ (World.cur().isHakenAllowed() ? "haken1.tga" : "hakenfake.tga"), 1.0F, 1.0F, 1.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryNetherlands) {
			...
			changeMat(hiermesh, "Overlay1", "psBM0RDUTCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psBM0RDUTCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			return;
		}
		if (regiment.country() == PaintScheme.countrySouthAfricaS) {
			...
			changeMat(hiermesh, "Overlay3", "psBM02SASSNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psBM02SASSNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			return;
		}
		if (regiment.country() == PaintScheme.countrySouthAfricaB) {
			...
			changeMat(hiermesh, "Overlay3", "psBM02SASBNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psBM02SASBNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			return;
		}
		if (regiment.country() == PaintScheme.countryAngola) {
			changeMat(hiermesh, "Overlay3", "psBM02ANGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
			...
			changeMat(hiermesh, "Overlay2", "psBM02ANGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryMozambique) {
			changeMat(hiermesh, "Overlay3", "psBM02MZBCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay2", "psBM02MZBCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryFinland) {
			...
			changeMat(class1, hiermesh, "Overlay7", "FAFhaken", "Finnish/"
					+ (World.cur().isHakenAllowed() ? "FAFhaken.tga" : "FAFroundel.tga"), 1.0F, 1.0F, 1.0F);
			if (k < 10)
				changeMat(class1, hiermesh, "Overlay8", "psBM02FINANUM" + l + i + "0" + k, "Finnish/0" + k + ".tga",
						PaintScheme.psFinnishFighterColor[i][0], PaintScheme.psFinnishFighterColor[i][1],
						PaintScheme.psFinnishFighterColor[i][2]);
			else
				changeMat(hiermesh, "Overlay8", "psBM02FINCNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
			...
			changeMat(hiermesh, "Overlay2", "psBM02FINACOD" + s1 + c, "Finnish/" + s1 + ".tga", "Finnish/sn" + c + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			changeMat(hiermesh, "Overlay3", "psBM02FINACOD" + s1 + c, "Finnish/" + s1 + ".tga", "Finnish/sn" + c + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryFrance) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay2", "psFB02FRALNUM" + l + i + k, "Finnish/" + k % 10 + ".tga", 1.0F, 1.0F,
						1.0F);
				changeMat(hiermesh, "Overlay3", "psFB02FRARNUM" + l + i + k, "null.tga", "Finnish/" + k % 10 + ".tga", 1.0F,
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay2", "psFB02FRACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFB02FRACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
		...
		if (regiment.country() == PaintScheme.countryBritain) {
			if ("ra".equals(regiment.branch()) || "rz".equals(regiment.branch()) || "rn".equals(regiment.branch())) {
				k = clampToLiteral(k);
				changeMat(hiermesh, "Overlay1", "psBM02BRINAVYREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
				...
				changeMat(hiermesh, "Overlay4", "psBM02BRINAVYREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
						"British/" + regiment.aid()[1] + ".tga", PaintScheme.psBritishWhiteColor[0],
						PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2],
						PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1],
						PaintScheme.psBritishWhiteColor[2]);
				changeMat(hiermesh, "Overlay2", "psBM02BRINAVYLNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/"
				...
				changeMat(hiermesh, "Overlay3", "psBM02BRINAVYRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga",
				...
				k = clampToLiteral(k);
				changeMat(hiermesh, "Overlay1", "psBM02BRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
						"British/" + regiment.aid()[1] + ".tga", PaintScheme.psBritishSkyColor[0],
						PaintScheme.psBritishSkyColor[1], PaintScheme.psBritishSkyColor[2], PaintScheme.psBritishSkyColor[0],
						PaintScheme.psBritishSkyColor[1], PaintScheme.psBritishSkyColor[2]);
				changeMat(hiermesh, "Overlay4", "psBM02BRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
						"British/" + regiment.aid()[1] + ".tga", PaintScheme.psBritishSkyColor[0],
						PaintScheme.psBritishSkyColor[1], PaintScheme.psBritishSkyColor[2], PaintScheme.psBritishSkyColor[0],
						PaintScheme.psBritishSkyColor[1], PaintScheme.psBritishSkyColor[2]);
				changeMat(hiermesh, "Overlay2", "psBM02BRILNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/"
				...
				changeMat(hiermesh, "Overlay3", "psBM02BRIRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/"
		...
		if (regiment.country() == PaintScheme.countryHungary) {
			changeMat(hiermesh, "Overlay1", "psBM02HUNREGI" + regiment.id(), "German/" + regiment.aid()[0] + ".tga", "German/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "psBM02HUNREGI" + regiment.id(), "German/" + regiment.aid()[0] + ".tga", "German/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psBM02HUNCNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"German/" + k / 10 + ".tga", "German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psBM02HUNCNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"German/" + k / 10 + ".tga", "German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryItaly) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay2", "psFB02ITALNUM" + l + i + k + regiment.aid()[1], "Italian/" + k % 10
						+ regiment.aid()[1] + ".tga", 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFB02ITARNUM" + l + i + k + regiment.aid()[1], "null.tga", "Italian/" + k
						% 10 + regiment.aid()[1] + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay2", "psFB02ITACNUM" + l + i + k + regiment.aid()[1],
						"Italian/" + k / 10 + regiment.aid()[1] + ".tga", "Italian/" + k % 10 + regiment.aid()[1] + ".tga",
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFB02ITACNUM" + l + i + k + regiment.aid()[1],
						"Italian/" + k / 10 + regiment.aid()[1] + ".tga", "Italian/" + k % 10 + regiment.aid()[1] + ".tga",
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
			if (regiment.aid()[0] != 'Z') {
				changeMat(class1, hiermesh, "Overlay4", "psFB02ITARNUM" + regiment.id(), "Italian/" + regiment.aid()[0]
						+ "4.tga", 1.0F, 1.0F, 1.0F);
				changeMat(class1, hiermesh, "Overlay1", "psFB02ITALNUM" + regiment.id(), "Italian/" + regiment.aid()[0]
						+ "1.tga", 1.0F, 1.0F, 1.0F);
			}
			changeMat(class1, hiermesh, "Overlay6", "italian3", "Italian/roundel0.tga", 0.1F, 0.1F, 0.1F);
		}
		if (regiment.country() == PaintScheme.countryJapan) {
			changeMat(hiermesh, "Overlay2", "psBM02JAPCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
			...
			changeMat(hiermesh, "Overlay3", "psBM02JAPCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", PaintScheme.psRussianBomberColor[0][0],
					PaintScheme.psRussianBomberColor[0][1], PaintScheme.psRussianBomberColor[0][2],
					PaintScheme.psRussianBomberColor[0][0], PaintScheme.psRussianBomberColor[0][1],
					PaintScheme.psRussianBomberColor[0][2]);
		...
		if (regiment.country() == PaintScheme.countryPoland) {
			changeMat(hiermesh, "Overlay1", "psBM02POLCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "psBM02POLCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryRomania) {
			changeMat(hiermesh, "Overlay8", "psFB02ROMCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryRussia) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay2", "psBM02RUSLNUM" + l + i + "0" + k, "Russian/0" + k + ".tga",
						PaintScheme.psRussianBomberColor[i][0], PaintScheme.psRussianBomberColor[i][1],
						PaintScheme.psRussianBomberColor[i][2]);
				changeMat(hiermesh, "Overlay3", "psBM02RUSRNUM" + l + i + "0" + k, "null.tga", "Russian/0" + k + ".tga", 1.0F,
						1.0F, 1.0F, PaintScheme.psRussianBomberColor[i][0], PaintScheme.psRussianBomberColor[i][1],
						PaintScheme.psRussianBomberColor[i][2]);
			} else {
				changeMat(hiermesh, "Overlay2", "psBM02RUSCNUM" + l + i + k, "Russian/0" + k / 10 + ".tga", "Russian/0" + k
						% 10 + ".tga", PaintScheme.psRussianBomberColor[i][0], PaintScheme.psRussianBomberColor[i][1],
						PaintScheme.psRussianBomberColor[i][2], PaintScheme.psRussianBomberColor[i][0],
						PaintScheme.psRussianBomberColor[i][1], PaintScheme.psRussianBomberColor[i][2]);
				changeMat(hiermesh, "Overlay3", "psBM02RUSCNUM" + l + i + k, "Russian/0" + k / 10 + ".tga", "Russian/0" + k
						% 10 + ".tga", PaintScheme.psRussianBomberColor[i][0], PaintScheme.psRussianBomberColor[i][1],
						PaintScheme.psRussianBomberColor[i][2], PaintScheme.psRussianBomberColor[i][0],
						PaintScheme.psRussianBomberColor[i][1], PaintScheme.psRussianBomberColor[i][2]);
			}
		...
		if (regiment.country() == PaintScheme.countryNewZealand) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay1", "psBM0RRZREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1],
					PaintScheme.psBritishWhiteColor[2], PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1],
					PaintScheme.psBritishWhiteColor[2]);
			changeMat(hiermesh, "Overlay4", "psBM0RRZREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1],
					PaintScheme.psBritishWhiteColor[2], PaintScheme.psBritishWhiteColor[0], PaintScheme.psBritishWhiteColor[1],
					PaintScheme.psBritishWhiteColor[2]);
			changeMat(hiermesh, "Overlay2", "psBM0RRZLNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", PaintScheme.psBritishWhiteColor[0],
					PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2], 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay3", "psBM0RRZRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/"
		...
		if (regiment.country() == PaintScheme.countrySlovakia) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay2", "psBM02SLVKLNUM" + l + i + "0" + k, "Finnish/" + k + ".tga", 1.0F,
						1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psBM02SLVKRNUM" + l + i + "0" + k, "null.tga", "Finnish/" + k + ".tga", 1.0F,
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay2", "psBM02SLVKCNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psBM02SLVKCNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
		...
		if (regiment.country() == PaintScheme.countryUSA) {
			changeMat(hiermesh, "Overlay1", "psBM0RUSACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "psBM0RUSACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countrySwitzerland) {
			changeMat(class1, hiermesh, "Overlay6", "CHRoundel", "CH/CHRoundel.tga", 1.0F, 1.0F, 1.0F);
			changeMat(class1, hiermesh, "Overlay7", "CHRoundel", "CH/CHRoundel.tga", 1.0F, 1.0F, 1.0F);
			String s = getCHBMCode(class1);
		...
		if (regiment.country() == PaintScheme.countrySpainNat) {
			...
			changeMat(hiermesh, "Overlay1", "BlackNum_00" + (i1 < 10 ? "0" + i1 : "" + i1), "Default/1" + i1 / 10 + ".tga",
					"Default/1" + i1 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "BlackNum_00" + (i1 < 10 ? "0" + i1 : "" + i1), "Default/1" + i1 / 10 + ".tga",
					"Default/1" + i1 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryFinlandAllied) {
			...
			changeMat(hiermesh, "Overlay2", "psBM02FINACOD" + s2 + c1, "Finnish/" + s2 + ".tga", "Finnish/sn" + c1 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			changeMat(hiermesh, "Overlay3", "psBM02FINACOD" + s2 + c1, "Finnish/" + s2 + ".tga", "Finnish/sn" + c1 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryBelgium) {
		...
		if (regiment.country() == PaintScheme.countrySweden) {
			...
			changeMat(hiermesh, "Overlay2", "BlackNum_00" + (j1 < 10 ? "0" + j1 : "" + j1), "Default/1" + j1 / 10 + ".tga",
					"Default/1" + j1 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay3", "BlackNum_00" + (j1 < 10 ? "0" + j1 : "" + j1), "Default/1" + j1 / 10 + ".tga",
					"Default/1" + j1 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryManchukuo) {
			...
			changeMat(hiermesh, "Overlay3", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(class1, hiermesh, "Overlay6", "MKWings", "MK/MKWings.tga", 1.0F, 1.0F, 1.0F);
			changeMat(class1, hiermesh, "Overlay8", "MKTail", "MK/MKTail.tga", 1.0F, 1.0F, 1.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryRussianEmpire) {
			changeMat(hiermesh, "Overlay2", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
		...
		if (regiment.country() == PaintScheme.countryLithuania) {
			...
			changeMat(hiermesh, "Overlay2", "psBM02FINACID" + s3 + c2, "Finnish/" + s3 + ".tga", "Finnish/sn" + c2 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			changeMat(hiermesh, "Overlay3", "psBM02FINACID" + s3 + c2, "Finnish/" + s3 + ".tga", "Finnish/sn" + c2 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
