...
public abstract class Main {
	...
	public static String onlineUsernameOverride = "";
	...
	public void preload() {
		...
		while (localEntry != null) {
			...
			if ((localObject instanceof Class)) {
				...
				if ((Bomb.class.isAssignableFrom(localClass)) || (BombGun.class.isAssignableFrom(localClass))
						|| (RocketBombGun.class.isAssignableFrom(localClass)) || (FuelTank.class.isAssignableFrom(localClass))
						|| (FuelTankGun.class.isAssignableFrom(localClass)) || (Rocket.class.isAssignableFrom(localClass))
						|| (RocketGun.class.isAssignableFrom(localClass))) {
					...
					if (Property.vars(localArrayList, localObject)) {
						try {
							...
							BufferedReader localBufferedReader = new BufferedReader(new InputStreamReader(
									new KryptoInputFilter(new SFSInputStream(
											Finger.LongFN(0L, "cod/" + Finger.incInt(i, "slg"))), getSwTbl2(i))));
							while (true) {
	...
	public static void exec(Main main, String s, String s2, int i) {
		...
		if (Config.LOCALE.equals("RU")) {
			...
			if ((!"de".equals(str)) && (!"fr".equals(str)) && (!"cs".equals(str)) && (!"pl".equals(str)) && (!"hu".equals(str))
					&& (!"lt".equals(str)) && (!"us".equals(str))) {
				Locale.setDefault(Locale.US);
			}
		}
		try {
	...
	static {
		try {
			BufferedReader localBufferedReader = new BufferedReader(new InputStreamReader(new KryptoInputFilter(
					new SFSInputStream(Finger.LongFN(0L, "cod/" + Finger.Int("allc"))), getSwTbl(Finger.Int("alls")))));
			while (true) {
