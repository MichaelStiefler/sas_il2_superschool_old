...
public class Controls {
    ...
    public void update(float f, float f_10_, EnginesInterface enginesinterface, boolean bool, boolean bool_11_) {
        ...
        if (tick != Time.tickCounter()) {
            ...
            CTL = (byte) ((GearControl <= 0.5F ? 0 : 1) | (FlapsControl <= 0.2F ? 0 : 2) | (BrakeControl <= 0.2F ? 0 : 4) | (RadiatorControl <= 0.5F ? 0 : 8) | (BayDoorControl <= 0.5F ? 0 : 16) | (AirBrakeControl <= 0.5F ? 0 : 32));
            WCT &= 0xfc;
            TWCT &= 0xfc;
            int i = 0;
                                ...
                                if (!bIsMustang || (System.currentTimeMillis() > (lWeaponTime + 250L / (long) Time.speed()))) {
                                    ...
                                    for (int i_22_ = 0; i_22_ < Weapons[i_19_].length; i_22_ += 2) {
                                        if (!(Weapons[i_19_][i_22_] instanceof FuelTankGun) && Weapons[i_19_][i_22_].haveBullets()) {
                                            if (bHasBayDoors && Weapons[i_19_][i_22_].getHookName().startsWith("_BombSpawn")) {
                                                ...
                                                if (!bIsMustang || (Weapons[i_19_][i_22_] instanceof RocketGun4andHalfInch) || ((Weapons[i_19_][i_22_] instanceof RocketGun) && (iToggleRocketSide == LEFT))
                                            ...
                                            if (((Weapons[i_19_][i_22_] instanceof BombGun) && !((BombGun) Weapons[i_19_][i_22_]).isCassette()) || ((Weapons[i_19_][i_22_] instanceof RocketGun) && !((RocketGun) Weapons[i_19_][i_22_]).isCassette())) {
                                                i_21_ = i_22_;
                                    ...
                                    for (int i_23_ = 1; i_23_ < Weapons[i_19_].length; i_23_ += 2) {
                                        if (!(Weapons[i_19_][i_23_] instanceof FuelTankGun) && Weapons[i_19_][i_23_].haveBullets()) {
                                            ...
                                            } else if (!bIsMustang || (Weapons[i_19_][i_23_] instanceof RocketGun4andHalfInch) || ((Weapons[i_19_][i_23_] instanceof RocketGun) && (iToggleRocketSide == RIGHT))
                                                    || ((Weapons[i_19_][i_23_] instanceof BombGun) && (iToggleBombSide == RIGHT))) {
                                                Weapons[i_19_][i_23_].shots(i_20_);
                                                // TODO:Added by |ZUTI|
                                                ZutiSupportMethods_FM.executeOnbombDropped(zutiOwnerAircraftName, i_19_, i_23_, i_20_);
                                            }
                                            if (((Weapons[i_19_][i_23_] instanceof BombGun) && !((BombGun) Weapons[i_19_][i_23_]).isCassette()) || ((Weapons[i_19_][i_23_] instanceof RocketGun) && !((RocketGun) Weapons[i_19_][i_23_]).isCassette())) {
                                                i_21_ = i_23_;
                                                lWeaponTime = System.currentTimeMillis();
                                                break;
                                            }
