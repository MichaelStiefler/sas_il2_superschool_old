...
public class LocomotiveTrailorVerm extends Wagon implements MsgCollisionRequestListener, MsgExplosionListener, MsgShotListener {
...
//				Eff3DActor.New(wagon, new HookNamed(wagon, "Damage"), null, 1.0F, "Effects/Smokes/SmokeTrailorFC.eff", 12F);
				//TODO: --- FX Repack Mod ---
			}
	...
	public LocomotiveTrailorVerm(Train train) {
...
//		killTNT = 1.9F;
	...
	private static String getMeshName(int i) {
		...
		return "3do/Trains/PrvzB_B" + (i == 1 ? "_Dmg" : "") + "/" + s + "/hier.him";
	}
	...
	static {
		cls = LocomotiveTrailorVerm.class;
