...
//TODO: +++ FX Repack Mod +++
public abstract class P_51Mustang extends P51FLAME implements TypeFighter, TypeBNZFighter, TypeStormovik {
		...
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				...
				if (s.endsWith("p1"))
					...
					getEnergyPastArmor((double)World.Rnd().nextFloat(20F, 40F)
