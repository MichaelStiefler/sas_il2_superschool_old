...
public class Platform3 extends Wagon implements MsgCollisionRequestListener, MsgExplosionListener, MsgShotListener {
	public static class SPAWN implements WagonSpawn {

		public Wagon wagonSpawn(Train train) {
			return new Platform3(train);
		}
...
//		killTNT = 3F;
	...
	private static String getMeshName(int i) {
		...
		return "3do/Trains/Platform3" + (i == 1 ? "_Dmg" : "") + "/" + s + "/hier.him";
	}
