...
public class BombTiBase2 extends Bomb {
        ...
        if (this.charge < 1.01D) {
            ...
            if (Actor.isValid(actor)) {
                ...
                for (int i = 0; i < 60; i++) {
                    ...
                    vector3d.scale(World.Rnd().nextDouble(5D, 12.199999999999999D));
                    vector3d.add(vector3d1);
                    Bomb bomb = spawnNewBomb();
    ...
    protected static void initStatic(Class theClass) {
        Property.set(theClass, "mesh", "3DO/Arms/Flare/mono.sim");
        Property.set(theClass, "radius", 0.0F);
        Property.set(theClass, "power", 0.0F);
        Property.set(theClass, "powerType", 0);
        Property.set(theClass, "kalibr", 0.32F);
        Property.set(theClass, "massa", 125F);
        Property.set(theClass, "sound", "weapon.bomb_big");
    }
}
