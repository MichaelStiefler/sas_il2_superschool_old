...
//        }
    ...
    public void netFirstUpdate(NetMsgInput netMsgInput) throws IOException {
        ...
        if ((this.aircraft instanceof TypeBomber)) {
            ((TypeBomber) this.aircraft).typeBomberReplicateFromNet(netMsgInput);
        }
        if ((this.aircraft instanceof TypeDockable)) {
            ((TypeDockable) this.aircraft).typeDockableReplicateFromNet(netMsgInput);
        }
...
//        }
        ...
        if (this.bWantBeaconsNet) {
            this.beacon = netMsgInput.readUnsignedByte();
        }
