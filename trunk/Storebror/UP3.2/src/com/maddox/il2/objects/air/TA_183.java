...
// private float kangle = 0.0F;
	...
	public void moveWheelSink() {
		...
		this.hierMesh().chunkSetAngles("GearL7_D0", 0.0F,
				Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.28F, 0.0F, -48.0F), 0.0F);
		this.hierMesh().chunkSetAngles("GearL8_D0", 0.0F,
				Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.28F, 0.0F, -96.0F), 0.0F);
		...
		this.hierMesh().chunkSetAngles("GearR7_D0", 0.0F,
				Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.28F, 0.0F, -48.0F), 0.0F);
		this.hierMesh().chunkSetAngles("GearR8_D0", 0.0F,
				Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.28F, 0.0F, -96.0F), 0.0F);
	...
	protected void hitBone(String var1, Shot var2, Point3d var3) {
		if (var1.startsWith("xx")) {
			if (var1.startsWith("xxarmor")) {
				...
				if (var1.endsWith("p1")) {
					this.getEnergyPastArmor(
							World.Rnd().nextFloat(12.0F, 19.0F) / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-5D),
							var2);
				} else if (var1.endsWith("p2")) {
					this.getEnergyPastArmor(
							World.Rnd().nextFloat(12.7F, 12.7F) / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-5D),
							var2);
				} else if (var1.endsWith("g1")) {
					this.getEnergyPastArmor(
							World.Rnd().nextFloat(20.0F, 60.0F) / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-5D),
							var2);
				...
				if (var1.startsWith("xxcontrols")) {
					...
					if (var1.endsWith("bloc")) {
						this.getEnergyPastArmor(
								World.Rnd().nextFloat(0.0F, 60.0F) / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-5D),
								var2);
					}

					if (var1.endsWith("cams") && (this.getEnergyPastArmor(0.45F, var2) > 0.0F)
							&& (World.Rnd().nextFloat() < (this.FM.EI.engines[0].getCylindersRatio() * 20.0F))) {
						this.FM.EI.engines[0].setCyliderKnockOut(var2.initiator,
								World.Rnd().nextInt(1, (int) (var2.power / 4800.0F)));
						this.debuggunnery(
								"Engine Module: Engine Cams Hit, " + this.FM.EI.engines[0].getCylindersOperable() + "/"
					...
					if (var1.startsWith("xxsparli") && (World.Rnd().nextFloat(0.0F, 0.115F) < var2.mass)
							&& (this.getEnergyPastArmor(6.8F * World.Rnd().nextFloat(1.0F, 1.5F), var2) > 0.0F)) {
					...
					if (var1.startsWith("xxsparri") && (World.Rnd().nextFloat(0.0F, 0.115F) < var2.mass)
							&& (this.getEnergyPastArmor(6.8F * World.Rnd().nextFloat(1.0F, 1.5F), var2) > 0.0F)) {
					...
					if (var1.startsWith("xxsparlm") && (World.Rnd().nextFloat(0.0F, 0.115F) < var2.mass)
							&& (this.getEnergyPastArmor(6.8F * World.Rnd().nextFloat(1.0F, 1.5F), var2) > 0.0F)) {
					...
					if (var1.startsWith("xxsparrm") && (World.Rnd().nextFloat(0.0F, 0.115F) < var2.mass)
							&& (this.getEnergyPastArmor(6.8F * World.Rnd().nextFloat(1.0F, 1.5F), var2) > 0.0F)) {
					...
					if (var1.startsWith("xxsparlo") && (World.Rnd().nextFloat(0.0F, 0.115F) < var2.mass)
							&& (this.getEnergyPastArmor(6.8F * World.Rnd().nextFloat(1.0F, 1.5F), var2) > 0.0F)) {
					...
					if (var1.startsWith("xxsparro") && (World.Rnd().nextFloat(0.0F, 0.115F) < var2.mass)
							&& (this.getEnergyPastArmor(6.8F * World.Rnd().nextFloat(1.0F, 1.5F), var2) > 0.0F)) {
					...
					if (var1.startsWith("xxspark") && (World.Rnd().nextFloat() < 0.5F)
							&& (this.getEnergyPastArmor(6.8F * World.Rnd().nextFloat(1.0F, 1.5F)
									/ (Math.abs(Aircraft.v1.x) + 9.999999747378752E-5D), var2) > 0.0F)) {
						Aircraft.debugprintln(this, "*** Keel Spars Damaged..");
						this.nextDMGLevels(1, 2, "Keel1_D" + this.chunkDamageVisible("Keel1"), var2.initiator);
					}

					if (var1.startsWith("xxspart") && (this.chunkDamageVisible("Tail1") > 2)
							&& (this.getEnergyPastArmor(
									3.86F / (float) Math
											.sqrt((Aircraft.v1.y * Aircraft.v1.y) + (Aircraft.v1.z * Aircraft.v1.z)),
									var2) > 0.0F)
			...
			if (var1.startsWith("xtail")) {
				...
				if (var1.endsWith("2") && (World.Rnd().nextFloat() < 0.1F)
						&& (this.getEnergyPastArmor(World.Rnd().nextFloat(1.2F, 3.435F), var2) > 0.0F)) {
	...
	public void rareAction(float var1, boolean var2) {
		...
		if ((!(this.FM instanceof RealFlightModel) || !((RealFlightModel) this.FM).isRealMode()) && var2
			...
			if ((var3.get_maneuver() == 63) && (var3.target != null)) {
				...
				if ((((var4.x > 4000.0D) && (var4.x < 5500.0D))
						|| ((var4.x > 100.0D) && (var4.x < 5000.0D) && (World.Rnd().nextFloat() < 0.33F)))
	 ...
	 * old code:
	 *
	 * public void typeFighterAceMakerAdjSideslipPlus() { --this.k14WingspanType;
	 * if(this.k14WingspanType < 0) { this.k14WingspanType = 0; }
	 *
	 * HUD.log(AircraftHotKeys.hudLogWeaponId, "AskaniaWing" +
	...
	static {
		...
		Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 9, 9, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
		...
		Aircraft.weaponHooksRegister(class1,
				new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalDev01", "_ExternalDev02",
						...
						"_ExternalRock21", "_ExternalRock22", "_ExternalRock23", "_ExternalRock24", "_ExternalRock25",
						"_ExternalRock25", "_ExternalRock26", "_ExternalRock26", "_ExternalRock27", "_ExternalRock27",
