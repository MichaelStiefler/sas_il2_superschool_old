...
public class CockpitHudsonMkI_Bombardier extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((Hudson_MkI)aircraft()).fSightCurForwardAngle;
            float f1 = ((Hudson_MkI)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((Hudson_MkI)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((Hudson_MkI)aircraft()).fSightCurReadyness > 0.93F;
