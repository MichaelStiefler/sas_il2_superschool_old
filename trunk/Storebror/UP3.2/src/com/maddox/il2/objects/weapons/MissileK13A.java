...
public class MissileK13A extends Missile {
	...
	static {
		...
		Property.set(class1, "engineDelayTime", -400L); // Rocket Engine Start Delay Time (in milliseconds), negative Value means that Engine is started before Missile leaves it's rail
