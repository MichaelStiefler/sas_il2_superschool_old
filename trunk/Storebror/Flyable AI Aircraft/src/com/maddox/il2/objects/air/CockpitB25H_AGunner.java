...
public class CockpitB25H_AGunner extends CockpitGunner {
	...
	static {
		Property.set(CockpitB25H_AGunner.class, "aiTuretNum", 2);
		Property.set(CockpitB25H_AGunner.class, "weaponControlNum", 12);
		Property.set(CockpitB25H_AGunner.class, "astatePilotIndx", 3);
	}
}
