...
public class CockpitTBM_BGunner extends CockpitGunner {
	...
	static {
		Property.set(CockpitTBM_BGunner.class, "aiTuretNum", 1);
		Property.set(CockpitTBM_BGunner.class, "weaponControlNum", 11);
		Property.set(CockpitTBM_BGunner.class, "astatePilotIndx", 2);
	}
}
