...
public class CockpitBLENHEIM1 extends CockpitPilot {
	...
	public void reflectWorldToInstruments(float f) {
		...
		super.mesh.chunkSetAngles("Z_Fuel1", 0.0F, 0.0F, cvt(((FlightModelMain) (super.fm)).M.fuel, 0.0F, 900F, 0.0F, 77F));
		super.mesh.chunkSetAngles("Z_Fuel2", 0.0F, 0.0F, cvt(((FlightModelMain) (super.fm)).M.fuel, 0.0F, 900F, 0.0F, 77F));
	...
	static {
		Property.set(CLASS.THIS(), "normZNs", new float[] { 0.75F, 0.75F, 0.75F, 0.75F });
	}
