...
public class CockpitB_24J100 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (fm != null) {
				...
				if (b24J100 != null)
					setNew.PDI = b24J100.fSightCurSideslip;
	...
	public CockpitB_24J100() {
		...
		cockpitNightMats = (new String[] { "texture01_dmg", "texture01", "texture02_dmg", "texture02", "texture03_dmg", "texture03", "texture04_dmg", "texture04", "texture05_dmg", "texture05", "texture06_dmg", "texture06", "texture21_dmg", "texture21",
				"texture25" });
		setNightMats(false);
		if (aircraft() instanceof B_24J100)
			b24J100 = (B_24J100) aircraft();
	...
	public void reflectWorldToInstruments(float f) {
		...
		mesh.chunkSetAngles("zOilFlap3", 0.0F, -35F * fm.EI.engines[2].getControlRadiator(), 0.0F);
		mesh.chunkSetAngles("zOilFlap4", 0.0F, -35F * fm.EI.engines[3].getControlRadiator(), 0.0F);
		...
		mesh.chunkSetAngles("zMix3", 0.0F, -45.8F * fm.EI.engines[2].getControlMix(), 0.0F);
		mesh.chunkSetAngles("zMix4", 0.0F, -45.8F * fm.EI.engines[3].getControlMix(), 0.0F);
		...
		mesh.chunkSetAngles("zPitch3", 0.0F, -54F * interp(setNew.prop3, setOld.prop3, f), 0.0F);
		mesh.chunkSetAngles("zPitch4", 0.0F, -54F * interp(setNew.prop4, setOld.prop4, f), 0.0F);
		...
		mesh.chunkSetAngles("zThrottle3", 0.0F, -49F * interp(setNew.throttle3, setOld.throttle3, f), 0.0F);
		mesh.chunkSetAngles("zThrottle4", 0.0F, -49F * interp(setNew.throttle4, setOld.throttle4, f), 0.0F);
		...
		mesh.chunkSetAngles("zCompressor3", 0.0F, cvt(fm.EI.engines[2].getControlCompressor(), 0.0F, 1.0F, 0.0F, -50F), 0.0F);
		mesh.chunkSetAngles("zCompressor4", 0.0F, cvt(fm.EI.engines[3].getControlCompressor(), 0.0F, 1.0F, 0.0F, -50F), 0.0F);
		if (fm.Gears.cgear) {
			resetYPRmodifier();
		...
		if ((fm.AS.astateCockpitState & 0x40) == 0) {
			...
			mesh.chunkSetAngles("zRPM3", 0.0F, cvt(fm.EI.engines[2].getRPM(), 0.0F, 4500F, 0.0F, 323F), 0.0F);
			mesh.chunkSetAngles("zRPM4", 0.0F, cvt(fm.EI.engines[3].getRPM(), 0.0F, 4500F, 0.0F, 323F), 0.0F);
			...
			mesh.chunkSetAngles("Z_Pres3", 0.0F, pictManf3 = 0.9F * pictManf3 + 0.1F * cvt(fm.EI.engines[2].getManifoldPressure(), 0.3386378F, 2.539784F, 0.0F, 346.5F), 0.0F);
			mesh.chunkSetAngles("Z_Pres4", 0.0F, pictManf4 = 0.9F * pictManf4 + 0.1F * cvt(fm.EI.engines[3].getManifoldPressure(), 0.3386378F, 2.539784F, 0.0F, 346.5F), 0.0F);
		}
		...
		mesh.chunkSetAngles("Z_FuelPres3", 0.0F, cvt(fm.M.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
		mesh.chunkSetAngles("Z_FuelPres4", 0.0F, cvt(fm.M.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
		...
		mesh.chunkSetAngles("Z_Oilpres1", 0.0F, cvt(1.0F + 0.05F * fm.EI.engines[0].tOilOut * fm.EI.engines[0].getReadyness(), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
		mesh.chunkSetAngles("Z_Oilpres2", 0.0F, cvt(1.0F + 0.05F * fm.EI.engines[1].tOilOut * fm.EI.engines[1].getReadyness(), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
		mesh.chunkSetAngles("Z_Oilpres3", 0.0F, cvt(1.0F + 0.05F * fm.EI.engines[2].tOilOut * fm.EI.engines[2].getReadyness(), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
		mesh.chunkSetAngles("Z_Oilpres4", 0.0F, cvt(1.0F + 0.05F * fm.EI.engines[3].tOilOut * fm.EI.engines[3].getReadyness(), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
		...
		mesh.chunkSetAngles("BL_Vert", cvt(setNew.ilsLoc, -9.1F, 9.1F, -26F, 26F), 0.0F, 0.0F);
	...
	static {
		Property.set(CLASS.THIS(), "normZNs", new float[] { 0.75F, 0.75F, 1.27F, 1.27F });
	}
