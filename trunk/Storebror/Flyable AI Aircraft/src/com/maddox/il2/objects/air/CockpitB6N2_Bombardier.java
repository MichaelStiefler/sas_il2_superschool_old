...
public class CockpitB6N2_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			if (bEntered) {
				float f = ((B6N2) aircraft()).fSightCurForwardAngle;
				float f1 = -((B6N2) aircraft()).fSightCurSideslip;
	...
	public CockpitB6N2_Bombardier() {
		super("3DO/Cockpit/Pe-2-Bombardier/BombardierB6N2.him", "he111");
		bEntered = false;
		try {
			Loc loc = new Loc();
	...
	public void reflectWorldToInstruments(float f) {
		mesh.chunkSetAngles("zMark1", ((B6N2) aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
		float f1 = cvt(((B6N2) aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
