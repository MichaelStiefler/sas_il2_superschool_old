...
// Source File Name:   CockpitWellington3_Bombardier.java
...
//            CockpitPilot, Wellington3

public class CockpitWellington_MkIII_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			float f = ((Wellington3) aircraft()).fSightCurForwardAngle;
			float f1 = ((Wellington3) aircraft()).fSightCurSideslip;
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (bEntered) {
			mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((Wellington3) aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((Wellington3) aircraft()).fSightCurReadyness > 0.93F;
