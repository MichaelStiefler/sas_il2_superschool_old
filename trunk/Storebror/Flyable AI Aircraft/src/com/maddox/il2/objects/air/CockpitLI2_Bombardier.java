...
public class CockpitLI2_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (bEntered) {
				float f = ((LI_2) aircraft()).fSightCurForwardAngle;
				float f1 = -((LI_2) aircraft()).fSightCurSideslip;
	...
	public void reflectWorldToInstruments(float f) {
		mesh.chunkSetAngles("zMark1", ((LI_2) aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
		float f1 = cvt(((LI_2) aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
