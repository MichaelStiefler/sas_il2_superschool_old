...
public class CockpitTU_2S_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			if (bEntered) {
				float f = ((TU_2S) aircraft()).fSightCurForwardAngle;
				float f1 = -((TU_2S) aircraft()).fSightCurSideslip;
	...
	public CockpitTU_2S_Bombardier() {
		super("3DO/Cockpit/Pe-2-Bombardier/BombardierTU2S.him", "he111");
		bEntered = false;
		try {
			Loc loc = new Loc();
	...
	public void reflectWorldToInstruments(float f) {
		mesh.chunkSetAngles("zMark1", ((TU_2S) aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
		float f1 = cvt(((TU_2S) aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
