...
public class CockpitDB3B_FGunner extends CockpitGunner {
	...
	public CockpitDB3B_FGunner() {
		super("3DO/Cockpit/Pe-8_NGUN/DB3B_hier.him", "i16");
		bNeedSetUp = true;
		hook1 = null;
	...
	static {
		Property.set(CockpitDB3B_FGunner.class, "aiTuretNum", 0);
		Property.set(CockpitDB3B_FGunner.class, "weaponControlNum", 10);
		Property.set(CockpitDB3B_FGunner.class, "astatePilotIndx", 1);
		Property.set(CockpitDB3B_FGunner.class, "normZN", 1.1F);
		Property.set(CockpitDB3B_FGunner.class, "gsZN", 1.1F);
	}
}
