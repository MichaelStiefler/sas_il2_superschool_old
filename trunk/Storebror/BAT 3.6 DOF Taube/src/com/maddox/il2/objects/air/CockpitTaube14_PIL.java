...
public class CockpitTaube14_PIL extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTaube14_PIL.this.fm != null) {
                if (CockpitTaube14_PIL.this.bNeedSetUp) {
                    CockpitTaube14_PIL.this.reflectPlaneMats();
                    CockpitTaube14_PIL.this.bNeedSetUp = false;
                }
                CockpitTaube14_PIL.this.setTmp = CockpitTaube14_PIL.this.setOld;
                CockpitTaube14_PIL.this.setOld = CockpitTaube14_PIL.this.setNew;
                CockpitTaube14_PIL.this.setNew = CockpitTaube14_PIL.this.setTmp;
                CockpitTaube14_PIL.this.setNew.throttle = ((10F * CockpitTaube14_PIL.this.setOld.throttle) + CockpitTaube14_PIL.this.fm.CT.PowerControl) / 11F;
                CockpitTaube14_PIL.this.setNew.prop = ((10F * CockpitTaube14_PIL.this.setOld.prop) + CockpitTaube14_PIL.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitTaube14_PIL.this.setNew.altimeter = CockpitTaube14_PIL.this.fm.getAltitude();
                if (Math.abs(CockpitTaube14_PIL.this.fm.Or.getKren()) < 30F) {
                    CockpitTaube14_PIL.this.setNew.azimuth = ((35F * CockpitTaube14_PIL.this.setOld.azimuth) + -CockpitTaube14_PIL.this.fm.Or.getYaw()) / 36F;
                }
                if ((CockpitTaube14_PIL.this.setOld.azimuth > 270F) && (CockpitTaube14_PIL.this.setNew.azimuth < 90F)) {
                    CockpitTaube14_PIL.this.setOld.azimuth -= 360F;
                }
                if ((CockpitTaube14_PIL.this.setOld.azimuth < 90F) && (CockpitTaube14_PIL.this.setNew.azimuth > 270F)) {
                    CockpitTaube14_PIL.this.setOld.azimuth += 360F;
                }
                CockpitTaube14_PIL.this.setNew.waypointAzimuth = ((10F * CockpitTaube14_PIL.this.setOld.waypointAzimuth) + (CockpitTaube14_PIL.this.waypointAzimuth() - CockpitTaube14_PIL.this.setOld.azimuth) + World.Rnd().nextFloat(-10F, 10F)) / 11F;
                CockpitTaube14_PIL.this.setNew.vspeed = ((199F * CockpitTaube14_PIL.this.setOld.vspeed) + CockpitTaube14_PIL.this.fm.getVertSpeed()) / 200F;
                boolean flag = false;
                if (CockpitTaube14_PIL.this.setNew.gCrankAngle < (CockpitTaube14_PIL.this.fm.CT.getGear() - 0.005F)) {
                    if (Math.abs(CockpitTaube14_PIL.this.setNew.gCrankAngle - CockpitTaube14_PIL.this.fm.CT.getGear()) < 0.33F) {
                        CockpitTaube14_PIL.this.setNew.gCrankAngle += 0.0025F;
                        flag = true;
                    } else {
                        CockpitTaube14_PIL.this.setNew.gCrankAngle = CockpitTaube14_PIL.this.fm.CT.getGear();
                        CockpitTaube14_PIL.this.setOld.gCrankAngle = CockpitTaube14_PIL.this.fm.CT.getGear();
                    }
                }
                if (CockpitTaube14_PIL.this.setNew.gCrankAngle > (CockpitTaube14_PIL.this.fm.CT.getGear() + 0.005F)) {
                    if (Math.abs(CockpitTaube14_PIL.this.setNew.gCrankAngle - CockpitTaube14_PIL.this.fm.CT.getGear()) < 0.33F) {
                ...
                if (flag != this.sfxPlaying) {
                    if (flag) {
                        CockpitTaube14_PIL.this.sfxStart(16);
                    } else {
                        CockpitTaube14_PIL.this.sfxStop(16);
                    }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zGas1a", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 190F, 0.0F, 14F), CockpitTaube14_PIL.fuelQuantityScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitTaube14_PIL.speedometerScale), 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x20) == 0)) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 13F), CockpitTaube14_PIL.engineRPMScale), 0.0F);
