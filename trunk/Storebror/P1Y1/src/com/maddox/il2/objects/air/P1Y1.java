...
//        this.FM.AS.setEngineState(this, 0, 2); // Just for Engine Smoke Debugging
//        this.FM.AS.setEngineState(this, 1, 3);
    }
    ...
    private static Aircraft._WeaponSlot[] GenerateDefaultConfig(int i) {
        ...
        try {
            a_lweaponslot[0] = new Aircraft._WeaponSlot(10, "MGunType99t", 240);
            a_lweaponslot[1] = new Aircraft._WeaponSlot(11, "MGunType99t", 240);
            for (int j = 3; j < i; j++) {
    ...
    static {
        ...
        try {
            ...
            a_lweaponslot[3] = new Aircraft._WeaponSlot(3, "BombGun250kgJ", 1);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);

            s = "2x500";
            a_lweaponslot = GenerateDefaultConfig(slotLength);
            a_lweaponslot[2] = new Aircraft._WeaponSlot(3, "BombGun500kgJ", 1);
            a_lweaponslot[3] = new Aircraft._WeaponSlot(3, "BombGun500kgJ", 1);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);

            s = "1x800";
            a_lweaponslot = GenerateDefaultConfig(slotLength);
            a_lweaponslot[4] = new Aircraft._WeaponSlot(3, "BombGun800kgJ", 1);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);

            s = "1xtyp91";
            a_lweaponslot = GenerateDefaultConfig(slotLength);
            a_lweaponslot[5] = new Aircraft._WeaponSlot(3, "BombGunTorpType91P1Y1", 1);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);

            s = "1xtyp91_late";
            a_lweaponslot = GenerateDefaultConfig(slotLength);
            a_lweaponslot[5] = new Aircraft._WeaponSlot(3, "BombGunTorpType91lateP1Y1", 1);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);

            s = "1xtyp91_late2";
            a_lweaponslot = GenerateDefaultConfig(slotLength);
            a_lweaponslot[5] = new Aircraft._WeaponSlot(3, "BombGunTorpType91late2P1Y1", 1);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);

            s = "none";
            a_lweaponslot = new Aircraft._WeaponSlot[slotLength];
            ...
            System.out.println("### ERROR ### at P1Y1 Weapon Slot creation, slotname = " + s );
        }
    }
}
