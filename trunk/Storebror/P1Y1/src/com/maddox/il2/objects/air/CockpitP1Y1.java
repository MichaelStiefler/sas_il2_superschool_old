...
public class CockpitP1Y1 extends CockpitPilot {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (P1Y.getGameVersion() >= 4.12F) {
            this.mesh.chunkVisible("X_LGearDown", (this.fm.CT.getGearL() == 1.0F) && this.fm.Gears.lgear);
            this.mesh.chunkVisible("X_RGearDown", (this.fm.CT.getGearR() == 1.0F) && this.fm.Gears.lgear);
            this.mesh.chunkVisible("X_LGearUp", this.fm.CT.getGearL() == 0.0F);
            this.mesh.chunkVisible("X_RGearUp", this.fm.CT.getGearR() == 0.0F);
            this.mesh.chunkVisible("X_TailGearDown", (this.fm.CT.getGearC() == 1.0F) && this.fm.Gears.cgear);
            this.mesh.chunkVisible("X_TailGearUp", this.fm.CT.getGearC() == 0.0F);
        } else {
