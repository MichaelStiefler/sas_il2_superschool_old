...
//    private static final String _VERSION                      = "4.10.1_(UP_EDITION)";
    private static final String   CORE_VERSION_NUMBER   = "4.60";
    private static final String   VERSION_NUMBER        = "3.4";
    private static final String   VERSION_NAME          = "Cassie";
    private static final String   CONNECT_VERSION       = "IL2_UP" + VERSION_NUMBER;
    private static final String[] CONNECT_VERSION2      = { "IL2_UP3.3", "IL2_UP3.2", "IL2_UP3_RC_MDS_v1.2_v2" };

    private static final String   MIN_PATCH_LEVEL       = "0";
    private static final String   MAX_PATCH_LEVEL       = "0";
    private static final String   PATCH_LEVEL           = "0";
    private static final String[] PATCHLEVEL_G          = { "0" };
    private static final String[] PATCHLEVEL_Y          = { "9" };
