...
// private float kangle = 0.0F;
            ...
            if (var1.startsWith("xxarmor")) {
                ...
                if (var1.startsWith("xxcontrols")) {
                    ...
                    if (var1.endsWith("bloc")) {
                        this.getEnergyPastArmor(World.Rnd().nextFloat(0.0F, 60.0F) / (Math.abs(Aircraft.v1.x) + 9.999999747378752E-5D), var2);
                    }
    ...
    static {
        ...
        Property.set(var0, "PaintScheme", (new PaintSchemeFMPar06()));
        ...
        Property.set(var0, "cockpitClass", new Class[] { CockpitTA_183.class });
