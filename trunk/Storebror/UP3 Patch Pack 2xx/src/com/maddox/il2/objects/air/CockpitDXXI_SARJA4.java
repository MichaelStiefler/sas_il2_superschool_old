...
public class CockpitDXXI_SARJA4 extends CockpitPilot
{
    private class Variables
    {
        ...
        private Variables()
        {
            ...
            cP = new Vector3d[4];
            compassPoint[0] = new Vector3d(0.0D, Math.sqrt(1.0D - CockpitDXXI_SARJA4.compassZ * CockpitDXXI_SARJA4.compassZ), CockpitDXXI_SARJA4.compassZ);
            compassPoint[1] = new Vector3d(-Math.sqrt(1.0D - CockpitDXXI_SARJA4.compassZ * CockpitDXXI_SARJA4.compassZ), 0.0D, CockpitDXXI_SARJA4.compassZ);
            compassPoint[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - CockpitDXXI_SARJA4.compassZ * CockpitDXXI_SARJA4.compassZ), CockpitDXXI_SARJA4.compassZ);
            compassPoint[3] = new Vector3d(Math.sqrt(1.0D - CockpitDXXI_SARJA4.compassZ * CockpitDXXI_SARJA4.compassZ), 0.0D, CockpitDXXI_SARJA4.compassZ);
            cP[0] = new Vector3d(0.0D, Math.sqrt(1.0D - CockpitDXXI_SARJA4.compassZ * CockpitDXXI_SARJA4.compassZ), CockpitDXXI_SARJA4.compassZ);
            cP[1] = new Vector3d(-Math.sqrt(1.0D - CockpitDXXI_SARJA4.compassZ * CockpitDXXI_SARJA4.compassZ), 0.0D, CockpitDXXI_SARJA4.compassZ);
            cP[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - CockpitDXXI_SARJA4.compassZ * CockpitDXXI_SARJA4.compassZ), CockpitDXXI_SARJA4.compassZ);
            cP[3] = new Vector3d(Math.sqrt(1.0D - CockpitDXXI_SARJA4.compassZ * CockpitDXXI_SARJA4.compassZ), 0.0D, CockpitDXXI_SARJA4.compassZ);
            // ---
        }
...
//                setNew.azimuth.setDeg(setOld.azimuth.getDeg(1.0F), fm.Or.azimut());
            if(useRealisticNavigationInstruments())
                setNew.azimuth.setDeg(setOld.azimuth.getDeg(1.0F), fm.Or.azimut() + ((DXXI)CockpitDXXI_SARJA4.this.aircraft()).gyroDelta);
            else
                setNew.azimuth.setDeg(setOld.azimuth.getDeg(1.0F), fm.Or.azimut());
            // ---
            ...
            if(setNew.dimPos > 0.0F)
                setNew.dimPos = setOld.dimPos - 0.03F;
            if((double)flaps > (double)fm.CT.FlapsControl - 0.05D && (double)flaps < (double)fm.CT.FlapsControl + 0.05D || fm.CT.bHasFlapsControlRed)
                flapsDirection = 0;
            else
