...
public class CanberraBIMk6 extends Canberra
    implements TypeStormovik
{
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitCanberraB62.class, CockpitCanberraBombardier.class, CockpitCanberraBombardier2.class
        });
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            ...
            "_ExternalRock18", "_ExternalRock19", "_ExternalRock20", "_ExternalDev10", "_ExternalDev11", "_ExternalRock23", "_ExternalRock24", "_ExternalRock25", "_ExternalRock26", "_ExternalRock27", 
