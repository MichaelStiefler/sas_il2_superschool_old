...
public class TRI_MD extends JB
    implements TypeBomber
{
    ...
    public void update(float f)
    {
        ...
        if(this.FM.CT.DragChuteControl > 0.0F && !bHasDeployedDragChute)
        {
            ...
            ((Actor) (chute)).pos.setRel(new Point3d(-17D, 0.0D, 0.69999999999999996D), new Orient(0.0F, 90F, 0.0F));
        ...
        if(this.FM.CT.getFlap() < this.FM.CT.FlapsControl)
            this.FM.CT.forceFlaps(flapsMovement(f, this.FM.CT.FlapsControl, this.FM.CT.getFlap(), 999F, Aircraft.cvt(this.FM.getSpeedKMH(), 0.0F, 500F, 0.5F, 0.08F)));
        else
            this.FM.CT.forceFlaps(flapsMovement(f, this.FM.CT.FlapsControl, this.FM.CT.getFlap(), 999F, Aircraft.cvt(this.FM.getSpeedKMH(), 0.0F, 500F, 0.5F, 0.7F)));
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            Cockpit3MD.class, Cockpit3MD_Bombardier.class
        });
