...
public class F7F_3 extends F7F
    implements TypeFighter, TypeBNZFighter, TypeStormovik
{
    ...
    public void onAircraftLoaded()
    {
        ...
        if(this.thisWeaponsName.indexOf("1x") == -1 && this.thisWeaponsName.indexOf("3x") == -1)
            hierMesh().chunkVisible("HardpointC_D0", false);
        if(this.thisWeaponsName.indexOf("2x") == -1 && this.thisWeaponsName.indexOf("3x") == -1)
        {
            hierMesh().chunkVisible("HardpointR_D0", false);
            hierMesh().chunkVisible("HardpointL_D0", false);
        }
    }
    ...
    {
        hierMesh().chunkSetAngles("Hook1_D0", 0.0F, 55F * f, 0.0F);
    }
    ...
    static 
    {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04", "_ExternalDev01", "_ExternalDev02", 
