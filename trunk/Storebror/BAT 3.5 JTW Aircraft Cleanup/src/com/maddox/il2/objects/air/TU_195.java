...
public class TU_195 extends TU_95X
    implements TypeBomber, TypeGuidedMissileCarrier, TypeX4Carrier, TypeFastJet, TypeFuelDump, TypeSupersonic, TypeDockable
{
    ...
    public TU_195()
    {
        ...
        deltaAzimuth = 0.0F;
        deltaTangage = 0.0F;
        fxSPO2 = newSound("aircraft.Sirena2", false);
        smplSPO2 = new Sample("sample.Sirena2.wav", 256, 65535);
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitTU195.class, CockpitTU195_Bombardier.class, CockpitTU195_RGunner.class, CockpitTU195_AGunner.class
        });
