...
public class Short_Sunderland extends Sunderlandxyz
    implements TypeSailPlane, TypeSeaPlane, TypeTransport, TypeBomber
{
    ...
    private static Aircraft._WeaponSlot[] createDefaultWeaponSlot(byte byte0)
    {
        ...
        {
            for(int i = 0; i < 4; i++)
                a_lweaponslot[i] = new Aircraft._WeaponSlot(ai[i], "MGunVikkersKt", 500);

            for(int j = 4; j < 7; j++)
                a_lweaponslot[j] = new Aircraft._WeaponSlot(ai[j], "MGunVikkersKt", 1000);
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitSunderland.class, CockpitSunderlandBombardier.class, CockpitSunderlandNGunner.class, CockpitSunderlandTGunner.class, CockpitSunderlandAGunner.class
        });
