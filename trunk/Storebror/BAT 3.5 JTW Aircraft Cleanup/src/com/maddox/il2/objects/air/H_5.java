...
public class H_5 extends Scheme1
    implements TypeScout, TypeTransport
{
    ...
    public void onAircraftLoaded()
    {
        ...
        {
            hierMesh().chunkVisible("Grua_D0", true);
            return;
        } else
        {
            return;
    ...
    public void doMurderPilot(int i)
    {
        ...
        case 0:
            ...
            hierMesh().chunkVisible("HMask1_D0", false);
            hierMesh().chunkVisible("Casco1_D0", false);
            break;
        ...
        case 1:
            ...
            hierMesh().chunkVisible("HMask2_D0", false);
            hierMesh().chunkVisible("Casco2_D0", false);
            break;
        }
    }
    ...
    {
        float f = Aircraft.cvt(FM.getSpeedKMH(), 90F, 190F, 1718F, 3500F);
    ...
    static 
    {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            "_BombSpawn01", "_BombSpawn02", "_MGUN01", "_MGUN02", "_ExternalDev01", "_ExternalDev02", "_ExternalDev03", "_ExternalRock01", "_ExternalRock02", "_ExternalDev04", 
            "_ExternalRock03", "_ExternalRock04", "_BombSpawn03", "_BombSpawn04"
        });
    }
}
