...
public class CH_47 extends Scheme2
    implements TypeTransport
{
    ...
    public void computeVerticalThrust()
    {
        ...
        float f3 = Aircraft.cvt(FM.getAltitude(), 0.0F, 5500F, 1.0F, 0.5F);
        float f4 = 0.0F;
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 < 15F)
            f4 = 1.68F * f;
        else
        if(FM.EI.engines[0].getStage() > 5 && FM.EI.getPowerOutput() > 0.2F && flag && f1 > 15F)
            f4 = 1.23F * f;
    ...
    public void computeOrizzontalThrust()
    {
        ...
        if(FM.EI.engines[0].getStage() > 5 && f1 > 2.0F && flag)
            f3 = 0.14F * f;
    ...
    public void computeHovering()
    {
        ...
        float f2 = Aircraft.cvt(f1, 0.0F, 100F, 1.0F, 0.0F);
        float f3 = 0.0F;
        if(FM.EI.engines[0].getStage() > 5 && !flag && f1 < 50F && FM.getSpeedKMH() > 6F && FM.CT.StabilizerControl)
            f3 = 0.3F * f;
        FM.producedAF.x -= f3 * (10F * FM.M.mass) * (1.0F * f2);
    }
    ...
    static 
    {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            "_BombSpawn01", "_BombSpawn02", "_MGUN01", "_MGUN02", "_ExternalDev01", "_ExternalDev02", "_ExternalDev03", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", 
            "_ExternalBomb04"
        });
    }
}
