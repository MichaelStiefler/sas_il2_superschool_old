...
public class F_4D extends F_4fuelReceiver
    implements TypeX4Carrier, TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump, TypeFastJet
{
    ...
    private boolean InertialNavigation()
    {
        ...
        Vector3d vector3d = new Vector3d();
        Aircraft aircraft = World.getPlayerAircraft();
        if(aircraft.getSpeed(vector3d) > 20D && ((Actor) (aircraft)).pos.getAbsPoint().z >= 150D && (aircraft instanceof F_4D))
        {
            pos.getAbs(point3d);
            if(Mission.cur() != null)
            {
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitF_4E.class, CockpitF_4Laser.class, CockpitF_4_Bombardier.class
        });
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            ...
            "_ExternalDev46", "_ExternalDev47", "_ExternalRock54", "_ExternalRock55", "_ExternalRock56", "_ExternalDev48", "_ExternalBomb38", "_ExternalBomb39", "_ExternalBomb40"
        });
    }
}
