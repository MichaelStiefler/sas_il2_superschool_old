...
public class MIG_21MFN extends MIG_21
    implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeLaserSpotter
{

    private void hellaLights()
    {
        if(lastTickWhenIDidThis == Time.tickCounter())
            return;
        lastTickWhenIDidThis = Time.tickCounter();
        if(this.FM.AS.bNavLightsOn)
        {
            ...
            if(hellaTimer == 0)
            {
                Eff3DActor eff3dactor = Eff3DActor.New(this, findHook("_Hella1"), new Loc(), 1.0F, "3DO/Effects/Fireworks/FlareRed.eff", 0.2F);
            ...
            if(hellaTimer == 30)
            {
                Eff3DActor eff3dactor1 = Eff3DActor.New(this, findHook("_Hella2"), new Loc(), 1.0F, "3DO/Effects/Fireworks/FlareRed.eff", 0.2F);
                ...
                ((Actor) (eff3dactor1)).draw.lightMap().put("light", lightpointactor1);
