...
public class F_104ASA extends F_104
    implements TypeGuidedMissileCarrier, TypeThreatDetector, TypeGSuit, TypeAcePlane
{
    ...
    private boolean InertialNavigation()
    {
        ...
        Vector3d vector3d = new Vector3d();
        Aircraft aircraft = World.getPlayerAircraft();
        if(aircraft.getSpeed(vector3d) > 20D && ((Actor) (aircraft)).pos.getAbsPoint().z >= 150D && (aircraft instanceof F_104ASA))
        {
            pos.getAbs(point3d);
            if(Mission.cur() != null)
            {
    ...
    static 
    {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            ...
            "_ExternalRock17", "_ExternalRock18", "_ExternalRock19", "_ExternalRock20", "_Dev13", "_ExternalDev14"
        });
    }
}
