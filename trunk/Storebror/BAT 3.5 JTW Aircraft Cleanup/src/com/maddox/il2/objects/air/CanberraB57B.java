...
public class CanberraB57B extends Canberra
    implements TypeStormovik
{
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitCanberraB57.class, CockpitCanberraBombardier2.class
        });
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            ...
            "_ExternalRock18", "_ExternalRock19", "_ExternalRock20", "_ExternalDev10", "_ExternalDev11", "_ExternalBomb05", "_ExternalBomb06", "_ExternalBomb07", "_ExternalBomb08", "_ExternalRock27", 
