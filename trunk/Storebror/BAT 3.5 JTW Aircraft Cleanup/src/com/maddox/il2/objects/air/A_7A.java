...
public class A_7A extends A_7fuelReceiver
    implements TypeCountermeasure, TypeThreatDetector, TypeFastJet
{
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitA_7.class, CockpitA_7Bombardier.class
        });
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            ...
            "_Pylon3", "_Pylon4", "_ExternalPylon5", "_ExternalPylon6", "_Pylon7", "_Pylon8", "_ExternalBomb25", "_ExternalBomb26", "_Bomb27", "_Bomb28", 
            "_ExternalBomb29", "_ExternalBomb30", "_Bomb31", "_Bomb32", "_ExternalBomb33", "_ExternalBomb34", "_Bomb35", "_Bomb36", "_ExternalBomb37", "_ExternalBomb38", 
            "_Bomb39", "_Bomb40", "_ExternalBomb41", "_ExternalBomb42", "_Bomb43", "_Bomb44", "_ExternalBomb45", "_ExternalBomb46", "_Bomb47", "_Bomb48"
        });
    }
}
