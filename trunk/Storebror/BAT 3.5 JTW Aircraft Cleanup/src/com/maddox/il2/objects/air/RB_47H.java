...
public class RB_47H extends B_47fuelReceiver
{
    ...
    private boolean InertialNavigation()
    {
        ...
        Vector3d vector3d = new Vector3d();
        Aircraft aircraft = World.getPlayerAircraft();
        if(aircraft.getSpeed(vector3d) > 20D && ((Actor) (aircraft)).pos.getAbsPoint().z >= 150D && (aircraft instanceof RB_47H))
        {
            pos.getAbs(point3d);
            if(Mission.cur() != null)
            {
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitB_47.class, CockpitB_47Bombardier.class, CockpitB_47Gunner.class
        });
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            ...
            "_BombSpawn49", "_BombSpawn50", "_BombSpawn51", "_BombSpawn52", "_BombSpawn53", "_BombSpawn54", "_BombSpawn55", "_BombSpawn56", "_BombSpawn57"
        });
    }
}
