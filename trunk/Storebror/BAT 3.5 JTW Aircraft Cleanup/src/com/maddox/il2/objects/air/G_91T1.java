...
public class G_91T1 extends G_91
    implements TypeFastJet
{
    ...
    {
        hierMesh().chunkSetAngles("Blister1_D0", 0.0F, 0.0F, 60F * f);
        hierMesh().chunkSetAngles("Blister2_D0", 0.0F, 0.0F, 60F * f);
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitG_91T.class, CockpitT_33i.class
        });
