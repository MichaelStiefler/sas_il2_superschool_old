...
public class PBM_5 extends PBM
{
    ...
    private static Aircraft._WeaponSlot[] GenerateDefaultConfig(int i)
    {
        ...
        try
        {
            ...
            a_lweaponslot[2] = new Aircraft._WeaponSlot(11, "MGunBrowning50t", 700);
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitMariner.class, CockpitMariner_Bombardier.class, Cockpit_Mariner_Radar.class, CockpitMariner_TGunner.class, CockpitMariner_AGunner.class
        });
        Property.set(class1, "LOSElevation", 1.4078F);
        Aircraft.weaponTriggersRegister(class1, new int[] {
            10, 10, 11, 11, 12, 12, 3, 3, 3, 3, 
            3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 
            3, 9, 9, 2, 2, 2, 2, 2, 2, 2, 
            2, 2, 2, 2, 2
        });
        Aircraft.weaponHooksRegister(class1, new String[] {
            ...
            "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_BombSpawn09", "_BombSpawn10", "_BombSpawn11", "_BombSpawn12", "_BombSpawn13", "_BombSpawn14", 
            "_BombSpawn15", "_ExternalDev01", "_ExternalDev02", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05", "_ExternalBomb06", "_ExternalBomb07", 
            "_ExternalBomb08", "_ExternalBomb09", "_ExternalBomb10", "_ExternalBomb11", "_ExternalBomb12"
        });
    }
}
