...
public class MS_502A extends Scheme1
    implements TypeScout, TypeTransport
{
    ...
    static 
    {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04", "_CANNON05", "_CANNON06", "_CANNON07", "_CANNON08", "_CANNON09", "_CANNON010", 
            "_CANNON011", "_CANNON012"
        });
    }
}
