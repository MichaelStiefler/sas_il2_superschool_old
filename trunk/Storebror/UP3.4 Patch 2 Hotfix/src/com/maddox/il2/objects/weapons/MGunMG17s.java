...
public class MGunMG17s extends MGunAircraftGeneric
{
    public GunProperties createProperties()
    {
        ...
        gunproperties.shotFreq = 16.666F;
        ...
        gunproperties.bullet[2].massa = 0.0115F;
        gunproperties.bullet[2].kalibr = 2.900001E-005F;
        gunproperties.bullet[2].speed = 865F;
        ...
        gunproperties.bullet[3].massa = 0.0115F;
        gunproperties.bullet[3].kalibr = 2.900001E-005F;
        gunproperties.bullet[3].speed = 865F;
        ...
        gunproperties.bullet[4].speed = 865F;
        ...
        gunproperties.bullet[5].massa = 0.0097F;
        gunproperties.bullet[5].kalibr = 2.900001E-005F;
        gunproperties.bullet[5].speed = 900F;
        gunproperties.bullet[5].power = 0.0002F;
        ...
        gunproperties.bullet[6].speed = 895F;
        ...
        gunproperties.bullet[7].massa = 0.0097F;
        gunproperties.bullet[7].kalibr = 2.900001E-005F;
        gunproperties.bullet[7].speed = 900F;
        gunproperties.bullet[7].power = 0.0002F;
        ...
        gunproperties.bullet[8].massa = 0.0101F;
        gunproperties.bullet[8].kalibr = 2.900001E-005F;
        gunproperties.bullet[8].speed = 895F;
        gunproperties.bullet[8].power = 0.0005F;
        ...
        gunproperties.bullet[8].traceColor = 0;
        gunproperties.bullet[8].timeLife = 2.0F;
        gunproperties.bullet[9].massa = 0.0108F;
        gunproperties.bullet[9].kalibr = 2.900001E-005F;
        gunproperties.bullet[9].speed = 855F;
        gunproperties.bullet[9].power = 0.000375F;
        gunproperties.bullet[9].powerType = 0;
        gunproperties.bullet[9].powerRadius = 0.01F;
        ...
        gunproperties.bullet[9].timeLife = 3F;
