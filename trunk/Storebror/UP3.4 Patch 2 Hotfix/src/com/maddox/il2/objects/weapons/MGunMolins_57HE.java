...
public class MGunMolins_57HE extends MGunAircraftGeneric
{
    public GunProperties createProperties()
    {
        ...
        gunproperties.bullet[0].massa = 3F;
        gunproperties.bullet[0].kalibr = 0.00201155F;
        gunproperties.bullet[0].speed = 820F;
        gunproperties.bullet[0].power = 0.21F;
