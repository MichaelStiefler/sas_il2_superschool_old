...
public class CockpitBLENHEIM1 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        this.mesh.chunkSetAngles("Z_Fuel1", 0.0F, 0.0F, cvt(this.fm.M.fuel, 0.0F, 900F, 0.0F, 77F));
        this.mesh.chunkSetAngles("Z_Fuel2", 0.0F, 0.0F, cvt(this.fm.M.fuel, 0.0F, 900F, 0.0F, 77F));
        if((this.fm.AS.astateCockpitState & 0x40) == 0)
    ...
    static 
    {
        Property.set(CockpitBLENHEIM1.class, "normZNs", new float[] {
