...
public class MGunSh37s extends MGunAircraftGeneric
{
    public GunProperties createProperties()
    {
        ...
        gunproperties.sound = "weapon.MGunSh37s";
        ...
        gunproperties.bullet[0].massa = 0.76F;
        ...
        gunproperties.bullet[1].power = 0.048F;
        ...
        gunproperties.bullet[1].traceColor = 0xd494c476;
