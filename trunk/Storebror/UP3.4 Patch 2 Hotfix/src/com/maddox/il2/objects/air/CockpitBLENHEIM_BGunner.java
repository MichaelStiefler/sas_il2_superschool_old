...
public class CockpitBLENHEIM_BGunner extends CockpitGunner {
    ...
    protected boolean doFocusEnter()
    {
        if(super.doFocusEnter())
        {
            ...
            aircraft().hierMesh().chunkVisible("TurretBase3A_D0", false);
            aircraft().hierMesh().chunkVisible("Turret3A_D0", false);
            aircraft().hierMesh().chunkVisible("Blister3A_D0", false);
            return true;
        } else
        {
            return false;
    ...
    protected void doFocusLeave()
    {
        ...
        aircraft().hierMesh().chunkVisible("TurretBase3A_D0", true);
        aircraft().hierMesh().chunkVisible("Turret3A_D0", true);
        aircraft().hierMesh().chunkVisible("Blister3A_D0", true);
        super.doFocusLeave();
    }
