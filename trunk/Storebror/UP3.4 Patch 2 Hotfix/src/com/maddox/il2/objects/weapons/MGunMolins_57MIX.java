...
public class MGunMolins_57MIX extends MGunAircraftGeneric
{
    public GunProperties createProperties()
    {
        ...
        gunproperties.sound = "weapon.MGunMolins57s";
        ...
        gunproperties.bullet[1].massa = 3F;
        gunproperties.bullet[1].kalibr = 0.00201155F;
        gunproperties.bullet[1].speed = 820F;
        gunproperties.bullet[1].power = 0.21F;
        gunproperties.bullet[1].powerType = 0;
        gunproperties.bullet[1].powerRadius = 4.5F;
        ...
        gunproperties.bullet[1].timeLife = 10F;
