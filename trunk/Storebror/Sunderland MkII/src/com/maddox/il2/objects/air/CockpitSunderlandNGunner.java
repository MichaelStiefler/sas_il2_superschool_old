...
public class CockpitSunderlandNGunner extends CockpitGunner {
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
             ...
             * hide the gunner and hide the plane's fuselage,
    ...
    protected void doFocusLeave() {
        if (!this.isFocused()) {
             ...
             * show gunner if alive and show the fuselage in it's appropriate damage state again!
             */
