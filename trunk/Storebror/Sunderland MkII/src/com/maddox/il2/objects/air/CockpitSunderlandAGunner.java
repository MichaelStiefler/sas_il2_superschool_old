...
public class CockpitSunderlandAGunner extends CockpitGunner {
    ...
    protected void interpTick() {
        ...
        if (this.bGunFire) {
            ...
            if (this.hook3 == null)
                this.hook3 = new HookNamed(this.aircraft(), "_MGUN06");
            this.doHitMasterAircraft(this.aircraft(), this.hook3, "_MGUN06");
            if (this.hook4 == null)
                this.hook4 = new HookNamed(this.aircraft(), "_MGUN07");
    ...
    public void moveGun(Orient orient) {
        ...
        /*
         * Add rotation offset when turret is elevated and elevation offset when turret is rotated.
         * These are just estimated values, they're necessary because plane's gun hooks are not aligned orthogonally
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
             ...
             * hide the gunner and hide the plane's tail,
