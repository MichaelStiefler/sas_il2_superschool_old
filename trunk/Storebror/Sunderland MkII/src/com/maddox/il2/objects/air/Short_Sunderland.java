...
public class Short_Sunderland extends Sunderlandxyz implements TypeSeaPlane, TypeTransport, TypeBomber {
    ...
    public void rareAction(float f, boolean flag) {
        ...
        if (this.FM.getAltitude() < 3000F) { // Toggle Oxygen Mask
            for (int i = 1; i < 7; i++)
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F)
            this.fSightCurReadyness += 0.1F / 3F * f;
    ...
    // Helper function to create the default Weapon Slot layout, saves a lot of lines in the static initializer
    private static Aircraft._WeaponSlot[] createDefaultWeaponSlot(byte slotLength) {
    ...
    static {
        ...
        try {
            ...
            s = "default";
            Aircraft._WeaponSlot a_lweaponslot[] = createDefaultWeaponSlot(slotLength);
            arraylist.add(s);
            ...
            for (int i = 11; i < 19; i++)
                a_lweaponslot[i] = new Aircraft._WeaponSlot(3, "BombGun250lbsE", 1);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            ...
            a_lweaponslot = createDefaultWeaponSlot(slotLength);
            for (int i = 19; i < 23; i++)
                a_lweaponslot[i] = new Aircraft._WeaponSlot(3, "BombGun500lbsE", 1);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
        } catch (Exception e) { // Never catch errors without showing them!
            System.out.println("Error Creating Sunderland MkII Weapon Slot " + s);
            e.printStackTrace();
        }
    }
}
