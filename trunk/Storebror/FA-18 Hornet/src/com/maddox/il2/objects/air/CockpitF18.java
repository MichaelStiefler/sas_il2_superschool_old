...
public class CockpitF18 extends CockpitPilot {
...
//		aircraft().hierMesh().chunkVisible("Capglass2", true);
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			float f = ((F_18) aircraft()).k14Distance;
			setNew.k14w = (5F * CockpitF18.k14TargetWingspanScale[((F_18) aircraft()).k14WingspanType]) / f;
			setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
			setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitF18.k14TargetMarkScale[((F_18) aircraft()).k14WingspanType];
			...
			float f3 = floatindex((f - 200F) * 0.04F, CockpitF18.k14BulletDrop) - CockpitF18.k14BulletDrop[0];
...
//			AircraftLH.printCompassHeading = true;
			try {
		        Field field = AircraftLH.class.getDeclaredField("printCompassHeading");
	...
	protected void moveGauge(float f) {
		...
		super.mesh.chunkSetAngles("GaugeMove_RPM_R", floatindex(cvt(fm.EI.engines[1].getRPM(), 0.0F, 3828F, 0.0F, 300F) / 100F, rpmScale), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("GaugeMove_TGT_L", cvt(fm.EI.engines[0].tOilOut, 0.0F, 100F, 0.0F, 200F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("GaugeMove_TGT_R", cvt(fm.EI.engines[1].tOilOut, 0.0F, 100F, 0.0F, 200F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("GaugeMove_FF_L", cvt(fm.EI.engines[0].getRPM(), 0.0F, 3828F, 0.0F, 330F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("GaugeMove_FF_R", cvt(fm.EI.engines[1].getRPM(), 0.0F, 3828F, 0.0F, 330F), 0.0F, 0.0F);
