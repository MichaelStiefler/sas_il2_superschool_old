...
//    implements TypeTurretK4Sight
{
		...
		public boolean tick() {
			if (CockpitHE_177A3_TGunner.this.fm != null) {
				...
				if (CockpitHE_177A3_TGunner.this.useRealisticNavigationInstruments()) {
					...
					CockpitHE_177A3_TGunner.this.setNew.radioCompassAzimuth.setDeg(
							CockpitHE_177A3_TGunner.this.setOld.radioCompassAzimuth.getDeg(0.02F),
							CockpitHE_177A3_TGunner.this.radioCompassAzimuthInvertMinus()
									- CockpitHE_177A3_TGunner.this.setOld.azimuth.getDeg(1.0F) - 90F);
				} else {
					CockpitHE_177A3_TGunner.this.setNew.waypointAzimuth.setDeg(
							CockpitHE_177A3_TGunner.this.setOld.waypointAzimuth.getDeg(0.1F),
							f - CockpitHE_177A3_TGunner.this.setOld.azimuth.getDeg(1.0F));
				}
				CockpitHE_177A3_TGunner.this.setNew.azimuth.setDeg(
						CockpitHE_177A3_TGunner.this.setOld.azimuth.getDeg(1.0F),
						CockpitHE_177A3_TGunner.this.fm.Or.azimut());
				CockpitHE_177A3_TGunner.this.setNew.throttle1 = 0.85F * CockpitHE_177A3_TGunner.this.setOld.throttle1
						+ CockpitHE_177A3_TGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
				CockpitHE_177A3_TGunner.this.setNew.throttle2 = 0.85F * CockpitHE_177A3_TGunner.this.setOld.throttle2
						+ CockpitHE_177A3_TGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
				CockpitHE_177A3_TGunner.this.setNew.pictAiler = 0.85F * CockpitHE_177A3_TGunner.this.setOld.pictAiler
						+ 0.15F * CockpitHE_177A3_TGunner.this.cvt(CockpitHE_177A3_TGunner.this.fm.CT.AileronControl,
								-1F, 1.0F, -1F, 1.0F);
				CockpitHE_177A3_TGunner.this.setNew.pictElev = 0.85F * CockpitHE_177A3_TGunner.this.setOld.pictElev
						+ 0.15F * CockpitHE_177A3_TGunner.this.cvt(CockpitHE_177A3_TGunner.this.fm.CT.ElevatorControl,
								-1F, 1.0F, -1F, 1.0F);
				CockpitHE_177A3_TGunner.this.setNew.ailTrim = 0.85F * CockpitHE_177A3_TGunner.this.setOld.ailTrim
						+ 0.15F * CockpitHE_177A3_TGunner.this.fm.CT.trimAileron;
				if (Math.toDegrees(CockpitHE_177A3_TGunner.this.fm.EI.engines[0].getPropPhi()) < 36D) {
					CockpitHE_177A3_TGunner.this.setNew.prop1 = 0.85F * CockpitHE_177A3_TGunner.this.setOld.prop1
							+ ((FlightModelMain) CockpitHE_177A3_TGunner.this.fm).EI.engines[0].getControlProp()
									* 0.15F;
					CockpitHE_177A3_TGunner.this.setNew._prop1 = CockpitHE_177A3_TGunner.this
							.cvt(CockpitHE_177A3_TGunner.this.setNew.prop1, 0.0F, 1.0F, -22F, -63F);
				} else {
					CockpitHE_177A3_TGunner.this.setNew.prop1 = 0.85F * CockpitHE_177A3_TGunner.this.setOld.prop1;
					CockpitHE_177A3_TGunner.this.setNew._prop1 = CockpitHE_177A3_TGunner.this
							.cvt(CockpitHE_177A3_TGunner.this.setNew.prop1, 0.0F, 1.0F, 0.0F, -63F);
				}
				if (Math.toDegrees(CockpitHE_177A3_TGunner.this.fm.EI.engines[1].getPropPhi()) < 36D) {
					CockpitHE_177A3_TGunner.this.setNew.prop2 = 0.85F * CockpitHE_177A3_TGunner.this.setOld.prop2
							+ ((FlightModelMain) CockpitHE_177A3_TGunner.this.fm).EI.engines[1].getControlProp()
									* 0.15F;
					CockpitHE_177A3_TGunner.this.setNew._prop2 = CockpitHE_177A3_TGunner.this
							.cvt(CockpitHE_177A3_TGunner.this.setNew.prop2, 0.0F, 1.0F, -22F, -63F);
				} else {
					CockpitHE_177A3_TGunner.this.setNew.prop2 = 0.85F * CockpitHE_177A3_TGunner.this.setOld.prop2;
					CockpitHE_177A3_TGunner.this.setNew._prop2 = CockpitHE_177A3_TGunner.this
							.cvt(CockpitHE_177A3_TGunner.this.setNew.prop2, 0.0F, 1.0F, 0.0F, -63F);
				}
				...
				CockpitHE_177A3_TGunner.this.setNew.turn = (12F * CockpitHE_177A3_TGunner.this.setOld.turn
						+ CockpitHE_177A3_TGunner.this.w.z) / 13F;
				CockpitHE_177A3_TGunner.this.setNew.altimeter = 0.85F * CockpitHE_177A3_TGunner.this.setOld.altimeter
						+ CockpitHE_177A3_TGunner.this.fm.getAltitude() * 0.15F;
				CockpitHE_177A3_TGunner.this.setNew.vspeed = (99F * CockpitHE_177A3_TGunner.this.setOld.vspeed
						+ CockpitHE_177A3_TGunner.this.fm.getVertSpeed()) / 100F;
				...
				if (f1 > 55F || f1 < -55F || f2 < -55F || f2 > 55F) {
					CockpitHE_177A3_TGunner.this.Pn.z = 250D;
				} else {
					CockpitHE_177A3_TGunner.this.Pn.set(CockpitHE_177A3_TGunner.this.fm.Loc);
					CockpitHE_177A3_TGunner.this.Pn.z = CockpitHE_177A3_TGunner.this.fm.getAltitude()
							- Engine.cur.land.HQ(((Tuple3d) CockpitHE_177A3_TGunner.this.Pn).x,
									((Tuple3d) CockpitHE_177A3_TGunner.this.Pn).y);
					...
					CockpitHE_177A3_TGunner.this.Pn.z = (float) Math.sqrt(
							d * d + d1 * d1 + CockpitHE_177A3_TGunner.this.Pn.z * CockpitHE_177A3_TGunner.this.Pn.z);
					if (CockpitHE_177A3_TGunner.this.fm.CT.getGear() > 0.5F) {
						CockpitHE_177A3_TGunner.this.Pn.z = CockpitHE_177A3_TGunner.this
								.cvt((float) CockpitHE_177A3_TGunner.this.Pn.z, 0.0F, 150F, 0.0F, 250F);
					} else {
						CockpitHE_177A3_TGunner.this.Pn.z = CockpitHE_177A3_TGunner.this
								.cvt((float) CockpitHE_177A3_TGunner.this.Pn.z, 0.0F, 750F, 0.0F, 250F);
					}
				}
				CockpitHE_177A3_TGunner.this.setNew.AFN101 = 0.9F * CockpitHE_177A3_TGunner.this.setOld.AFN101
						+ 0.1F * (float) CockpitHE_177A3_TGunner.this.Pn.z;
				CockpitHE_177A3_TGunner.this.setNew.beaconDirection = (10F
						* CockpitHE_177A3_TGunner.this.setOld.beaconDirection
						+ CockpitHE_177A3_TGunner.this.getBeaconDirection()) / 11F;
				CockpitHE_177A3_TGunner.this.setNew.beaconRange = (10F * CockpitHE_177A3_TGunner.this.setOld.beaconRange
						+ CockpitHE_177A3_TGunner.this.getBeaconRange()) / 11F;
				CockpitHE_177A3_TGunner.this.setNew.pictManf1 = 0.9F * CockpitHE_177A3_TGunner.this.setOld.pictManf1
						+ 0.1F * CockpitHE_177A3_TGunner.this.cvt(
								CockpitHE_177A3_TGunner.this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_TGunner.this.setNew.pictManf2 = 0.8F * CockpitHE_177A3_TGunner.this.setOld.pictManf2
						+ 0.2F * CockpitHE_177A3_TGunner.this.cvt(
								CockpitHE_177A3_TGunner.this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_TGunner.this.setNew.pictManf3 = 0.9F * CockpitHE_177A3_TGunner.this.setOld.pictManf3
						+ 0.1F * CockpitHE_177A3_TGunner.this.cvt(
								CockpitHE_177A3_TGunner.this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_TGunner.this.setNew.pictManf4 = 0.8F * CockpitHE_177A3_TGunner.this.setOld.pictManf4
						+ 0.2F * CockpitHE_177A3_TGunner.this.cvt(
								CockpitHE_177A3_TGunner.this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				...
				CockpitHE_177A3_TGunner.this.setNew.consumptionL = 0.9F
						* CockpitHE_177A3_TGunner.this.setOld.consumptionL + 0.1F * (f6 * f4) / (f4 + f5 + 1.0F);
				CockpitHE_177A3_TGunner.this.setNew.consumptionR = 0.9F
						* CockpitHE_177A3_TGunner.this.setOld.consumptionR + 0.1F * (f6 * f5) / (f4 + f5 + 1.0F);
				if (CockpitHE_177A3_TGunner.this.cockpitDimControl) {
					if (CockpitHE_177A3_TGunner.this.setNew.dimPosition > 0.0F) {
						CockpitHE_177A3_TGunner.this.setNew.dimPosition = CockpitHE_177A3_TGunner.this.setOld.dimPosition
								- 0.05F;
					}
				} else if (CockpitHE_177A3_TGunner.this.setNew.dimPosition < 1.0F) {
					CockpitHE_177A3_TGunner.this.setNew.dimPosition = CockpitHE_177A3_TGunner.this.setOld.dimPosition
							+ 0.05F;
				}
			}
	...
	public void moveGun(Orient orient) {
		...
		this.mesh.chunkSetAngles("Z_tLink", 0.0F, 0.0F,
				this.floatindex(this.cvt(orient.getTangage(), 0.0F, 90F, 0.0F, 18F), Turret_Z1));
		this.mesh.chunkSetAngles("Z_tHandle", 0.0F, 0.0F,
				-this.floatindex(this.cvt(orient.getTangage(), 0.0F, 90F, 0.0F, 18F), Turret_Z2));
	...
	public void typeTurretK4AdjDistancePlus() {
		...
		if (((HE_177A3) this.fm.actor).B1_Distance > 500F) {
			((HE_177A3) this.fm.actor).B1_Distance = 500F;
		}
		this.mesh.chunkSetAngles("Z_ReviDist", 0.0F, 0.0F, (500F - ((HE_177A3) this.fm.actor).B1_Distance) / 2.0F);
		HUD.log(AircraftHotKeys.hudLogWeaponId, "K4DistanceM",
				new Object[] { new Integer((int) ((HE_177A3) this.fm.actor).B1_Distance) });
		this.calculateSight();
	}

	public void typeTurretK4AdjDistanceMinus() {
		((HE_177A3) this.fm.actor).B1_Distance -= 10F;
		if (((HE_177A3) this.fm.actor).B1_Distance < 100F) {
			((HE_177A3) this.fm.actor).B1_Distance = 100F;
		}
		this.mesh.chunkSetAngles("Z_ReviDist", 0.0F, 0.0F, (500F - ((HE_177A3) this.fm.actor).B1_Distance) / 2.0F);
		HUD.log(AircraftHotKeys.hudLogWeaponId, "K4DistanceM",
				new Object[] { new Integer((int) ((HE_177A3) this.fm.actor).B1_Distance) });
	...
	public void typeTurretK4AdjSpanPlus() {
		...
		if (((HE_177A3) this.fm.actor).B1_Speed > 600F) {
			((HE_177A3) this.fm.actor).B1_Speed = 600F;
		}
		this.mesh.chunkSetAngles("Z_ReviSpeed", 0.0F, 0.0F, ((HE_177A3) this.fm.actor).B1_Speed / 2.0F);
		HUD.log(AircraftHotKeys.hudLogWeaponId, "K4SpanM",
				new Object[] { new Integer((int) ((HE_177A3) this.fm.actor).B1_Speed) });
		this.calculateSight();
	}

	public void typeTurretK4AdjSpanMinus() {
		((HE_177A3) this.fm.actor).B1_Speed -= 25F;
		if (((HE_177A3) this.fm.actor).B1_Speed < 0.0F) {
			((HE_177A3) this.fm.actor).B1_Speed = 0.0F;
		}
		this.mesh.chunkSetAngles("Z_ReviSpeed", 0.0F, 0.0F, ((HE_177A3) this.fm.actor).B1_Speed / 2.0F);
		HUD.log(AircraftHotKeys.hudLogWeaponId, "K4SpanM",
				new Object[] { new Integer((int) ((HE_177A3) this.fm.actor).B1_Speed) });
	...
	protected void interpTick() {
		...
		if (this.bGunFire) {
			this.mesh.chunkSetAngles("Z_tGunFire", 0.0F, 0.0F, 1.2F);
		} else {
			this.mesh.chunkSetAngles("Z_tGunFire", 0.0F, 0.0F, 0.0F);
		}
...
//        magazines = -2;
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkVisible("F_AllGearsDown", this.fm.CT.getGear() == 1.0F && this.fm.CT.getGear() == 1.0F
		...
		if (!this.fm.CT.bHasFlapsControl) {
			...
			if (f1 > 0.21F && f2 > 270F && (f2 - 270F) * f1 > 8F) {
				flag = true;
			}
		}
		...
		float f8 = Geom.RAD2DEG((float) Math.acos((0.038666129112243652D - 0.18320585787296295D * d)
		...
		double d3 = Math.sqrt(
				0.035435102880001068D + d2 * d2 - 0.37648427486419678D * d2 * (float) Math.cos(Geom.DEG2RAD(f15)));
		...
		double d6 = Math.sqrt(
				0.035435102880001068D + d5 * d5 - 0.37648427486419678D * d5 * (float) Math.cos(Geom.DEG2RAD(f23)));
		...
		this.mesh.chunkSetAngles("Z_N_RPM1", -this.floatindex(this.cvt(f30, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_N_RPM2", -this.floatindex(this.cvt(f30, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		float f31 = ((FlightModelMain) this.fm).EI.engines[1].getRPM();
		this.mesh.chunkSetAngles("Z_N_RPM3", -this.floatindex(this.cvt(f31, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_N_RPM4", -this.floatindex(this.cvt(f31, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_N_FuelConsom", -this.cvt(0.5F * this.setNew.consumptionL, 0.0F, 500F, 0.0F, 255.5F),
				0.0F, 0.0F);
