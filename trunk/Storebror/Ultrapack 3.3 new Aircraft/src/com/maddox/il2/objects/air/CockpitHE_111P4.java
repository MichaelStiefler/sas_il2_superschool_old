...
public class CockpitHE_111P4 extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            mesh.chunkSetAngles("TurretNA", 0.0F, fm.turret[6].tu[0], 0.0F);
            mesh.chunkSetAngles("TurretNB", 0.0F, fm.turret[6].tu[1], 0.0F);
    ...
    static 
    {
        Property.set(CockpitHE_111P4.class, "normZNs", new float[] {
