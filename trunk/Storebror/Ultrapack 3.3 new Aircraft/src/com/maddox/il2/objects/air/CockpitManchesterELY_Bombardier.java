...
public class CockpitManchesterELY_Bombardier extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((ManchesterBombers) ((Manchester_early)aircraft())).fSightCurForwardAngle;
                float f1 = -((ManchesterBombers) ((Manchester_early)aircraft())).fSightCurSideslip;
    ...
    {
        this.mesh.chunkSetAngles("zMark1", ((ManchesterBombers) ((Manchester_early)aircraft())).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((ManchesterBombers) ((Manchester_early)aircraft())).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
