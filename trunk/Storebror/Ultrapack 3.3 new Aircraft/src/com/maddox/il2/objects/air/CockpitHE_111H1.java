...
public class CockpitHE_111H1 extends CockpitPilot
{
    ...
    public CockpitHE_111H1()
    {
        ...
        this.cockpitNightMats = (new String[] {
            "clocks1", "clocks2", "clocks3", "clocks4", "clocks5", "clocks6", "clocks7", "AFN-1"
        });
        setNightMats(false);
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        this.mesh.chunkSetAngles("zVSI", cvt(setNew.vspeed, -10F, 10F, -178F, 178F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", floatindex(cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3000F, 0.0F, 15F), rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", floatindex(cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3000F, 0.0F, 15F), rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zExtT", cvt(Atmosphere.temperature((float)this.fm.Loc.z), 213.09F, 313.09F, -60F, 60F), 0.0F, 0.0F);
    ...
    private static final float rpmScale[] = {
        0.0F, 5F, 9F, 13.8F, 37.27F, 62.32F, 90F, 120.43F, 150.36F, 179F, 
        211.26F, 242.65F, 271.55F, 296.88F, 320.76F, 344.05F
    };

    static 
    {
        Property.set(CockpitHE_111H1.class, "normZNs", new float[] {
