...
public class CockpitLanc_Bombardier extends CockpitPilot
{
    class Interpolater extends com.maddox.il2.engine.InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((LancasterX)aircraft()).fSightCurForwardAngle;
                float f1 = -((LancasterX)aircraft()).fSightCurSideslip;
    ...
    {
        this.mesh.chunkSetAngles("zMark1", ((LancasterX)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((LancasterX)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
