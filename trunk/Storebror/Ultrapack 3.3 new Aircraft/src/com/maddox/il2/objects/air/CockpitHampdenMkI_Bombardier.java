...
public class CockpitHampdenMkI_Bombardier extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((HAMPDEN)aircraft()).fSightCurForwardAngle;
                float f1 = -((HAMPDEN)aircraft()).fSightCurSideslip;
    ...
    {
        this.mesh.chunkSetAngles("zMark1", ((HAMPDEN)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((HAMPDEN)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
