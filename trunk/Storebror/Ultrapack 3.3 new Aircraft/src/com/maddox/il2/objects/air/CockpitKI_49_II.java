...
public class CockpitKI_49_II extends CockpitPilot
{
    ...
    protected boolean doFocusEnter()
    {
        ...
        {
            aircraft().hierMesh().chunkVisible("CFa", false);
    ...
    protected void doFocusLeave()
    {
        ...
        {
            aircraft().hierMesh().chunkVisible("CFa", true);
    ...
    public CockpitKI_49_II()
    {
        ...
        this.limits6DoF = (new float[] {
            0.7F, 0.055F, -0.07F, 0.08F, 0.12F, -0.1F, 0.04F, -0.03F
        });
    }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        this.mesh.chunkSetAngles("Z_Mixture1", 62.9F * interp(setNew.mix1, setOld.mix1, f), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Mixture2", 62.9F * interp(setNew.mix2, setOld.mix2, f), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Compass5", -setNew.waypointAzimuth.getDeg(f * 0.1F) + 90F, 0.0F, 0.0F);
        ...
        float f2 = floatindex(cvt(0.539957F * Pitot.Indicator((float)this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), speedometerScale);
        ...
        this.mesh.chunkSetAngles("Z_Temp1", cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 350F, 0.0F, 90F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp2", cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 350F, 0.0F, 90F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp3", cvt(this.fm.EI.engines[1].tOilIn, 0.0F, 350F, 0.0F, 90F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp4", cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 350F, 0.0F, 90F), 0.0F, 0.0F);
        float f3 = (Atmosphere.temperature((float)this.fm.Loc.z) - 273.09F) + 44.4F * this.fm.EI.engines[0].getPowerOutput();
        if(f3 < 0.0F)
            this.mesh.chunkSetAngles("Z_Temp5", cvt(f3, -40F, 0.0F, 0.0F, 45F), 0.0F, 0.0F);
        else
            this.mesh.chunkSetAngles("Z_Temp5", cvt(f3, 0.0F, 60F, 45F, 90F), 0.0F, 0.0F);
        f3 = (Atmosphere.temperature((float)this.fm.Loc.z) - 273.09F) + 44.4F * this.fm.EI.engines[1].getPowerOutput();
        if(f3 < 0.0F)
            this.mesh.chunkSetAngles("Z_Temp6", cvt(f3, -40F, 0.0F, 0.0F, 45F), 0.0F, 0.0F);
        else
            this.mesh.chunkSetAngles("Z_Temp6", cvt(f3, 0.0F, 60F, 45F, 90F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp7", floatindex(cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", floatindex(cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Manifold1", cvt(setNew.man1, 0.33339F, 1.66661F, -162F, 162F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Manifold2", cvt(setNew.man2, 0.33339F, 1.66661F, -162F, 162F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_fuelpress1", cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 0.5F, 0.0F, 180F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_fuelpress2", cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 0.5F, 0.0F, 180F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_AFN12", 0.0F, cvt(setNew.beaconDirection, -45F, 45F, -13F, 13F), 0.0F);
        this.mesh.chunkSetAngles("Z_AFN11", 0.0F, cvt(setNew.beaconRange, 0.0F, 1.0F, 28F, -28F), 0.0F);
    ...
    static 
    {
        Property.set(CockpitKI_49_II.class, "normZNs", new float[] {
