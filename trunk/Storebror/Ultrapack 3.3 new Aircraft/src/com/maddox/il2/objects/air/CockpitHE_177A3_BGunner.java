...
public class CockpitHE_177A3_BGunner extends CockpitGunner {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitHE_177A3_BGunner.this.fm != null) {
				...
				CockpitHE_177A3_BGunner.this.setNew.AirEnemy = 0.95F * CockpitHE_177A3_BGunner.this.setOld.AirEnemy
						+ 0.05F * (((HE_177A3) CockpitHE_177A3_BGunner.this.fm.actor).bAirEnemy ? 1.0F : 0.0F);
				if (CockpitHE_177A3_BGunner.this.cockpitDimControl) {
					if (CockpitHE_177A3_BGunner.this.setNew.dimPosition > 0.0F) {
						CockpitHE_177A3_BGunner.this.setNew.dimPosition = CockpitHE_177A3_BGunner.this.setOld.dimPosition
								- 0.05F;
					}
				} else if (CockpitHE_177A3_BGunner.this.setNew.dimPosition < 1.0F) {
					CockpitHE_177A3_BGunner.this.setNew.dimPosition = CockpitHE_177A3_BGunner.this.setOld.dimPosition
							+ 0.05F;
				}
				...
				if (CockpitHE_177A3_BGunner.this.useRealisticNavigationInstruments()) {
					...
					CockpitHE_177A3_BGunner.this.setNew.radioCompassAzimuth.setDeg(
							CockpitHE_177A3_BGunner.this.setOld.radioCompassAzimuth.getDeg(0.02F),
							CockpitHE_177A3_BGunner.this.radioCompassAzimuthInvertMinus()
									- CockpitHE_177A3_BGunner.this.setOld.azimuth.getDeg(1.0F) - 90F);
				} else {
					CockpitHE_177A3_BGunner.this.setNew.waypointAzimuth.setDeg(
							CockpitHE_177A3_BGunner.this.setOld.waypointAzimuth.getDeg(0.1F),
							f - CockpitHE_177A3_BGunner.this.setOld.azimuth.getDeg(1.0F));
				}
				CockpitHE_177A3_BGunner.this.setNew.azimuth.setDeg(
						CockpitHE_177A3_BGunner.this.setOld.azimuth.getDeg(1.0F),
						CockpitHE_177A3_BGunner.this.fm.Or.azimut());
				CockpitHE_177A3_BGunner.this.setNew.throttle1 = 0.85F * CockpitHE_177A3_BGunner.this.setOld.throttle1
						+ CockpitHE_177A3_BGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
				CockpitHE_177A3_BGunner.this.setNew.throttle2 = 0.85F * CockpitHE_177A3_BGunner.this.setOld.throttle2
						+ CockpitHE_177A3_BGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
				CockpitHE_177A3_BGunner.this.setNew.pictAiler = 0.85F * CockpitHE_177A3_BGunner.this.setOld.pictAiler
						+ 0.15F * CockpitHE_177A3_BGunner.this.cvt(CockpitHE_177A3_BGunner.this.fm.CT.AileronControl,
								-1F, 1.0F, -1F, 1.0F);
				CockpitHE_177A3_BGunner.this.setNew.pictElev = 0.85F * CockpitHE_177A3_BGunner.this.setOld.pictElev
						+ 0.15F * CockpitHE_177A3_BGunner.this.cvt(CockpitHE_177A3_BGunner.this.fm.CT.ElevatorControl,
								-1F, 1.0F, -1F, 1.0F);
				CockpitHE_177A3_BGunner.this.setNew.elevTrim = 0.85F * CockpitHE_177A3_BGunner.this.setOld.elevTrim
						+ 0.15F * CockpitHE_177A3_BGunner.this.fm.CT.trimElevator;
				CockpitHE_177A3_BGunner.this.setNew.rudderTrim = 0.85F * CockpitHE_177A3_BGunner.this.setOld.rudderTrim
						+ 0.15F * CockpitHE_177A3_BGunner.this.fm.CT.trimRudder;
				CockpitHE_177A3_BGunner.this.setNew.ailTrim = 0.85F * CockpitHE_177A3_BGunner.this.setOld.ailTrim
						+ 0.15F * CockpitHE_177A3_BGunner.this.fm.CT.trimAileron;
				if (Math.toDegrees(CockpitHE_177A3_BGunner.this.fm.EI.engines[0].getPropPhi()) < 36D) {
					CockpitHE_177A3_BGunner.this.setNew.prop1 = 0.85F * CockpitHE_177A3_BGunner.this.setOld.prop1
							+ ((FlightModelMain) CockpitHE_177A3_BGunner.this.fm).EI.engines[0].getControlProp()
									* 0.15F;
					CockpitHE_177A3_BGunner.this.setNew._prop1 = CockpitHE_177A3_BGunner.this
							.cvt(CockpitHE_177A3_BGunner.this.setNew.prop1, 0.0F, 1.0F, -22F, -63F);
				} else {
					CockpitHE_177A3_BGunner.this.setNew.prop1 = 0.85F * CockpitHE_177A3_BGunner.this.setOld.prop1;
					CockpitHE_177A3_BGunner.this.setNew._prop1 = CockpitHE_177A3_BGunner.this
							.cvt(CockpitHE_177A3_BGunner.this.setNew.prop1, 0.0F, 1.0F, 0.0F, -63F);
				}
				if (Math.toDegrees(CockpitHE_177A3_BGunner.this.fm.EI.engines[1].getPropPhi()) < 36D) {
					CockpitHE_177A3_BGunner.this.setNew.prop2 = 0.85F * CockpitHE_177A3_BGunner.this.setOld.prop2
							+ ((FlightModelMain) CockpitHE_177A3_BGunner.this.fm).EI.engines[1].getControlProp()
									* 0.15F;
					CockpitHE_177A3_BGunner.this.setNew._prop2 = CockpitHE_177A3_BGunner.this
							.cvt(CockpitHE_177A3_BGunner.this.setNew.prop2, 0.0F, 1.0F, -22F, -63F);
				} else {
					CockpitHE_177A3_BGunner.this.setNew.prop2 = 0.85F * CockpitHE_177A3_BGunner.this.setOld.prop2;
					CockpitHE_177A3_BGunner.this.setNew._prop2 = CockpitHE_177A3_BGunner.this
							.cvt(CockpitHE_177A3_BGunner.this.setNew.prop2, 0.0F, 1.0F, 0.0F, -63F);
				}
				...
				CockpitHE_177A3_BGunner.this.setNew.turn = (12F * CockpitHE_177A3_BGunner.this.setOld.turn
						+ CockpitHE_177A3_BGunner.this.w.z) / 13F;
				CockpitHE_177A3_BGunner.this.setNew.altimeter = 0.85F * CockpitHE_177A3_BGunner.this.setOld.altimeter
						+ CockpitHE_177A3_BGunner.this.fm.getAltitude() * 0.15F;
				CockpitHE_177A3_BGunner.this.setNew.vspeed = (99F * CockpitHE_177A3_BGunner.this.setOld.vspeed
						+ CockpitHE_177A3_BGunner.this.fm.getVertSpeed()) / 100F;
				...
				if (f1 > 55F || f1 < -55F || f2 < -55F || f2 > 55F) {
					CockpitHE_177A3_BGunner.this.Pn.z = 250D;
				} else {
					CockpitHE_177A3_BGunner.this.Pn.set(CockpitHE_177A3_BGunner.this.fm.Loc);
					CockpitHE_177A3_BGunner.this.Pn.z = CockpitHE_177A3_BGunner.this.fm.getAltitude()
							- Engine.cur.land.HQ(((Tuple3d) CockpitHE_177A3_BGunner.this.Pn).x,
									((Tuple3d) CockpitHE_177A3_BGunner.this.Pn).y);
					...
					CockpitHE_177A3_BGunner.this.Pn.z = (float) Math.sqrt(
							d * d + d1 * d1 + CockpitHE_177A3_BGunner.this.Pn.z * CockpitHE_177A3_BGunner.this.Pn.z);
					if (CockpitHE_177A3_BGunner.this.fm.CT.getGear() > 0.5F) {
						CockpitHE_177A3_BGunner.this.Pn.z = CockpitHE_177A3_BGunner.this
								.cvt((float) CockpitHE_177A3_BGunner.this.Pn.z, 0.0F, 150F, 0.0F, 250F);
					} else {
						CockpitHE_177A3_BGunner.this.Pn.z = CockpitHE_177A3_BGunner.this
								.cvt((float) CockpitHE_177A3_BGunner.this.Pn.z, 0.0F, 750F, 0.0F, 250F);
					}
				}
				CockpitHE_177A3_BGunner.this.setNew.AFN101 = 0.9F * CockpitHE_177A3_BGunner.this.setOld.AFN101
						+ 0.1F * (float) CockpitHE_177A3_BGunner.this.Pn.z;
				CockpitHE_177A3_BGunner.this.setNew.beaconDirection = (10F
						* CockpitHE_177A3_BGunner.this.setOld.beaconDirection
						+ CockpitHE_177A3_BGunner.this.getBeaconDirection()) / 11F;
				CockpitHE_177A3_BGunner.this.setNew.beaconRange = (10F * CockpitHE_177A3_BGunner.this.setOld.beaconRange
						+ CockpitHE_177A3_BGunner.this.getBeaconRange()) / 11F;
				CockpitHE_177A3_BGunner.this.setNew.pictManf1 = 0.9F * CockpitHE_177A3_BGunner.this.setOld.pictManf1
						+ 0.1F * CockpitHE_177A3_BGunner.this.cvt(
								CockpitHE_177A3_BGunner.this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_BGunner.this.setNew.pictManf2 = 0.8F * CockpitHE_177A3_BGunner.this.setOld.pictManf2
						+ 0.2F * CockpitHE_177A3_BGunner.this.cvt(
								CockpitHE_177A3_BGunner.this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_BGunner.this.setNew.pictManf3 = 0.9F * CockpitHE_177A3_BGunner.this.setOld.pictManf3
						+ 0.1F * CockpitHE_177A3_BGunner.this.cvt(
								CockpitHE_177A3_BGunner.this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_BGunner.this.setNew.pictManf4 = 0.8F * CockpitHE_177A3_BGunner.this.setOld.pictManf4
						+ 0.2F * CockpitHE_177A3_BGunner.this.cvt(
								CockpitHE_177A3_BGunner.this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				...
				CockpitHE_177A3_BGunner.this.setNew.consumptionL = 0.9F
						* CockpitHE_177A3_BGunner.this.setOld.consumptionL + 0.1F * (f6 * f4) / (f4 + f5 + 1.0F);
				CockpitHE_177A3_BGunner.this.setNew.consumptionR = 0.9F
						* CockpitHE_177A3_BGunner.this.setOld.consumptionR + 0.1F * (f6 * f5) / (f4 + f5 + 1.0F);
				CockpitHE_177A3_BGunner.this.setNew.bombDoor = 0.9F * CockpitHE_177A3_BGunner.this.setOld.bombDoor
						+ 0.1F * CockpitHE_177A3_BGunner.this.fm.CT.getBayDoor();
			}
			return true;
		}
	...
	public void clipAnglesGun(Orient orient) {
		if (this.isRealMode())
			if (!this.aiTurret().bIsOperable) {
					...
					if (f2 >= 0.0F) {
						if (f3 >= -35F) {
							if (f3 >= -3F && f2 < 40.03915F) {
								...
								if (f3 > this.cvt(f2, 0.0F, 40.03915F, -3F, -2.311216F)) {
									f3 = this.cvt(f2, 0.0F, 40.03915F, -3F, -2.311216F);
								}
							} else {
								if (f3 > -2.311216F) {
									f3 = -2.311216F;
								}
								if (f2 > this.cvt(f3, -35F, -2.311216F, 59F, 40.03915F)) {
									f2 = this.cvt(f3, -35F, -2.311216F, 59F, 40.03915F);
								}
							}
						} else if (f3 >= -51.67F) {
							if (f2 > this.cvt(f3, -51.67F, -35F, 71.48F, 59F)) {
								f2 = this.cvt(f3, -51.67F, -35F, 71.48F, 59F);
							}
						} else {
							if (f2 > 71.48F) {
								f2 = 71.48F;
							}
							if (f3 < this.cvt(f2, 0.0F, 71.48F, -80F, -51.67F)) {
								f3 = this.cvt(f2, 0.0F, 71.48F, -80F, -51.67F);
							}
						}
					} else if (f3 >= -35F) {
						if (f3 >= -3F && f2 > -40.03915F) {
							...
							if (f3 > this.cvt(f2, -40.03915F, 0.0F, -2.311216F, -3F)) {
								f3 = this.cvt(f2, -40.03915F, 0.0F, -2.311216F, -3F);
							}
						} else {
							if (f3 > -2.311216F) {
								f3 = -2.311216F;
						...
						if (f2 < this.cvt(f3, -43.29834F, -35F, -42.30127F, -59F)) {
							f2 = this.cvt(f3, -43.29834F, -35F, -42.30127F, -59F);
						}
					} else if (f3 < -56.89526F) {
						if (f2 < -57.896F) {
							f2 = -57.896F;
						}
						if (f3 < this.cvt(f2, -57.896F, 0.0F, -56.89526F, -80F)) {
							f3 = this.cvt(f2, -57.896F, 0.0F, -56.89526F, -80F);
						}
					} else if (f2 < this.cvt(f3, -56.89526F, -43.29834F, -57.896F, -42.30127F)) {
						f2 = this.cvt(f3, -56.89526F, -43.29834F, -57.896F, -42.30127F);
					}
					f = f2;
					f1 = f3;
				}
				this.CurrentYaw = f;
				if (this.isToggleAim()) {
					if (this.CurrentYaw > 15F) {
						this.doToggleAim2(false);
					}
				} else if (this.CurrentYaw < -15F) {
					this.doToggleAim2(true);
				}
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("Z_MG131TintL",
				this.cvt(this.interp(this.setNew.dimPosition, this.setOld.dimPosition, f), 0.0F, 1.0F, 45F, 0.0F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_MG131TintR",
				this.cvt(this.interp(this.setNew.dimPosition, this.setOld.dimPosition, f), 0.0F, 1.0F, 45F, 0.0F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_Lotfe7", ((HE_177A3) this.fm.actor).fSightCurSideslip * -10F, 0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_Gears", this.fm.CT.getGear() != 1.0F || this.fm.CT.getGear() != 1.0F
				|| !this.fm.Gears.lgear || !this.fm.Gears.rgear ? 0.0F : 90F, 0.0F, 0.0F);
		float f3 = this.fm.CT.getFlap();
		float f4 = 0.0F;
		if (f3 > 0.5F) {
			f4 = 90F;
		} else if (f3 > 0.1F && f3 < 0.5F) {
			f4 = 45F;
		}
		...
		double d2 = Math.sqrt(
				0.035435102880001068D + d1 * d1 - 0.37648427486419678D * d1 * (float) Math.cos(Geom.DEG2RAD(f12)));
		...
		float f16 = (float) Math
				.acos((0.0071521135978400707D + d2 * d2 - 0.035434890538454056D) / (0.16914033889770508D * d2));
		...
		double d5 = Math.sqrt(
				0.035435102880001068D + d4 * d4 - 0.37648427486419678D * d4 * (float) Math.cos(Geom.DEG2RAD(f20)));
		float f21 = (float) Math.acos((0.035435102880001068D + d5 * d5 - d4 * d4) / (0.37648427486419678D * d5));
		float f22 = (float) Math
				.acos((0.0071521135978400707D + d5 * d5 - 0.035434890538454056D) / (0.16914033889770508D * d5));
		...
		this.mesh.chunkSetAngles("Z_N_E1CoolTemp",
				-this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 130F, 0.0F, 13F), Fl20342_Scale), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_N_E2CoolTemp",
				-this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 130F, 0.0F, 13F), Fl20342_Scale), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_N_E3CoolTemp",
				-this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 130F, 0.0F, 13F), Fl20342_Scale), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_N_E4CoolTemp",
				-this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 130F, 0.0F, 13F), Fl20342_Scale), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_N_E1OilTemp",
				-this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 130F, 0.0F, 13F), Fl20342_Scale), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_N_E2OilTemp",
				-this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 130F, 0.0F, 13F), Fl20342_Scale), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_N_E3OilTemp",
				-this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 130F, 0.0F, 13F), Fl20342_Scale), 0.0F,
				0.0F);
...
//        mesh.chunkSetAngles("Z_Course2b", ((HE_177A3)aircraft()).getCourse(), 0.0F, 0.0F);
		...
		this.mesh.chunkSetAngles("Z_tLink", 0.0F, 0.0F,
				this.floatindex(this.cvt(f27, 0.0F, 90F, 0.0F, 18F), Turret_Z1));
		this.mesh.chunkSetAngles("Z_tHandle", 0.0F, 0.0F,
				-this.floatindex(this.cvt(f27, 0.0F, 90F, 0.0F, 18F), Turret_Z2));
	...
	public CockpitHE_177A3_BGunner() {
		...
		this.w = new Vector3f();
		this.Pn = new Point3d();
		this.cockpitNightMats = new String[] { "CompGrad", "Fl20342na", "Fl20342", "Fl20516", "Fl20841", "Fl22334b",
				"Fl22334c", "Fl22561", "Fl30489", "Fl30532", "Gauge20", "NeedlesnLights" };
		//this.hidePilot = true;
		if (this.gun == null) {
