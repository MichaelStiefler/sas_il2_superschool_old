...
public class CockpitStirling extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        this.mesh.chunkSetAngles("Z_Columnbase2", 12F * (pictElev = 0.85F * pictElev + 0.15F * this.fm.CT.ElevatorControl), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Column2", 45F * (pictAiler = 0.85F * pictAiler + 0.15F * this.fm.CT.AileronControl), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_ColumnSwitch2", 20F * (pictBrake = 0.91F * pictBrake + 0.09F * this.fm.CT.BrakeControl), 0.0F, 0.0F);
