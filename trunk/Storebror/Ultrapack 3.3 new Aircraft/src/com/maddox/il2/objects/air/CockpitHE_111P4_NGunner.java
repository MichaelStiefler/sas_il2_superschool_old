...
public class CockpitHE_111P4_NGunner extends CockpitGunner
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        float f1 = waypointAzimuthInvertMinus(30F);
        if(useRealisticNavigationInstruments())
        {
            ...
            this.mesh.chunkSetAngles("Z_Compass5", radioCompassAzimuthInvertMinus() - this.fm.Or.azimut(), 0.0F, 0.0F);
        } else
        {
            this.mesh.chunkSetAngles("Z_Compass4", -this.fm.Or.azimut() - 90F, 0.0F, 0.0F);
            way = 0.95F * way + 0.05F * (f1 - this.fm.Or.azimut());
            this.mesh.chunkSetAngles("Z_Compass3", way, 0.0F, 0.0F);
        }
    }
