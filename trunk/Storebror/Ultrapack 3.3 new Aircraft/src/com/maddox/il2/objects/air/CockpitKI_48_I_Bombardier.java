...
public class CockpitKI_48_I_Bombardier extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((KI_48_I)aircraft()).fSightCurForwardAngle;
                float f1 = -((KI_48_I)aircraft()).fSightCurSideslip;
    ...
    {
        mesh.chunkSetAngles("zMark1", ((KI_48_I)aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((KI_48_I)aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
