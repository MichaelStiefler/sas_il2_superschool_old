...
public class CockpitHE_177A3_FGunner extends CockpitGunner {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitHE_177A3_FGunner.this.fm != null) {
				...
				CockpitHE_177A3_FGunner.this.setNew.AirEnemy = 0.95F * CockpitHE_177A3_FGunner.this.setOld.AirEnemy
						+ 0.05F * (((HE_177A3) CockpitHE_177A3_FGunner.this.fm.actor).bAirEnemy ? 1.0F : 0.0F);
				...
				if (CockpitHE_177A3_FGunner.this.useRealisticNavigationInstruments()) {
					...
					CockpitHE_177A3_FGunner.this.setNew.radioCompassAzimuth.setDeg(
							CockpitHE_177A3_FGunner.this.setOld.radioCompassAzimuth.getDeg(0.02F),
							CockpitHE_177A3_FGunner.this.radioCompassAzimuthInvertMinus()
									- CockpitHE_177A3_FGunner.this.setOld.azimuth.getDeg(1.0F) - 90F);
				} else {
					CockpitHE_177A3_FGunner.this.setNew.waypointAzimuth.setDeg(
							CockpitHE_177A3_FGunner.this.setOld.waypointAzimuth.getDeg(0.1F),
							f - CockpitHE_177A3_FGunner.this.setOld.azimuth.getDeg(1.0F));
				}
				CockpitHE_177A3_FGunner.this.setNew.azimuth.setDeg(
						CockpitHE_177A3_FGunner.this.setOld.azimuth.getDeg(1.0F),
						CockpitHE_177A3_FGunner.this.fm.Or.azimut());
				CockpitHE_177A3_FGunner.this.setNew.throttle1 = 0.85F * CockpitHE_177A3_FGunner.this.setOld.throttle1
						+ CockpitHE_177A3_FGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
				CockpitHE_177A3_FGunner.this.setNew.throttle2 = 0.85F * CockpitHE_177A3_FGunner.this.setOld.throttle2
						+ CockpitHE_177A3_FGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
				CockpitHE_177A3_FGunner.this.setNew.pictAiler = 0.85F * CockpitHE_177A3_FGunner.this.setOld.pictAiler
						+ 0.15F * CockpitHE_177A3_FGunner.this.cvt(CockpitHE_177A3_FGunner.this.fm.CT.AileronControl,
								-1F, 1.0F, -1F, 1.0F);
				CockpitHE_177A3_FGunner.this.setNew.pictElev = 0.85F * CockpitHE_177A3_FGunner.this.setOld.pictElev
						+ 0.15F * CockpitHE_177A3_FGunner.this.cvt(CockpitHE_177A3_FGunner.this.fm.CT.ElevatorControl,
								-1F, 1.0F, -1F, 1.0F);
				if (Math.toDegrees(CockpitHE_177A3_FGunner.this.fm.EI.engines[0].getPropPhi()) < 36D) {
					CockpitHE_177A3_FGunner.this.setNew.prop1 = 0.85F * CockpitHE_177A3_FGunner.this.setOld.prop1
							+ ((FlightModelMain) CockpitHE_177A3_FGunner.this.fm).EI.engines[0].getControlProp()
									* 0.15F;
					CockpitHE_177A3_FGunner.this.setNew._prop1 = CockpitHE_177A3_FGunner.this
							.cvt(CockpitHE_177A3_FGunner.this.setNew.prop1, 0.0F, 1.0F, -22F, -63F);
				} else {
					CockpitHE_177A3_FGunner.this.setNew.prop1 = 0.85F * CockpitHE_177A3_FGunner.this.setOld.prop1;
					CockpitHE_177A3_FGunner.this.setNew._prop1 = CockpitHE_177A3_FGunner.this
							.cvt(CockpitHE_177A3_FGunner.this.setNew.prop1, 0.0F, 1.0F, 0.0F, -63F);
				}
				if (Math.toDegrees(CockpitHE_177A3_FGunner.this.fm.EI.engines[1].getPropPhi()) < 36D) {
					CockpitHE_177A3_FGunner.this.setNew.prop2 = 0.85F * CockpitHE_177A3_FGunner.this.setOld.prop2
							+ ((FlightModelMain) CockpitHE_177A3_FGunner.this.fm).EI.engines[1].getControlProp()
									* 0.15F;
					CockpitHE_177A3_FGunner.this.setNew._prop2 = CockpitHE_177A3_FGunner.this
							.cvt(CockpitHE_177A3_FGunner.this.setNew.prop2, 0.0F, 1.0F, -22F, -63F);
				} else {
					CockpitHE_177A3_FGunner.this.setNew.prop2 = 0.85F * CockpitHE_177A3_FGunner.this.setOld.prop2;
					CockpitHE_177A3_FGunner.this.setNew._prop2 = CockpitHE_177A3_FGunner.this
							.cvt(CockpitHE_177A3_FGunner.this.setNew.prop2, 0.0F, 1.0F, 0.0F, -63F);
				}
				...
				CockpitHE_177A3_FGunner.this.setNew.turn = (12F * CockpitHE_177A3_FGunner.this.setOld.turn
						+ CockpitHE_177A3_FGunner.this.w.z) / 13F;
				CockpitHE_177A3_FGunner.this.setNew.altimeter = 0.85F * CockpitHE_177A3_FGunner.this.setOld.altimeter
						+ CockpitHE_177A3_FGunner.this.fm.getAltitude() * 0.15F;
				CockpitHE_177A3_FGunner.this.setNew.vspeed = (99F * CockpitHE_177A3_FGunner.this.setOld.vspeed
						+ CockpitHE_177A3_FGunner.this.fm.getVertSpeed()) / 100F;
				...
				if (f1 > 55F || f1 < -55F || f2 < -55F || f2 > 55F) {
					CockpitHE_177A3_FGunner.this.Pn.z = 250D;
				} else {
					CockpitHE_177A3_FGunner.this.Pn.set(CockpitHE_177A3_FGunner.this.fm.Loc);
					CockpitHE_177A3_FGunner.this.Pn.z = CockpitHE_177A3_FGunner.this.fm.getAltitude()
							- Engine.cur.land.HQ(((Tuple3d) CockpitHE_177A3_FGunner.this.Pn).x,
									((Tuple3d) CockpitHE_177A3_FGunner.this.Pn).y);
					...
					CockpitHE_177A3_FGunner.this.Pn.z = (float) Math.sqrt(
							d * d + d1 * d1 + CockpitHE_177A3_FGunner.this.Pn.z * CockpitHE_177A3_FGunner.this.Pn.z);
					if (CockpitHE_177A3_FGunner.this.fm.CT.getGear() > 0.5F) {
						CockpitHE_177A3_FGunner.this.Pn.z = CockpitHE_177A3_FGunner.this
								.cvt((float) CockpitHE_177A3_FGunner.this.Pn.z, 0.0F, 150F, 0.0F, 250F);
					} else {
						CockpitHE_177A3_FGunner.this.Pn.z = CockpitHE_177A3_FGunner.this
								.cvt((float) CockpitHE_177A3_FGunner.this.Pn.z, 0.0F, 750F, 0.0F, 250F);
					}
				}
				CockpitHE_177A3_FGunner.this.setNew.AFN101 = 0.9F * CockpitHE_177A3_FGunner.this.setOld.AFN101
						+ 0.1F * (float) CockpitHE_177A3_FGunner.this.Pn.z;
				CockpitHE_177A3_FGunner.this.setNew.beaconDirection = (10F
						* CockpitHE_177A3_FGunner.this.setOld.beaconDirection
						+ CockpitHE_177A3_FGunner.this.getBeaconDirection()) / 11F;
				CockpitHE_177A3_FGunner.this.setNew.beaconRange = (10F * CockpitHE_177A3_FGunner.this.setOld.beaconRange
						+ CockpitHE_177A3_FGunner.this.getBeaconRange()) / 11F;
				CockpitHE_177A3_FGunner.this.setNew.pictManf1 = 0.9F * CockpitHE_177A3_FGunner.this.setOld.pictManf1
						+ 0.1F * CockpitHE_177A3_FGunner.this.cvt(
								CockpitHE_177A3_FGunner.this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_FGunner.this.setNew.pictManf2 = 0.8F * CockpitHE_177A3_FGunner.this.setOld.pictManf2
						+ 0.2F * CockpitHE_177A3_FGunner.this.cvt(
								CockpitHE_177A3_FGunner.this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_FGunner.this.setNew.pictManf3 = 0.9F * CockpitHE_177A3_FGunner.this.setOld.pictManf3
						+ 0.1F * CockpitHE_177A3_FGunner.this.cvt(
								CockpitHE_177A3_FGunner.this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				CockpitHE_177A3_FGunner.this.setNew.pictManf4 = 0.8F * CockpitHE_177A3_FGunner.this.setOld.pictManf4
						+ 0.2F * CockpitHE_177A3_FGunner.this.cvt(
								CockpitHE_177A3_FGunner.this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F, 0.0F,
								330F);
				...
				CockpitHE_177A3_FGunner.this.setNew.consumptionL = 0.9F
						* CockpitHE_177A3_FGunner.this.setOld.consumptionL + 0.1F * (f6 * f4) / (f4 + f5 + 1.0F);
				CockpitHE_177A3_FGunner.this.setNew.consumptionR = 0.9F
						* CockpitHE_177A3_FGunner.this.setOld.consumptionR + 0.1F * (f6 * f5) / (f4 + f5 + 1.0F);
				CockpitHE_177A3_FGunner.this.setNew.bombDoor = 0.9F * CockpitHE_177A3_FGunner.this.setOld.bombDoor
						+ 0.1F * CockpitHE_177A3_FGunner.this.fm.CT.getBayDoor();
			}
			return true;
		}
			...
			if (!this.aiTurret().bIsOperable) {
				...
				if (f >= 0.0F) {
					if (f1 >= -1.7F) {
						...
						if (f > this.cvt(f1, -14.39F, -1.7F, 5.5F, 15F)) {
							f = this.cvt(f1, -14.39F, -1.7F, 5.5F, 15F);
						}
					} else {
						if (f > 5.5F) {
							f = 5.5F;
					...
					if (f < this.cvt(f1, -22.9F, -20.29F, -6.5F, -15F)) {
						f = this.cvt(f1, -22.9F, -20.29F, -6.5F, -15F);
					}
				} else {
					if (f < -6.5F) {
						f = -6.5F;
	...
	public void reflectWorldToInstruments(float f) {
		...
		double d3 = Math.sqrt(
				0.035435102880001068D + d2 * d2 - 0.37648427486419678D * d2 * (float) Math.cos(Geom.DEG2RAD(f16)));
		...
		double d6 = Math.sqrt(
				0.035435102880001068D + d5 * d5 - 0.37648427486419678D * d5 * (float) Math.cos(Geom.DEG2RAD(f24)));
		...
		this.mesh.chunkSetAngles("Z_N_RPM1", -this.floatindex(this.cvt(f33, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_N_RPM2", -this.floatindex(this.cvt(f33, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		float f34 = ((FlightModelMain) this.fm).EI.engines[1].getRPM();
		this.mesh.chunkSetAngles("Z_N_RPM3", -this.floatindex(this.cvt(f34, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_N_RPM4", -this.floatindex(this.cvt(f34, 400F, 3600F, 0.0F, 32F), Fl20274_Scale),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_N_FuelConsom", -this.cvt(0.5F * this.setNew.consumptionL, 0.0F, 500F, 0.0F, 255.5F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_N_FuelQuant", -this.cvt(this.fm.M.fuel, 0.0F, this.fm.M.maxFuel, 37F, 84F), 0.0F,
				0.0F);
...
//        mesh.chunkSetAngles("Z_Course2b", ((HE_177A3)aircraft()).getCourse(), 0.0F, 0.0F);
		...
		this.mesh.chunkSetAngles("Z_tLink", 0.0F, 0.0F,
				this.floatindex(this.cvt(f36, 0.0F, 90F, 0.0F, 18F), Turret_Z1));
		this.mesh.chunkSetAngles("Z_tHandle", 0.0F, 0.0F,
				-this.floatindex(this.cvt(f36, 0.0F, 90F, 0.0F, 18F), Turret_Z2));
	...
	public CockpitHE_177A3_FGunner() {
		...
		this.cockpitNightMats = new String[] { "CompGrad", "Fl20274", "Fl20342na", "Fl20342", "Fl20516", "Fl20556",
				"Fl20570", "Fl20572", "Fl20723_200na", "Fl20723_200", "Fl20841", "Fl22231", "Fl22316", "Fl22334b",
				"Fl22334c", "Fl22382", "Fl22412", "Fl22561", "Fl23885na", "Fl23885", "Fl30489", "Fl30532", "Fl32336",
				"Gauge20", "Ln27002", "Ln28330b", "Ln28330", "NeedlesnLights", "Nr92182B1na", "Voltmeters" };
//		this.hidePilot = true;
		if (this.gun == null) {
