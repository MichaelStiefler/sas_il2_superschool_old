...
public class CockpitHe111ABE_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			float f = ((He111ABE) CockpitHe111ABE_Bombardier.this.aircraft()).fSightCurForwardAngle;
			float f1 = ((He111ABE) CockpitHe111ABE_Bombardier.this.aircraft()).fSightCurSideslip;
			CockpitHe111ABE_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F, -f1, f);
			if (CockpitHe111ABE_Bombardier.this.bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setSimpleAimOrient(CockpitHe111ABE_Bombardier.this.aAim + f1, CockpitHe111ABE_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	...
	public CockpitHe111ABE_Bombardier() {
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (this.bEntered) {
			this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((He111ABE) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((He111ABE) this.aircraft()).fSightCurReadyness > 0.93F;
	...
	static {
		Property.set(CockpitHe111ABE_Bombardier.class, "astatePilotIndx", 0);
	}
}
