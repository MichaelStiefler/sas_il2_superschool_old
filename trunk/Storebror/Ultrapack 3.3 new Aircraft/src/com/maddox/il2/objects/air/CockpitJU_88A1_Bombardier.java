...
public class CockpitJU_88A1_Bombardier extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((JU_88A1)aircraft()).fSightCurForwardAngle;
            float f1 = ((JU_88A1)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bEntered)
        {
            this.mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((JU_88A1)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((JU_88A1)aircraft()).fSightCurReadyness > 0.93F;
