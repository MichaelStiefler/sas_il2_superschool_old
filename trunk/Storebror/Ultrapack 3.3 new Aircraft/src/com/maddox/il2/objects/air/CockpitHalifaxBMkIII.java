...
public class CockpitHalifaxBMkIII extends CockpitPilot
{
            ...
            if(fm != null)
            {
                ...
                case 0:
                    ...
                    if(Main3D.cur3D().clouds != null && Main3D.cur3D().bDrawClouds)
                    {
                        ...
                        aircraft().getSpeed(vector3d);
                        Point3d point3d = new Point3d();
                        point3d.set(aircraft().pos.getAbsPoint());
                        point3d.add(vector3d);
                        float f1 = Main3D.cur3D().clouds.getVisibility(aircraft().pos.getAbsPoint(), point3d);
                        if(f1 <= 0.9F)
                            iWiper = 1;
                    }
                    break;
                ...
                case 2:
                    ...
                    if(setNew.wiper >= 0.02F)
                        break;
                    if(fm.getSpeedKMH() > 350F || fm.getAltitude() > Mission.curCloudsHeight() + 400F)
                        iWiper++;
                    else
                        iWiper = 1;
                    if(Main3D.cur3D().clouds == null || !Main3D.cur3D().bDrawClouds)
                    ...
                    aircraft().getSpeed(vector3d1);
                    Point3d point3d1 = new Point3d();
                    point3d1.set(aircraft().pos.getAbsPoint());
                    point3d1.add(vector3d1);
                    float f2 = Main3D.cur3D().clouds.getVisibility(aircraft().pos.getAbsPoint(), point3d1);
                    if(f2 <= 0.9F)
                        iWiper = 1;
                    break;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_Wiper1", cvt(interp(setNew.wiper, setOld.wiper, f), 0.0F, 1.0F, 72.5F, 7.5F), 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("Z_Throtle3", 62.72F * interp(setNew.throttle3, setOld.throttle3, f), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Throtle4", 62.72F * interp(setNew.throttle4, setOld.throttle4, f), 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("Z_Prop3", 0.0F, 45F * interp(setNew.prop3, setOld.prop3, f), 0.0F);
        mesh.chunkSetAngles("Z_Prop4", 0.0F, 45F * interp(setNew.prop4, setOld.prop4, f), 0.0F);
        ...
        pictManf4 = 0.91F * pictManf4 + 0.09F * fm.EI.engines[3].getManifoldPressure();
        f1 = pictManf4 - 1.0F;
        f2 = 1.0F;
        if(f1 <= 0.0F)
            f2 = -1F;
        f1 = Math.abs(f1);
        mesh.chunkSetAngles("STRELKA_BOOST4", f2 * floatindex(cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), boostScale), 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("Z_RPM_SHORT3", cvt(fm.EI.engines[2].getRPM(), 0.0F, 10000F, 0.0F, 360F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_RPM_LONG3", cvt(fm.EI.engines[2].getRPM(), 0.0F, 10000F, 0.0F, 3600F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_RPM_SHORT4", cvt(fm.EI.engines[3].getRPM(), 0.0F, 10000F, 0.0F, 360F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_RPM_LONG4", cvt(fm.EI.engines[3].getRPM(), 0.0F, 10000F, 0.0F, 3600F), 0.0F, 0.0F);
