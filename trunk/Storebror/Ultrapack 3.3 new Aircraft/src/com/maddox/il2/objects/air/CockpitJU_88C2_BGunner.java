...
public class CockpitJU_88C2_BGunner extends CockpitGunner
{
    ...
    protected void doFocusLeave()
    {
        if(isFocused())
        {
            ...
            aircraft().hierMesh().chunkVisible("Pilot4_D0", !aircraft().hierMesh().isChunkVisible("Pilot4_D1"));
            aircraft().hierMesh().chunkVisible("HMask4_D0", aircraft().hierMesh().isChunkVisible("HMask1_D0"));
    ...
    public CockpitJU_88C2_BGunner()
    {
        ...
        this.cockpitNightMats = (new String[] {
            "88a4_I_Set2", "88a4_I_Set3", "88a4_I_Set4", "88a4_I_Set6", "88a4_SlidingGlass", "88gardinen", "Peil1", "Pedal", "skala"
        });
        setNightMats(false);
