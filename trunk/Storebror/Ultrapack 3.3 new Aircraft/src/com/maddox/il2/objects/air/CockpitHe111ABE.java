...
public class CockpitHe111ABE extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			CockpitHe111ABE.this.setTmp = CockpitHe111ABE.this.setOld;
			CockpitHe111ABE.this.setOld = CockpitHe111ABE.this.setNew;
			CockpitHe111ABE.this.setNew = CockpitHe111ABE.this.setTmp;
			CockpitHe111ABE.this.setNew.altimeter = CockpitHe111ABE.this.fm.getAltitude();
			CockpitHe111ABE.this.setNew.throttlel = (10F * CockpitHe111ABE.this.setOld.throttlel + CockpitHe111ABE.this.fm.EI.engines[0].getControlThrottle()) / 11F;
			CockpitHe111ABE.this.setNew.throttler = (10F * CockpitHe111ABE.this.setOld.throttler + CockpitHe111ABE.this.fm.EI.engines[1].getControlThrottle()) / 11F;
			CockpitHe111ABE.this.w.set(CockpitHe111ABE.this.fm.getW());
			CockpitHe111ABE.this.fm.Or.transform(CockpitHe111ABE.this.w);
			CockpitHe111ABE.this.setNew.turn = (12F * CockpitHe111ABE.this.setOld.turn + CockpitHe111ABE.this.w.z) / 13F;
			float f = CockpitHe111ABE.this.waypointAzimuth();
			CockpitHe111ABE.this.setNew.waypointAzimuth.setDeg(CockpitHe111ABE.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHe111ABE.this.setOld.azimuth.getDeg(1.0F));
			CockpitHe111ABE.this.setNew.azimuth.setDeg(CockpitHe111ABE.this.setOld.azimuth.getDeg(1.0F), CockpitHe111ABE.this.fm.Or.azimut());
			CockpitHe111ABE.this.setNew.vspeed = (499F * CockpitHe111ABE.this.setOld.vspeed + CockpitHe111ABE.this.fm.getVertSpeed()) / 500F;
			return true;
		}
	...
	static {
		Property.set(CockpitHe111ABE.class, "normZNs", new float[] { 1.0F, 1.0F, 1.25F, 1.0F });
	}
}
