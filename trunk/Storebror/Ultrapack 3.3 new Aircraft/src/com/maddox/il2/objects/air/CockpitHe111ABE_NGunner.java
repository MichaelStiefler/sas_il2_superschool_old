...
public class CockpitHe111ABE_NGunner extends CockpitGunner {
	...
	public CockpitHe111ABE_NGunner() {
	...
	static {
		Property.set(CockpitHe111ABE_NGunner.class, "aiTuretNum", 0);
		Property.set(CockpitHe111ABE_NGunner.class, "weaponControlNum", 10);
		Property.set(CockpitHe111ABE_NGunner.class, "astatePilotIndx", 1);
	}
}
