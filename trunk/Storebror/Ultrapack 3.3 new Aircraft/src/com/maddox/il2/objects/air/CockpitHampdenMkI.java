...
public class CockpitHampdenMkI extends CockpitPilot
{
    ...
    {
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, 0.48F);
        ...
        this.mesh.chunkSetAngles("Z_Fuel1", 0.0F, 0.0F, cvt(this.fm.M.fuel, 0.0F, 910F, 0.0F, 77F));
        this.mesh.chunkSetAngles("Z_Fuel2", 0.0F, 0.0F, cvt(this.fm.M.fuel, 0.0F, 910F, 0.0F, 77F));
        this.mesh.chunkSetAngles("Z_FuelPres1", 0.0F, cvt(this.fm.M.fuel > 1.0F ? 10F * this.fm.EI.engines[0].getPowerOutput() : 0.0F, 0.0F, 10F, 0.0F, 277F), 0.0F);
        this.mesh.chunkSetAngles("Z_FuelPres2", 0.0F, cvt(this.fm.M.fuel > 1.0F ? 10F * this.fm.EI.engines[1].getPowerOutput() : 0.0F, 0.0F, 10F, 0.0F, 277F), 0.0F);
