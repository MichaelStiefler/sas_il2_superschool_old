...
public class CockpitManchesterIa_Bombardier extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(bEntered)
            {
                float f = ((ManchesterBombers) ((Manchester_Ia)aircraft())).fSightCurForwardAngle;
                float f1 = -((ManchesterBombers) ((Manchester_Ia)aircraft())).fSightCurSideslip;
    ...
    {
        this.mesh.chunkSetAngles("zMark1", ((ManchesterBombers) ((Manchester_Ia)aircraft())).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = cvt(((ManchesterBombers) ((Manchester_Ia)aircraft())).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
