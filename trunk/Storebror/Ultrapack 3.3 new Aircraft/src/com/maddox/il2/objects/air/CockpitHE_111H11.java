...
public class CockpitHE_111H11 extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            float f4 = fm.Or.getKren();
            float f5 = fm.Or.getTangage();
            ...
            {
                Pn.set(fm.Loc);
                Pn.z = (double)fm.getAltitude() - Engine.cur.land.HQ(Pn.x, Pn.y);
                double d = Pn.z * (double)(float)Math.tan(Geom.DEG2RAD(f4));
                double d1 = Pn.z * (double)(float)Math.tan(Geom.DEG2RAD(f5));
                Pn.z = (float)Math.sqrt(d * d + d1 * d1 + Pn.z * Pn.z);
                if(fm.CT.getGear() > 0.5F)
                    Pn.z = cvt((float)Pn.z, 0.0F, 150F, 0.0F, 236F);
                else
                    Pn.z = cvt((float)Pn.z, 0.0F, 750F, 0.0F, 236F);
            }
            setNew.AFN101 = 0.9F * setOld.AFN101 + 0.1F * (float)Pn.z;
            return true;
        }
    ...
    public CockpitHE_111H11()
    {
        ...
        this.cockpitNightMats = (new String[] {
            "clocks1C", "clocks2C", "clocks3B", "clocks4", "clocks5", "clocks6", "clocks7", "clocks8C"
        });
        setNightMats(false);
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        this.mesh.chunkSetAngles("zHour", cvt(World.getTimeofDay(), 0.0F, 24F, -6F, 714F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zMinute", cvt(World.getTimeofDay() % 1.0F, 0.0F, 1.0F, -6F, 356F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zSecond", cvt(((World.getTimeofDay() % 1.0F) * 60F) % 1.0F, 0.0F, 1.0F, -6F, 356F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zAlt2", cvt(interp(setNew.altimeter, setOld.altimeter, f), 0.0F, 10000F, -90F, 90F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zVSI", cvt(setNew.vspeed, -15F, 15F, -135F, 135F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zTurnBank", cvt(setNew.turn, -0.23562F, 0.23562F, 25F, -25F), 0.0F, 0.0F);
        float f1 = getBall(4.5D);
        this.mesh.chunkSetAngles("zBall", cvt(f1, -4F, 4F, -6F, 6F), 0.0F, 0.0F);
        float f2 = this.fm.Or.getKren();
        this.mesh.chunkSetAngles("zAH1", 0.0F, -f2, 0.0F);
        resetYPRmodifier();
        float f3 = this.fm.Or.getTangage();
        Cockpit.xyz[1] = cvt(f3, -45F, 45F, -0.014F, 0.014F);
        this.mesh.chunkSetLocate("zHorizon", Cockpit.xyz, Cockpit.ypr);
        this.mesh.chunkSetAngles("zBall2", cvt(f1, -4F, 4F, -12.5F, 12.5F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zBall3", cvt(f1, -4F, 4F, -12.5F, 12.5F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zAFN101a", setNew.AFN101, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("AFN101b", cvt(this.fm.CT.getGear(), 0.5F, 0.6F, 0.0F, -45F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zBoost1", cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F, 328F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zBoost2", cvt(this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F, 0.0F, 328F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zOilTemp1", cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 120F, 0.0F, 70F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zOilTemp2", cvt(this.fm.EI.engines[1].tOilIn, 0.0F, 120F, 0.0F, 70F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zCoolant1", cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 120F, 0.0F, 70F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zCoolant2", cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 120F, 0.0F, 70F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zFC-1", cvt(setNew.consL, 0.0F, 500F, 0.0F, -270F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zFC-2", cvt(setNew.consR, 0.0F, 500F, 0.0F, -270F), 0.0F, 0.0F);
        if(useRealisticNavigationInstruments())
        {
    ...
    static 
    {
        Property.set(CockpitHE_111H11.class, "normZNs", new float[] {
