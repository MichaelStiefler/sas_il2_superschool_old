...
public class CockpitJU_88C2_LGunner extends CockpitGunner
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(fm != null)
            {
                ...
                if(buzzerFX != null)
                    if(fm.Loc.z < (double)((JU_88C2)aircraft()).fDiveRecoveryAlt && ((JU_88C2)((Interpolate) (fm)).actor).diveMechStage == 1)
                        buzzerFX.play();
                    else
    ...
    protected boolean doFocusEnter()
    {
        if(super.doFocusEnter())
        {
            ...
            if(!((JU_88C2)aircraft()).topBlisterRemoved)
            {
            ...
            if(!((JU_88C2)aircraft()).blisterRemoved)
            {
                aircraft().hierMesh().chunkVisible("Turret4B_D0", false);
                aircraft().hierMesh().chunkVisible("BlisterDown_D0", false);
            }
            return true;
        } else
        {
    ...
    protected void doFocusLeave()
    {
        ...
        if(!((JU_88C2)aircraft()).blisterRemoved)
        {
            ...
            aircraft().hierMesh().chunkVisible("BlisterDown_D0", true);
        }
        super.doFocusLeave();
    }
    ...
    public void moveGun(Orient orient)
    {
        ...
        if(f2 > 20F)
            this.mesh.chunkSetAngles("CameraRodC", 0.0F, f2 - f1, 0.0F);
        else
            this.mesh.chunkSetAngles("CameraRodC", 0.0F, 0.0F, 0.0F);
    }
    ...
    public void clipAnglesGun(Orient orient)
    {
        ...
        if(f > 3F)
        {
            if(f1 < cvt(f, 3F, 8.4F, -1.72F, -10F))
                f1 = cvt(f, 3F, 8.4F, -1.72F, -10F);
        } else
        if(f > -5.3F)
        {
            if(f1 < cvt(f, -5.3F, 3F, -1.72F, -1.72F))
                f1 = cvt(f, -5.3F, 3F, -1.72F, -1.72F);
        } else
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        this.mesh.chunkSetAngles("z_Object20", cvt(((JU_88C2)aircraft()).fSightCurSpeed, 400F, 800F, 87F, -63.5F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zAlt3", (((JU_88C2)aircraft()).fDiveRecoveryAlt * 360F) / 6000F, 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Compass3", setNew.waypointAzimuth.getDeg(f * 0.1F) - 90F, 0.0F, 0.0F);
