// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 24.11.2020 10:44:57
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: fullnames 
// Source File Name:   CockpitBC18.java
...
//            CockpitPilot, BC18, Cockpit

public class CockpitBC18 extends com.maddox.il2.objects.air.CockpitPilot
{
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                if(useRealisticNavigationInstruments())
                {
                    ...
                    if(((com.maddox.il2.fm.FlightModelMain) (fm)).AS.listenLorenzBlindLanding && ((com.maddox.il2.fm.FlightModelMain) (fm)).AS.isAAFIAS)
                    {
                ...
                if(bBC18 != null)
                    setNew.PDI = bBC18.fSightCurSideslip;
    ...
    public CockpitBC18()
    {
        super("3DO/Cockpit/BC18/hier.him", "bf109");
        ...
        setNightMats(false);
        if(aircraft() instanceof com.maddox.il2.objects.air.BC18)
            bBC18 = (com.maddox.il2.objects.air.BC18)aircraft();
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        {
            resetYPRmodifier();
            com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getGearC(), 0.0F, 1.0F, 0.0F, 0.0135F);
        ...
        {
            resetYPRmodifier();
            com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getGearL(), 0.0F, 1.0F, 0.0F, 0.0135F);
        ...
        {
            resetYPRmodifier();
            com.maddox.il2.objects.air.Cockpit.xyz[1] = cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getGearR(), 0.0F, 1.0F, 0.0F, 0.0135F);
        ...
        super.mesh.chunkSetAngles("Z_FuelPres1", 0.0F, cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).M.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
        super.mesh.chunkSetAngles("Z_FuelPres2", 0.0F, cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).M.fuel > 1.0F ? 0.78F : 0.0F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
        ...
        super.mesh.chunkSetAngles("Z_Temp1", 0.0F, -cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].tWaterOut, 0.0F, 350F, 0.0F, 102.5F), 0.0F);
        super.mesh.chunkSetAngles("Z_Temp2", 0.0F, cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[1].tWaterOut, 0.0F, 350F, 0.0F, 102.5F), 0.0F);
        super.mesh.chunkSetAngles("zOilTemp1", 0.0F, cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].tOilIn, -70F, 150F, 34F, -76F), 0.0F);
        super.mesh.chunkSetAngles("zOilTemp2", 0.0F, -cvt(((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[1].tOilIn, -70F, 150F, 34F, -76F), 0.0F);
        super.mesh.chunkSetAngles("Z_Oilpres1", 0.0F, cvt(1.0F + 0.05F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[1].tOilIn * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[1].getReadyness(), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
        super.mesh.chunkSetAngles("Z_Oilpres2", 0.0F, cvt(1.0F + 0.05F * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].tOilIn * ((com.maddox.il2.fm.FlightModelMain) (super.fm)).EI.engines[0].getReadyness(), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
        ...
        super.mesh.chunkSetAngles("BL_Vert", cvt(setNew.ilsLoc, -63F, 63F, -45F, 45F), 0.0F, 0.0F);
        if(setNew.ilsGS >= 0.0F)
            super.mesh.chunkSetAngles("BL_Horiz", cvt(setNew.ilsGS, 0.0F, 0.5F, 0.0F, 40F), 0.0F, 0.0F);
        else
            super.mesh.chunkSetAngles("BL_Horiz", cvt(setNew.ilsGS, -0.3F, 0.0F, -40F, 0.0F), 0.0F, 0.0F);
        if(((com.maddox.il2.fm.FlightModelMain) (super.fm)).AS.isAAFIAS)
        ...
        super.mesh.chunkVisible("Z_GearCGreen1", ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getGearC() > 0.99F && ((com.maddox.il2.fm.FlightModelMain) (super.fm)).Gears.cgear);
        super.mesh.chunkVisible("Z_GearLGreen1", ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getGearL() > 0.99F && ((com.maddox.il2.fm.FlightModelMain) (super.fm)).Gears.lgear);
        super.mesh.chunkVisible("Z_GearRGreen1", ((com.maddox.il2.fm.FlightModelMain) (super.fm)).CT.getGearR() > 0.99F && ((com.maddox.il2.fm.FlightModelMain) (super.fm)).Gears.rgear);
    }
    ...
    private com.maddox.il2.objects.air.BC18 bBC18;
