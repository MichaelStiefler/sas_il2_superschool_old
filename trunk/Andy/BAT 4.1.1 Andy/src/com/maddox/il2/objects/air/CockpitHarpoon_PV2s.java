// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 24.11.2020 11:08:14
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: fullnames 
// Source File Name:   CockpitHarpoon_PV2s.java
...
public class CockpitHarpoon_PV2s extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    protected boolean doFocusEnter()
    {
        if(super.doFocusEnter())
        {
            ...
            aircraft().hierMesh().chunkVisible("CF_D1", false);
            aircraft().hierMesh().chunkVisible("CF_D2", false);
    ...
    public CockpitHarpoon_PV2s()
    {
        super("3DO/Cockpit/Harpoon_PV2s/Harpoon.him", "bf109");
