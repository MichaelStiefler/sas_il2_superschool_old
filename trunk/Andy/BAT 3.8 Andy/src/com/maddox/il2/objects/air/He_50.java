...
public class He_50 extends Susie123 implements TypeStormovik, TypeDiveBomber {
    ...
    static {
        Class class1 = He_50.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Susie");
        Property.set(class1, "meshName", "3DO/Plane/He_50/hier.him");
