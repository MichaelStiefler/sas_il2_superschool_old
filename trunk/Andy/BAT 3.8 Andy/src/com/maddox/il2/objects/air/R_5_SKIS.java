 ...
 implements TypeBomber, TypeStormovik
{
    ...
    public boolean turretAngles(int i, float af[])
    {
        ...
        if(f1 > 75F) {
         ...
         if(f1 < -3.5F && f > -12.0F && f < 12.0F)
         {
           f1 = -3.5F;
           flag = false;
         } else if(f > -37.0F && f <= -12.0F && f1 < cvt(f, -37F, -12F, -30F, -3.5F))
         {
           f1 = cvt(f, -37F, -12F, -30F, -3.5F);
           flag = false;
         } else if(f >= 12.0F && f < 37.0F &&  f1 < cvt(f, 12F, 37F, -3.5F, -30F))
         {
           f1 = cvt(f, 12F, 37F, -3.5F, -30F);
           flag = false;
         } else if(f > -60.0F && f <= -37.0F && f1 < cvt(f, -60F, -37F, -45F, -30F))
         {
           f1 = cvt(f, -60F, -37F, -45F, -30F);
           flag = false;
         } else if(f >= 37.0F && f < 60.0F &&  f1 < cvt(f, 37F, 60F, -30F, -45F))
         {
    ...
    public static String getSkinPrefix(String s, Regiment regiment)
    {
        ...
        if(regiment.country().equals(((Object) (PaintScheme.countryRussia))))
        {
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.air.R_5_SKIS.class;
        ...
        Property.set(class1, "FlightModel", "FlightModels/R-5-Skis.fmd:dt_r-5_fm");		
        Property.set(class1, "cockpitClass", new Class[] {
            com.maddox.il2.objects.air.CockpitR_5dt.class, com.maddox.il2.objects.air.CockpitR_5_OP1.class, com.maddox.il2.objects.air.CockpitR_5_Bombardier.class, com.maddox.il2.objects.air.CockpitR_5_TGunner.class
        });
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07",
            ...
            "_ExternalBomb09", "_ExternalBomb10",
