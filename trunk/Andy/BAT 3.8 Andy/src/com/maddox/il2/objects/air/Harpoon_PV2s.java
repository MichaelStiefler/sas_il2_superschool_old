// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 10.02.2020 06:27:40
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: fullnames 
// Source File Name:   Harpoon_PV2s.java
...
//            Venturas123, PaintSchemeBMPar00, TypeStormovik, TypeBomber, 
//            NetAircraft, Aircraft

public class Harpoon_PV2s extends com.maddox.il2.objects.air.Venturas123
    implements com.maddox.il2.objects.air.TypeStormovik, com.maddox.il2.objects.air.TypeBomber
{
    ...
    public void typeBomberAdjDistancePlus()
    {
        ...
        fSightCurDistance = com.maddox.il2.objects.air.Harpoon_PV2s.toMeters(fSightCurAltitude) * (float)java.lang.Math.tan(java.lang.Math.toRadians(fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f)
    {
        ...
        if(bSightAutomation)
        {
            fSightCurDistance -= com.maddox.il2.objects.air.Harpoon_PV2s.toMetersPerSecond(fSightCurSpeed) * f;
            if(fSightCurDistance < 0.0F)
            {
                fSightCurDistance = 0.0F;
                typeBomberToggleAutomation();
            }
            fSightCurForwardAngle = (float)java.lang.Math.toDegrees(java.lang.Math.atan(fSightCurDistance / com.maddox.il2.objects.air.Harpoon_PV2s.toMeters(fSightCurAltitude)));
            if((double)fSightCurDistance < (double)com.maddox.il2.objects.air.Harpoon_PV2s.toMetersPerSecond(fSightCurSpeed) * java.lang.Math.sqrt(com.maddox.il2.objects.air.Harpoon_PV2s.toMeters(fSightCurAltitude) * 0.2038736F))
                bSightBombDump = true;
            if(bSightBombDump)
                if(FM.isTick(3, 0))
                {
    ...
    static 
    {
        java.lang.Class class1 = com.maddox.il2.objects.air.Harpoon_PV2s.class;
        new NetAircraft.SPAWN(class1);
        com.maddox.rts.Property.set(class1, "iconFar_shortClassName", "Harpoon");
        com.maddox.rts.Property.set(class1, "meshName", "3DO/Plane/Harpoon_PV2s(Multi1)/hier.him");
        ...
        com.maddox.rts.Property.set(class1, "cockpitClass", new java.lang.Class[] {
            com.maddox.il2.objects.air.CockpitHarpoon_PV2s.class, com.maddox.il2.objects.air.CockpitHarpoon_PV2s_TGunner.class
        });
        ...
        com.maddox.il2.objects.air.Aircraft.weaponHooksRegister(class1, new java.lang.String[] {
            ...
            "_BombSpawn07", "_BombSpawn08", "_BombSpawn09", "_BombSpawn10", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_MGUN09", "_MGUN10", 
            "_MGUN11", "_ExternalRock01", "_ExternalRock02", "_ExternalRock03", "_ExternalRock04", "_ExternalRock05", "_ExternalRock06", "_ExternalRock07", "_ExternalRock08", "_ExternalDev01", 
