// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 24.05.2020 11:58:56
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: fullnames 
// Source File Name:   CockpitZeppelin_M.java
...
public class CockpitZeppelin_M extends com.maddox.il2.objects.air.CockpitPilot
{
    ...
    public CockpitZeppelin_M()
    {
        super("3DO/Cockpit/Zeppelin_M/hier.him", "i16");
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        super.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, floatindex(cvt(com.maddox.il2.fm.Pitot.Indicator((float)((com.maddox.JGP.Tuple3d) (((com.maddox.il2.fm.FlightModelMain) (super.fm)).Loc)).z, super.fm.getSpeedKMH()), 50F, 400F, 1.0F, 8F), speedometerScale), 0.0F);
        super.mesh.chunkSetAngles("Z_Speedometer2", 0.0F, floatindex(cvt(com.maddox.il2.fm.Pitot.Indicator((float)((com.maddox.JGP.Tuple3d) (((com.maddox.il2.fm.FlightModelMain) (super.fm)).Loc)).z, super.fm.getSpeedKMH()), 50F, 400F, 1.0F, 8F), speedometerScale), 0.0F);
        w.set(super.fm.getW());
        ...
        super.mesh.chunkSetAngles("Z_Variometr", 0.0F, cvt(setNew.vspeed, -40F, 40F, -180F, 180F)+90F, 0.0F);
        for(int j = 0; j < 4; j++)
