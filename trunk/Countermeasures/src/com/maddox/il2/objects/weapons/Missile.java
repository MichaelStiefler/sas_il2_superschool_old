...
//TODO: For RWR
  public int RWRDetectorMode = 0;
  
  protected static java.util.ArrayList activeMissiles = new java.util.ArrayList(0);
  private static RangeRandom theRangeRandom;

//TODO: For RWR
	public int getMissileDetectorType() {
		return this.RWRDetectorMode = Property.intValue(this, "detectorType", Missile.DETECTOR_TYPE_MANUAL);
	}
