...
public class PaintSchemeFCSPar05 extends PaintSchemeFMPar05
{
    ...
    public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k)
    {
        ...
        if(regiment.country() == PaintScheme.countryUSA)
        {
            ...
            changeMat(hiermesh, "Overlay2", "psFCS05USALNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/" + (char)((65 + k) - 1) + ".tga", "null.tga", 0.21F * PaintScheme.psBritishSkyColor[0], 0.21F * PaintScheme.psBritishSkyColor[1], 0.21F * PaintScheme.psBritishSkyColor[2], 1.0F, 1.0F, 1.0F);
            changeMat(hiermesh, "Overlay3", "psFCS05USARNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/" + (char)((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, 0.21F * PaintScheme.psBritishSkyColor[0], 0.21F * PaintScheme.psBritishSkyColor[1], 0.21F * PaintScheme.psBritishSkyColor[2]);
        }
        if(regiment.country() == PaintScheme.countryUSABlue)
        {
            k = clampToLiteral(k);
