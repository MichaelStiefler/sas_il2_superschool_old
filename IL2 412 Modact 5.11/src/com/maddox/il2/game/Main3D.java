...
//        CmdEnv.top().exec("load com.maddox.rts.cmd.CmdSFS NAME saspreload");
//        CmdEnv.top().exec("saspreload MOUNT SAS_SFS/sas_basic_50.sfs");
...
;
    ...
    public boolean saveRecordedMission(String s)
    {
        ...
        try {
	        ...
	        sectfile.lineAdd(i, "133", "");
	        long l = Finger.incLong(mission.finger(), 133);
