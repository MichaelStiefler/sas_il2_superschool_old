...
public class CockpitU2VS_TGunner extends CockpitGunner {
	...
	protected boolean doFocusEnter() {
		if (super.doFocusEnter()) {
			aircraft().hierMesh().chunkVisible("VatorLRodN_D0", false);
			aircraft().hierMesh().chunkVisible("VatorLRodR_D0", false);
			aircraft().hierMesh().chunkVisible("VatorLRodV_D0", false);
			aircraft().hierMesh().chunkVisible("VatorRRodN_D0", false);
			aircraft().hierMesh().chunkVisible("VatorRRodR_D0", false);
			aircraft().hierMesh().chunkVisible("VatorRRodV_D0", false);
			return true;
		} else {
			return false;
		}
	...
	protected void doFocusLeave() {
		aircraft().hierMesh().chunkVisible("VatorLRodN_D0", true);
		aircraft().hierMesh().chunkVisible("VatorLRodR_D0", true);
		aircraft().hierMesh().chunkVisible("VatorLRodV_D0", true);
		aircraft().hierMesh().chunkVisible("VatorRRodN_D0", true);
		aircraft().hierMesh().chunkVisible("VatorRRodR_D0", true);
		aircraft().hierMesh().chunkVisible("VatorRRodV_D0", true);
		super.doFocusLeave();
	}

	public CockpitU2VS_TGunner() {
		super("3DO/Cockpit/U-2vs/hiergun.him", "i16");
	...
	protected void reflectPlaneToModel() {
		...
		mesh.chunkVisible("Head1_D0", hiermesh.isChunkVisible("Head1_D0"));
