...
public class CockpitBF_110C4 extends CockpitPilot {
	...
	public CockpitBF_110C4() {
		super("3DO/Cockpit/Bf-110C/hier.him", "bf109");
		...
		cockpitNightMats = (new String[] { "bague1", "bague2", "boitier", "cadran1", "cadran2", "cadran3", "cadran4", "cadran5", "cadran6", "cadran7", "cadran8", "consoledr2", "enggauge", "fils", "gauche", "skala" });
		setNightMats(false);
		interpPut(new Interpolater(), null, Time.current(), null);
		printCompassHeading = true;
		if (acoustics != null)
			acoustics.globFX = new ReverbFXRoom(0.3F);
		limits6DoF = (new float[] { 0.7F, 0.055F, -0.07F, 0.11F, 0.15F, -0.11F, 0.03F, -0.025F });
	}
	...
	static {
		Property.set(CLASS.THIS(), "normZNs", new float[] { 1.29F, 1.0F, 1.0F, 1.0F });
	}
