...
public class B_25G1 extends B_25 implements TypeStormovik, TypeStormovikArmored {
	...
	static {
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitB25G1.class, CockpitB25G1_Copilot.class, CockpitB25G1_TGunner.class });
