...
public class HE_111Z extends Scheme5 implements TypeTransport {
		...
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				if (s.endsWith("p1") || s.endsWith("p6")) {
					...
					else if (v1.x > 0.93969261646270752D)
						getEnergyPastArmor((10D / v1.x) * (double) World.Rnd().nextFloat(1.0F, 1.2F), shot);
				} else if (s.endsWith("p2") || s.endsWith("p7"))
					getEnergyPastArmor(5D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
				else if (s.endsWith("p3a") || s.endsWith("p3b") || s.endsWith("p8a") || s.endsWith("p8b"))
					getEnergyPastArmor(8D / (Math.abs(v1.x) * (double) World.Rnd().nextFloat(1.0F, 1.2F) + 9.9999997473787516E-005D), shot);
				else if (s.endsWith("p4") || s.endsWith("p9")) {
					if (v1.x > 0.70710676908493042D)
						getEnergyPastArmor(8D / (v1.x * (double) World.Rnd().nextFloat(1.0F, 1.2F) + 0.0010000000474974513D), shot);
					else if (v1.x > -0.70710676908493042D)
						getEnergyPastArmor(6F, shot);
				} else if (s.endsWith("o1") || s.endsWith("o2") || s.endsWith("o3") || s.endsWith("o4") || s.endsWith("o5"))
					if (v1.x > 0.70710676908493042D)
						getEnergyPastArmor(8D / (v1.x * (double) World.Rnd().nextFloat(1.0F, 1.2F) + 9.9999997473787516E-005D), shot);
					else
			...
			if (s.startsWith("xxspar")) {
				if ((s.endsWith("ta1") || s.endsWith("ta2")) && World.Rnd().nextFloat() < 0.1F && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(12.9F / (float) Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F) {
					debuggunnery("Tail1 Spars Broken in Half..");
					nextDMGLevels(3, 2, "Tail1_D3", shot.initiator);
				}
				if ((s.endsWith("ta3") || s.endsWith("ta4")) && World.Rnd().nextFloat() < 0.1F && chunkDamageVisible("Tail2") > 2 && getEnergyPastArmor(12.9F / (float) Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F) {
					debuggunnery("Tail2 Spars Broken in Half..");
					nextDMGLevels(3, 2, "Tail2_D3", shot.initiator);
				}
				if ((s.endsWith("li1") || s.endsWith("li2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.92000001668930054D * Math.abs(v1.x) && chunkDamageVisible("WingLIn") > 2
						&& getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debuggunnery("WingLIn Spars Damaged..");
					nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
				}
				if ((s.endsWith("ri1") || s.endsWith("ri2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.92000001668930054D * Math.abs(v1.x) && chunkDamageVisible("WingRIn") > 2
						&& getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debuggunnery("WingRIn Spars Damaged..");
					nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
				}
				if ((s.endsWith("lm1") || s.endsWith("lm2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.86000001430511475D * Math.abs(v1.x) && chunkDamageVisible("WingLMid") > 2
						&& getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debuggunnery("WingLMid Spars Damaged..");
					nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
				}
				if ((s.endsWith("rm1") || s.endsWith("rm2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.86000001430511475D * Math.abs(v1.x) && chunkDamageVisible("WingRMid") > 2
						&& getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debuggunnery("WingRMid Spars Damaged..");
					nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
				}
				if ((s.endsWith("lo1") || s.endsWith("lo2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * Math.abs(v1.x) && chunkDamageVisible("WingLOut") > 2
						&& getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debuggunnery("WingLOut Spars Damaged..");
					nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
				}
				if ((s.endsWith("ro1") || s.endsWith("ro2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * Math.abs(v1.x) && chunkDamageVisible("WingROut") > 2
						&& getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debuggunnery("WingROut Spars Damaged..");
					nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
				}
				if ((s.endsWith("k1") || s.endsWith("k2")) && (double) World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * Math.abs(v1.x) && chunkDamageVisible("Keel1") > 1 && getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debuggunnery("Keel1 Spars Damaged..");
					nextDMGLevels(1, 2, "Keel1_D2", shot.initiator);
				}
				if ((s.endsWith("k3") || s.endsWith("k4")) && (double) World.Rnd().nextFloat() < 1.0D - 0.79000002145767212D * Math.abs(v1.x) && chunkDamageVisible("Keel1") > 1 && getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
			...
			if (s.startsWith("xxengine")) {
				...
				} else if (s.endsWith("oil1") && getEnergyPastArmor(0.21F, shot) > 0.0F) {
	...
	public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
		float f3 = Math.max(-f * 1100F, -80F);
		float f4 = Math.max(-f1 * 1100F, -80F);
		hiermesh.chunkSetAngles("GearC2_D0", 0.0F, 60F * f2, 0.0F);
		...
		hiermesh.chunkSetAngles("GearL7_D0", 0.0F, -f3 * f, 0.0F);
		hiermesh.chunkSetAngles("GearL8_D0", 0.0F, f3 * f, 0.0F);
		hiermesh.chunkSetAngles("GearL9_D0", 0.0F, -f3 * f, 0.0F);
		hiermesh.chunkSetAngles("GearL10_D0", 0.0F, f3 * f, 0.0F);
		hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 0.0F, 95F * f1);
		hiermesh.chunkSetAngles("GearR4_D0", 0.0F, -13.5F * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR5_D0", 0.0F, 36.5F * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR6_D0", 0.0F, -40F * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR7_D0", 0.0F, f4 * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR8_D0", 0.0F, -f4 * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR9_D0", 0.0F, f4 * f1, 0.0F);
		hiermesh.chunkSetAngles("GearR10_D0", 0.0F, -f4 * f1, 0.0F);
	}
	...
	public void doMurderPilot(int i) {
		...
		case 0: // '\0'
			...
			if (isChunkAnyDamageVisible("CF") && World.cur().isHighGore())
		...
		case 5: // '\005'
			if (isChunkAnyDamageVisible("Nose") && World.cur().isHighGore())
	...
	public void onAircraftLoaded() {
		this.FM.crew = 10;
		this.FM.AS.astatePilotFunctions[5] = (byte) 5;
	}
	...
	static {
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitHE_111Z.class, CockpitHE_111Z_RNGunner.class, CockpitHE_111Z_LNGunner.class, CockpitHE_111Z_RTGunner.class, CockpitHE_111Z_LTGunner.class, CockpitHE_111Z_RBGunner.class,
				CockpitHE_111Z_LBGunner.class, CockpitHE_111Z_RGunner.class, CockpitHE_111Z_LGunner.class });
		weaponTriggersRegister(class1, new int[] { 10, 11, 12, 13, 14, 15, 16, 17 });
		weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08" });
		weaponsRegister(class1, "default", new String[] { "MGunMG15t 150", "MGunMG15t 1000", "MGunMG15t 750", "MGunMG15t 750", "MGunMGFFt 450", "MGunMG15t 1000", "MGunMG15t 750", "MGunMG15t 750" });
