...
public class Config {
    ...
    private static final String _VERSION = "4.12.1";
    private static final int _TRACK_SINGLE_VERSION = 34;
	public static final int TRACK_NET_VERSION = 106;
	public static final boolean TRACK_CHECK = false;
	public static final String VERSION = "4.12.1m";
	public static final String NET_VERSION = "FB_PF_v_4.12.1m";
	public static final int TRACK_SINGLE_VERSION = 134;
