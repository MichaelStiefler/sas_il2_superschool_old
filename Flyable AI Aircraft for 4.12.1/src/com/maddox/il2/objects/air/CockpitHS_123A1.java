...
public class CockpitHS_123A1 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (fm != null) {
				...
				if (((HS_123A1) aircraft()).bChangedPit) {
					reflectPlaneToModel();
					((HS_123A1) aircraft()).bChangedPit = false;
				}
				setTmp = setOld;
				setOld = setNew;
				setNew = setTmp;
	...
	public CockpitHS_123A1() {
		...
		limits6DoF = (new float[] { 0.7F, 0.055F, -0.07F, 0.11F, 0.13F, -0.11F, 0.03F, -0.03F });
	}
