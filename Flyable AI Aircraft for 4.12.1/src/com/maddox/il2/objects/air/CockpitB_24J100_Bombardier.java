...
public class CockpitB_24J100_Bombardier extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			float f1 = ((B_24J100) aircraft()).fSightCurSideslip;
			CockpitB_24J100_Bombardier.calibrAngle = 360F - fm.Or.getPitch();
			mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, CockpitB_24J100_Bombardier.calibrAngle + f);
			if (bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(aAim + 10F * f1, tAim + CockpitB_24J100_Bombardier.calibrAngle + f, 0.0F);
			}
	...
	public CockpitB_24J100_Bombardier() {
		super("3DO/Cockpit/B-25J-Bombardier/BombardierB24J.him", "bf109");
		enteringAim = false;
		bEntered = false;
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (bEntered) {
			mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((B_24J100) aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((B_24J100) aircraft()).fSightCurReadyness > 0.93F;
	...
	static {
		Property.set(CockpitB_24J100_Bombardier.class, "astatePilotIndx", 0);
	}
