...
public class EnginesInterface extends FMMath
{
    ...
    {
        //TODO: +++ Catapult Mod Enhanced +++#
    	this.setCatapult(flag);
//        bCatapultArmed = true;
//        double d = f;
//        if(d > 8000D)
//            d = 8000D;
...
//        lCatapultStartTime = java.lang.System.currentTimeMillis();
    ...
    //TODO: +++ Catapult Mod Enhanced +++
    public void setCatapult(boolean flag)
    {
    	double dCatapultForceFactor = 15D;
    	if (flag) dCatapultForceFactor = 22D;
    	
    	dCatapultForceFactor *= Math.pow(this.reference.CruiseSpeed / 400.0F, 0.5F);
    	dCatapultForceFactor /= (double)this.num;
    	dCatapultForceFactor *= Math.pow(this.reference.M.getFullMass() / 5000.0F, 0.5F);
    	
    	dCatapultForce = this.reference.M.getFullMass() * dCatapultForceFactor;
    	
//    	DecimalFormat tp = new DecimalFormat("#.##");
//    	
//    	HUD.training("M:" + tp.format(this.reference.M.getFullMass()) + " F:" + tp.format(dCatapultForceFactor));
