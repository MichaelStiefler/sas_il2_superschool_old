...
public class MissileAIM7E extends Missile {
	static class SPAWN extends Missile.SPAWN {
		...
		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAIM7E(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAIM7E.class;
		...
		Property.set(class1, "timeFire", 8.0F); // Rocket Booster Burn time in Seconds
		Property.set(class1, "force", 41000F); // Rocket Booster Power (in Newton)
	...
	public MissileAIM7E(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
