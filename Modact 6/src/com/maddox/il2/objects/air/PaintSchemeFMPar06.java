...
public class PaintSchemeFMPar06 extends PaintScheme {
	...
	public void prepareNum(Class class1, HierMesh hiermesh, Regiment regiment, int i, int j, int k) {
		...
		if (regiment.country() == PaintScheme.countryGermany) {
			...
			changeMat(class1, hiermesh, "Overlay8", "opthaken3", "German/"
					+ (World.cur().isHakenAllowed() ? "optionhaken3.tga" : "hakenfake.tga"), 1.0F, 1.0F, 1.0F);
			if (k <= 1 && i == 0) {
				...
				if (j2 == 1 || j2 == 5) {
					...
					changeMat(class1, hiermesh, "Overlay2", "psFM06GERCOMCGID" + j2, "German/00cG" + j2 + ".tga", 1.0F, 1.0F,
							1.0F);
					changeMat(class1, hiermesh, "Overlay3", "psFM06GERCOMCGID" + j2, "German/00cG" + j2 + ".tga", 1.0F, 1.0F,
							1.0F);
				}
				return;
			}
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay1", "psFM06GERLNUM" + l + i + "0" + k, "German/1" + i1 + k % 10 + ".tga",
						1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay4", "psFM06GERRNUM" + l + i + "0" + k, "null.tga", "German/1" + i1 + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay1", "psFM06GERCNUM" + l + i + k, "German/1" + i1 + k / 10 + ".tga", "German/1" + i1
						+ k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay4", "psFM06GERCNUM" + l + i + k, "German/1" + i1 + k / 10 + ".tga", "German/1" + i1
						+ k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
			if (j2 == 1 || j2 == 5) {
				changeMat(class1, hiermesh, "Overlay2", "null", "null.tga", 1.0F, 1.0F, 1.0F);
				...
				changeMat(class1, hiermesh, "Overlay2", "psFM06GERGRUPP" + j2 + "S" + i1, "German/1" + i1 + "0G" + j2 + ".tga",
						1.0F, 1.0F, 1.0F);
				changeMat(class1, hiermesh, "Overlay3", "psFM06GERGRUPP" + j2 + "S" + i1, "German/1" + i1 + "0G" + j2 + ".tga",
						1.0F, 1.0F, 1.0F);
			}
			return;
		}
		if (regiment.country() == PaintScheme.countryNetherlands) {
			...
			changeMat(hiermesh, "Overlay1", "psBMIUDUTCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psBMIUDUTCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			return;
		}
		if (regiment.country() == PaintScheme.countrySouthAfricaS) {
			...
			changeMat(hiermesh, "Overlay3", "psFM06SASSNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psFM06SASSNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			return;
		}
		if (regiment.country() == PaintScheme.countrySouthAfricaB) {
			...
			changeMat(hiermesh, "Overlay3", "psFM06SASBNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psFM06SASBNUM" + (k >= 10 ? "" + k : "0" + k), "SAPRE/" + k / 10 + ".tga", "SA/"
					+ k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			return;
		}
		if (regiment.country() == PaintScheme.countryAngola) {
			changeMat(hiermesh, "Overlay4", "psFM06ANGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay1", "psFM06ANGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryMozambique) {
			changeMat(hiermesh, "Overlay4", "psFM06MZBCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay1", "psFM06MZBCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryAlbania) {
			changeMat(hiermesh, "Overlay4", "psBM00ALGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay1", "psBM00ALGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
			changeMat(class1, hiermesh, "Overlay8", "AlbaniaRoundel", "Albania/ALRoundel.tga", 1.0F, 1.0F, 1.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryCuba) {
			changeMat(hiermesh, "Overlay4", "psBM00CUGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay1", "psBM00CUGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryVietnamNorth) {
			changeMat(hiermesh, "Overlay4", "psBM00NVGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay1", "psBM00NVGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryChile) {
			changeMat(hiermesh, "Overlay1", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryNigeria) {
			changeMat(hiermesh, "Overlay1", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k),
					"Slovakian/" + k / 10 + ".tga", "Slovakian/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k),
					"Slovakian/" + k / 10 + ".tga", "Slovakian/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(class1, hiermesh, "Overlay6", "NigeriaRoundel", "Nigeria/NGRoundel.tga", 1.0F, 1.0F, 1.0F);
			changeMat(class1, hiermesh, "Overlay8", "NigeriaTail", "Nigeria/NGRoundel.tga", 1.0F, 1.0F, 1.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryAlgeria) {
			changeMat(hiermesh, "Overlay1", "psBM00AGGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay4", "psBM00AGGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryCambodia) {
			changeMat(hiermesh, "Overlay4", "psBM00CMGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "psBM00CMGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryEritrea) {
			changeMat(hiermesh, "Overlay4", "psBM00ETGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "psBM00ETGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(class1, hiermesh, "Overlay6", "EritreaWing", "Eritrea/ETWings.tga", 1.0F, 1.0F, 1.0F);
			changeMat(class1, hiermesh, "Overlay8", "EritreaTail", "Eritrea/ETWings.tga", 1.0F, 1.0F, 1.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryGuatemala) {
			changeMat(hiermesh, "Overlay4", "psBM00GLGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "psBM00GLGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryHonduras) {
			changeMat(hiermesh, "Overlay4", "psBM00HOGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "psBM00HOGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryIndonesia) {
			changeMat(hiermesh, "Overlay4", "psBM00DOGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "psBM00DOGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryIreland) {
			changeMat(hiermesh, "Overlay4", "psBM00ADGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "psBM00ADGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryLibya) {
			changeMat(hiermesh, "Overlay4", "psBM00LYGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "psBM00LYGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryMalaysia) {
			changeMat(hiermesh, "Overlay4", "psBM00MYGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "psBM00MYGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countrySingapore) {
			changeMat(hiermesh, "Overlay4", "psBM00SIGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "psBM00SIGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryVenezuala) {
			changeMat(hiermesh, "Overlay4", "psBM00VZGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "psBM00VZGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryGermanyBlue) {
			changeMat(hiermesh, "Overlay1", "psFM03GPNREGI" + regiment.id(), "German/" + regiment.aid()[0] + ".tga", "German/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "psFM03GPNREGI" + regiment.id(), "German/" + regiment.aid()[0] + ".tga", "German/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psFM03GPCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psFM03GPCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryEthiopia) {
			changeMat(hiermesh, "Overlay1", "psBM0JEHACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psBM0JEHACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryMorocco) {
			changeMat(hiermesh, "Overlay1", "psBM0JMRACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psBM0JMRACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryNicaragua) {
			changeMat(hiermesh, "Overlay1", "psBM0JNIACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psBM0JNIACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryPanama) {
			changeMat(hiermesh, "Overlay1", "psBM0JPMACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "psBM0JPMACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryVietnamSouth) {
			changeMat(hiermesh, "Overlay1", "psBM0JVNACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psBM0JVNACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryJordan) {
			changeMat(hiermesh, "Overlay1", "ArabicNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Arabic/1" + k / 10 + ".tga",
					"Arabic/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "ArabicNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Arabic/1" + k / 10 + ".tga",
					"Arabic/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryBiafra) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay1", "psFM03BIALNUM" + l + i + k, "Finnish/" + k % 10 + ".tga",
						PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
				changeMat(hiermesh, "Overlay4", "psFM03BIARNUM" + l + i + k, "null.tga", "Finnish/" + k % 10 + ".tga",
						PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2],
						PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
			} else {
				changeMat(hiermesh, "Overlay1", "psFM03BIACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
						PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
						PaintScheme.psBritishRedColor[2]);
				changeMat(hiermesh, "Overlay4", "psFM03BIACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
						PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
						PaintScheme.psBritishRedColor[2]);
			}
		...
		if (regiment.country() == PaintScheme.countryBorduria) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay1", "psFM03BDALNUM" + l + i + k, "Finnish/" + k % 10 + ".tga",
						PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
				changeMat(hiermesh, "Overlay4", "psFM03BDARNUM" + l + i + k, "null.tga", "Finnish/" + k % 10 + ".tga",
						PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2],
						PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
			} else {
				changeMat(hiermesh, "Overlay1", "psFM03BDACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
						PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
						PaintScheme.psBritishRedColor[2]);
				changeMat(hiermesh, "Overlay4", "psFM03BDACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
						PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
						PaintScheme.psBritishRedColor[2]);
			}
		...
		if (regiment.country() == PaintScheme.countryCostaRica) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay2", "psFM03CRALNUM" + l + i + k, "Finnish/" + k % 10 + ".tga", 1.0F, 1.0F,
						1.0F);
				changeMat(hiermesh, "Overlay3", "psFM03CRARNUM" + l + i + k, "null.tga", "Finnish/" + k % 10 + ".tga", 1.0F,
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay2", "psFM03CRACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFM03CRACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
		...
		if (regiment.country() == PaintScheme.countryCostaVerde) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay2", "psFM03CVALNUM" + l + i + k, "Finnish/" + k % 10 + ".tga", 1.0F, 1.0F,
						1.0F);
				changeMat(hiermesh, "Overlay3", "psFM03CVARNUM" + l + i + k, "null.tga", "Finnish/" + k % 10 + ".tga", 1.0F,
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay2", "psFM03CVACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFM03CVACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
		...
		if (regiment.country() == PaintScheme.countrySylvadia) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay2", "psFM03SLALNUM" + l + i + k, "Finnish/" + k % 10 + ".tga", 1.0F, 1.0F,
						1.0F);
				changeMat(hiermesh, "Overlay3", "psFM03SLARNUM" + l + i + k, "null.tga", "Finnish/" + k % 10 + ".tga", 1.0F,
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay2", "psFM03SLACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFM03SLACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
		...
		if (regiment.country() == PaintScheme.countryAustralia) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay1", "SAASRegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "SAASRegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "ABritishLnum_" + l + i + (k < 10 ? "0" + k : "" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "ABritishRnum_" + l + i + (k < 10 ? "0" + k : "" + k), "null.tga", "British/"
					+ (char)((65 + k) - 1) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryNewZeeland) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay1", "NZSARegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "NZSARegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "NZBritishLnum_" + l + i + (k < 10 ? "0" + k : "" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "NZBritishRnum_" + l + i + (k < 10 ? "0" + k : "" + k), "null.tga", "British/"
					+ (char)((65 + k) - 1) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryBotswana) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay2", "BTSARegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "BTSARegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "BTBritishLnum_" + l + i + (k < 10 ? "0" + k : "" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "BTBritishRnum_" + l + i + (k < 10 ? "0" + k : "" + k), "null.tga", "British/"
					+ (char)((65 + k) - 1) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryUganda) {
			changeMat(hiermesh, "Overlay4", "psBM00UGGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishOrangeColor[0], PaintScheme.psBritishOrangeColor[1],
					PaintScheme.psBritishOrangeColor[2], PaintScheme.psBritishOrangeColor[0],
					PaintScheme.psBritishOrangeColor[1], PaintScheme.psBritishOrangeColor[2]);
			changeMat(hiermesh, "Overlay1", "psBM00UGGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishOrangeColor[0], PaintScheme.psBritishOrangeColor[1],
					PaintScheme.psBritishOrangeColor[2], PaintScheme.psBritishOrangeColor[0],
					PaintScheme.psBritishOrangeColor[1], PaintScheme.psBritishOrangeColor[2]);
		...
		if (regiment.country() == PaintScheme.countryFinland) {
			char c = (char)(48 + k % 10);
			changeMat(class1, hiermesh, "Overlay6", "FAFhaken", "Finnish/"
					+ (World.cur().isHakenAllowed() ? "FAFhaken.tga" : "FAFroundel.tga"), 1.0F, 1.0F, 1.0F);
			changeMat(class1, hiermesh, "Overlay7", "FAFhaken", "Finnish/"
					+ (World.cur().isHakenAllowed() ? "FAFhaken.tga" : "FAFroundel.tga"), 1.0F, 1.0F, 1.0F);
			if (i == 3)
				changeMat(class1, hiermesh, "Overlay8", "psFM06FINCNUM" + l + i + "_" + (char)(65 + (k % 10 - 1)), "Finnish/"
						+ (char)(65 + (k % 10 - 1)) + ".tga", PaintScheme.psFinnishFighterColor[i][0],
						PaintScheme.psFinnishFighterColor[i][1], PaintScheme.psFinnishFighterColor[i][2]);
			else if (k < 10)
				changeMat(class1, hiermesh, "Overlay8", "psFM06FINCNUM" + l + i + "0" + k, "Finnish/0" + k + ".tga",
						PaintScheme.psFinnishFighterColor[i][0], PaintScheme.psFinnishFighterColor[i][1],
						PaintScheme.psFinnishFighterColor[i][2]);
			else
				changeMat(hiermesh, "Overlay8", "psFM06FINCNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", PaintScheme.psFinnishFighterColor[i][0], PaintScheme.psFinnishFighterColor[i][1],
						PaintScheme.psFinnishFighterColor[i][2], PaintScheme.psFinnishFighterColor[i][0],
						PaintScheme.psFinnishFighterColor[i][1], PaintScheme.psFinnishFighterColor[i][2]);
			String s1 = getFAFACCode(class1, i);
			changeMat(hiermesh, "Overlay2", "psFM06FINACID" + s1 + c, "Finnish/" + s1 + ".tga", "Finnish/sn" + c + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			changeMat(hiermesh, "Overlay3", "psFM06FINACID" + s1 + c, "Finnish/" + s1 + ".tga", "Finnish/sn" + c + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryFrance) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay2", "psFM06FRALNUM" + l + i + k, "Finnish/" + k % 10 + ".tga", 1.0F, 1.0F,
						1.0F);
				changeMat(hiermesh, "Overlay3", "psFM06FRARNUM" + l + i + k, "null.tga", "Finnish/" + k % 10 + ".tga", 1.0F,
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay2", "psFM06FRACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFM06FRACNUM" + l + i + k, "Finnish/" + k / 10 + ".tga", "Finnish/" + k % 10
						+ ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
		...
		if (regiment.country() == PaintScheme.countryBritain) {
			if ("ra".equals(regiment.branch()) || "rz".equals(regiment.branch()) || "rn".equals(regiment.branch())) {
				k = clampToLiteral(k);
				changeMat(hiermesh, "Overlay1", "psFM06BRINAVYREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
						"British/" + regiment.aid()[1] + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFM06BRINAVYREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
						"British/" + regiment.aid()[1] + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay2", "psFM06BRINAVYLNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/"
						+ (char)((65 + k) - 1) + ".tga", "null.tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay4", "psFM06BRINAVYRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga",
						"British/" + (char)((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				...
				k = clampToLiteral(k);
				changeMat(hiermesh, "Overlay1", "psFM06BRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
						"British/" + regiment.aid()[1] + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFM06BRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga",
						"British/" + regiment.aid()[1] + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay2", "psFM06BRILNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/"
						+ (char)((65 + k) - 1) + ".tga", "null.tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay4", "psFM06BRIRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/"
						+ (char)((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryBritainBlue) {
			...
			changeMat(hiermesh, "Overlay1", "psBBBBRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "psBBBBRIREGI" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psBBBBRILNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psBBBBRIRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/"
					+ (char)((65 + k) - 1) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(class1, hiermesh, "Overlay6", "britishroundel2c", "British/roundel2c.tga", 1.0F, 1.0F, 1.0F);
			changeMat(class1, hiermesh, "Overlay7", "britishroundel4cthin", "British/roundel4cthin.tga", 1.0F, 1.0F, 1.0F);
			changeMat(class1, hiermesh, "Overlay8", "BritBTail", "CA/CATail.tga", 1.0F, 1.0F, 1.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryHungary) {
			changeMat(hiermesh, "Overlay1", "psFM06HUNREGI" + regiment.id(), "German/" + regiment.aid()[0] + ".tga", "German/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "psFM06HUNREGI" + regiment.id(), "German/" + regiment.aid()[0] + ".tga", "German/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "psFM06HUNCNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"German/" + k / 10 + ".tga", "German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psFM06HUNCNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"German/" + k / 10 + ".tga", "German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryItaly) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay2", "psFM06ITALNUM" + l + i + k, "Italian/1" + k % 10 + ".tga", 1.0F, 1.0F,
						1.0F);
				changeMat(hiermesh, "Overlay3", "psFM06ITARNUM" + l + i + k, "null.tga", "Italian/1" + k % 10 + ".tga", 1.0F,
						1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			} else {
				changeMat(hiermesh, "Overlay2", "psFM06ITACNUM" + l + i + k, "Italian/1" + k / 10 + ".tga", "Italian/1" + k
						% 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
				changeMat(hiermesh, "Overlay3", "psFM06ITACNUM" + l + i + k, "Italian/1" + k / 10 + ".tga", "Italian/1" + k
						% 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			}
			changeMat(class1, hiermesh, "Overlay6", "italian3", "Italian/roundel0.tga", 0.1F, 0.1F, 0.1F);
		}
		if (regiment.country() == PaintScheme.countryJapan) {
			changeMat(hiermesh, "Overlay2", "psFM06JAPCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", PaintScheme.psRussianBomberColor[0][0],
					PaintScheme.psRussianBomberColor[0][1], PaintScheme.psRussianBomberColor[0][2],
					PaintScheme.psRussianBomberColor[0][0], PaintScheme.psRussianBomberColor[0][1],
					PaintScheme.psRussianBomberColor[0][2]);
			changeMat(hiermesh, "Overlay3", "psFM06JAPCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", PaintScheme.psRussianBomberColor[0][0],
					PaintScheme.psRussianBomberColor[0][1], PaintScheme.psRussianBomberColor[0][2],
					PaintScheme.psRussianBomberColor[0][0], PaintScheme.psRussianBomberColor[0][1],
					PaintScheme.psRussianBomberColor[0][2]);
		...
		if (regiment.country() == PaintScheme.countryPoland) {
			changeMat(hiermesh, "Overlay1", "psFM06POLCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay4", "psFM06POLCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryRomania) {
			changeMat(hiermesh, "Overlay8", "psFM06ROMCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryRussia) {
			changeMat(hiermesh, "Overlay1", "psFM06RUSCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay4", "psFM06RUSCNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "Russian/1" + k / 10
					+ ".tga", "Russian/1" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryNewZealand) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay1", "psFM00RZLNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", PaintScheme.psBritishWhiteColor[0],
					PaintScheme.psBritishWhiteColor[1], PaintScheme.psBritishWhiteColor[2], 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "psFM00RZRNUM" + l + i + (k >= 10 ? "" + k : "0" + k), "null.tga", "British/"
					+ (char)((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishWhiteColor[0],
		...
		if (regiment.country() == PaintScheme.countrySlovakia) {
			if (k < 10) {
				changeMat(class1, hiermesh, "Overlay4", "psFM06SLVKLNUM" + l + i + "0" + k, "Slovakian/" + k + ".tga", 0.1F,
						0.1F, 0.1F);
				changeMat(hiermesh, "Overlay1", "psFM06SLVKRNUM" + l + i + "0" + k, "null.tga", "Slovakian/" + k + ".tga",
						0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			} else {
				changeMat(hiermesh, "Overlay1", "psFM06SLVKCNUM" + l + i + k, "Slovakian/" + k / 10 + ".tga", "Slovakian/" + k
						% 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
				changeMat(hiermesh, "Overlay4", "psFM06SLVKCNUM" + l + i + k, "Slovakian/" + k / 10 + ".tga", "Slovakian/" + k
						% 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			}
		...
		if (regiment.country() == PaintScheme.countryUSA) {
			changeMat(hiermesh, "Overlay1", "psFM06USACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "psFM06USACNUM" + l + i + (k >= 10 ? "" + k : "0" + k),
					"States/" + k / 10 + ".tga", "States/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countrySwitzerland) {
			...
			changeMat(hiermesh, "Overlay2", "CHCode_" + s + (k < 10 ? "0" + k : "" + k), "Swiss/" + s + ".tga", "Swiss/" + k
					% 10 + ".tga", 0.95F, 0.95F, 0.95F, 0.95F, 0.95F, 0.95F);
			changeMat(hiermesh, "Overlay3", "CHCode_" + s + (k < 10 ? "0" + k : "" + k), "Swiss/" + s + ".tga", "Swiss/" + k
					% 10 + ".tga", 0.95F, 0.95F, 0.95F, 0.95F, 0.95F, 0.95F);
			return;
		}
		if (regiment.country() == PaintScheme.countryChina) {
			changeMat(hiermesh, "Overlay1", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k),
					"Slovakian/" + k / 10 + ".tga", "Slovakian/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k),
					"Slovakian/" + k / 10 + ".tga", "Slovakian/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countrySpainRep) {
			if (k > 9) {
				if (k > 19) {
					changeMat(class1, hiermesh, "Overlay2", "ESNum_" + regiment.id() + 17 + k % 10, "Spanish/" + regiment.id()
							+ 17 + k % 10 + ".tga", 1.0F, 1.0F, 1.0F);
					changeMat(class1, hiermesh, "Overlay2", "ESNum_" + regiment.id() + 17 + k % 10, "Spanish/" + regiment.id()
							+ 17 + k % 10 + ".tga", 1.0F, 1.0F, 1.0F);
				} else {
					changeMat(class1, hiermesh, "Overlay2", "ESNum_" + regiment.id() + 16 + k % 10, "Spanish/" + regiment.id()
							+ 16 + k % 10 + ".tga", 1.0F, 1.0F, 1.0F);
					changeMat(class1, hiermesh, "Overlay3", "ESNum_" + regiment.id() + 16 + k % 10, "Spanish/" + regiment.id()
							+ 16 + k % 10 + ".tga", 1.0F, 1.0F, 1.0F);
				}
			} else {
				changeMat(class1, hiermesh, "Overlay2", "ESNum_" + regiment.id() + 15 + k, "Spanish/" + regiment.id() + 15 + k
						+ ".tga", 1.0F, 1.0F, 1.0F);
				changeMat(class1, hiermesh, "Overlay3", "ESNum_" + regiment.id() + 15 + k, "Spanish/" + regiment.id() + 15 + k
						+ ".tga", 1.0F, 1.0F, 1.0F);
			}
		...
		if (regiment.country() == PaintScheme.countryManagua) {
			changeMat(hiermesh, "Overlay1", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countrySpainNat) {
			...
			changeMat(hiermesh, "Overlay1", "BlackNum_00" + (j1 < 10 ? "0" + j1 : "" + j1), "Default/1" + j1 / 10 + ".tga",
					"Default/1" + j1 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "BlackNum_00" + (j1 < 10 ? "0" + j1 : "" + j1), "Default/1" + j1 / 10 + ".tga",
					"Default/1" + j1 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay2", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay3", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryIsrael) {
			changeMat(hiermesh, "Overlay2", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k),
					"Slovakian/" + k / 10 + ".tga", "Slovakian/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay3", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k),
					"Slovakian/" + k / 10 + ".tga", "Slovakian/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryCanada) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay1", "CARegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", PaintScheme.psBritishSkyColor[0], PaintScheme.psBritishSkyColor[1],
					PaintScheme.psBritishSkyColor[2], PaintScheme.psBritishSkyColor[0], PaintScheme.psBritishSkyColor[1],
					PaintScheme.psBritishSkyColor[2]);
			changeMat(hiermesh, "Overlay3", "CARegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", PaintScheme.psBritishSkyColor[0], PaintScheme.psBritishSkyColor[1],
					PaintScheme.psBritishSkyColor[2], PaintScheme.psBritishSkyColor[0], PaintScheme.psBritishSkyColor[1],
					PaintScheme.psBritishSkyColor[2]);
			changeMat(hiermesh, "Overlay2", "BritishLnum_" + l + i + (k < 10 ? "0" + k : "" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", PaintScheme.psBritishSkyColor[0],
					PaintScheme.psBritishSkyColor[1], PaintScheme.psBritishSkyColor[2], 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "BritishRnum_" + l + i + (k < 10 ? "0" + k : "" + k), "null.tga", "British/"
					+ (char)((65 + k) - 1) + ".tga", 1.0F, 1.0F, 1.0F, PaintScheme.psBritishSkyColor[0],
					PaintScheme.psBritishSkyColor[1], PaintScheme.psBritishSkyColor[2]);
		...
		if (regiment.country() == PaintScheme.countryCanadaBlue) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay1", "CABRegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "CABRegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "CBritishLnum_" + l + i + (k < 10 ? "0" + k : "" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "CBritishRnum_" + l + i + (k < 10 ? "0" + k : "" + k), "null.tga", "British/"
					+ (char)((65 + k) - 1) + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(class1, hiermesh, "Overlay6", "CARoundel", "CA/CARoundel.tga", 1.0F, 1.0F, 1.0F);
			changeMat(class1, hiermesh, "Overlay7", "CARoundel", "CA/CARoundel.tga", 1.0F, 1.0F, 1.0F);
			changeMat(class1, hiermesh, "Overlay8", "CATail", "CA/CATail.tga", 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryItalyAllied) {
			changeMat(hiermesh, "Overlay1", "ITLDefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "IA/1" + k / 10 + ".tga",
					"IA/1" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "ITLDefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "IA/1" + k / 10 + ".tga",
					"IA/1" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryRomaniaAllied) {
			changeMat(hiermesh, "Overlay1", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay4", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
		...
		if (regiment.country() == PaintScheme.countryFinlandAllied) {
			...
			changeMat(hiermesh, "Overlay2", "psFM06FINACID" + s2 + c1, "Finnish/" + s2 + ".tga", "Finnish/sn" + c1 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			changeMat(hiermesh, "Overlay3", "psFM06FINACID" + s2 + c1, "Finnish/" + s2 + ".tga", "Finnish/sn" + c1 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryBelgium) {
			changeMat(hiermesh, "Overlay2", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryNorway) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay1", "NORegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "NORegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "BritishLnum_" + l + i + (k < 10 ? "0" + k : "" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "BritishRnum_" + l + i + (k < 10 ? "0" + k : "" + k), "null.tga", "British/"
		...
		if (regiment.country() == PaintScheme.countryGreece) {
			changeMat(hiermesh, "Overlay1", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryBrazil) {
			...
			changeMat(hiermesh, "Overlay8", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			return;
		}
		if (regiment.country() == PaintScheme.countrySweden) {
			int k1 = Integer.parseInt(regiment.id());
			changeMat(hiermesh, "Overlay2", "BlackNum_00" + (k1 < 10 ? "0" + k1 : "" + k1), "Slovakian/" + k1 / 10 + ".tga",
					"Slovakian/" + k1 % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "BlackNum_00" + (k1 < 10 ? "0" + k1 : "" + k1), "Slovakian/" + k1 / 10 + ".tga",
					"Slovakian/" + k1 % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			...
			changeMat(hiermesh, "Overlay8", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k),
					"Slovakian/" + k / 10 + ".tga", "Slovakian/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			return;
		}
		if (regiment.country() == PaintScheme.countrySouthAfrica) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay1", "SARegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "SARegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "BritishLnum_" + l + i + (k < 10 ? "0" + k : "" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "BritishRnum_" + l + i + (k < 10 ? "0" + k : "" + k), "null.tga", "British/"
		...
		if (regiment.country() == PaintScheme.countryYugoslavia) {
			changeMat(hiermesh, "Overlay1", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k),
					"Slovakian/" + k / 10 + ".tga", "Slovakian/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay4", "DefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k),
					"Slovakian/" + k / 10 + ".tga", "Slovakian/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0],
		...
		if (regiment.country() == PaintScheme.countryCroatia) {
			changeMat(hiermesh, "Overlay2", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Slovakian/" + k / 10 + ".tga",
					"Slovakian/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay3", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Slovakian/" + k / 10 + ".tga",
					"Slovakian/" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryThailand) {
			...
			changeMat(hiermesh, "Overlay1", "BlackNum_00" + (l1 < 10 ? "0" + l1 : "" + l1), "Default/1" + l1 / 10 + ".tga",
					"Default/1" + l1 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "BlackNum_00" + (l1 < 10 ? "0" + l1 : "" + l1), "Default/1" + l1 / 10 + ".tga",
					"Default/1" + l1 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay2", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay3", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
		...
		if (regiment.country() == PaintScheme.countryThailandBlue) {
			...
			changeMat(hiermesh, "Overlay1", "BlackNum_00" + (i2 < 10 ? "0" + i2 : "" + i2), "Default/1" + i2 / 10 + ".tga",
					"Default/1" + i2 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "BlackNum_00" + (i2 < 10 ? "0" + i2 : "" + i2), "Default/1" + i2 / 10 + ".tga",
					"Default/1" + i2 % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay2", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay3", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
		...
		if (regiment.country() == PaintScheme.countryManchukuo) {
			...
			changeMat(hiermesh, "Overlay8", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
					"Default/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryRussianEmpire) {
		...
		if (regiment.country() == PaintScheme.countryAbyssinia) {
			...
			changeMat(class1, hiermesh, "Overlay8", "ABTail", "AB/ABWings.tga", 1.0F, 1.0F, 1.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countryMexico) {
			changeMat(hiermesh, "Overlay1", "BlackNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Default/1" + k / 10 + ".tga",
		...
		if (regiment.country() == PaintScheme.countryIraq) {
			changeMat(hiermesh, "Overlay2", "ArabicNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Arabic/1" + k / 10 + ".tga",
					"Arabic/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay3", "ArabicNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Arabic/1" + k / 10 + ".tga",
					"Arabic/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (regiment.country() == PaintScheme.countryGenericBlue) {
			changeMat(hiermesh, "Overlay4", "psBM00BNGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay1", "psBM00BNGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
		...
		if (regiment.country() == PaintScheme.countryGenericRed) {
			changeMat(hiermesh, "Overlay4", "psBM00RNGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay1", "psBM00RNGCNUM" + (k >= 10 ? "" + k : "0" + k), "German/" + k / 10 + ".tga",
					"German/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0], PaintScheme.psBritishRedColor[1],
					PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryCzechoslovakia) {
			changeMat(hiermesh, "Overlay1", "DefaultcNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Slovakian/" + k / 10
					+ ".tga", "Slovakian/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
			changeMat(hiermesh, "Overlay4", "DefaultcNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Slovakian/" + k / 10
					+ ".tga", "Slovakian/" + k % 10 + ".tga", PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2], PaintScheme.psBritishRedColor[0],
					PaintScheme.psBritishRedColor[1], PaintScheme.psBritishRedColor[2]);
		...
		if (regiment.country() == PaintScheme.countryPortugal) {
			k = clampToLiteral(k);
			changeMat(hiermesh, "Overlay1", "PTRegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay3", "PTRegi_" + regiment.id(), "British/" + regiment.aid()[0] + ".tga", "British/"
					+ regiment.aid()[1] + ".tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay2", "BritishLnum_" + l + i + (k < 10 ? "0" + k : "" + k), "British/"
					+ (char)((65 + k) - 1) + ".tga", "null.tga", 0.1F, 0.1F, 0.1F, 0.1F, 0.1F, 0.1F);
			changeMat(hiermesh, "Overlay4", "BritishRnum_" + l + i + (k < 10 ? "0" + k : "" + k), "null.tga", "British/"
		...
		if (regiment.country() == PaintScheme.countryLithuania) {
			...
			changeMat(hiermesh, "Overlay2", "psFM06FINACID" + s3 + c2, "Finnish/" + s3 + ".tga", "Finnish/sn" + c2 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
			changeMat(hiermesh, "Overlay3", "psFM06FINACID" + s3 + c2, "Finnish/" + s3 + ".tga", "Finnish/sn" + c2 + ".tga",
					0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
		...
		if (regiment.country() == PaintScheme.countryColombia) {
			...
			changeMat(class1, hiermesh, "Overlay7", "CORoundel", "CO/CORoundel.tga", 1.0F, 1.0F, 1.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countrySyria) {
			...
			changeMat(hiermesh, "Overlay8", "SYTailNum_" + l + i + (k < 10 ? "0" + k : "" + k), "Arabic/1" + k / 10 + ".tga",
					"Arabic/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			return;
		}
		if (regiment.country() == PaintScheme.countrySyriaRed) {
		...
		if (regiment.country() == PaintScheme.countryItalyANR) {
			changeMat(hiermesh, "Overlay1", "ANRDefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "IA/1" + k / 10 + ".tga",
					"IA/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
			changeMat(hiermesh, "Overlay4", "ANRDefaultNum_" + l + i + (k < 10 ? "0" + k : "" + k), "IA/1" + k / 10 + ".tga",
					"IA/1" + k % 10 + ".tga", 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F);
