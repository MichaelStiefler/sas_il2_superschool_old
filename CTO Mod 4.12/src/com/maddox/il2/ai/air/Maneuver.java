...
public class Maneuver extends AIFlightModel {
	...
	private void set_flags() {
		...
		if (maneuver != 48 && maneuver != 0 && maneuver != 26 && maneuver != 64 && maneuver != 102 && maneuver != 44)
			resetControls();
		if (maneuver == 20 || maneuver == 25 || maneuver == 102 || maneuver == 1 || maneuver == 26 || maneuver == 69 || maneuver == 44 || maneuver == 49 || maneuver == 43 || maneuver == 50 || maneuver == 51 || maneuver == 73 || maneuver == 46
		...
		if (maneuver == 60 || maneuver == 61 || maneuver == 102 || maneuver == 1 || maneuver == 24 || maneuver == 26 || maneuver == 69 || maneuver == 64 || maneuver == 44)
			...
			checkStrike = true;
		if (maneuver == 44 || maneuver == 1 || maneuver == 48 || maneuver == 0 || maneuver == 26 || maneuver == 69 || maneuver == 64 || maneuver == 43 || maneuver == 50 || maneuver == 51 || maneuver == 52 || maneuver == 47 || maneuver == 71
					...
					if (canTakeoff) {
						if (!bStage7) {
							if (bStage6) {
								...
								try {
									theTypeSupersonicClass = Class.forName("com.maddox.il2.objects.air.Typethissonic");
								} catch (Exception e) {
								}
								try {
								...
								if ((theTypeSupersonicClass != null) && (this.actor != null) && (this.actor.getClass().isInstance(theTypeSupersonicClass)))
									bIsTypeSupersonic = true;
								if ((theTypeFastJetClass != null) && (this.actor != null) && (this.actor.getClass().isInstance(theTypeFastJetClass)))
									bIsTypeFastJet = true;
								if ((theF9FClass != null) && (this.actor != null) && (this.actor.getClass().isInstance(theF9FClass)))
									bIsF9F = true;
								if (this.CT.bHasCockpitDoorControl && (bIsTypeSupersonic | bIsTypeFastJet | bIsF9F)) {
									if (bFastLaunchAI)
