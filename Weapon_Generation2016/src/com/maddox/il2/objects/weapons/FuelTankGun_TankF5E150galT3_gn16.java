    ...
    private void checkChangeWeaponColors()
    {
        for(int i = 0; i < ((FlightModelMain) (super.FM)).CT.Weapons.length; i++)
            if(((FlightModelMain) (super.FM)).CT.Weapons[i] != null)
            {
                ...
                {
                    if(((FlightModelMain) (super.FM)).CT.Weapons[i][j] instanceof FuelTankGun_TankF5E150galT3_gn16)
                        ((FuelTankGun_TankF5E150galT3_gn16)((FlightModelMain) (super.FM)).CT.Weapons[i][j]).matTwoTone();
                }
            }
    }
...
public class FuelTankGun_TankF5E150galT3_gn16 extends FuelTankGun
{
    ...
    {
        ((FuelTank_TankF5E150galT3_gn16) bomb).matTwoTone();
    }

    public void matGreen()
    {
        ((FuelTank_TankF5E150galT3_gn16) bomb).matGreen();
    }
