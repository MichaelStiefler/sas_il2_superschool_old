...
public class BombMk77NapalmMod1_gn16 extends Bomb
{
    ...
    private void doFireContaineds()
    {
        ...
        for(int i = 0; i < 14; i++)
        {
            ...
            if(i < 3)
            {
                vector3d1.x *= 0.54000001192092896D;
                vector3d1.y *= 0.54000001192092896D;
            ...
            {
                vector3d1.x *= 0.59000002384185791D;
                vector3d1.y *= 0.59000002384185791D;
