...
public class FuelTank_TankSkyhawk_Highvis_gn16 extends FuelTank
{

    public FuelTank_TankSkyhawk_Highvis_gn16()
    {
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.FuelTank_TankSkyhawk_Highvis_gn16.class;
