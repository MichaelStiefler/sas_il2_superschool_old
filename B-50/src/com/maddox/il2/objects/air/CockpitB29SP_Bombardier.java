...
public class CockpitB29SP_Bombardier extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((B_29SP)aircraft()).fSightCurForwardAngle;
            float f1 = ((B_29SP)aircraft()).fSightCurSideslip;
            ...
            if(bEntered)
            {
                ...
                hookpilot.setInstantOrient(aAim + 10F * f1, tAim + CockpitB29SP_Bombardier.calibrAngle + f, 0.0F);
            }
            if(fm != null)
            {
                if(bNeedSetUp)
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((B_29SP)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((B_29SP)aircraft()).fSightCurReadyness > 0.93F;
    ...
    static 
    {
        Property.set(com.maddox.il2.objects.air.CockpitB29SP_Bombardier.class, "astatePilotIndx", 0);
    }
}