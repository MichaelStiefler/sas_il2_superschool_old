// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 25.11.2013 19:37:14
...
public class CockpitSu_25 extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
      ...
      //          f = ((Su_25X)aircraft()).fSightCurForwardAngle;
      //          f1 = ((Su_25X)aircraft()).fSightCurSideslip;
                f2 = fm.getAltitude();
...
//        Su_25.spot.get(laserP);

        laserP = Su_25.spot;
    	
    double x = ((Tuple3d) ((Point3d)laserP)).x;
    tangage = ((Tuple3d) ((Point3d)laserP)).y;
    azimult = ((Tuple3d) ((Point3d)laserP)).z;
        FOV = 2680D / x;
        double d3 = -((Tuple3d) ((Point3d)laserP)).y * FOV;
        double d4 = ((Tuple3d) ((Point3d)laserP)).z * FOV;
        double d5 = ((Tuple3d) ((Point3d)laserP)).x;
